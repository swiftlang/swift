...
macro(swift_common_cxx_warnings)
  ...
  check_cxx_compiler_flag("-Werror -Wdocumentation"
    CXX_SUPPORTS_DOCUMENTATION_FLAG)
  if(CXX_SUPPORTS_DOCUMENTATION_FLAG)
    add_compile_options($<$<COMPILE_LANGUAGE:CXX>:-Wdocumentation>)
  endif()

  check_cxx_compiler_flag("-Werror -Wimplicit-fallthrough"
    CXX_SUPPORTS_IMPLICIT_FALLTHROUGH_FLAG)
  if(CXX_SUPPORTS_IMPLICIT_FALLTHROUGH_FLAG)
    add_compile_options($<$<COMPILE_LANGUAGE:CXX>:-Wimplicit-fallthrough>)
  endif()

  # Check for -Wunreachable-code-aggressive instead of -Wunreachable-code, as
  # that indicates that we have the newer -Wunreachable-code implementation.
  check_cxx_compiler_flag("-Werror -Wunreachable-code-aggressive"
    CXX_SUPPORTS_UNREACHABLE_CODE_FLAG)
  if(CXX_SUPPORTS_UNREACHABLE_CODE_FLAG)
    add_compile_options($<$<COMPILE_LANGUAGE:CXX>:-Wunreachable-code>)
  endif()

  check_cxx_compiler_flag("-Werror -Woverloaded-virtual"
    CXX_SUPPORTS_OVERLOADED_VIRTUAL)
  ...
  check_cxx_compiler_flag("-fapplication-extension"
    CXX_SUPPORTS_FAPPLICATION_EXTENSION)

  # Disable C4068: unknown pragma. This means that MSVC doesn't report hundreds
  # of warnings across the repository for IDE features such as #pragma mark
  # "Title".
