...
#   Libraries that this library depends on that have been imported from an
#   already build CMake project.
#
# FRAMEWORK_DEPENDS
...
function(_add_swift_library_single target name)
  ...
  cmake_parse_arguments(SWIFTLIB_SINGLE
    ...
    "DEPENDS;LINK_LIBRARIES;FRAMEWORK_DEPENDS;FRAMEWORK_DEPENDS_WEAK;COMPONENT_DEPENDS;C_COMPILE_FLAGS;SWIFT_COMPILE_FLAGS;LINK_FLAGS;PRIVATE_LINK_LIBRARIES;INTERFACE_LINK_LIBRARIES;INCORPORATE_OBJECT_LIBRARIES;FILE_DEPENDS;LINK_IMPORTED_LIBRARIES"
    ${ARGN})
  ...
  elseif("${libkind}" STREQUAL "OBJECT")
    ...
    target_link_libraries("${target}" INTERFACE ${SWIFTLIB_SINGLE_LINK_LIBRARIES} ${SWIFTLIB_SINGLE_LINK_IMPORTED_LIBRARIES})
  endif()
    ...
    foreach(sdk ${SWIFTLIB_TARGET_SDKS})
      ...
      foreach(arch ${SWIFT_SDK_${sdk}_ARCHITECTURES})
        ...
        _add_swift_library_single(
          ...
          LINK_IMPORTED_LIBRARIES ${SWIFTLIB_LINK_IMPORTED_LIBRARIES}
...
function(_add_swift_executable_single name)
  ...
  cmake_parse_arguments(SWIFTEXE_SINGLE
    ...
    "SDK;ARCHITECTURE"
    "DEPENDS;COMPONENT_DEPENDS;LINK_LIBRARIES;LINK_FAT_LIBRARIES;LINK_IMPORTED_LIBRARIES"
    ${ARGN})
...
#     [LINK_IMPORTED_LIBRARIES target1 ...]
#     [EXCLUDE_FROM_ALL]
#     [DONT_STRIP_NON_MAIN_SYMBOLS]
#     [DISABLE_ASLR]
#     source1 [source2 source3 ...])
...
function(add_swift_executable name)
  ...
  cmake_parse_arguments(SWIFTEXE
    "EXCLUDE_FROM_ALL;DONT_STRIP_NON_MAIN_SYMBOLS;DISABLE_ASLR"
    ""
    "DEPENDS;COMPONENT_DEPENDS;LINK_LIBRARIES;LINK_IMPORTED_LIBRARIES"
    ${ARGN})
  ...
  _add_swift_executable_single(
      ...
      LINK_IMPORTED_LIBRARIES ${SWIFTEXE_LINK_IMPORTED_LIBRARIES}
