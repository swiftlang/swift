...
#
# TARGET_SDKS_EXCLUDE
#   The set of SDKs in which this library is NOT included.  If empty, the
#   library is included in all SDKs.
#
# C_COMPILE_FLAGS
...
function(add_swift_library name)
  ...
  if(NOT "${SWIFTLIB_TARGET_SDKS_EXCLUDE}" STREQUAL "")
    list(REMOVE_ITEM SWIFTLIB_TARGET_SDKS ${SWIFTLIB_TARGET_SDKS_EXCLUDE})
  endif()
