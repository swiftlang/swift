...
macro(configure_sdk_unix name architectures)
  ...
  elseif("${prefix}" STREQUAL "WASI" OR "${prefix}" STREQUAL "WASIP2" OR "${prefix}" STREQUAL "EMSCRIPTEN")
  ...
  foreach(arch ${architectures})
    if("${prefix}" STREQUAL "ANDROID")
      ...
      if("${prefix}" STREQUAL "LINUX")
        ...
        elseif(arch MATCHES "(aarch64|i686|powerpc|powerpc64|powerpc64le|s390x|x86_64|riscv64|mipsel|mips64el)")
      ...
      elseif("${prefix}" STREQUAL "WASIP2")
        ...
        set(SWIFT_SDK_WASIP2_ARCH_wasm32_PATH "${SWIFT_WASIP2_SYSROOT_PATH}")
        set(SWIFT_SDK_WASIP2_ARCH_wasm32_TRIPLE "wasm32-unknown-wasip2")
      elseif("${prefix}" STREQUAL "EMSCRIPTEN")
        if(NOT arch STREQUAL "wasm32")
