...
public let benchmarks: [BenchmarkInfo] = [
  BenchmarkInfo(
    ...
    runFunction: run_UncheckedStr8_Walk_Ascii,
    tags: uncheckedStringTags),
  BenchmarkInfo(
    name: "UncheckedStr8.Walk.Ascii.Indices",
    runFunction: run_UncheckedStr8_Walk_Ascii_Indices,
    tags: uncheckedStringTags),
  BenchmarkInfo(
    name: "UncheckedStr8.Walk.Ascii.Backwards",
    runFunction: run_UncheckedStr8_Walk_Ascii_Backwards,
    tags: uncheckedStringTags),
  BenchmarkInfo(
    name: "UncheckedStr8.Walk.Emoji",
    runFunction: run_UncheckedStr8_Walk_Emoji,
    tags: uncheckedStringTags),
  BenchmarkInfo(
    name: "UncheckedStr8.Walk.CJK",
    runFunction: run_UncheckedStr8_Walk_CJK,
    tags: uncheckedStringTags),

  BenchmarkInfo(
    name: "UncheckedStr8.Cmp.Ascii",
    runFunction: { compareLoop($0, comparisonAscii) },
    tags: uncheckedStringTags,
    setUpFunction: { blackHole(comparisonAscii) }),
  BenchmarkInfo(
    name: "UncheckedStr8.Cmp.Emoji",
    runFunction: { compareLoop($0, comparisonEmoji) },
    tags: uncheckedStringTags,
    setUpFunction: { blackHole(comparisonEmoji) }),
  BenchmarkInfo(
    name: "UncheckedStr8.Cmp.CJK",
    runFunction: { compareLoop($0, comparisonCJK) },
    tags: uncheckedStringTags,
    setUpFunction: { blackHole(comparisonCJK) }),
  BenchmarkInfo(
    name: "UncheckedStr8.Cmp.SharedPrefix",
    runFunction: { compareLoop($0, comparisonSharedPrefix) },
    tags: uncheckedStringTags,
    setUpFunction: { blackHole(comparisonSharedPrefix) }),
  BenchmarkInfo(
    name: "UncheckedStr8.Hash.Ascii",
    runFunction: { hashLoop($0, comparisonAscii) },
    tags: uncheckedStringTags,
    setUpFunction: { blackHole(comparisonAscii) }),
  BenchmarkInfo(
    name: "UncheckedStr8.Hash.Emoji",
    runFunction: { hashLoop($0, comparisonEmoji) },
    tags: uncheckedStringTags,
    setUpFunction: { blackHole(comparisonEmoji) }),

  BenchmarkInfo(
    name: "UncheckedStr8.HasPrefix.Ascii",
    runFunction: {
      hasPrefixLoop($0, hasPrefixAsciiString, hasPrefixAsciiPrefix, 10_000)
    },
    tags: uncheckedStringTags),
  BenchmarkInfo(
    name: "UncheckedStr8.HasPrefix.Unicode",
    runFunction: {
      hasPrefixLoop($0, hasPrefixUnicodeString, hasPrefixUnicodePrefix, 100)
    },
    tags: uncheckedStringTags),
  BenchmarkInfo(
    name: "UncheckedStr8.HasSuffix.Ascii",
    runFunction: {
      hasSuffixLoop($0, hasSuffixAsciiString, hasSuffixAsciiSuffix, 10_000)
    },
    tags: uncheckedStringTags),
  BenchmarkInfo(
    name: "UncheckedStr8.HasSuffix.Unicode",
    runFunction: {
  ...
  BenchmarkInfo(
    name: "UncheckedStr8.Builder.Small",
    runFunction: run_UncheckedStr8_Builder_Small,
    tags: uncheckedStringTags),
  BenchmarkInfo(
    name: "UncheckedStr8.Builder.Dynamic",
    runFunction: run_UncheckedStr8_Builder_Dynamic,
    tags: uncheckedStringTags),

  BenchmarkInfo(
    name: "UncheckedStr8.replaceSubrange.Small",
    runFunction: { replaceSubrangeLoop($0, replaceSmallBase, replacement) },
    tags: uncheckedStringTags),
  BenchmarkInfo(
    name: "UncheckedStr8.replaceSubrange.Large",
    runFunction: { replaceSubrangeLoop($0, replaceLargeBase, replacement) },
    tags: uncheckedStringTags),

  BenchmarkInfo(
    name: "UncheckedStr8.encode.Ascii",
    runFunction: { encodeLoop($0, encodeAsciiSource) },
    tags: uncheckedStringTags),
  BenchmarkInfo(
    name: "UncheckedStr8.encode.Unicode",
    runFunction: { encodeLoop($0, encodeUnicodeSource) },
    tags: uncheckedStringTags),
  BenchmarkInfo(
    name: "UncheckedStr8.decode.Ascii",
    runFunction: { decodeLoop($0, decodeAsciiSource) },
    tags: uncheckedStringTags),
  BenchmarkInfo(
    name: "UncheckedStr8.decode.Unicode",
...
private func encodeLoop(_ n: Int, _ source: String) {
  for _ in 0 ..< 2000 * n {
    blackHole(
      getString(source).encode(as: UTF8.self, onUnsupportedEncoding: .substitute))
  }
}
...
private func decodeLoop(_ n: Int, _ source: UStr) {
  for _ in 0 ..< 2000 * n {
    blackHole(identity(source).decode(as: UTF8.self, onInvalidEncoding: .substitute))
  }
}
