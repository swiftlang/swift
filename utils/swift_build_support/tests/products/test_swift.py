...
class SwiftTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.args = argparse.Namespace(
            ...
            enable_experimental_tutorial=False,
    ...
    def test_by_default_no_cmake_options(self):
        ...
        expected = [
            ...
            '-DSWIFT_ENABLE_EXPERIMENTAL_TUTORIAL:BOOL=FALSE',
    ...
    def test_experimental_tutorial_flags(self):
        self.args.enable_experimental_tutorial = True
        swift = Swift(
            args=self.args,
            toolchain=self.toolchain,
            source_dir='/path/to/src',
            build_dir='/path/to/build')
        self.assertEqual(
            ['-DSWIFT_ENABLE_EXPERIMENTAL_TURORIAL:BOOL='
             'TRUE'],
            [x for x in swift.cmake_options
             if 'DSWIFT_ENABLE_EXPERIMENTAL_TUTORIAL' in x])
