# swift_build_support/host_specific_configuration.py ----------- -*- python -*-
#
...
class HostSpecificConfiguration(object):
    ...
    def __init__(self, host_target, args):
        ...
        for deployment_target_name in stdlib_targets_to_configure:
            ...
            build = deployment_platform not in platforms_to_skip_build
            test = deployment_platform not in platforms_to_skip_test
            test_host_only = None
            ...
            if deployment_platform.is_darwin and \
               ...
               not deployment_platform.is_simulator:
                if deployment_platform not in platforms_to_skip_test_host:
                    test_host_only = True
                    test = True
                else:
                    test = False
