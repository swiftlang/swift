...
class SwiftSystem(product.Product):
    @classmethod
    ...
    # TODO: I copied the below defs from swift-testing, what should I do here?
    ...
    def should_install(self, host_target):
        return True # WAS: self.args.install_swift_system
...
class SwiftSystemCMakeShim(cmake_product.CMakeProduct):
    def clean(self, host_target):
