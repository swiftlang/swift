...
class Swift(product.Product):
    ...
    def __init__(self, args, toolchain, source_dir, build_dir):
        ...
        # Add experimental tutorial flag.
        self.cmake_options.extend(self._enable_experimental_tutorial)
...
updated without updating swift.py?")
    ...
    @property
    def _enable_experimental_tutorial(self):
        return [('SWIFT_ENABLE_EXPERIMENTAL_TUTORIAL:BOOL',
                 self.args.enable_experimental_tutorial)]
