  ...
  Invoke-IsolatingEnvVars {
    ...
    Build-CMakeProject `
      ...
      -Defines @{
        ...
        dispatch_DIR = "$(Get-ProjectBinaryCache $Arch Dispatch)\cmake\modules";
      }
  }
}
...
function Test-Format {
  $SwiftPMArguments = @(
    # swift-syntax
    "-Xswiftc", "-I$(Get-ProjectCMakeModules $BuildArch Compilers)\lib\swift\host",
    "-Xswiftc", "-L$(Get-ProjectCMakeModules $BuildArch Compilers)\lib\swift\host",
    # swift-argument-parser
    "-Xswiftc", "-I$(Get-ProjectCMakeModules $BuildArch ArgumentParser)\swift",
    "-Xlinker", "-L$(Get-ProjectCMakeModules $BuildArch ArgumentParser)\lib",
    # swift-cmark
    ...
    # swift-markdown
    "-Xlinker", "$(Get-ProjectCMakeModules $BuildArch Markdown)\lib\CAtomic.lib",
    "-Xswiftc", "-I$SourceCache\swift-markdown\Sources\CAtomic\include",
    "-Xswiftc", "-I$(Get-ProjectCMakeModules $BuildArch Markdown)\swift",
    "-Xlinker", "-L$(Get-ProjectCMakeModules $BuildArch Markdown)\lib",
    # swift-format
    "-Xswiftc", "-I$(Get-ProjectCMakeModules $BuildArch Format)\swift",
    "-Xlinker", "-L$(Get-ProjectCMakeModules $BuildArch Format)\lib"
  )
