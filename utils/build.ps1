...
$DefaultPinned = @{
  AMD64 = @{
    PinnedBuild = "https://ci-external.swift.org/job/swift-main-windows-toolchain/1710/artifact/build/artifacts/installer.exe";
    PinnedSHA256 = "FEB0A9072A377B345C356116AB995E37624BC50B8F31C227407B1B332192012F";
    PinnedVersion = "0.0.0";
  };
  ARM64 = @{
    PinnedBuild = ""
