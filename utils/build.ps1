...
$DefaultPinned = @{
  AMD64 = @{
    PinnedBuild = "https://ci-external.swift.org/job/swift-PR-build-toolchain-windows/6153/artifact/build/artifacts/installer.exe";
    PinnedSHA256 = "71E921FD9E15C981E94E974F761859CAB4ECF33523245F5808609477D418C131";
    PinnedVersion = "0.0.0";
  };
  ARM64 = @{
