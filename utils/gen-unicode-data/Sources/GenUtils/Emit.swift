...
func _eytzingerize<C: Collection>(_ collection: C, result: inout [C.Element], sourceIndex: Int, resultIndex: Int) -> Int
 ...
 */
public func eytzingerize<C: Collection>(_ collection: C, dummy: C.Element) -> [C.Element]
where C.Element: Comparable, C.Index == Int {
