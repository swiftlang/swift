...
SWIFT_USER_VISIBLE_VERSION = Version('6.5')
CLANG_USER_VISIBLE_VERSION = Version('21.0.0')
SWIFT_ANALYZE_CODE_COVERAGE = 'false'

DARWIN_XCRUN_TOOLCHAIN = 'default'
DARWIN_DEPLOYMENT_VERSION_OSX = '15.0'
DARWIN_DEPLOYMENT_VERSION_IOS = '18.0'
DARWIN_DEPLOYMENT_VERSION_TVOS = '18.0'
DARWIN_DEPLOYMENT_VERSION_WATCHOS = '11.0'
DARWIN_DEPLOYMENT_VERSION_XROS = '2.0'
