...
EXPECTED_DEFAULTS = {
    ...
    'build_swift_testing_harness': False,
    ...
    'install_swift_testing_harness': False,
    ...
    'build_wasmkit': False,
    'build_emscriptenstdlib': False,
    'build_emscripten_host_llvm': False,
    'build_emscripten_host_swift': False,
    ...
    'caching_depscan_socket': '/tmp/clang-scand',
    'caching_plugin_path': None,
    'caching_plugin_option': [],
    'caching_prefix_map': False,
    'caching_remote_service_path': None,
    'dry_run': False,
...
EXPECTED_OPTIONS = [
    ...
    # SetTrueOption('--swift-testing-harness', dest='build_swift_testing_harness'),
    ...
    SetTrueOption('--build-emscripten-stdlib', dest='build_emscriptenstdlib'),
    SetTrueOption('--build-emscripten-host-llvm',
                  dest='build_emscripten_host_llvm'),
    SetTrueOption('--build-emscripten-host-swift',
                  dest='build_emscripten_host_swift'),
    ...
    EnableOption('--enable-caching'),
    EnableOption('--caching-prefix-map'),
    ...
    # EnableOption('--install-swift-testing-harness',
    #              dest='install_swift_testing_harness'),
    ...
    DisableOption('--skip-test-emscripten-stdlib',
                  dest='test_emscriptenstdlib'),
    ...
    StrOption('--caching-depscan-socket'),
    ...
    AppendOption('--caching-plugin-option'),
    ...
    PathOption('--caching-cas-path'),
    PathOption('--caching-plugin-path'),
    PathOption('--caching-remote-service-path'),
