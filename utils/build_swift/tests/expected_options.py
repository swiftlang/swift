...
EXPECTED_OPTIONS = [
    ...
    # TODO: Update test suite to respect multiple destinations as the options
    # -B and --benchmark set both 'build_benchmarks' and 'test_benchmarks'.
    SetTrueOption('--benchmark', dest='build_benchmarks'),
    SetTrueOption('--clean'),
    ...
    SetTrueOption('-B', dest='build_benchmarks'),
