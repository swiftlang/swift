...
EXPECTED_OPTIONS = [
    ...
    EnableOption('--swift-driver', dest='build_swift-driver'),
    ...
    EnableOption('--install-swift-driver', dest='install_swiftdriver'),
    ...
    DisableOption('--skip-test-swift-driver', dest='test_swiftdriver'),
