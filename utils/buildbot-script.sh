...
case "${CMAKE_GENERATOR}" in
    ...
    Xcode)
        ...
        COMMON_CMAKE_OPTIONS=(
            "${COMMON_CMAKE_OPTIONS[@]}"
            -DCMAKE_XCODE_ATTRIBUTE_CLANG_WARN_BOOL_CONVERSION=YES
            -DCMAKE_XCODE_ATTRIBUTE_CLANG_WARN_EMPTY_BODY=YES
            -DCMAKE_XCODE_ATTRIBUTE_CLANG_WARN_ENUM_CONVERSION=YES
            -DCMAKE_XCODE_ATTRIBUTE_CLANG_WARN_INT_CONVERSION=YES
            -DCMAKE_XCODE_ATTRIBUTE_CLANG_WARN_CONSTANT_CONVERSION=YES
            -DCMAKE_XCODE_ATTRIBUTE_GCC_WARN_ABOUT_RETURN_TYPE=YES
            -DCMAKE_XCODE_ATTRIBUTE_GCC_WARN_HIDDEN_VIRTUAL_FUNCTIONS=YES
            -DCMAKE_XCODE_ATTRIBUTE_GCC_WARN_INITIALIZER_NOT_FULLY_BRACKETED=YES
            -DCMAKE_XCODE_ATTRIBUTE_GCC_WARN_NON_VIRTUAL_DESTRUCTOR=YES
            -DCMAKE_XCODE_ATTRIBUTE_GCC_WARN_SIGN_COMPARE=YES
            -DCMAKE_XCODE_ATTRIBUTE_GCC_WARN_UNINITIALIZED_AUTOS=YES
            -DCMAKE_XCODE_ATTRIBUTE_GCC_WARN_UNUSED_FUNCTION=YES
            -DCMAKE_XCODE_ATTRIBUTE_GCC_WARN_UNUSED_VALUE=YES
            -DCMAKE_XCODE_ATTRIBUTE_GCC_WARN_UNUSED_VARIABLE=YES
