...
public:
  ...
  void visitDeclRefExpr(DeclRefExpr *E, Label label) {
    ...
    printField(E->getFunctionRefKind(), Label::always("function_ref"));
  ...
  void visitOneWayExpr(OneWayExpr *E, Label label) {
...
#undef TRIVIAL_ATTR_PRINTER
  ...
  void visitAvailableAttr(AvailableAttr *Attr, Label label) {
    ...
    if (!Attr->Rename.empty())
      printFieldQuoted(Attr->Rename, Label::always("rename"));
    printFoot();
  }
