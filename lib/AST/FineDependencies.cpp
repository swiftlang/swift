//===--- FineDependencies.cpp - Generates swiftdeps files ---------===//
//
...
void ScalarEnumerationTraits<DeclAspect>::enumeration(
    IO &io, swift::fine_dependencies::DeclAspect &value) {
  using DeclAspect = swift::fine_dependencies::DeclAspect;
...
void MappingTraits<DependencyKey>::mapping(
    IO &io, swift::fine_dependencies::DependencyKey &key) {
...
void MappingTraits<DepGraphNode>::mapping(
    IO &io, swift::fine_dependencies::DepGraphNode &node) {
