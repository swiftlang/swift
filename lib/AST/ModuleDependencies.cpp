...
SwiftDependencyScanningService::getClangScanningFS(ASTContext &ctx) const {
  ...
  ClangInvocationFileMapping fileMapping = getClangInvocationFileMapping(
      ctx, nullptr, /* suppressDiagnostic */ false);
  applyClangInvocationMapping(ctx, fileMapping, baseFileSystem);
