...
std::optional<bool> HasNoncopyableAnnotationRequest::getCachedResult() const {
  auto decl = std::get<0>(getStorage());
...
std::optional<bool> IsEscapableRequest::getCachedResult() const {
  auto decl = std::get<0>(getStorage());
...
std::optional<Type> ThrownTypeRequest::getCachedResult() const {
