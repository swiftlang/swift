...
SILIsolationInfo SILIsolationInfo::get(SILInstruction *inst) {
  ...
  if (auto *pai = dyn_cast<PartialApplyInst>(inst)) {
    ...
    bool allCapturesNonIsolatedUnsafe =
        pai->getArgumentOperands().size() &&
        llvm::all_of(pai->getArgumentOperands(), [](Operand &op) -> bool {
          ...
          return SILIsolationInfo::get(value).isUnsafeNonIsolated();
        });
    ...
    if (auto *ace = pai->getLoc().getAsASTNode<AbstractClosureExpr>()) {
      ...
      if (actorIsolation.isGlobalActor()) {
        return SILIsolationInfo::getGlobalActorIsolated(
            ...
            .withUnsafeNonIsolated(allCapturesNonIsolatedUnsafe);
      }
    ...
    if (allCapturesNonIsolatedUnsafe)
      return SILIsolationInfo::getDisconnected(allCapturesNonIsolatedUnsafe);
  }
