...
static llvm::cl::opt<bool> SILEnableDebugify(
    "sil-enable-debugify", llvm::cl::init(false),
    llvm::cl::desc("Attach debug variables to every instruction result "
                   "generated by SILGen"));
