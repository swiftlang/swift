...
static void addLowLevelPassPipeline(SILPassPipelinePlan &P) {
  ...
  P.addDeadObjectElimination();
  // SWIFT_ENABLE_TENSORFLOW
  // FIXME(SR-8709): ObjectOutliner tries to demangle functions generated by AD,
  // which are not properly mangled. We disable object outliner to unblock AD in
  // user code until AD-generated functions are properly mangled.
  // P.addObjectOutliner();
