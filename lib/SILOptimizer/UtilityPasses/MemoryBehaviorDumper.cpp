...
/// \file
///
/// This pass collects all values in a function and then for each value prints
/// out the memory behavior of a function upon that value. This enables testing
/// of MemoryBehavior independent of any other passes.
///
//===----------------------------------------------------------------------===//

#define DEBUG_TYPE "sil-membehavior-dumper"
