...
static llvm::cl::opt<bool> &ForceVisitImplicitAutogeneratedFunctions() {
  ...
  auto it = opts.find("assemblyvisionremarkgen-visit-implicit-autogen-funcs");
  if (it != opts.end()) {
...
static auto &EarlyInitForceVisitImplicitAutogeneratedFunctions = ForceVisitImplicitAutogeneratedFunctions();

static llvm::cl::opt<bool> &DecllessDebugValueUseSILDebugInfo() {
  auto &opts = llvm::cl::getRegisteredOptions();
  auto it = opts.find("assemblyvisionremarkgen-declless-debugvalue-use-sildebugvar-info");
  if (it != opts.end()) {
    return *static_cast<llvm::cl::opt<bool>*>(it->second);
  }
  static auto *opt = new llvm::cl::opt<bool>(
...
static auto &EarlyInitDecllessDebugValueUseSILDebugInfo = DecllessDebugValueUseSILDebugInfo();

static llvm::cl::opt<bool> &DiagnoseCopyDestroyAddr() {
  auto &opts = llvm::cl::getRegisteredOptions();
  auto it = opts.find("assemblyvisionremarkgen-diagnose-copy-destroy-addr");
  if (it != opts.end()) {
    return *static_cast<llvm::cl::opt<bool>*>(it->second);
  }
  static auto *opt = new llvm::cl::opt<bool>(
...
static auto &EarlyInitDiagnoseCopyDestroyAddr = DiagnoseCopyDestroyAddr();
