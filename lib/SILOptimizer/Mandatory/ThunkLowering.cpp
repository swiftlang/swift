...
struct ThunkBodyBuilder {
  ...
  SILFunctionConventions getThunkConventions() const {
    return SILFunctionConventions(
        getThunkType(), SILAddressConventions::forFunction(*thunk));
  }
...
void ThunkBodyBuilder::callBeginApplyThunkedFunction(
  ...
  auto conventions = SILFunctionConventions(
      calleeType, SILAddressConventions::forFunction(*thunk));
...
SILFunction *IdentityLowering::createThunk() const {
  ...
  auto *fn = funcBuilder.getOrCreateSharedFunction(
      ...
      ActorIsolation::forUnspecified(), IsBare_t::IsNotBare,
      IsTransparent_t::IsNotTransparent, SerializedKind_t::IsNotSerialized,
      ProfileCounter(), IsThunk_t::IsThunk,
