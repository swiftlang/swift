...
namespace irgen {
  ...
  enum : unsigned {
    // Class metadata has five words of head-allocated data: Extended flags
    // field,
    ...
    // Struct and enum metadata have four word of head-allocated data:
    // Extended flags field, typed malloc type id, layout string and
