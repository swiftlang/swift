...
ParserResult<ImportDecl> Parser::parseDeclImport(ParseDeclOptions Flags,
  ...
  if (Context.getBinaryModuleName(parsedModuleID, ASTContext::ModuleAliasLookupOption::binaryNameWithSyntaxNameKey).empty()) {
    ...
    auto aliasName = Context.getBinaryModuleName(parsedModuleID, ASTContext::ModuleAliasLookupOption::syntaxNameWithBinaryNameKey);
