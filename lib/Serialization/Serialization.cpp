...
static decls_block::SerializableLLVMTypeKind
getStableSerializableLLVMTypeKind(llvm::Type::TypeID kind) {
  using Kind = decls_block::SerializableLLVMTypeKind;
  switch (kind) {
  case llvm::Type::HalfTyID: return Kind::Half;
  case llvm::Type::BFloatTyID: return Kind::BFloat;
  case llvm::Type::FloatTyID: return Kind::Float;
  case llvm::Type::DoubleTyID: return Kind::Double;
  case llvm::Type::X86_FP80TyID: return Kind::X86FP80;
  case llvm::Type::FP128TyID: return Kind::FP128;
  case llvm::Type::PPC_FP128TyID: return Kind::PPCFP128;
  case llvm::Type::IntegerTyID: return Kind::Integer;
  case llvm::Type::PointerTyID: return Kind::Pointer;
  case llvm::Type::ArrayTyID: return Kind::Array;
  case llvm::Type::FixedVectorTyID: return Kind::FixedVector;
  case llvm::Type::StructTyID: return Kind::Struct;
...
static decls_block::SerializableReferenceCountingKind
getStableSerializableReferenceCountingKind(
    std::optional<ReferenceCounting> referenceCounting) {
  using Kind = decls_block::SerializableReferenceCountingKind;
  if (!referenceCounting)
    return Kind::Absent;

  switch (*referenceCounting) {
  case ReferenceCounting::Native: return Kind::Native;
  case ReferenceCounting::ObjC: return Kind::ObjC;
  case ReferenceCounting::None: return Kind::None;
  case ReferenceCounting::Custom: return Kind::Custom;
  case ReferenceCounting::Block: return Kind::Block;
  case ReferenceCounting::Unknown: return Kind::Unknown;
  case ReferenceCounting::Bridge: return Kind::Bridge;
  case ReferenceCounting::Error: return Kind::Error;
  }
...
void Serializer::writeSerializableLLVMType(
  ...
  auto kind = getStableSerializableLLVMTypeKind(type.kind);
  unsigned abbrCode = DeclTypeAbbrCodes[SerializableLLVMTypeLayout::Code];
  SerializableLLVMTypeLayout::emitRecord(
      Out, ScratchRecord, abbrCode, static_cast<unsigned>(kind), type.payload,
...
void Serializer::writeSerializableTypeInfoBase(
  ...
  SerializableTypeInfoLayout::emitRecord(
      ...
      representation.alignment, representation.triviallyDestroyable,
      representation.bitwiseTakable, representation.bitwiseBorrowable,
      representation.copyable, representation.alwaysFixedSize,
      representation.abiAccessible);
...
void Serializer::writeSerializableFixedTypeInfo(
  ...
  SerializableFixedTypeInfoLayout::emitRecord(
      Out, ScratchRecord, abbrCode, representation.size,
      representation.spareBits.size(), spareBitWords);
}
...
void Serializer::writeHiddenTypeLayout(const Decl *decl) {
  ...
  SerializableSILTypePropertiesLayout::emitRecord(
      ...
      properties.isFixedABI, properties.isAddressOnly, properties.isResilient,
      properties.isTypeExpansionSensitive, properties.hasRawPointer,
      properties.isLexical, properties.hasPack,
      properties.isAddressableForDependencies, properties.hasRawLayout,
      properties.mayHaveCustomDeinit, properties.isVeryLargeType,
