...
copyCodeCompletionResults(CodeCompletionResultSink &targetSink,
  ...
  std::function<bool(ContextFreeCodeCompletionResult *)> shouldIncludeResult;
  if (onlyTypes) {
    shouldIncludeResult = [](ContextFreeCodeCompletionResult *R) -> bool {
