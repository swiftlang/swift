...
static ManagedValue emitCFunctionPointer(SILGenFunction &SGF,
  ...
  SILDeclRef constant(loc, /*foreign*/ true, false, false);
  SILConstantInfo constantInfo =
      SGF.getConstantInfo(SGF.getTypeExpansionContext(), constant, destFnType);
  ...
  return convertCFunctionSignature(
      SGF, conversionExpr, constantInfo.getSILType(), C, [&]() -> ManagedValue {
        SILValue cRef = SGF.emitGlobalFunctionRef(
            expr, constant, constantInfo,
            /*callPreviousDynamicReplaceableImpl=*/false, destFnType);
