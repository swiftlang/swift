...
/// prologue actor hop(s) injected later by definite initialization.
/// What distinguishes
static bool ctorPrologueHopsAreInjectedByDefiniteInit(ConstructorDecl *ctor,
...
void SILGenFunction::emitConstructorPrologActorHop(
  ...
  if (auto executor = emitExecutor(loc, isolation, self)) {
