...
functionSectionForConvention(llvm::Optional<ForeignAsyncConvention> foreignAsync) {
...
SILValue SILGenFunction::emitForeignErrorBlock(
    SILLocation loc, SILBasicBlock *errorBB, llvm::Optional<ManagedValue> errorSlot,
...
emitErrorIsNonNilErrorCheck(SILGenFunction &SGF, SILLocation loc,
  ...
  // argument.
  SILValue error = SGF.emitForeignErrorBlock(loc, errorBB, llvm::None, foreignAsync);
