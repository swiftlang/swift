...
void SILGenFunction::emitProtocolWitness(AbstractionPattern reqtOrigTy,
  ...
  llvm::dbgs() << "emitting witness thunk\n";
  F.dump();
  llvm::dbgs() << "\n\n";
  ...
  // if (witness.kind == SILDeclRef::Kind::DifferentiationFunc) {
  //   llvm::dbgs() << "origWFT " << origWitnessFTy << "\n";
  //   llvm::dbgs() << "wFT " << witnessFTy << "\n";
  //   llvm::dbgs() << "witness " << witness << "\n";
  //   auto fn = SGM.getEmittedFunction(witness, NotForDefinition);
  //   llvm::dbgs() << "\n\n";

  //   origWitnessFTy = fn->getLoweredFunctionType();
  //   witnessFTy = origWitnessFTy;
  //   llvm::dbgs() << "origWFT " << origWitnessFTy << "\n";
  //   llvm::dbgs() << "wFT " << witnessFTy << "\n";
  //   llvm::dbgs() << "\n\n";
  // }

  // llvm::dbgs() << "skippin the silliness\n";

  SmallVector<ManagedValue, 8> witnessParams;
  llvm::dbgs() << witnessInfo.LoweredType << "\n";
