...
extension ASTGenVisitor {
  ...
  func generateDeclNameRef(declReferenceExpr node: DeclReferenceExprSyntax) -> (
    ...
    return self.generateDeclNameRef(
      ...
      arguments: node.argumentNames.map { argumentClause in
        (
          leftParen: argumentClause.leftParen,
          labels: argumentClause.arguments.lazy.map { $0.name },
          rightParen: argumentClause.rightParen
        )
      }
    )
  }
