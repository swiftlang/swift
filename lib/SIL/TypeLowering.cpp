...
namespace {
  ...
  public:
    ...
    SILValue emitCopyValue(SILBuilder &B, SILLocation loc,
      ...
      B.createRetainValue(loc, value, getAtomicity(B));
      return value;
    }
  ...
  public:
    ...
    SILValue emitCopyValue(SILBuilder &B, SILLocation loc,
      ...
      B.createStrongRetain(loc, value, getAtomicity(B));
      return value;
    }
  ...
  public:
    ...
    SILValue emitCopyValue(SILBuilder &B, SILLocation loc,
      ...
      B.createUnownedRetain(loc, value, getAtomicity(B));
      return value;
    }
    ...
    void emitDestroyValue(SILBuilder &B, SILLocation loc,
      ...
      B.createUnownedRelease(loc, value, getAtomicity(B));
    }
  };
