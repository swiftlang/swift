...
CONSTANT_OWNERSHIP_BUILTIN(None, CreateDetachedContinuation)
CONSTANT_OWNERSHIP_BUILTIN(None, ResumeDetachedContinuationReturning)
CONSTANT_OWNERSHIP_BUILTIN(None, ResumeDetachedThrowingContinuationReturning)
CONSTANT_OWNERSHIP_BUILTIN(None, ResumeDetachedThrowingContinuationThrowing)
CONSTANT_OWNERSHIP_BUILTIN(None, DestroyDetachedContinuation)
