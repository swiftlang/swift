...
CONSTANT_OWNERSHIP_BUILTIN(None, CreateSplitContinuation)
CONSTANT_OWNERSHIP_BUILTIN(None, GetSplitContinuationAddr)
CONSTANT_OWNERSHIP_BUILTIN(None, DestroySplitContinuation)
