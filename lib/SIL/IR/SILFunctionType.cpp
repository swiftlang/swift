...
static CanSILFunctionType getSILFunctionType(
  ...
  auto lowerLifetimeDependence
    ...
    IndexSubset *scopeIndicesSet = lowerIndexSet(
        formalDeps.getScopeIndices(), formalDeps.dependsOnClosureContext());
