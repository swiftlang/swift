...
namespace {
  class ConstraintGenerator : public ExprVisitor<ConstraintGenerator, Type> {
    ...
    Type addSubscriptConstraints(
      ...
      // We do this before adding the member constraint since some member
      // constraints such as key-path dynamic member require the applicable
      // function constraint to be available.
