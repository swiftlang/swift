...
static std::optional<AttributedImport<ImportedModule>>
...
ActorReferenceResult ActorReferenceResult::forSameConcurrencyDomain(
    ActorIsolation isolation) {
  return ActorReferenceResult{SameConcurrencyDomain, std::nullopt, isolation};
}
...
ActorReferenceResult ActorReferenceResult::forExitsActorToNonisolated(
    ActorIsolation isolation) {
  return ActorReferenceResult{ExitsActorToNonisolated, std::nullopt, isolation};
}
...
ActorReferenceResult ActorReferenceResult::forReference(
  ...
  if (isAccessibleAcrossActors(
    ...
    return forEntersActor(declIsolation, std::nullopt);
