...
bool swift::emitReferenceDependencies(DiagnosticEngine &diags,
  ...
  llvm::sys::fs::rename(opts.OutputPaths.ReferenceDependenciesFilePath,
                        opts.OutputPaths.ReferenceDependenciesFilePath + "~");

  std::error_code EC;
  llvm::raw_fd_ostream out(opts.OutputPaths.ReferenceDependenciesFilePath, EC,
                           llvm::sys::fs::F_None);
