...
bool swift::emitReferenceDependencies(DiagnosticEngine &diags,
  ...
  llvm::sys::fs::rename(opts.InputsAndOutputs.pathsForAtMostOnePrimary().ReferenceDependenciesFilePath,
                        opts.InputsAndOutputs.pathsForAtMostOnePrimary().ReferenceDependenciesFilePath + "~");

  std::error_code EC;
  llvm::raw_fd_ostream out(opts.InputsAndOutputs.pathsForAtMostOnePrimary().ReferenceDependenciesFilePath, EC,
                           llvm::sys::fs::F_None);
