...
ClangImporter::create(ASTContext &ctx,
  ...
  if (ppOpts.DetailedRecord)
    PCHContainerOps.reset(new clang::RawPCHContainerOperations());
  else
    PCHContainerOps.reset(new clang::ObjectFilePCHContainerOperations());

  importer->Impl.Instance.reset(new CompilerInstance(PCHContainerOps));
