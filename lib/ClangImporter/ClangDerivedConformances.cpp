...
conformToCxxIteratorIfNeeded(ClangImporter::Implementation &impl,
  ...
  auto *pointee = dyn_cast_or_null<VarDecl>(
      impl.importPropertyFromOperator(PropertyFromOperator::pointee, decl));
  ...
  auto *successor = dyn_cast_or_null<FuncDecl>(
      impl.importPropertyFromOperator(PropertyFromOperator::successor, decl));
...
static void conformToCxxOptional(ClangImporter::Implementation &impl,
  ...
  if (!impl.importPropertyFromOperator(PropertyFromOperator::pointee, decl))
    return;
