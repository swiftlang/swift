  ...
  private func getConcreteTypeOfExistential() -> CanonicalType? {
    ...
    for use in uses {
      ...
      case let iea as InitExistentialAddrInst:
        ...
        initExistential = iea
      case is CheckedCastAddrBranchInst, is UnconditionalCheckedCastAddrInst, is UncheckedAddrCastInst:
    ...
    if let initExistential {
      ...
      return initExistential.type.astType
    }
    if self.type.astType.isExistentialArchetype, let cft = self.concreteTypeOfDependentExistentialArchetype {
