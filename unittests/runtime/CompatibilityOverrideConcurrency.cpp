...
TEST_F(CompatibilityOverrideConcurrencyTest, test_swift_asyncLet_initialize) {
  swift_asyncLet_initialize(nullptr, nullptr);
}

TEST_F(CompatibilityOverrideConcurrencyTest, test_swift_asyncLet_create) {
  swift_asyncLet_create(nullptr);
}
