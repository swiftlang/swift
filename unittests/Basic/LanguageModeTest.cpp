...
TEST(LanguageMode, version) {
  EXPECT_EQ(LanguageMode::v4.version(), std::pair(4, 0));
  EXPECT_EQ(LanguageMode::v4_2.version(), std::pair(4, 2));
  EXPECT_EQ(LanguageMode::v5.version(), std::pair(5, 0));
  EXPECT_EQ(LanguageMode::v6.version(), std::pair(6, 0));
}
