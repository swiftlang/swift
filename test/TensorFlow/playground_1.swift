...
// RUN: %target-swift-frontend -debugger-support -Xllvm -tf-dump-intermediates -Onone -emit-sil -playground %t/main.swift %S/PlaygroundsRuntime.swift
// RUN: %target-swift-frontend -debugger-support -Xllvm -tf-dump-intermediates -Onone -emit-sil -playground %t/main.swift %S/PlaygroundsRuntime.swift -verify | %FileCheck %s
