...
// RUN: %target-swift-frontend -Xllvm -sil-print-types -emit-silgen-ossa -sil-verify-all -enable-sil-opaque-values %s -module-name main -import-objc-header %S/Inputs/open_enum.h -experimental-skip-non-inlinable-function-bodies
