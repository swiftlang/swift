// RUN: %target-swift-frontend(mock-sdk: %clang-importer-sdk) -emit-silgen-ossa -sil-verify-all -enable-sil-opaque-values -I %S/Inputs/custom-modules -import-objc-header %S/Inputs/objc_async_tuple_88949633.h -target %target-swift-5.1-abi-triple %s -verify
