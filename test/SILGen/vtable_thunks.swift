// RUN: %target-swift-frontend -sdk %S/Inputs -emit-silgen -enable-vtable-thunks -I %S/Inputs -enable-source-import %s -disable-objc-attr-requires-foundation-module | FileCheck %s
