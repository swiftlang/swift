// RUN: %target-swift-emit-silgen -parse-stdlib -enable-sil-ownership-verifier -Xllvm -sil-print-debuginfo -verify -primary-file %s %S/Inputs/errors_other.swift | %FileCheck %s
