...
// RUN: %target-swift-emit-silgen-ossa(mock-sdk: %clang-importer-sdk) -enable-sil-opaque-values -Xllvm -sil-print-types -module-name retaining_globals -import-objc-header %S/Inputs/globals.h %s
