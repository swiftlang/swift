// RUN: %target-swift-frontend(mock-sdk: %clang-importer-sdk) -emit-silgen-ossa -sil-verify-all -enable-sil-opaque-values %s -import-objc-header %S/Inputs/objc_error_convention_from_protocol.h
