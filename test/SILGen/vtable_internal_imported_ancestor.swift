...
// RUN: %target-swift-frontend -enable-upcoming-feature InternalImportsByDefault -I %t -emit-silgen-ossa -sil-verify-all -enable-sil-opaque-values %S/Inputs/vtable_internal_imported_ancestor/Repro2.swift -primary-file %s
