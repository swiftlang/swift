...
// RUN: %target-swift-emit-silgen-ossa -enable-sil-opaque-values -module-name SomeModule %S/Inputs/objc_dynamic_replacement_ext.swift -swift-version 5 -enable-implicit-dynamic
