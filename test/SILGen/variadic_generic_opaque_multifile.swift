// RUN: %target-swift-frontend -emit-silgen-ossa -sil-verify-all -enable-sil-opaque-values -primary-file %s %S/Inputs/variadic_generic_opaque_multifile_other.swift -target %target-swift-5.9-abi-triple
