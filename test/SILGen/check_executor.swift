...
// RUN: %target-sil-opt -sil-print-types -enable-sil-verify-all %t.sil -lower-hop-to-actor -enable-experimental-feature CoroutineFunctions | %FileCheck --enable-var-scope %s --check-prefix=CHECK-CANONICAL
