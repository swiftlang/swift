...
// CHECK-LABEL: sil @_TF25default_arguments_generic3barFT_T_ : $@thin () -> () {
func bar() {
  ...
  foo()
  // CHECK: [[ZIM_DFLT:%.*]] = function_ref @_TIFV25default_arguments_generic3Zim3zimUSs25IntegerLiteralConvertible_USs33_BuiltinIntegerLiteralConvertible__FMGS0_Q__FT1xQ__T_A_ 
