...
// RUN: not --crash %target-swift-emit-silgen-ossa -enable-sil-opaque-values -enable-experimental-feature AddressableTypes -enable-experimental-feature Lifetimes %s
