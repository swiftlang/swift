...
// SILGEN: bb0([[ARG:%.*]] :
// SILGEN:   [[MARK:%.*]] = mark_unresolved_noncopyable [consumable_and_assignable] [[ARG]]
...
// SILGEN: bb0([[ARG:%.*]] :
// SILGEN:   [[MARKED:%.*]] = mark_unresolved_noncopyable [consumable_and_assignable] [[ARG]]
...
//
// SILGEN: bb1:
// SILGEN:   [[MARKED:%.*]] = mark_unresolved_noncopyable [no_consume_or_assign] [[PROJECT]]
