...
// CHECK-LABEL: sil shared [serializable] [thunk] @_T0So12GenericClassCSQyAByxGGs10DictionaryVySo0A6OptionaypGSg7options_tcfcTO : $@convention(method) <T where T : AnyObject> (@owned Optional<Dictionary<GenericOption, Any>>, @owned GenericClass<T>) -> @owned Optional<GenericClass<T>>
...
// CHECK: method #Hashable.hashValue!getter.1: {{.*}}: @_T0So13GenericOptionas8Hashable13objc_genericssACP9hashValueSifgTW
// CHECK: }
