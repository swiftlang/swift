...
// CHECK-LABEL: sil  @_TF8manglingX22egbpdajGbuEbxfgehfvwxnFT_T_
func ليهمابتكلموشعربي؟() { }
// CHECK-LABEL: sil  @_TF8manglingX24ihqwcrbEcvIaIdqgAFGpqjyeFT_T_
func 他们为什么不说中文() { }
// CHECK-LABEL: sil  @_TF8manglingX27ihqwctvzcJBfGFJdrssDxIboAybFT_T_
func 他們爲什麽不說中文() { }
// CHECK-LABEL: sil  @_TF8manglingX30Proprostnemluvesky_uybCEdmaEBaFT_T_
...
// CHECK-LABEL: sil  @_TF8mangling12any_protocolFP_T_
func any_protocol(_: protocol<>) {}
// CHECK-LABEL: sil  @_TF8mangling12one_protocolFPS_3Foo_T_
func one_protocol(_: Foo) {}
// CHECK-LABEL: sil  @_TF8mangling18one_protocol_twiceFTPS_3Foo_PS0___T_
func one_protocol_twice(_: Foo, _: Foo) {}
// CHECK-LABEL: sil  @_TF8mangling12two_protocolFPS_3BarS_3Foo_T_
func two_protocol(_: protocol<Foo, Bar>) {}

// Ensure archetype depths are mangled correctly.
class Zim<T> {
  // CHECK-LABEL: sil  @_TFC8mangling3Zim4zangU__fGS0_Q__U__FTQd__Q__T_
  func zang<U>(_: T, _: U) {}
  // CHECK-LABEL: sil  @_TFC8mangling3Zim4zungU__fGS0_Q__U__FTQ_Qd___T_
  func zung<U>(_: U, _: T) {}
}
...
enum GenericUnion<T> {
  ...
  case Foo(Int)
  // CHECK-LABEL: sil [transparent] @_TFO8mangling12GenericUnion3BarU__FMGS0_Q__GS0_Q__
  case Bar
}
...
// CHECK-LABEL: sil @_TF8mangling4fooAUS_12HasAssocType_U__FT_T_ : $@thin <T where T : HasAssocType> () -> ()
func fooA<T: HasAssocType>() {}
// CHECK-LABEL: sil @_TF8mangling4fooBUS_12HasAssocType_US_9AssocReqt__FT_T_ : $@thin <T where T : HasAssocType, T.Assoc : AssocReqt> () -> ()
