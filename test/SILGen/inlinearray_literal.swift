...
// RUN: not --crash %target-swift-emit-silgen-ossa -enable-sil-opaque-values %s -disable-availability-checking
...
// CHECK-NEXT:    [[ELT_0_OFFSET:%.*]] = integer_literal $Builtin.Word, 0
// CHECK-NEXT:    [[ELT_0_PTR:%.*]] = index_addr [projection] [[ELEMENT_PTR]], [[ELT_0_OFFSET]]
...
// CHECK-NEXT:    store [[ELT_0]] to [trivial] [[ELT_0_PTR]]
// CHECK-NEXT:    [[ELT_1_OFFSET:%.*]] = integer_literal $Builtin.Word, 1
// CHECK-NEXT:    [[ELT_1_PTR:%.*]] = index_addr [projection] [[ELEMENT_PTR]], [[ELT_1_OFFSET]]
...
// CHECK-NEXT:    [[ELT_2_PTR:%.*]] = index_addr [projection] [[ELEMENT_PTR]], [[ELT_2_OFFSET]]
...
// CHECK-NEXT:    [[ELT_3_PTR:%.*]] = index_addr [projection] [[ELEMENT_PTR]], [[ELT_3_OFFSET]]
...
// CHECK-NEXT:    store [[ELT_0]] to [init] [[ELT_0_PTR]]
// CHECK-NEXT:    [[ELT_1_OFFSET:%.*]] = integer_literal $Builtin.Word, 1
// CHECK-NEXT:    [[ELT_1_PTR:%.*]] = index_addr [projection] [[ELEMENT_PTR]], [[ELT_1_OFFSET]]
...
// CHECK-NEXT:    [[ELT_0:%.*]] = apply [[ATOMIC_INIT]]<Int>([[ELT_0_PTR]], {{.*}}) : $@convention(method) <τ_0_0 where τ_0_0 : AtomicRepresentable> (@in τ_0_0, @thin Atomic<τ_0_0>.Type) -> @out Atomic<τ_0_0>
...
// CHECK-NEXT:    store [[THIN_TO_THICK_FN]] to [init] [[ELT_0_PTR]]
