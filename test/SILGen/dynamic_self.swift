...
// CHECK:   [[X_F_REF_AS_Y:%[0-9]+]] = unchecked_convert_function [[THICK_X_F_REF]] : $@callee_owned (@owned X) -> @owned @callee_owned () -> @owned X to $@callee_owned (@owned X) -> @owned @callee_owned () -> @owned Y
