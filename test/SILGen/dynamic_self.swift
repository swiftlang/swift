// RUN: %target-swift-emit-silgen -module-name dynamic_self -enable-sil-ownership-verifier %s -disable-objc-attr-requires-foundation-module -enable-objc-interop | %FileCheck %s
