...
// RUN: %target-swift-emit-silgen-ossa -enable-sil-opaque-values -load-plugin-library %t/%target-library-name(MacroDefinition) -primary-file %s %S/Inputs/accessor_macro_multifile_other.swift -module-name AccMacroMulti
