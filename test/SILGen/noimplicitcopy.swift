...
// CHECK:   [[X_MOVEONLYWRAPPED_MARKED:%.*]] = mark_unresolved_noncopyable [consumable_and_assignable] [[X]]
...
// CHECK:   [[MARKED_ARG:%.*]] = mark_unresolved_noncopyable [no_consume_or_assign] [[LEXICAL_ARG]]
...
// CHECK:   [[ARG_WRAPPED:%.*]] = copyable_to_moveonlywrapper [owned] [[ARG]]
// CHECK:   [[LEXICAL_ARG:%.*]] = move_value [lexical] [[ARG_WRAPPED]]
// CHECK:   [[MARKED_ARG:%.*]] = mark_unresolved_noncopyable [consumable_and_assignable] [[LEXICAL_ARG]]
// CHECK:   [[BORROWED_MARKED_ARG_1:%.*]] = begin_borrow [[MARKED_ARG]]
// CHECK:   [[BORROWED_MARKED_ARG_2:%.*]] = begin_borrow [[MARKED_ARG]]
// CHECK:   [[FUNC:%.*]] = function_ref @$sSi1poiyS2i_SitFZ : $@convention(method) (Int, Int, @thin Int.Type) -> Int
// CHECK:   [[GUARANTEED_ESCAPED_X_1:%.*]] = moveonlywrapper_to_copyable [guaranteed] [[BORROWED_MARKED_ARG_1]]
...
// CHECK:   [[MARKED_X:%.*]] = mark_unresolved_noncopyable [no_consume_or_assign] [[MOVED_X]]
...
// CHECK:   [[MARKED_ARG:%.*]] = mark_unresolved_noncopyable [consumable_and_assignable] [[MOVED_ARG]]
...
// CHECK:   [[X_MOVEONLYWRAPPED_MARKED:%.*]] = mark_unresolved_noncopyable [consumable_and_assignable] [[X_MOVEONLYWRAPPED]]
// CHECK:   [[BORROWED_X_MOVEONLYWRAPPED_MARKED:%.*]] = begin_borrow [[X_MOVEONLYWRAPPED_MARKED]]
...
// CHECK:   [[MARKED_ARG:%.*]] = mark_unresolved_noncopyable [no_consume_or_assign] [[COPIED_WRAPPED_ARG]]
...
// CHECK:   [[MARKED_ARG:%.*]] = mark_unresolved_noncopyable [no_consume_or_assign] [[COPIED_ARG]]
...
// CHECK:   [[MARKED:%.*]] = mark_unresolved_noncopyable [consumable_and_assignable] [[MV_WRAPPED]]
