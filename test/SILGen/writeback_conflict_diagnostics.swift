// RUN: %target-swift-emit-silgen -enable-sil-ownership-verifier %s -o /dev/null -verify
// RUN: %target-swift-emit-silgen -enable-sil-ownership-verifier -enforce-exclusivity=checked %s -o /dev/null -verify
