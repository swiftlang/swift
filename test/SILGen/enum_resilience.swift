...
// RUN: %target-swift-emit-silgen -Xllvm -sil-print-types -module-name enum_resilience -I %t -enable-library-evolution %s -disable-experimental-serialize-debug-info | %FileCheck %s
