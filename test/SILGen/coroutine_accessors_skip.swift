// RUN: %target-swift-emit-silgen-ossa -enable-sil-opaque-values %s -enable-callee-allocated-coro-abi -experimental-skip-non-inlinable-function-bodies -enable-library-evolution -enable-experimental-feature CoroutineAccessors
