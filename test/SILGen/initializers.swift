// RUN: %target-swift-emit-silgen -enable-sil-ownership-verifier -disable-objc-attr-requires-foundation-module -enable-objc-interop %s -module-name failable_initializers | %FileCheck %s
