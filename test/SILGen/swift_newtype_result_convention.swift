// RUN: %target-swift-emit-silgen-ossa(mock-sdk: %clang-importer-sdk) -enable-sil-opaque-values -import-objc-header %S/Inputs/swift_newtype_result_convention.h %s
