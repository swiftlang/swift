...
// RUN: %target-swift-emit-silgen -module-name enum_resilience_testable -I %t -enable-sil-ownership-verifier -enable-nonfrozen-enum-exhaustivity-diagnostics -swift-version 5 %s | %FileCheck %s
