...
// RUN: %target-swift-emit-silgen -module-name function_conversion -enable-sil-ownership-verifier -primary-file %s | %FileCheck %s
// RUN: %target-swift-emit-ir -module-name function_conversion -enable-sil-ownership-verifier -primary-file %s
