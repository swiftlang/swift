...
// RUN: %target-swift-emit-silgen -module-name partial_apply_protocol -enable-sil-ownership-verifier -primary-file %s | %FileCheck %s
// RUN: %target-swift-emit-ir -module-name partial_apply_protocol -enable-sil-ownership-verifier -primary-file %s
