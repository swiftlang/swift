...
// CHECK-LABEL: sil hidden [thunk] @_TTWV17witness_same_type3FooS_7FooableS_FS1_3fooUS1__U__fQPS1_US1___FT1xQ__QS2_3Bar : $@cc(witness_method) @thin <T where T : Fooable, T.Bar == X> (@out X, @in T, @in_guaranteed Foo) -> ()
struct Foo: Fooable {
  typealias Bar = X
...
// CHECK-LABEL: sil [thunk] @_TTWUSs12SequenceType__USs13GeneratorType__GV17witness_same_type14LazySequenceOfQ_Q0__Ss14_Sequence_TypeS1_FS3_8generateUS3__US0____fQPS3_FT_QS4_9Generator
