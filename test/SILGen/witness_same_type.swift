...
// RUN: %target-swift-emit-silgen -module-name witness_same_type -enable-sil-ownership-verifier %s | %FileCheck %s
// RUN: %target-swift-emit-ir -module-name witness_same_type -enable-sil-ownership-verifier %s
