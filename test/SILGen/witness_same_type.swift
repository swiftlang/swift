...
// CHECK-LABEL: sil hidden @_TTWV17witness_same_type3FooS_7FooableS_FS1_3fooUS1__U__fRQPS1_US1___FT1xQ__QS2_3Bar : $@cc(witness_method) @thin <T where T : Fooable, T.Bar == X> (@out X, @in T, @inout Foo) -> ()
struct Foo: Fooable {
  typealias Bar = X
