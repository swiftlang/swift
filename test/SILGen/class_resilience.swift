...
public class MyResilientClass {
  ...
  // CHECK-LABEL: sil [thunk] @$S16class_resilience16MyResilientClassC17publicMethodFirstSiSgyFTj : $@convention(method) (@guaranteed MyResilientClass) -> Optional<Int>
  ...
  // CHECK-LABEL: sil [thunk] @$S16class_resilience16MyResilientClassC18publicMethodSecondyyyXlFTj : $@convention(method) (@owned AnyObject, @guaranteed MyResilientClass) -> ()
...
public class MyResilientSubclass : MyResilientClass {
  ...
  // CHECK-LABEL: sil [thunk] @$S16class_resilience19MyResilientSubclassC17publicMethodFirstSiyFTj : $@convention(method) (@guaranteed MyResilientSubclass) -> Int
...
// CHECK-LABEL: sil @$S16class_resilience19callResilientMethodyyAA02MyD8SubclassCF : $@convention(thin) (@owned MyResilientSubclass) -> ()
...
// CHECK-LABEL: sil [serialized] @$S16class_resilience29callResilientMethodInlineableyyAA02MyD8SubclassCF : $@convention(thin) (@owned MyResilientSubclass) -> ()
@_inlineable public func callResilientMethodInlineable(_ s: MyResilientSubclass) {
// CHECK:   [[FN:%.*]] = function_ref @$S16class_resilience19MyResilientSubclassC17publicMethodFirstSiyFTj : $@convention(method) (@guaranteed MyResilientSubclass) -> Int
  _ = s.publicMethodFirst()
  // CHECK:   [[FN:%.*]] = function_ref @$S16class_resilience16MyResilientClassC18publicMethodSecondyyyXlFTj : $@convention(method) (@owned AnyObject, @guaranteed MyResilientClass) -> ()
  ...
  // CHECK:   function_ref @$S16class_resilience19MyResilientSubclassC17publicMethodFirstSiyFTc
  _ = s.publicMethodFirst

  // CHECK:   function_ref @$S16class_resilience19MyResilientSubclassC18publicMethodSecondyyyXlSgFTc
  _ = s.publicMethodSecond
// CHECK:   return
}

// CHECK-LABEL: sil shared [serializable] [thunk] @$S16class_resilience19MyResilientSubclassC17publicMethodFirstSiyFTc : $@convention(thin) (@owned MyResilientSubclass) -> @owned @callee_guaranteed () -> Int
// CHECK:     function_ref @$S16class_resilience19MyResilientSubclassC17publicMethodFirstSiyFTj
// CHECK:     return

// CHECK-LABEL: sil shared [serializable] [thunk] @$S16class_resilience19MyResilientSubclassC18publicMethodSecondyyyXlSgFTc : $@convention(thin) (@owned MyResilientSubclass) -> @owned @callee_guaranteed (@owned Optional<AnyObject>) -> ()
// CHECK:     function_ref @$S16class_resilience16MyResilientClassC18publicMethodSecondyyyXlFTj : $@convention(method) (@owned AnyObject, @guaranteed MyResilientClass) -> ()
// CHECK:     return
