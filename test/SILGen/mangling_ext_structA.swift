...
// RUN: %target-swift-frontend -emit-module -enable-sil-ownership-verifier -o %t %S/Inputs/def_structA.swift
// RUN: %target-swift-emit-silgen -enable-sil-ownership-verifier -module-name ext_structA -I %t %s | %FileCheck %s
