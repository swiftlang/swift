...
// RUN: %target-swift-frontend -emit-module -verify-sil-ownership -o %t %S/Inputs/def_structA.swift
// RUN: %target-swift-emit-silgen -verify-sil-ownership -module-name ext_structA -I %t %s | %FileCheck %s
