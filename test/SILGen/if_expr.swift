// RUN: %target-swift-emit-silgen -enable-experimental-feature StatementExpressions %s | %FileCheck %s
// RUN: %target-swift-emit-ir -enable-experimental-feature StatementExpressions %s
