...
// CHECK-FRAGILE:   @_semantics("derived_enum_equals") @_implements(Equatable, ==(_:_:)) static func __derived_enum_equals(_ lhs: NoValues, _ rhs: NoValues) -> Bool
// CHECK-RESILIENT: static func == (lhs: NoValues, rhs: NoValues) -> Bool
// CHECK:   case a, b
...
// CHECK-FRAGILE:   @_semantics("derived_enum_equals") @_implements(Equatable, ==(_:_:)) static func __derived_enum_equals(_ lhs: Enum<T>, _ rhs: Enum<T>) -> Bool
// CHECK-RESILIENT: static func == (lhs: Enum<T>, rhs: Enum<T>) -> Bool
// CHECK: }
