...
func testSlowServing(p: SlowServing) async throws {
    // CHECK-NN: bb0([[HOP_TARGET:%.*]] : @guaranteed $Builtin.ImplicitIsolationActor,
...
// CHECK-C:   [[FUNC:%.*]] = function_ref @$sSo10SlowServerC011doSomethingA0ySiSSYaFTO : $@convention(method) @async (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed String, @guaranteed SlowServer) -> Int
// CHECK-C:   [[ACTOR:%.*]] = enum $Optional<any Actor>, #Optional.none!enumelt
// CHECK-C:   [[ACTOR_C:%.*]] = unchecked_value_cast [[ACTOR]] : $Optional<any Actor> to $Builtin.ImplicitIsolationActor
...
// CHECK-NN-LABEL: sil private [transparent] [thunk] [ossa] @$sSo10SlowServerC21objc_async_from_swift08NativelyA7ServingA2cDP011doSomethingA0ySiSSYaFTW : $@convention(witness_method: NativelySlowServing) @async (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed String, @in_guaranteed SlowServer) -> Int {
// CHECK-NN: bb0([[ACTOR:%.*]] : @guaranteed $Builtin.ImplicitIsolationActor, [[ARG:%.*]] : @guaranteed $String, [[SELF_ADDR:%.*]] : $*SlowServer):
// CHECK-NN:   [[SELF:%.*]] = load_borrow [[SELF_ADDR]]
// CHECK-NN:   [[FUNC:%.*]] = function_ref @$sSo10SlowServerC011doSomethingA0ySiSSYaFTO : $@convention(method) @async (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed String, @guaranteed SlowServer) -> Int
...
// CHECK-C:   [[SELF:%.*]] = load_borrow [[SELF_ADDR]]
// CHECK-C:   [[FUNC:%.*]] = function_ref @$sSo10SlowServerC10findAnswerSSyYaKFTO : $@convention(method) @async (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed SlowServer) -> (@owned String, @error any Error)
// CHECK-C:   [[ACTOR:%.*]] = enum $Optional<any Actor>, #Optional.none!enumelt
// CHECK-C:   [[ACTOR_CAST:%.*]] = unchecked_value_cast [[ACTOR]] : $Optional<any Actor> to $Builtin.ImplicitIsolationActor
...
// CHECK-NN-LABEL: sil private [transparent] [thunk] [ossa] @$sSo10SlowServerC21objc_async_from_swift08NativelyA7ServingA2cDP10findAnswerSSyYaKFTW : $@convention(witness_method: NativelySlowServing) @async (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @in_guaranteed SlowServer) -> (@owned String, @error any Error) {
// CHECK-NN: bb0([[ACTOR:%.*]] : @guaranteed $Builtin.ImplicitIsolationActor, [[SELF_ADDR:%.*]] : $*SlowServer):
// CHECK-NN:   [[SELF:%.*]] = load_borrow [[SELF_ADDR]]
// CHECK-NN:   [[FUNC:%.*]] = function_ref @$sSo10SlowServerC10findAnswerSSyYaKFTO : $@convention(method) @async (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed SlowServer) -> (@owned String, @error any Error)
...
// CHECK-C:   [[FUNC:%.*]] = function_ref @$sSo10SlowServerC13serverRestartyySSYaFTO : $@convention(method) @async (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed String, @guaranteed SlowServer) -> ()
// CHECK-C:   [[ACTOR:%.*]] = enum $Optional<any Actor>, #Optional.none!enumelt
// CHECK-C:   [[ACTOR_CAST:%.*]] = unchecked_value_cast [[ACTOR]] : $Optional<any Actor> to $Builtin.ImplicitIsolationActor
// CHECK-C:   hop_to_executor [[ACTOR_CAST]]
...
// CHECK-NN-LABEL: sil private [transparent] [thunk] [ossa] @$sSo10SlowServerC21objc_async_from_swift08NativelyA7ServingA2cDP13serverRestartyySSYaFTW : $@convention(witness_method: NativelySlowServing) @async (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed String, @in_guaranteed SlowServer) -> () {
// CHECK-NN: bb0([[ACTOR:%.*]] : @guaranteed $Builtin.ImplicitIsolationActor, [[ARG:%.*]] : @guaranteed $String, [[SELF_PTR:%.*]] : $*SlowServer):
// CHECK-NN:   [[SELF:%.*]] = load_borrow [[SELF_PTR]]
// CHECK-NN:   [[FUNC:%.*]] = function_ref @$sSo10SlowServerC13serverRestartyySSYaFTO : $@convention(method) @async (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed String, @guaranteed SlowServer) -> ()
// CHECK-NN:   apply [[FUNC]]([[ACTOR]], [[ARG]], [[SELF]])
// CHECK-NN:   hop_to_executor [[ACTOR]]
...
// CHECK-C: bb0([[SELF_ADDR:%.*]] : $*SlowServer):
// CHECK-C:   [[SELF:%.*]] = load_borrow [[SELF_ADDR]]
// CHECK-C:   [[FUNC:%.*]] = function_ref @$sSo10SlowServerC19findMultipleAnswersSS_SityYaKFTO : $@convention(method) @async (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed SlowServer) -> (@owned String, Int, @error any Error)
// CHECK-C:   [[ACTOR:%.*]] = enum $Optional<any Actor>, #Optional.none!enumelt
// CHECK-C:   [[ACTOR_CAST:%.*]] = unchecked_value_cast [[ACTOR]] : $Optional<any Actor> to $Builtin.ImplicitIsolationActor
// CHECK-C:   hop_to_executor [[ACTOR_CAST]]
// CHECK-C:   try_apply [[FUNC]]([[ACTOR_CAST]], [[SELF]])
...
// CHECK-NN-LABEL: sil private [transparent] [thunk] [ossa] @$sSo10SlowServerC21objc_async_from_swift08NativelyA7ServingA2cDP19findMultipleAnswersSS_SityYaKFTW : $@convention(witness_method: NativelySlowServing) @async (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @in_guaranteed SlowServer) -> (@owned String, Int, @error any Error) {
// CHECK-NN: bb0([[ACTOR:%.*]] : @guaranteed $Builtin.ImplicitIsolationActor, [[SELF_ADDR:%.*]] : $*SlowServer):
// CHECK-NN:   [[SELF:%.*]] = load_borrow [[SELF_ADDR]]
// CHECK-NN:   [[FUNC:%.*]] = function_ref @$sSo10SlowServerC19findMultipleAnswersSS_SityYaKFTO : $@convention(method) @async (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed SlowServer) -> (@owned String, Int, @error any Error)
// CHECK-NN:   try_apply [[FUNC]]([[ACTOR]], [[SELF]])
//
// CHECK-NN:  bb1(
// CHECK-NN:   hop_to_executor [[ACTOR]]
...
class SlowServerlet: SlowServer {
    ...
    // CHECK-C-NOT: bb0([[ACTOR:%.*]] : @guaranteed $Builtin.ImplicitIsolationActor
    // CHECK-C: [[ACTOR:%.*]] = enum $Optional<any Actor>, #Optional.none!enumelt
    ...
    // CHECK-NN-LABEL: sil hidden [ossa] @$s21objc_async_from_swift13SlowServerletC011doSomethingE8NullablyySiSSYaF : $@convention(method) @async (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed String, @guaranteed SlowServerlet) -> Int {
    // CHECK-NN: bb0([[ACTOR:%.*]] : @guaranteed $Builtin.ImplicitIsolationActor
    // CHECK-NN:   hop_to_executor [[ACTOR]]
    ...
    // CHECK-NN: [[NONE_CAST:%.*]] = unchecked_value_cast [[NONE]] : $Optional<any Actor> to $Builtin.ImplicitIsolationActor
    ...
    // CHECK-NN: [[FUNC:%.*]] = function_ref @$s21objc_async_from_swift13SlowServerletC011doSomethingE8NullablyySiSSYaF : $@convention(method) @async (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed String, @guaranteed SlowServerlet) -> Int
    ...
    // CHECK-NN-LABEL: sil hidden [ossa] @$s21objc_async_from_swift13SlowServerletC18findAnswerNullablyyS2SYaF : $@convention(method) @async (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed String, @guaranteed SlowServerlet) -> @owned String {
    // CHECK-NN: bb0([[ACTOR:%.*]] : @guaranteed $Builtin.ImplicitIsolationActor,
    // CHECK-NN: hop_to_executor [[ACTOR]]
    ...
    // CHECK-NN: [[ACTOR_CAST:%.*]] = unchecked_value_cast [[ACTOR]] : $Optional<any Actor> to $Builtin.ImplicitIsolationActor
    // CHECK: [[STR_ARG:%.*]] = begin_borrow {{.*}} : $String
    // CHECK: [[SELF:%.*]] = begin_borrow {{.*}} : $SlowServerlet
    ...
    // CHECK-C: apply [[FUNC]]([[STR_ARG]], [[SELF]])
    // CHECK-NN: [[FUNC:%.*]] = function_ref @$s21objc_async_from_swift13SlowServerletC18findAnswerNullablyyS2SYaF : $@convention(method) @async (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed String, @guaranteed SlowServerlet) -> @owned String
    ...
    // CHECK-NN-LABEL: sil hidden [ossa] @$s21objc_async_from_swift13SlowServerletC28doSomethingDangerousNullablyyS2SYaKF : $@convention(method) @async (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed String, @guaranteed SlowServerlet) -> (@owned String, @error any Error) {
    // CHECK-NN: bb0([[ACTOR:%.*]] : @guaranteed $Builtin.ImplicitIsolationActor,
    // CHECK-NN: hop_to_executor [[ACTOR]]
    ...
    // CHECK-NN: [[NATIVE:%.*]] = function_ref @$s21objc_async_from_swift13SlowServerletC28doSomethingDangerousNullablyyS2SYaKF : $@convention(method) @async (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed String, @guaranteed SlowServerlet) -> (@owned String, @error any Error)
    ...
    // CHECK-NN-LABEL: sil hidden [ossa] @$s21objc_async_from_swift13SlowServerletC30doSomethingUnspecifiedNullablySSyYaKF : $@convention(method) @async (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed SlowServerlet) -> (@owned String, @error any Error) {
    // CHECK-NN: bb0([[ACTOR:%.*]] : @guaranteed $Builtin.ImplicitIsolationActor,
    // CHECK-NN:   hop_to_executor [[ACTOR]]
    ...
    // CHECK-NN: [[NATIVE:%.*]] = function_ref @$s21objc_async_from_swift13SlowServerletC30doSomethingUnspecifiedNullablySSyYaKF : $@convention(method) @async (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed SlowServerlet) -> (@owned String, @error any Error)
    ...
    // CHECK-NN-LABEL: sil hidden [ossa] @$s21objc_async_from_swift13SlowServerletC17doSomethingFlaggySSyYaKF : $@convention(method) @async (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed SlowServerlet) -> (@owned String, @error any Error) {
    // CHECK-NN: bb0([[ACTOR:%.*]] : @guaranteed $Builtin.ImplicitIsolationActor,
    // CHECK-NN:   hop_to_executor [[ACTOR]]
    ...
    // CHECK-NN: [[NATIVE:%.*]] = function_ref @$s21objc_async_from_swift13SlowServerletC17doSomethingFlaggySSyYaKF : $@convention(method) @async (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed SlowServerlet) -> (@owned String, @error any Error)
    ...
    //
    // CHECK-NN-LABEL: sil hidden [ossa] @$s21objc_async_from_swift13SlowServerletC21doSomethingZeroFlaggySSyYaKF : $@convention(method) @async (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed SlowServerlet) -> (@owned String, @error any Error) {
    // CHECK-NN: bb0([[ACTOR:%.*]] : @guaranteed $Builtin.ImplicitIsolationActor,
    // CHECK-NN:  hop_to_executor [[ACTOR]]
    ...
    // CHECK-C:    try_apply [[NATIVE]]([[SELF]]) : {{.*}}, normal [[NORMAL_BB:bb[0-9]+]], error [[ERROR_BB:bb[0-9]+]]
    // CHECK-NN:   [[NATIVE:%.*]] = function_ref @$s21objc_async_from_swift13SlowServerletC21doSomethingZeroFlaggySSyYaKF : $@convention(method) @async (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed SlowServerlet) -> (@owned String, @error any Error)
    // CHECK-NN:   try_apply [[NATIVE]]([[ACTOR_CAST]], [[SELF]]) : {{.*}}, normal [[NORMAL_BB:bb[0-9]+]], error [[ERROR_BB:bb[0-9]+]]
    //
    // CHECK:  [[NORMAL_BB]]({{.*}}):
    // CHECK:      integer_literal {{.*}}1
    ...
    //
    // CHECK-NN-LABEL: sil hidden [ossa] @$s21objc_async_from_swift13SlowServerletC28doSomethingMultiResultFlaggySS_SStyYaKF : $@convention(method) @async (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed SlowServerlet) -> (@owned String, @owned String, @error any Error) {
    // CHECK-NN: bb0([[ACTOR:%.*]] : @guaranteed $Builtin.ImplicitIsolationActor,
    // CHECK-NN:   hop_to_executor [[ACTOR]]
    ...
    // CHECK-C:  try_apply [[NATIVE]]([[SELF]]) : {{.*}}, normal [[NORMAL_BB:bb[0-9]+]], error [[ERROR_BB:bb[0-9]+]]
    // CHECK-NN: [[NATIVE:%.*]] = function_ref @$s21objc_async_from_swift13SlowServerletC28doSomethingMultiResultFlaggySS_SStyYaKF : $@convention(method) @async (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed SlowServerlet) -> (@owned String, @owned String, @error any Error)
    // CHECK-NN: try_apply [[NATIVE]]([[ACTOR_CAST]], [[SELF]]) : {{.*}}, normal [[NORMAL_BB:bb[0-9]+]], error [[ERROR_BB:bb[0-9]+]]
    //
    // CHECK: [[NORMAL_BB]]({{.*}}):
    // CHECK:   integer_literal {{.*}}1
...
func testAutoclosureInStaticMethod() {
  final class TestKlass {
    ...
    // CHECK-NN-LABEL: sil private [ossa] @$s21objc_async_from_swift29testAutoclosureInStaticMethodyyF9TestKlassL_C8getValue2id11valueForKeySSSgSS_S2SYaKYCXEtYaFZfA0_ : $@convention(thin) () -> @owned @async @callee_guaranteed (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed String) -> (@owned String, @error any Error) {
    //
    // Get standard.
    ...
    //
    // Then grab value.
    // CHECK-C: [[GET_VALUE:%.*]] = function_ref @$s21objc_async_from_swift29testAutoclosureInStaticMethodyyF9TestKlassL_C8getValue2id11valueForKeySSSgSS_S2SYaKXEtYaFZfA0_S2SYaKYCcSo10SlowServerCcfu_ : $@convention(thin) (@guaranteed SlowServer) -> @owned @async @callee_guaranteed (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed String) -> (@owned String, @error any Error)
    ...
    //
    // CHECK-C: [[THUNK_FN:%.*]] = function_ref @$sBAS2Ss5Error_pIegHgILgozo_S2SsAA_pIegHgozo_TR : $@convention(thin) @async (@guaranteed String, @guaranteed @async @callee_guaranteed (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed String) -> (@owned String, @error any Error)) -> (@owned String, @error any Error)
    ...
    // CHECK: bb0([[ACTOR:%.*]] : @guaranteed $Builtin.ImplicitIsolationActor, [[ARG:%.*]] : @guaranteed $String, [[CAPTURE:%.*]] : @closureCapture @guaranteed $SlowServer):
    //
    // Hop to the actor
    ...
    // CHECK-C-LABEL: sil shared [transparent] [serialized] [reabstraction_thunk] [ossa] @$sBAS2Ss5Error_pIegHgILgozo_S2SsAA_pIegHgozo_TR : $@convention(thin) @async (@guaranteed String, @guaranteed @async @callee_guaranteed (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed String) -> (@owned String, @error any Error)) -> (@owned String, @error any Error) {
    // CHECK-C: bb0([[ARG:%.*]] : @guaranteed $String, [[FUNC:%.*]] : @guaranteed $@async @callee_guaranteed (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed String) -> (@owned String, @error any Error)):
    // CHECK-C:   [[ACTOR:%.*]] = enum $Optional<any Actor>, #Optional.none!enumelt
    // CHECK-C:   hop_to_executor [[ACTOR]]
    // CHECK-C:   [[ACTOR_CAST:%.*]] = unchecked_value_cast [[ACTOR]] : $Optional<any Actor> to $Builtin.ImplicitIsolationActor
    // CHECK-C:   try_apply [[FUNC]]([[ACTOR_CAST]], [[ARG]])
    // CHECK-C: } // end sil function '$sBAS2Ss5Error_pIegHgILgozo_S2SsAA_pIegHgozo_TR'
    ...
    // CHECK-NN-LABEL: sil private [ossa] @$s21objc_async_from_swift29testAutoclosureInStaticMethodyyF9TestKlassL_C8getValue2id11valueForKeySSSgSS_S2SYaKYCXEtYaFZ : $@convention(method) @async (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed String, @guaranteed @noescape @async @callee_guaranteed (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed String) -> (@owned String, @error any Error), @thick TestKlass.Type) -> @owned Optional<String> {
    // CHECK-NN: bb0([[ACTOR:%.*]] : @guaranteed $Builtin.ImplicitIsolationActor, [[STRING:%.*]] : @guaranteed $String, [[COMPLETION:%.*]] : @guaranteed $@noescape @async @callee_guaranteed (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed String) -> (@owned String, @error any Error), %3 : $@thick TestKlass.Type):
    // CHECK-NN:   hop_to_executor [[ACTOR]]
    // CHECK-NN:   hop_to_executor [[ACTOR]]
    // CHECK-NN:   hop_to_executor [[ACTOR]]
    ...
    // CHECK: [[RESULT:%.*]] = apply [[GET_VALUE]]([[STANDARD]])
    //
    // CHECK-NN: [[THUNK:%.*]] = function_ref @$sS2Ss5Error_pIegHgozo_BAS2SsAA_pIegHgILgozo_TR : $@convention(thin) @async (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed String, @guaranteed @async @callee_guaranteed (@guaranteed String) -> (@owned String, @error any Error)) -> (@owned String, @error any Error)
    ...
    //
    // CHECK-NN-LABEL: sil shared [transparent] [serialized] [reabstraction_thunk] [ossa] @$sS2Ss5Error_pIegHgozo_BAS2SsAA_pIegHgILgozo_TR : $@convention(thin) @async (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @guaranteed String, @guaranteed @async @callee_guaranteed (@guaranteed String) -> (@owned String, @error any Error)) -> (@owned String, @error any Error) {
    // CHECK-NN: bb0([[ACTOR:%.*]] : @guaranteed $Builtin.ImplicitIsolationActor, [[ARG:%.*]] : @guaranteed $String, [[FUNC:%.*]] : @guaranteed $@async @callee_guaranteed (@guaranteed String) -> (@owned String, @error any Error)):
    ...
    // CHECK-NN: bb2(
    // CHECK-NN:   hop_to_executor [[ACTOR]]
    // CHECK-NN: } // end sil function '$sS2Ss5Error_pIegHgozo_BAS2SsAA_pIegHgILgozo_TR'
