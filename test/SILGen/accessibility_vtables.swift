...
// RUN: %target-swift-emit-silgen-ossa -enable-sil-opaque-values -Xllvm -sil-full-demangle -primary-file %s %S/Inputs/accessibility_vtables_other.swift -I %t -module-name accessibility_vtables
