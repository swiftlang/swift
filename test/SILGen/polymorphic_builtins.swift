...
// Under opaque values, SILGen emits polymorphic builtins in value form with no
// @out result. Their parameters are declared guaranteed, so SILGen passes the
// operands at +0 without copying them.
