...
// RUN: %target-swift-emit-silgen -module-name vtables_objc -enable-sil-ownership-verifier -sdk %S/Inputs -I %S/Inputs -enable-source-import %s -disable-objc-attr-requires-foundation-module | %FileCheck %s
