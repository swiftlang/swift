...
// FILE_A-NOT: sil [transparent] [thunk] @$S4main5ThingVs9EquatableAAsADP2eeoi{{[_0-9a-zA-Z]*}}FZTW
// FILE_A-NOT: sil [transparent] [thunk] @$S4main5ThingVs8HashableAAsADP9hashValueSivgTW
// FILE_A-NOT: sil_witness_table Thing: Hashable module main
// FILE_A-NOT: sil_witness_table Thing: Equatable module main

// FILE_B-NOT: sil [transparent] [thunk] @$S4main5ThingVs9EquatableAAsADP2eeoi{{[_0-9a-zA-Z]*}}FZTW
// FILE_B: sil private [transparent] [thunk] @$S4main5ThingVs8HashableAAsADP9hashValueSivgTW
// FILE_B-NOT: sil [transparent] [thunk] @$S4main5ThingVs9EquatableAAsADP2eeoi{{[_0-9a-zA-Z]*}}FZTW
...
// FILE_C-NOT: sil [transparent] [thunk] @$S4main5ThingVs8HashableAAsADP9hashValueSivgTW
// FILE_C: sil private [transparent] [thunk] @$S4main5ThingVs9EquatableAAsADP2eeoi{{[_0-9a-zA-Z]*}}FZTW
// FILE_C-NOT: sil [transparent] [thunk] @$S4main5ThingVs8HashableAAsADP9hashValueSivgTW
