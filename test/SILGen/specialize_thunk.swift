...
// CHECK:      [[T0:%.*]] = function_ref @_TF16specialize_thunk18standalone_genericU__FTQ_Q__Q_ : $@convention(thin) <τ_0_0> (@out τ_0_0, @in τ_0_0, @in τ_0_0) -> ()
// CHECK-NEXT: [[T1:%.*]] = partial_apply [[T0]]<Int>() : $@convention(thin) <τ_0_0> (@out τ_0_0, @in τ_0_0, @in τ_0_0) -> ()
// CHECK:      [[T2:%.*]] = function_ref @[[THUNK:.*]] : $@convention(thin) (Int, Int, @owned @callee_owned (@out Int, @in Int, @in Int) -> ()) -> Int
