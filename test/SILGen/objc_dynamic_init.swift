// RUN: %target-swift-emit-silgen-ossa(mock-sdk: %clang-importer-sdk) -enable-sil-opaque-values -Xllvm -sil-print-types -import-objc-header %S/Inputs/objc_dynamic_init.h %s
