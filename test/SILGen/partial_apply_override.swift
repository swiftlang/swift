...
// CHECK-LABEL: sil @$s22partial_apply_override7convert7stringsSaySiGSaySSG_tF :
...
// CHECK-LABEL: sil shared [thunk] @$s22partial_apply_override18StringIntConverterC7convert5inputSiSS_tFTc : 
