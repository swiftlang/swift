...
// CHECK: [[BORROW:%[0-9]+]] = store_borrow [[COPYABLE]] to [[SOURCE]]
// CHECK: [[DEST:%[0-9]+]] = alloc_stack $any ITarget
// CHECK-NEXT: unconditional_checked_cast_addr copy_on_success any ISource in [[BORROW]] to any ITarget in [[DEST]]
...
// CHECK: unconditional_checked_cast_addr copy_on_success T in {{%[0-9]+}} to any ITarget in [[DEST:%[0-9]+]]
// CHECK-NEXT: [[RESULT:%[0-9]+]] = load [take] [[DEST]]
...
// CHECK: unconditional_checked_cast_addr copy_on_success any ISource in
// CHECK-SAME: to Optional<any ITarget> in
...
// CHECK: [[BORROW:%[0-9]+]] = begin_borrow [[VALUE]]
// CHECK: [[STORED:%[0-9]+]] = store_borrow [[BORROW]]
// CHECK: unconditional_checked_cast_addr copy_on_success any ISource in [[STORED]]
// CHECK-NOT: checked_cast_addr_br
// CHECK-NOT: explicit_copy_addr
// CHECK: end_borrow [[STORED]]
// CHECK: end_borrow [[BORROW]]
