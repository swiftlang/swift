...
// RUN: %target-swift-emit-silgen-ossa(mock-sdk: %clang-importer-sdk-nosource -I %t) -enable-sil-opaque-values -primary-file %s %S/Inputs/ivar_initializer_other.swift
