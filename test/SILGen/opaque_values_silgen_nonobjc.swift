...
// CHECK-LABEL: sil {{.*}}[ossa] [opaque] @$s28opaque_values_silgen_nonobjc13UnownedVarBoxV5valuexvg : {{.*}} {
// CHECK:       bb0([[INSTANCE:%[^,]+]] :
...
// CHECK-LABEL: sil {{.*}}[ossa] [opaque] @$s28opaque_values_silgen_nonobjc13UnownedVarBoxV5valueACyxGx_tcfC : {{.*}} {
