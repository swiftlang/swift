// RUN: %target-swift-frontend -emit-silgen-ossa -sil-verify-all -enable-sil-opaque-values %S/Inputs/enum_debuginfo_other.swift -primary-file %s -module-name enum_debuginfo -g -Xllvm -sil-print-debuginfo
