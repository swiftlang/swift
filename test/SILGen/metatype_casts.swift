...
// CHECK-LABEL: sil hidden @_TF14metatype_casts6t_is_uU___FTQ_Q0__Sb
...
// CHECK-LABEL: sil hidden @_TF14metatype_casts8t_is_intU__FQ_TSbGSqMSi_MSi_ : $@convention(thin) <T> (@in T) 
