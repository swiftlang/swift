...
// CHECK-DAG: sil shared [serializable] @_T0So16NSRuncingOptionsV{{[_0-9a-zA-Z]*}}fC
// CHECK-DAG: sil shared [serializable] @_T0So16NSRuncingOptionsV8rawValueSifg
// CHECK-DAG: sil shared [serializable] @_T0So16NSRuncingOptionsV9hashValueSifg

// Non-payload enum ctors don't need to be instantiated at all.
// NEGATIVE-NOT: sil shared [transparent] @_T0So16NSRuncingOptionsV5MinceAbBmF
// NEGATIVE-NOT: sil shared [transparent] @_T0So16NSRuncingOptionsV12QuinceSlicedAbBmF
// NEGATIVE-NOT: sil shared [transparent] @_T0So16NSRuncingOptionsV15QuinceJuliennedAbBmF
// NEGATIVE-NOT: sil shared [transparent] @_T0So16NSRuncingOptionsV11QuinceDicedAbBmF
...
// CHECK-DAG: sil shared [transparent] [serialized] [thunk] @_T0So16NSRuncingOptionsVs16RawRepresentable5gizmosACP{{[_0-9a-zA-Z]*}}fCTW
