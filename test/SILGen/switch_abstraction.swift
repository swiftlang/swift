...
// CHECK-LABEL: sil hidden @_TF18switch_abstraction18enum_reabstractionFT1xGOS_10OptionableFVS_1AS1__1aS1__T_ : $@thin (@owned Optionable<A -> A>, A) -> ()
...
// CHECK-LABEL: sil hidden @_TF18switch_abstraction45enum_addr_only_to_loadable_with_reabstractionU__FT1xGOS_5WackyQ_VS_1A_1aS1__Q_ : $@thin <T> (@out T, @in Wacky<T, A>, A) -> () {
