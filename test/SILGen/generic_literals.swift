...
func genericFloatingLiteral<T : FloatLiteralConvertible>(var x: T) {
  ...
  // CHECK: apply [[BUILTIN_CONV]]<T.FloatLiteralType>([[FLT_VAL]]#1, [[LIT_VALUE]], [[TFLT_META]]) : $@cc(witness_method) @thin <τ_0_0 where τ_0_0 : _BuiltinFloatLiteralConvertible> (@out τ_0_0, Builtin.FPIEEE64, @thick τ_0_0.Type) -> ()
