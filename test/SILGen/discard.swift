...
@_moveOnly enum MaybeFile {
  ...
  // CHECK:    store {{.*}} to [init]
  // CHECK:    [[SELF_MMC:%.*]] = mark_unresolved_noncopyable [no_consume_or_assign] [[SELF_REF]] : $*MaybeFile
...
@_moveOnly struct File {
  ...
  // CHECK:  [[SELF_MMC:%.*]] = mark_unresolved_noncopyable [no_consume_or_assign] [[SELF_REF]] : $*File
...
// CHECK:     [[MMC:%.*]] = mark_unresolved_noncopyable [no_consume_or_assign] [[ACCESS]] : $*PointerTree
...
@_moveOnly enum Ticket {
  ...
  // CHECK:    [[SELF_MMC:%.*]] = mark_unresolved_noncopyable [no_consume_or_assign] [[SELF_ACCESS]]
