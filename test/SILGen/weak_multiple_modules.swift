...
// RUN: %target-swift-emit-silgen -module-name weak_multiple_modules -I %t -enable-sil-ownership-verifier %s | %FileCheck %s --check-prefix=CHECK --check-prefix=CHECK-%target-runtime
