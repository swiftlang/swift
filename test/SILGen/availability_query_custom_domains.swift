// RUN: %target-swift-emit-silgen-ossa -enable-sil-opaque-values -module-name Test %s -verify -enable-experimental-feature CustomAvailability -define-enabled-availability-domain EnabledDomain -define-always-enabled-availability-domain AlwaysEnabledDomain -define-disabled-availability-domain DisabledDomain -define-dynamic-availability-domain DynamicDomain
