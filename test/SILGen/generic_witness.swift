...
// RUN: %target-swift-emit-silgen -module-name generic_witness -enable-sil-ownership-verifier %s | %FileCheck %s
// RUN: %target-swift-emit-ir -module-name generic_witness -enable-sil-ownership-verifier %s
