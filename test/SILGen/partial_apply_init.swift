...
// CHECK:         class_method %1 : $@thick C.Type, #C.init!allocator.1
...
// CHECK:         class_method %1 : $@thick C.Type, #C.init!allocator.1 : (C.Type) -> (Double) -> C, $@convention(method) (Double, @thick C.Type) -> @owned C
...
// CHECK:         witness_method $T, #P.init!allocator.1 : <Self where Self : P> (Self.Type) -> (String) -> Self
...
// CHECK:         class_method %1 : $@thick C.Type, #C.init!allocator.1 : (C.Type) -> (Double) -> C
