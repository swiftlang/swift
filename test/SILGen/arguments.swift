...
// CHECK-LABEL: sil  @_TFSs9arg_tupleFT1xSi1ySf_T_
// CHECK: bb0([[X:%[0-9]+]] : $Int, [[Y:%[0-9]+]] : $Float):

arg_tuple(x: i, y: f)

func arg_deep_tuples(#x: Int, #y: (Float, UnicodeScalar)) {}
// CHECK-LABEL: sil  @_TFSs15arg_deep_tuplesFT1xSi1yTSfSc__T_
...
// CHECK-LABEL: sil  @_TFSs17arg_deep_tuples_2FT1xSiT1ySf1zSc__T_
...
// CHECK-LABEL: sil  @_TFSs17arg_default_tupleFT1xSi1ySf_T_
// CHECK: bb0([[X:%[0-9]+]] : $Int, [[Y:%[0-9]+]] : $Float):
...
// CHECK-LABEL: sil  @_TFSs14variadic_arg_1
...
// CHECK-LABEL: sil  @_TFSs14variadic_arg_2
