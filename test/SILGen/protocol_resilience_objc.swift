// RUN: %target-swift-emit-silgen-ossa -enable-sil-opaque-values -enable-objc-interop -disable-objc-attr-requires-foundation-module -enable-library-evolution %s
