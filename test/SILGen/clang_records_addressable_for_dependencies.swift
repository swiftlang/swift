// RUN: %target-swift-emit-silgen-ossa -enable-sil-opaque-values -import-objc-header %S/Inputs/clang_records_addressable_for_dependencies.h -enable-experimental-feature Lifetimes %s
