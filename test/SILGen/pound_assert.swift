// RUN: %target-swift-frontend -enable-experimental-static-assert -Xllvm -sil-print-types -emit-silgen-ossa -o /dev/null -sil-verify-all -enable-sil-opaque-values %s
