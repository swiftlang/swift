...
// RUN: %target-swift-emit-silgen(mock-sdk: %clang-importer-sdk -I %t) -module-name newtype -I %S/Inputs -I %S/../IDE/Inputs/custom-modules -enable-objc-interop %s | %FileCheck %s -check-prefix=CHECK-RAW
// RUN: %target-swift-emit-sil(mock-sdk: %clang-importer-sdk -I %t) -module-name newtype -I %S/Inputs -I %S/../IDE/Inputs/custom-modules -enable-objc-interop %s | %FileCheck %s -check-prefix=CHECK-CANONICAL
