...
// RUN: %target-swift-emit-silgen-ossa(mock-sdk: %clang-importer-sdk -I %t) -enable-sil-opaque-values -Xllvm -sil-print-types -module-name newtype -I %S/Inputs -I %S/Inputs -I %S/../IDE/Inputs/custom-modules -enable-objc-interop -enable-source-import %s
