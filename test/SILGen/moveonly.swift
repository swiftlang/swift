...
// CHECK:   mark_unresolved_noncopyable [no_consume_or_assign] [[COPIED_ARG]]
...
// CHECK:   mark_unresolved_noncopyable [no_consume_or_assign] [[PROJECT]]
...
// CHECK: bb0([[ARG:%.*]] :
// CHECK:   mark_unresolved_noncopyable [no_consume_or_assign] [[ARG]]
...
// CHECK: bb0([[ARG:%.*]] :
// CHECK:   mark_unresolved_noncopyable [consumable_and_assignable] [[ARG]]
...
extension AddressOnlyGeneric {
    ...
    // CHECK: bb0([[ARG_IN:%.*]] :
    // CHECK:   [[ARG:%.*]] = mark_unresolved_noncopyable [no_consume_or_assign] [[ARG_IN]] :
    //
    ...
    // CHECK:   [[MARKED_X:%.*]] = mark_unresolved_noncopyable [no_consume_or_assign] [[PROJECT_X]]
    ...
    // CHECK:   [[MARKED_Y:%.*]] = mark_unresolved_noncopyable [no_consume_or_assign] [[PROJECT_Y]]
    // CHECK:   [[BLACKHOLE_ADDR:%.*]] = alloc_stack $AddressOnlyGeneric<T>
...
//
// CHECK: [[MARKED:%.*]] = mark_unresolved_noncopyable [no_consume_or_assign] [[PROJECT]]
...
// CHECK: [[MARKED_ADDR:%.*]] = mark_unresolved_noncopyable [assignable_but_not_consumable] [[ACCESS]]
// CHECK: assign [[X]] to [[MARKED_ADDR]]
//
// CHECK: [[READ:%.*]] = begin_access [read] [unknown] [[PROJECT_BOX]]
// CHECK: [[MARKED_ADDR:%.*]] = mark_unresolved_noncopyable [no_consume_or_assign] [[READ]]
...
//
// CHECK: [[CLS:%.*]] = mark_unresolved_noncopyable [no_consume_or_assign] [[PROJECT]]
...
// CHECK: [[MARKED_ADDR:%.*]] = mark_unresolved_noncopyable [assignable_but_not_consumable]
// CHECK: assign {{%.*}} to [[MARKED_ADDR]]
//
// CHECK: [[ACCESS:%.*]] = begin_access [read] [unknown] [[PROJECT]]
// CHECK: [[MARKED_ADDR:%.*]] = mark_unresolved_noncopyable [no_consume_or_assign] [[ACCESS]]
...
// CHECK: store
//
// CHECK:   [[MARKED_ADDR2:%.*]] = mark_unresolved_noncopyable [no_consume_or_assign] [[PROJECT2]] : $*NonTrivialStruct2
// CHECK:   [[CONSUMED_LET:%.*]] = load [copy] [[MARKED_ADDR2]] : $*NonTrivialStruct2
// CHECK:   [[ACCESS:%.*]] = begin_access [modify] [unknown] [[PROJECT1]]
// CHECK:   [[MARKED_ADDR1:%.*]] = mark_unresolved_noncopyable [assignable_but_not_consumable] [[ACCESS]]
...
// CHECK:   [[ACCESS_MARK:%.*]] = mark_unresolved_noncopyable [no_consume_or_assign] [[ACCESS]]
...
// CHECK:   [[MARKED_ACCESS:%.*]] = mark_unresolved_noncopyable [assignable_but_not_consumable] [[ACCESS]]
...
// CHECK:   [[ARG_MARKED_VALUE:%.*]] = mark_unresolved_noncopyable [no_consume_or_assign] [[COPY_ARG]]
...
// CHECK:   [[MARKED_VALUE:%.*]] = mark_unresolved_noncopyable [consumable_and_assignable] [[MOVE_COPY_COPY_ARG]]
...
// CHECK: [[MARKED_GLOBAL:%.*]] = mark_unresolved_noncopyable [no_consume_or_assign] [[ACCESS]]
...
// CHECK: [[MARKED_GLOBAL:%.*]] = mark_unresolved_noncopyable [no_consume_or_assign] [[GLOBAL]]
// CHECK: [[LOADED_VAL:%.*]] = load [copy] [[MARKED_GLOBAL]] : $*NonTrivialStruct
// CHECK: apply {{%.*}}([[LOADED_VAL]])
// CHECK: destroy_value [[LOADED_VAL]]
//
...
// CHECK: [[MARKED_GLOBAL:%.*]] = mark_unresolved_noncopyable [assignable_but_not_consumable] [[ACCESS]]
...
// Make sure that we insert a mark_unresolved_noncopyable on the capture value.
// CHECK-LABEL: sil hidden [ossa] @$s8moveonly49checkMarkUnresolvedNonCopyableInstOnCaptured1xyAA2FDVn_tF : $@convention(thin) (@owned FD) -> () {
// CHECK: bb0([[ARG:%.*]] : @owned
// CHECK:   [[BOX:%.*]] = alloc_box
// CHECK:   [[PROJECT:%.*]] = project_box [[BOX]]
// CHECK:   store [[ARG]] to [init] [[PROJECT]]
//
// CHECK:   [[FN:%.*]] = function_ref @$s8moveonly49checkMarkUnresolvedNonCopyableInstOnCaptured1xyAA2FDVn_tFyyXEfU_ : $@convention(thin) @substituted <τ_0_0> (@guaranteed FD) -> @out τ_0_0 for <()>
// CHECK:   [[MARK:%.*]] = mark_unresolved_noncopyable [assignable_but_not_consumable] [[PROJECT]]
// CHECK:   [[VALUE:%.*]] = load [copy] [[MARK]]
// CHECK:   [[CLOSURE:%.*]] = partial_apply [callee_guaranteed] [[FN]]([[VALUE]])
// CHECK: } // end sil function '$s8moveonly49checkMarkUnresolvedNonCopyableInstOnCaptured1xyAA2FDVn_tF'
func checkMarkUnresolvedNonCopyableInstOnCaptured(x: __owned FD) {
    func clodger<T>(_: () -> T) {}
...
struct EmptyStruct {
  ...
  // CHECK: [[MV_CHECK:%.*]] = mark_unresolved_noncopyable [assignable_but_not_consumable] [[PROJECT]]
...
//
// CHECK: [[LHS_BB]]:
// CHECK:   [[MARKED:%.*]] = mark_unresolved_noncopyable [assignable_but_not_consumable] [[PROJECT]]
...
struct AddressOnlySetterTester : ~Copyable {
    var a: AddressOnlyProtocol {
        ...
        // CHECK: mark_unresolved_noncopyable [consumable_and_assignable] [[IN_ARG]]
        // CHECK: mark_unresolved_noncopyable [consumable_and_assignable] [[SELF_INOUT_ARG]]
...
public class NonFinalClassTest {
    ...
    // CHECK:   [[MARK:%.*]] = mark_unresolved_noncopyable [consumable_and_assignable] [[INPUT]]
    // CHECK:   [[TEMP:%.*]] = alloc_stack $AddressOnlyProtocol
    // CHECK:   copy_addr [[MARK]] to [init] [[TEMP]]
    // CHECK:   [[REF:%.*]] = ref_element_addr [[SELF]]
    // CHECK:   [[ACCESS:%.*]] = begin_access [modify] [dynamic] [[REF]]
    // CHECK:   [[MARK2:%.*]] = mark_unresolved_noncopyable [assignable_but_not_consumable] [[ACCESS]]
...
// The get call
// CHECK: [[ACCESS:%.*]] = begin_access [read] [unknown] [[PROJECT]]
// CHECK: [[MARK:%.*]] = mark_unresolved_noncopyable [no_consume_or_assign] [[ACCESS]]
// CHECK: [[LOAD_BORROW:%.*]] = load_borrow [[MARK]]
// CHECK: [[TEMP:%.*]] = alloc_stack $AddressOnlyProtocol
// CHECK: [[TEMP_MARK:%.*]] = mark_unresolved_noncopyable [consumable_and_assignable] [[TEMP]]
...
// CHECK: end_access [[ACCESS]]
// CHECK: [[M2_MARK:%.*]] = mark_unresolved_noncopyable [no_consume_or_assign] [[M2_PROJECT]]
...
//
// The get call
// CHECK: [[MARK:%.*]] = mark_unresolved_noncopyable [no_consume_or_assign] [[PROJECT]]
// CHECK: [[LOAD_BORROW:%.*]] = load_borrow [[MARK]]
// CHECK: [[TEMP:%.*]] = alloc_stack $AddressOnlyProtocol
// CHECK: [[TEMP_MARK:%.*]] = mark_unresolved_noncopyable [consumable_and_assignable] [[TEMP]]
// CHECK: apply {{%.*}}([[TEMP_MARK]], {{%.*}}, [[LOAD_BORROW]])
...
// CHECK: bb0([[ARG:%.*]] : $*
// CHECK:   [[MARK:%.*]] = mark_unresolved_noncopyable [consumable_and_assignable] [[ARG]]
//
...
// CHECK: [[TEMP_MARK:%.*]] = mark_unresolved_noncopyable [no_consume_or_assign] [[TEMP]]
...
// CHECK: [[TEMP2_MARK:%.*]] = mark_unresolved_noncopyable [consumable_and_assignable] [[TEMP2]]
...
// The assignment:
// CHECK: [[TEMP:%.*]] = alloc_stack $AddressOnlyProtocol
// CHECK: [[MARK_TEMP:%.*]] = mark_unresolved_noncopyable [consumable_and_assignable] [[TEMP]]
...
func testSelfCaptureHandledCorrectly() {
    ...
    struct Test : ~Copyable {
        ...
        // CHECK:   [[MARK:%.*]] = mark_unresolved_noncopyable [no_consume_or_assign] [[COPY]]
