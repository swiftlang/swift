...
// CHECK:   [[NSANSE:%.*]] = function_ref @$SSC6NSAnseySo7AnsibleCSgADFTO : $@convention(thin) (@owned Optional<Ansible>) -> @owned Optional<Ansible>
...
// CHECK: sil shared [serialized] [thunk] @$SSC6NSAnseySo7AnsibleCSgADFTO : $@convention(thin) (@owned Optional<Ansible>) -> @owned Optional<Ansible> {
