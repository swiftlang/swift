...
// CHECK: sil hidden [ossa] @$s15borrow_accessor7WrapperV1sAA1SVvz : $@convention(method) (@inout Wrapper) -> @inout S {
...
// CHECK: sil hidden [ossa] @$s15borrow_accessor7WrapperV1kAA5KlassCvz : $@convention(method) (@inout Wrapper) -> @inout Klass {
// CHECK:bb0([[REG0:%.*]] : $*Wrapper):
// CHECK:  debug_value [[REG0]], var, name "self", argno 1, expr op_deref
...
// CHECK: sil hidden [ossa] @$s15borrow_accessor7WrapperV14nested_borrow1AA5KlassCvz : $@convention(method) (@inout Wrapper) -> @inout Klass {
// CHECK:bb0([[REG0:%.*]] : $*Wrapper):
// CHECK:  debug_value [[REG0]], var, name "self", argno 1, expr op_deref
// CHECK:  [[REG2:%.*]] = function_ref @$s15borrow_accessor7WrapperV1sAA1SVvz : $@convention(method) (@inout Wrapper) -> @inout S
// CHECK:  [[REG3:%.*]] = apply [[REG2]]([[REG0]]) : $@convention(method) (@inout Wrapper) -> @inout S
...
// CHECK: sil hidden [ossa] @$s15borrow_accessor7WrapperV14nested_borrow2AA5KlassCvz : $@convention(method) (@inout Wrapper) -> @inout Klass {
// CHECK:bb0([[REG0:%.*]] : $*Wrapper):
// CHECK:  debug_value [[REG0]], var, name "self", argno 1, expr op_deref
// CHECK:  [[REG2:%.*]] = struct_element_addr [[REG0]], #Wrapper._k
// CHECK:  return [[REG2]]
...
// CHECK: sil hidden [ossa] @$s15borrow_accessor7WrapperVyAA5KlassCSiciz : $@convention(method) (Int, @inout Wrapper) -> @inout Klass {
...
// CHECK: sil hidden [ossa] @$s15borrow_accessor7WrapperV16nested_subscriptAA5KlassCvz : $@convention(method) (@inout Wrapper) -> @inout Klass {
// CHECK:bb0([[REG0:%.*]] : $*Wrapper):
// CHECK:  debug_value [[REG0]], var, name "self", argno 1, expr op_deref
// CHECK:  [[REG2:%.*]] = integer_literal $Builtin.IntLiteral, 0
// CHECK:  [[REG3:%.*]] = metatype $@thin Int.Type
// CHECK:  [[REG4:%.*]] = function_ref @$sSi22_builtinIntegerLiteralSiBI_tcfC : $@convention(method) (Builtin.IntLiteral, @thin Int.Type) -> Int
// CHECK:  [[REG5:%.*]] = apply [[REG4]]([[REG2]], [[REG3]]) : $@convention(method) (Builtin.IntLiteral, @thin Int.Type) -> Int
// CHECK:  [[REG6:%.*]] = function_ref @$s15borrow_accessor7WrapperVyAA5KlassCSiciz : $@convention(method) (Int, @inout Wrapper) -> @inout Klass
// CHECK:  [[REG7:%.*]] = apply [[REG6]]([[REG5]], [[REG0]]) : $@convention(method) (Int, @inout Wrapper) -> @inout Klass
// CHECK:  return [[REG7]]
// CHECK: }
...
// CHECK: sil [ossa] @$s15borrow_accessor10GenWrapperV4propxvz : $@convention(method) <T> (@inout GenWrapper<T>) -> @inout T {
// CHECK:bb0([[REG0:%.*]] : $*GenWrapper<T>):
// CHECK:  debug_value [[REG0]], var, name "self", argno 1, expr op_deref
// CHECK:  [[REG2:%.*]] = struct_element_addr [[REG0]], #GenWrapper._prop
// CHECK:  return [[REG2]]
...
// CHECK: sil hidden [ossa] @$s15borrow_accessor10GenWrapperV12nested_prop1xvz : $@convention(method) <T> (@inout GenWrapper<T>) -> @inout T {
// CHECK:bb0([[REG0:%.*]] : $*GenWrapper<T>):
// CHECK:  debug_value [[REG0]], var, name "self", argno 1, expr op_deref
// CHECK:  [[REG2:%.*]] = struct_element_addr [[REG0]], #GenWrapper._w
// CHECK:  [[REG3:%.*]] = function_ref @$s15borrow_accessor13SimpleWrapperV4propxvz : $@convention(method) <τ_0_0> (@inout SimpleWrapper<τ_0_0>) -> @inout τ_0_0
// CHECK:  [[REG4:%.*]] = apply [[REG3]]<T>([[REG2]]) : $@convention(method) <τ_0_0> (@inout SimpleWrapper<τ_0_0>) -> @inout τ_0_0
// CHECK:  return [[REG4]]
// CHECK: }
...
// CHECK:  debug_value [[REG0]], var, name "self", argno 1, expr op_deref
// CHECK:  [[REG2:%.*]] = struct_element_addr [[REG0]], #GenWrapper._s
// CHECK:  [[REG3:%.*]] = function_ref @$s15borrow_accessor1SV1kAA5KlassCvz : $@convention(method) (@inout S) -> @inout Klass
// CHECK:  [[REG4:%.*]] = apply [[REG3]]([[REG2]]) : $@convention(method) (@inout S) -> @inout Klass
// CHECK:  return [[REG4]]
// CHECK: }
...
// CHECK: sil hidden [ossa] @$s15borrow_accessor10GenWrapperV9nested_k2AA5KlassCvz : $@convention(method) <T> (@inout GenWrapper<T>) -> @inout Klass {
// CHECK:bb0([[REG0:%.*]] : $*GenWrapper<T>):
// CHECK:  debug_value [[REG0]], var, name "self", argno 1, expr op_deref
// CHECK:  [[REG2:%.*]] = function_ref @$s15borrow_accessor10GenWrapperV1sAA1SVvz : $@convention(method) <τ_0_0> (@inout GenWrapper<τ_0_0>) -> @inout S
// CHECK:  [[REG3:%.*]] = apply [[REG2]]<T>([[REG0]]) : $@convention(method) <τ_0_0> (@inout GenWrapper<τ_0_0>) -> @inout S
// CHECK:  [[REG4:%.*]] = function_ref @$s15borrow_accessor1SV1kAA5KlassCvz : $@convention(method) (@inout S) -> @inout Klass
// CHECK:  [[REG5:%.*]] = apply [[REG4]]([[REG3]]) : $@convention(method) (@inout S) -> @inout Klass
// CHECK:  return [[REG5]]
// CHECK: }
...
// CHECK: sil hidden [ossa] @$s15borrow_accessor10GenWrapperVyxSiciz : $@convention(method) <T> (Int, @inout GenWrapper<T>) -> @inout T {
// CHECK:bb0([[REG0:%.*]] : $Int, [[REG1:%.*]] : $*GenWrapper<T>):
// CHECK:  debug_value [[REG0]], let, name "index", argno 1
// CHECK:  debug_value [[REG1]], var, name "self", argno 2, expr op_deref
// CHECK:  [[REG4:%.*]] = struct_element_addr [[REG1]], #GenWrapper._prop
...
// CHECK: sil hidden [ossa] @$s15borrow_accessor10GenWrapperV16nested_subscriptxvz : $@convention(method) <T> (@inout GenWrapper<T>) -> @inout T {
// CHECK:bb0([[REG0:%.*]] : $*GenWrapper<T>):
// CHECK:  debug_value [[REG0]], var, name "self", argno 1, expr op_deref
// CHECK:  [[REG2:%.*]] = integer_literal $Builtin.IntLiteral, 0
// CHECK:  [[REG3:%.*]] = metatype $@thin Int.Type
// CHECK:  [[REG4:%.*]] = function_ref @$sSi22_builtinIntegerLiteralSiBI_tcfC : $@convention(method) (Builtin.IntLiteral, @thin Int.Type) -> Int
// CHECK:  [[REG5:%.*]] = apply [[REG4]]([[REG2]], [[REG3]]) : $@convention(method) (Builtin.IntLiteral, @thin Int.Type) -> Int
// CHECK:  [[REG6:%.*]] = function_ref @$s15borrow_accessor10GenWrapperVyxSiciz : $@convention(method) <τ_0_0> (Int, @inout GenWrapper<τ_0_0>) -> @inout τ_0_0
// CHECK:  [[REG7:%.*]] = apply [[REG6]]<T>([[REG5]], [[REG0]]) : $@convention(method) <τ_0_0> (Int, @inout GenWrapper<τ_0_0>) -> @inout τ_0_0
// CHECK:  return [[REG7]]
// CHECK: }
...
// CHECK: sil [ossa] @$s15borrow_accessor12GenNCWrapperVAARi_zrlE4propxvz : $@convention(method) <T where T : ~Copyable> (@inout GenNCWrapper<T>) -> @inout T {
// CHECK:bb0([[REG0:%.*]] : $*GenNCWrapper<T>):
// CHECK:  debug_value [[REG0]], var, name "self", argno 1, expr op_deref
...
// CHECK: sil hidden [ossa] @$s15borrow_accessor12GenNCWrapperVAARi_zrlE12nested_prop1xvz : $@convention(method) <T where T : ~Copyable> (@inout GenNCWrapper<T>) -> @inout T {
// CHECK:bb0([[REG0:%.*]] : $*GenNCWrapper<T>):
// CHECK:  debug_value [[REG0]], var, name "self", argno 1, expr op_deref
// CHECK:  [[REG2:%.*]] = mark_unresolved_non_copyable_value [consumable_and_assignable] [[REG0]]
// CHECK:  [[REG3:%.*]] = struct_element_addr [[REG2]], #GenNCWrapper._w
...
// CHECK: sil hidden [ossa] @$s15borrow_accessor12GenNCWrapperVAARi_zrlE12nested_prop2xvz : $@convention(method) <T where T : ~Copyable> (@inout GenNCWrapper<T>) -> @inout T {
// CHECK:bb0([[REG0:%.*]] : $*GenNCWrapper<T>):
// CHECK:  debug_value [[REG0]], var, name "self", argno 1, expr op_deref
// CHECK:  [[REG2:%.*]] = mark_unresolved_non_copyable_value [consumable_and_assignable] [[REG0]]
...
// CHECK: sil hidden [ossa] @$s15borrow_accessor12GenNCWrapperVAARi_zrlE10nested_nc2AA2NCVvz : $@convention(method) <T where T : ~Copyable> (@inout GenNCWrapper<T>) -> @inout NC {
// CHECK:bb0([[REG0:%.*]] : $*GenNCWrapper<T>):
// CHECK:  debug_value [[REG0]], var, name "self", argno 1, expr op_deref
// CHECK:  [[REG2:%.*]] = mark_unresolved_non_copyable_value [consumable_and_assignable] [[REG0]]
...
// CHECK: sil hidden [ossa] @$s15borrow_accessor12GenNCWrapperVAARi_zrlEyxSiciz : $@convention(method) <T where T : ~Copyable> (Int, @inout GenNCWrapper<T>) -> @inout T {
// CHECK:bb0([[REG0:%.*]] : $Int, [[REG1:%.*]] : $*GenNCWrapper<T>):
// CHECK:  debug_value [[REG0]], let, name "index", argno 1
// CHECK:  debug_value [[REG1]], var, name "self", argno 2, expr op_deref
...
// CHECK: sil hidden [ossa] @$s15borrow_accessor12GenNCWrapperVAARi_zrlE16nested_subscriptxvz : $@convention(method) <T where T : ~Copyable> (@inout GenNCWrapper<T>) -> @inout T {
// CHECK:bb0([[REG0:%.*]] : $*GenNCWrapper<T>):
// CHECK:  debug_value [[REG0]], var, name "self", argno 1, expr op_deref
// CHECK:  [[REG2:%.*]] = mark_unresolved_non_copyable_value [consumable_and_assignable] [[REG0]]
// CHECK:  [[REG3:%.*]] = integer_literal $Builtin.IntLiteral, 0
