// RUN: %target-swift-emit-silgen -Xllvm -sil-print-types -module-name implicit_property_initializers -Xllvm -sil-full-demangle -enable-testing %s -disable-experimental-serialize-debug-info|  %FileCheck %s
