...
// CHECK-NEXT: sil hidden @_TFV5decls19StructWithLazyFieldCfMS0_FT4onceGSqSi__S0_ : $@thin (Optional<Int>, @thin StructWithLazyField.Type) -> @owned StructWithLazyField {
