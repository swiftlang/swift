// RUN: %target-swift-frontend -Xllvm -sil-print-types -emit-silgen-ossa -sil-verify-all -enable-sil-opaque-values %s -import-objc-header %S/Inputs/foreign_to_native_inout_self_helper.h
