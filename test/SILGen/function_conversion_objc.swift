// RUN: %target-swift-emit-silgen -module-name function_conversion_objc -sdk %S/Inputs %s -I %S/Inputs -enable-sil-ownership-verifier -enable-source-import -enable-objc-interop -verify | %FileCheck %s
