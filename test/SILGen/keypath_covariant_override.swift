...
// CHECK:      sil_property instance #C.hashValue ()
// CHECK-NEXT: sil_property instance #Base.int ()
// CHECK-NEXT: sil_property instance #Base.ref ()
// CHECK-NEXT: sil_property instance #Base.subscript ()
// CHECK-NEXT: sil_property instance #Base.subscript ()
// CHECK-NEXT: sil_property instance #Derived.int ()
// CHECK-NEXT: sil_property instance #Derived.subscript ()
// CHECK-NEXT: sil_property instance #Generic.generic<τ_0_0> ()
// CHECK-NEXT: sil_property instance #Generic.subscript<τ_0_0> ()
// CHECK-NEXT: sil_property instance #Generic.subscript<τ_0_0> ()
// CHECK-NEXT: sil_property instance #DerivedGeneric.subscript<τ_0_0> ()
// CHECK-NEXT: sil_property instance #DerivedGeneric.subscript<τ_0_0> ()
// CHECK-NEXT: sil_property instance #DerivedConcrete.subscript ()
// CHECK-NEXT: sil_property instance #DerivedConcrete.subscript ()
