...
// CHECK-NEXT: method #Hashable.hashValue!getter.1: {{.*}} : @$SSo13GenericOptionaSkSCsACP9hashValueSivgTW
// CHECK-NEXT: method #Hashable.hash!1: {{.*}} : @$SSo13GenericOptionaSkSCsACP4hash4intoys6HasherVz_tFTW
// CHECK-NEXT: method #Hashable._rawHashValue!1: {{.*}} : @$SSo13GenericOptionaSkSCsACP13_rawHashValue4seedSis6UInt64V_AHt_tFTW
// CHECK-NEXT: }
