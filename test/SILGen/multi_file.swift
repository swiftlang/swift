// RUN: %swift_driver -frontend -emit-silgen -primary-file %s %S/Inputs/multi_file_helper.swift | FileCheck %s

// CHECK-LABEL: sil @_TF10multi_file12rdar16016713FT1rVS_5Range_T_ :
