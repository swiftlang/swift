...
// CHECK-LABEL: sil hidden @_TTWC10multi_file19HasComputedPropertyS_20ProtocolWithPropertyS_FS1_m3fooSi : $@cc(witness_method) @thin (Builtin.RawPointer, @inout HasComputedProperty) -> (Builtin.RawPointer, Builtin.Int1) {
