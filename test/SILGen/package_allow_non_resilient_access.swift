...
// CHECK-DIAG-1: warning: ignoring -experimental-skip-non-exportable-decls (overridden by -experimental-allow-non-resilient-access)
// RUN: llvm-bcanalyzer --dump %t/Utils.swiftmodule | %FileCheck %s --check-prefix=CHECK-ON
...
// CHECK-DIAG-2: warning: ignoring -experimental-skip-non-inlinable-function-bodies-without-types (overridden by -experimental-allow-non-resilient-access)
// RUN: llvm-bcanalyzer --dump %t/Utils.swiftmodule | %FileCheck %s --check-prefix=CHECK-ON
...
// CHECK-DIAG-3: warning: ignoring -experimental-skip-non-inlinable-function-bodies (overridden by -experimental-allow-non-resilient-access)
// RUN: llvm-bcanalyzer --dump %t/Utils.swiftmodule | %FileCheck %s --check-prefix=CHECK-ON
...
// CHECK-DIAG-4: warning: ignoring -experimental-skip-all-function-bodies (overridden by -experimental-allow-non-resilient-access)
// RUN: llvm-bcanalyzer --dump %t/Utils.swiftmodule | %FileCheck %s --check-prefix=CHECK-ON
...
// CHECK-DIAG-5: warning: ignoring -experimental-lazy-typecheck (overridden by -experimental-allow-non-resilient-access)
// RUN: llvm-bcanalyzer --dump %t/Utils.swiftmodule | %FileCheck %s --check-prefix=CHECK-ON
...
// CHECK-DIAG-TBD: warning: ignoring -tbd-is-installapi (overridden by -experimental-allow-non-resilient-access)
// RUN: llvm-bcanalyzer --dump %t/Utils.swiftmodule | %FileCheck %s --check-prefix=CHECK-ON
...
/// If built from interface, non-resilient access option is ignored with a warning.
...
// CHECK-DIAG-INTERFACE: warning: ignoring -experimental-allow-non-resilient-access (overridden by -compile-module-from-interface or -typecheck-module-from-interface)
