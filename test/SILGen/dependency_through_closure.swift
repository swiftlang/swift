...
// RUN: not --crash %target-swift-emit-silgen-ossa -enable-sil-opaque-values -verify -enable-experimental-feature Lifetimes -enable-experimental-feature AddressableTypes %s
