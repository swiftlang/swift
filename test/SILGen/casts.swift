...
func downcast_conditional(_ b: B) -> D? {
  return b as? D
}
...
// CHECK:   return [[RESULT]]
func downcast_existential_conditional(_ p: P) -> S? {
  return p as? S
}
