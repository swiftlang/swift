...
final class VarInit {
  // CHECK: sil_coverage_map {{.*}} _T017coverage_var_init7VarInitC04lazydE033_49373CB2DFB47C8DC62FA963604688DFLLSSvg 
  // CHECK-NEXT: [[@LINE+1]]:42 -> [[@LINE+3]]:4 : 2
  private lazy var lazyVarInit: String = {
    return "Hello"
  }()

  // CHECK: sil_coverage_map {{.*}} _T017coverage_var_init7VarInitC05basicdE033_49373CB2DFB47C8DC62FA963604688DFLLSSvpfiSSycfU_ 
  // CHECK-NEXT: [[@LINE+1]]:38 -> [[@LINE+3]]:4 : 0
  private var basicVarInit: String = {
    return "Hello"
  }()

  // CHECK: sil_coverage_map {{.*}} _T017coverage_var_init7VarInitC06simpleD033_49373CB2DFB47C8DC62FA963604688DFLLSSvg 
