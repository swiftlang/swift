// RUN: %target-swift-emit-silgen-ossa(mock-sdk: %clang-importer-sdk) -enable-sil-opaque-values -module-name objc_sending -Xllvm -sil-print-types -import-objc-header %S/Inputs/objc_sending.h %s
