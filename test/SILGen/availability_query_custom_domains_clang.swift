// RUN: %target-swift-emit-silgen-ossa -enable-sil-opaque-values -module-name Test %s -verify -enable-experimental-feature CustomAvailability -import-bridging-header %S/Inputs/AvailabilityDomains.h
