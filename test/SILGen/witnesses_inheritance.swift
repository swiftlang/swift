...
class Y : X, Barrable {
  func bar() {}
  // CHECK-LABEL: sil hidden @_TTWC21witnesses_inheritance1YS_7FooableS_FS1_3fooUS1___fRQPS1_FT_T_
  // CHECK:         upcast {{%.*}} : $Y to $X
  class func class_bar() {}
...
class B : A, Barrable {}
// CHECK-LABEL: sil hidden @_TTWC21witnesses_inheritance1BS_7FooableS_FS1_3fooUS1___fRQPS1_FT_T_
// CHECK:         upcast {{%.*}} : $B to $A
...
// CHECK-LABEL: sil hidden @_TTWC21witnesses_inheritance1BS_8BarrableS_FS1_3barUS1___fRQPS1_FT_T_
// CHECK:         upcast {{%.*}} : $B to $A
