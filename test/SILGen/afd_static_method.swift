...
// RUN: not --crash %target-swift-emit-silgen-ossa -enable-sil-opaque-values -enable-experimental-feature Lifetimes -enable-experimental-feature AddressableTypes -module-name main %s
