...
// CHECK: [[OPENED:%[0-9]+]] = open_existential_addr immutable_access %0 : $*P to $*@opened([[OPENED_ID:"[0-9A-F-]+"]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.covariantSelfMethod1 : <Self where Self : P> (Self) -> () -> Self
// CHECK: [[DEST:%[0-9]+]] = init_existential_addr [[LET]] : $*P, $@opened([[OPENED_ID]], P) Self
// CHECK: apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[DEST]], [[OPENED]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @out τ_0_0
...
// CHECK: [[OPENED:%[0-9]+]] = open_existential_addr immutable_access %0 : $*P to $*@opened([[OPENED_ID:"[0-9A-F-]+"]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.covariantSelfMethod2 : <Self where Self : P> (Self) -> () -> Self?
// CHECK: apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>(%{{[0-9]+}}, [[OPENED]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @out Optional<τ_0_0>
// CHECK: init_existential_addr %{{[0-9]+}} : $*P, $@opened([[OPENED_ID]], P) Self
...
// CHECK: [[OPENED:%[0-9]+]] = open_existential_addr immutable_access %0 : $*P to $*@opened([[OPENED_ID:"[0-9A-F-]+"]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.covariantSelfMethod3 : <Self where Self : P> (Self) -> () -> Self.Type
// CHECK: [[META:%[0-9]+]] = apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[OPENED]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @thick τ_0_0.Type
// CHECK: [[EXIST_META:%[0-9]+]] = init_existential_metatype [[META]] : $@thick (@opened([[OPENED_ID]], P) Self).Type, $@thick P.Type
...
// CHECK: [[OPENED:%[0-9]+]] = open_existential_addr immutable_access %0 : $*P to $*@opened([[OPENED_ID:"[0-9A-F-]+"]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.covariantSelfMethod4 : <Self where Self : P> (Self) -> () -> (Self, Self)
// CHECK: apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[SRC_0:%[0-9]+]], [[SRC_1:%[0-9]+]], [[OPENED]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> (@out τ_0_0, @out τ_0_0)
// CHECK: init_existential_addr %{{[0-9]+}} : $*P, $@opened([[OPENED_ID]], P) Self
// CHECK: init_existential_addr %{{[0-9]+}} : $*P, $@opened([[OPENED_ID]], P) Self
...
// CHECK: [[OPENED:%[0-9]+]] = open_existential_addr immutable_access %0 : $*P to $*@opened([[OPENED_ID:"[0-9A-F-]+"]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.covariantSelfMethod5 : <Self where Self : P> (Self) -> () -> Array<Self>
// CHECK: [[ARRAY:%[0-9]+]] = apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[OPENED]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @owned Array<τ_0_0>
...
// CHECK: [[RESULT:%[0-9]+]] = apply [[ARRAY_UPCAST_FN]]<@opened([[OPENED_ID]], P) Self, P>([[ARRAY]]) : $@convention(thin) <τ_0_0, τ_0_1> (@guaranteed Array<τ_0_0>) -> @owned Array<τ_0_1>
...
// CHECK: [[OPENED:%[0-9]+]] = open_existential_addr immutable_access %0 : $*P to $*@opened([[OPENED_ID:"[0-9A-F-]+"]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.covariantSelfMethod6 : <Self where Self : P> (Self) -> () -> [String : Self]
// CHECK: [[DICT:%[0-9]+]] = apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[OPENED]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @owned Dictionary<String, τ_0_0>
...
// CHECK: [[RESULT:%[0-9]+]] = apply [[DICT_UPCAST_FN]]<String, @opened([[OPENED_ID]], P) Self, String, P>([[DICT]]) : $@convention(thin) <τ_0_0, τ_0_1, τ_0_2, τ_0_3 where τ_0_0 : Hashable, τ_0_2 : Hashable> (@guaranteed Dictionary<τ_0_0, τ_0_1>) -> @owned Dictionary<τ_0_2, τ_0_3>
...
// CHECK: [[STEP1:%[0-9]+]] = partial_apply [callee_guaranteed] [[THUNK]]<@opened([[OPENED_ID]], P) Self>
// CHECK: [[STEP2:%[0-9]+]] = convert_function [[STEP1]] : $@callee_guaranteed (@in_guaranteed @opened([[OPENED_ID]], P) Self) -> () to $@callee_guaranteed @substituted <τ_0_0> (@in_guaranteed τ_0_0) -> () for <@opened([[OPENED_ID]], P) Self>
// CHECK: [[STEP3:%[0-9]+]] = convert_escape_to_noescape [not_guaranteed] [[STEP2]]
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.covariantSelfMethod7 : <Self where Self : P> (Self) -> ((Self) -> ()) -> ()
// CHECK: apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[STEP3]], [[OPENED]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@noescape @callee_guaranteed @substituted <τ_0_0> (@in_guaranteed τ_0_0) -> () for <τ_0_0>, @in_guaranteed τ_0_0) -> ()
...
// CHECK: [[OPENED:%[0-9]+]] = open_existential_addr immutable_access %0 : $*P to $*[[OPENED_TY:@opened\("[0-9A-F-]+", P\) Self]]
...
// CHECK: [[OPENED_COPY:%[0-9]+]] = alloc_stack $@opened([[OPENED_ID]], P) Self
// CHECK: copy_addr [[OPENED]] to [initialization] [[OPENED_COPY]] : $*@opened([[OPENED_ID]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.covariantSelfProperty1!getter : <Self where Self : P> (Self) -> () -> Self
// CHECK: [[DEST:%[0-9]+]] = init_existential_addr [[LET]] : $*P, $@opened([[OPENED_ID]], P) Self
// CHECK: apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[DEST]], [[OPENED_COPY]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @out τ_0_0
...
// CHECK: [[OPENED_COPY:%[0-9]+]] = alloc_stack $@opened([[OPENED_ID]], P) Self
// CHECK: copy_addr [[OPENED]] to [initialization] [[OPENED_COPY]] : $*@opened([[OPENED_ID]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.covariantSelfProperty2!getter : <Self where Self : P> (Self) -> () -> Self?
// CHECK: apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[OPTIONAL:%[0-9]+]], [[OPENED_COPY]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @out Optional<τ_0_0>
// CHECK: init_existential_addr %{{[0-9]+}} : $*P, $@opened([[OPENED_ID]], P) Self
...
// CHECK: [[OPENED_COPY:%[0-9]+]] = alloc_stack $@opened([[OPENED_ID]], P) Self
// CHECK: copy_addr [[OPENED]] to [initialization] [[OPENED_COPY]] : $*@opened([[OPENED_ID]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.covariantSelfProperty3!getter : <Self where Self : P> (Self) -> () -> Self.Type
// CHECK: [[META:%[0-9]+]] = apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[OPENED_COPY]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @thick τ_0_0.Type
// CHECK: [[EXIST_META:%[0-9]+]] = init_existential_metatype [[META]] : $@thick (@opened([[OPENED_ID]], P) Self).Type, $@thick P.Type
// CHECK: debug_value [[EXIST_META]] : $@thick P.Type, let, name "x"
...
// CHECK: [[OPENED_COPY:%[0-9]+]] = alloc_stack $@opened([[OPENED_ID]], P) Self
// CHECK: copy_addr [[OPENED]] to [initialization] [[OPENED_COPY]] : $*@opened([[OPENED_ID]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.covariantSelfProperty4!getter : <Self where Self : P> (Self) -> () -> (Self, Self)
// CHECK: apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[SRC_0:%[0-9]+]], [[SRC_1:%[0-9]+]], [[OPENED_COPY]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> (@out τ_0_0, @out τ_0_0)
// CHECK: [[DEST_0_INITED:%[0-9]+]] = init_existential_addr %{{[0-9]+}} : $*P, $@opened([[OPENED_ID]], P) Self
// CHECK: [[DEST_1_INITED:%[0-9]+]] = init_existential_addr %{{[0-9]+}} : $*P, $@opened([[OPENED_ID]], P) Self
...
// CHECK: [[OPENED_COPY:%[0-9]+]] = alloc_stack $@opened([[OPENED_ID]], P) Self
// CHECK: copy_addr [[OPENED]] to [initialization] [[OPENED_COPY]] : $*@opened([[OPENED_ID]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.covariantSelfProperty5!getter : <Self where Self : P> (Self) -> () -> Array<Self>
// CHECK: [[ARRAY:%[0-9]+]] = apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[OPENED_COPY]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @owned Array<τ_0_0>
// CHECK: [[ARRAY_UPCAST_FN:%[0-9]+]] = function_ref @$ss15_arrayForceCastySayq_GSayxGr0_lF : $@convention(thin) <τ_0_0, τ_0_1> (@guaranteed Array<τ_0_0>) -> @owned Array<τ_0_1>
// CHECK: [[RESULT:%[0-9]+]] = apply [[ARRAY_UPCAST_FN]]<@opened([[OPENED_ID]], P) Self, P>([[ARRAY]]) : $@convention(thin) <τ_0_0, τ_0_1> (@guaranteed Array<τ_0_0>) -> @owned Array<τ_0_1>
// CHECK: debug_value %{{[0-9]+}} : $Array<P>, let, name "x"
...
// CHECK: [[OPENED_COPY:%[0-9]+]] = alloc_stack $@opened([[OPENED_ID]], P) Self
// CHECK: copy_addr [[OPENED]] to [initialization] [[OPENED_COPY]] : $*@opened([[OPENED_ID]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.covariantSelfProperty6!getter : <Self where Self : P> (Self) -> () -> [String : Self]
// CHECK: [[DICT:%[0-9]+]] = apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[OPENED_COPY]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @owned Dictionary<String, τ_0_0>
// CHECK: [[DICT_UPCAST_FN:%[0-9]+]] = function_ref @$ss17_dictionaryUpCastySDyq0_q1_GSDyxq_GSHRzSHR0_r2_lF : $@convention(thin) <τ_0_0, τ_0_1, τ_0_2, τ_0_3 where τ_0_0 : Hashable, τ_0_2 : Hashable> (@guaranteed Dictionary<τ_0_0, τ_0_1>) -> @owned Dictionary<τ_0_2, τ_0_3>
// CHECK: [[RESULT:%[0-9]+]] = apply [[DICT_UPCAST_FN]]<String, @opened([[OPENED_ID]], P) Self, String, P>([[DICT]]) : $@convention(thin) <τ_0_0, τ_0_1, τ_0_2, τ_0_3 where τ_0_0 : Hashable, τ_0_2 : Hashable> (@guaranteed Dictionary<τ_0_0, τ_0_1>) -> @owned Dictionary<τ_0_2, τ_0_3>
// CHECK: debug_value %{{[0-9]+}} : $Dictionary<String, P>, let, name "x"
...
// CHECK: [[OPENED_COPY:%[0-9]+]] = alloc_stack $@opened([[OPENED_ID]], P) Self
// CHECK: copy_addr [[OPENED]] to [initialization] [[OPENED_COPY]] : $*@opened([[OPENED_ID]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self,  #P.covariantSelfProperty7!getter : <Self where Self : P> (Self) -> () -> ((Self) -> ()) -> ()
// CHECK: [[RESULT_FN:%[0-9]+]] = apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[OPENED_COPY]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @owned @callee_guaranteed @substituted <τ_0_0> (@noescape @callee_guaranteed @substituted <τ_0_0> (@in_guaranteed τ_0_0) -> () for <τ_0_0>) -> () for <τ_0_0>
// CHECK: [[STEP1:%[0-9]+]] = convert_function [[RESULT_FN]] : $@callee_guaranteed @substituted <τ_0_0> (@noescape @callee_guaranteed @substituted <τ_0_0> (@in_guaranteed τ_0_0) -> () for <τ_0_0>) -> () for <@opened([[OPENED_ID]], P) Self> to $@callee_guaranteed (@noescape @callee_guaranteed @substituted <τ_0_0> (@in_guaranteed τ_0_0) -> () for <@opened([[OPENED_ID]], P) Self>) -> ()
...
// CHECK: partial_apply [callee_guaranteed] [[THUNK]]<@opened([[OPENED_ID]], P) Self>([[STEP1]]) : $@convention(thin) <τ_0_0 where τ_0_0 : P> (@noescape @callee_guaranteed (@in_guaranteed P) -> (), @guaranteed @callee_guaranteed (@noescape @callee_guaranteed @substituted <τ_0_0> (@in_guaranteed τ_0_0) -> () for <τ_0_0>) -> ()) -> ()
...
// CHECK: [[OPENED_COPY:%[0-9]+]] = alloc_stack $@opened([[OPENED_ID]], P) Self
// CHECK: copy_addr [[OPENED]] to [initialization] [[OPENED_COPY]] : $*@opened([[OPENED_ID]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.subscript!getter : <Self where Self : P> (Self) -> (()) -> Self
// CHECK: [[DEST:%[0-9]+]] = init_existential_addr [[LET]] : $*P, $@opened([[OPENED_ID]], P) Self
// CHECK: apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[DEST]], [[OPENED_COPY]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @out τ_0_0
...
// CHECK: [[OPENED_COPY:%[0-9]+]] = alloc_stack $@opened([[OPENED_ID]], P) Self
// CHECK: copy_addr [[OPENED]] to [initialization] [[OPENED_COPY]] : $*@opened([[OPENED_ID]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.subscript!getter : <Self where Self : P> (Self) -> (()) -> Self.Type
// CHECK: [[META:%[0-9]+]] = apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[OPENED_COPY]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @thick τ_0_0.Type
// CHECK: [[EXIST_META:%[0-9]+]] = init_existential_metatype [[META]] : $@thick (@opened([[OPENED_ID]], P) Self).Type, $@thick P.Type
// CHECK: debug_value [[EXIST_META]] : $@thick P.Type, let, name "x"
...
// CHECK: [[OPENED_COPY:%[0-9]+]] = alloc_stack $@opened([[OPENED_ID]], P) Self
// CHECK: copy_addr [[OPENED]] to [initialization] [[OPENED_COPY]] : $*@opened([[OPENED_ID]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.subscript!getter : <Self where Self : P> (Self) -> (()) -> (Self, Self)
// CHECK: apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[SRC_0:%[0-9]+]], [[SRC_1:%[0-9]+]], [[OPENED_COPY]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> (@out τ_0_0, @out τ_0_0)
// CHECK: init_existential_addr %{{[0-9]+}} : $*P, $@opened([[OPENED_ID]], P) Self
// CHECK: init_existential_addr %{{[0-9]+}} : $*P, $@opened([[OPENED_ID]], P) Self
...
// CHECK: [[OPENED_COPY:%[0-9]+]] = alloc_stack $@opened([[OPENED_ID]], P) Self
// CHECK: copy_addr [[OPENED]] to [initialization] [[OPENED_COPY]] : $*@opened([[OPENED_ID]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.subscript!getter : <Self where Self : P> (Self) -> (()) -> Array<Self>
// CHECK: [[ARRAY:%[0-9]+]] = apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[OPENED_COPY]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @owned Array<τ_0_0>
// CHECK: [[ARRAY_UPCAST_FN:%[0-9]+]] = function_ref @$ss15_arrayForceCastySayq_GSayxGr0_lF : $@convention(thin) <τ_0_0, τ_0_1> (@guaranteed Array<τ_0_0>) -> @owned Array<τ_0_1>
// CHECK: [[RESULT:%[0-9]+]] = apply [[ARRAY_UPCAST_FN]]<@opened([[OPENED_ID]], P) Self, P>([[ARRAY]]) : $@convention(thin) <τ_0_0, τ_0_1> (@guaranteed Array<τ_0_0>) -> @owned Array<τ_0_1>
// CHECK: debug_value %{{[0-9]+}} : $Array<P>, let, name "x"
...
// CHECK: [[OPENED_COPY:%[0-9]+]] = alloc_stack $@opened([[OPENED_ID]], P) Self
// CHECK: copy_addr [[OPENED]] to [initialization] [[OPENED_COPY]] : $*@opened([[OPENED_ID]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.subscript!getter : <Self where Self : P> (Self) -> (()) -> [String : Self]
// CHECK: [[DICT:%[0-9]+]] = apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[OPENED_COPY]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @owned Dictionary<String, τ_0_0>
// CHECK: [[DICT_UPCAST_FN:%[0-9]+]] = function_ref @$ss17_dictionaryUpCastySDyq0_q1_GSDyxq_GSHRzSHR0_r2_lF : $@convention(thin) <τ_0_0, τ_0_1, τ_0_2, τ_0_3 where τ_0_0 : Hashable, τ_0_2 : Hashable> (@guaranteed Dictionary<τ_0_0, τ_0_1>) -> @owned Dictionary<τ_0_2, τ_0_3>
// CHECK: [[RESULT:%[0-9]+]] = apply [[DICT_UPCAST_FN]]<String, @opened([[OPENED_ID]], P) Self, String, P>([[DICT]]) : $@convention(thin) <τ_0_0, τ_0_1, τ_0_2, τ_0_3 where τ_0_0 : Hashable, τ_0_2 : Hashable> (@guaranteed Dictionary<τ_0_0, τ_0_1>) -> @owned Dictionary<τ_0_2, τ_0_3>
// CHECK: debug_value %{{[0-9]+}} : $Dictionary<String, P>, let, name "x"
...
// CHECK: copy_addr [[OPENED]] to [initialization] [[OPENED_COPY]] : $*@opened([[OPENED_ID]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.subscript!getter : <Self where Self : P> (Self) -> ((Self) -> ()) -> ()
// CHECK: apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[STEP3]], [[OPENED_COPY]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@noescape @callee_guaranteed @substituted <τ_0_0> (@in_guaranteed τ_0_0) -> () for <τ_0_0>, @in_guaranteed τ_0_0) -> ()
...
// CHECK: [[OPENED:%[0-9]+]] = open_existential_addr immutable_access %0 : $*P to $*@opened([[OPENED_ID:"[0-9A-F-]+"]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.covariantAssocMethod1 : <Self where Self : P> (Self) -> () -> Self.A
// CHECK: [[DEST:%[0-9]+]] = init_existential_addr [[LET]] : $*Any, $@opened([[OPENED_ID]], P) Self.A
// CHECK: apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[DEST]], [[OPENED]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @out τ_0_0.A
...
// CHECK: [[OPENED:%[0-9]+]] = open_existential_addr immutable_access %0 : $*P to $*@opened([[OPENED_ID:"[0-9A-F-]+"]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.covariantAssocMethod2 : <Self where Self : P> (Self) -> () -> Self.A?
// CHECK: apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>(%{{[0-9]+}}, [[OPENED]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @out Optional<τ_0_0.A>
// CHECK: init_existential_addr %{{[0-9]+}} : $*Any, $@opened([[OPENED_ID]], P) Self.A
...
// CHECK: [[OPENED:%[0-9]+]] = open_existential_addr immutable_access %0 : $*P to $*@opened([[OPENED_ID:"[0-9A-F-]+"]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.covariantAssocMethod3 : <Self where Self : P> (Self) -> () -> Self.A.Type
// CHECK: [[META:%[0-9]+]] = apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[OPENED]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @thick τ_0_0.A.Type
// CHECK: [[EXIST_META:%[0-9]+]] = init_existential_metatype [[META]] : $@thick (@opened([[OPENED_ID]], P) Self.A).Type, $@thick Any.Type
...
// CHECK: [[OPENED:%[0-9]+]] = open_existential_addr immutable_access %0 : $*P to $*@opened([[OPENED_ID:"[0-9A-F-]+"]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.covariantAssocMethod4 : <Self where Self : P> (Self) -> () -> (Self.A, Self.A)
// CHECK: apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>(%{{[0-9]+}}, %{{[0-9]+}}, [[OPENED]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> (@out τ_0_0.A, @out τ_0_0.A)
// CHECK: init_existential_addr %{{[0-9]+}} : $*Any, $@opened([[OPENED_ID]], P) Self.A
// CHECK: init_existential_addr %{{[0-9]+}} : $*Any, $@opened([[OPENED_ID]], P) Self.A
...
// CHECK: [[OPENED:%[0-9]+]] = open_existential_addr immutable_access %0 : $*P to $*@opened([[OPENED_ID:"[0-9A-F-]+"]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.covariantAssocMethod5 : <Self where Self : P> (Self) -> () -> Array<Self.A>
// CHECK: [[ARRAY:%[0-9]+]] = apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[OPENED]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @owned Array<τ_0_0.A>
// CHECK: [[ARRAY_UPCAST_FN:%[0-9]+]] = function_ref @$ss15_arrayForceCastySayq_GSayxGr0_lF : $@convention(thin) <τ_0_0, τ_0_1> (@guaranteed Array<τ_0_0>) -> @owned Array<τ_0_1>
// CHECK: [[RESULT:%[0-9]+]] = apply [[ARRAY_UPCAST_FN]]<@opened([[OPENED_ID]], P) Self.A, Any>([[ARRAY]]) : $@convention(thin) <τ_0_0, τ_0_1> (@guaranteed Array<τ_0_0>) -> @owned Array<τ_0_1>
...
// CHECK: [[OPENED:%[0-9]+]] = open_existential_addr immutable_access %0 : $*P to $*@opened([[OPENED_ID:"[0-9A-F-]+"]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.covariantAssocMethod6 : <Self where Self : P> (Self) -> () -> [String : Self.A]
// CHECK: [[DICT:%[0-9]+]] = apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[OPENED]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @owned Dictionary<String, τ_0_0.A>
// CHECK: [[DICT_UPCAST_FN:%[0-9]+]] = function_ref @$ss17_dictionaryUpCastySDyq0_q1_GSDyxq_GSHRzSHR0_r2_lF : $@convention(thin) <τ_0_0, τ_0_1, τ_0_2, τ_0_3 where τ_0_0 : Hashable, τ_0_2 : Hashable> (@guaranteed Dictionary<τ_0_0, τ_0_1>) -> @owned Dictionary<τ_0_2, τ_0_3>
// CHECK: [[RESULT:%[0-9]+]] = apply [[DICT_UPCAST_FN]]<String, @opened([[OPENED_ID]], P) Self.A, String, Any>([[DICT]]) : $@convention(thin) <τ_0_0, τ_0_1, τ_0_2, τ_0_3 where τ_0_0 : Hashable, τ_0_2 : Hashable> (@guaranteed Dictionary<τ_0_0, τ_0_1>) -> @owned Dictionary<τ_0_2, τ_0_3>
...
// CHECK: [[STEP1:%[0-9]+]] = partial_apply [callee_guaranteed] [[THUNK]]<@opened([[OPENED_ID]], P) Self>
// CHECK: [[STEP2:%[0-9]+]] = convert_function [[STEP1]] : $@callee_guaranteed (@in_guaranteed @opened([[OPENED_ID]], P) Self.A) -> () to $@callee_guaranteed @substituted <τ_0_0> (@in_guaranteed τ_0_0) -> () for <@opened([[OPENED_ID]], P) Self.A>
// CHECK: [[STEP3:%[0-9]+]] = convert_escape_to_noescape [not_guaranteed] [[STEP2]]
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.covariantAssocMethod7 : <Self where Self : P> (Self) -> ((Self.A) -> ()) -> ()
// CHECK: apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[STEP3]], [[OPENED]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@noescape @callee_guaranteed @substituted <τ_0_0> (@in_guaranteed τ_0_0) -> () for <τ_0_0.A>, @in_guaranteed τ_0_0) -> ()
...
// CHECK: [[OPENED_COPY:%[0-9]+]] = alloc_stack $@opened([[OPENED_ID]], P) Self
// CHECK: copy_addr [[OPENED]] to [initialization] [[OPENED_COPY]] : $*@opened([[OPENED_ID]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.covariantAssocProperty1!getter : <Self where Self : P> (Self) -> () -> Self.A
// CHECK: [[DEST:%[0-9]+]] = init_existential_addr [[LET]] : $*Any, $@opened([[OPENED_ID]], P) Self.A
// CHECK: apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[DEST]], [[OPENED_COPY]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @out τ_0_0.A
...
// CHECK: [[OPENED_COPY:%[0-9]+]] = alloc_stack $@opened([[OPENED_ID]], P) Self
// CHECK: copy_addr [[OPENED]] to [initialization] [[OPENED_COPY]] : $*@opened([[OPENED_ID]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.covariantAssocProperty2!getter : <Self where Self : P> (Self) -> () -> Self.A?
// CHECK: apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>(%{{[0-9]+}}, [[OPENED_COPY]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @out Optional<τ_0_0.A>
// CHECK: init_existential_addr %{{[0-9]+}} : $*Any, $@opened([[OPENED_ID]], P) Self.A
...
// CHECK: [[OPENED_COPY:%[0-9]+]] = alloc_stack $@opened([[OPENED_ID]], P) Self
// CHECK: copy_addr [[OPENED]] to [initialization] [[OPENED_COPY]] : $*@opened([[OPENED_ID]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.covariantAssocProperty3!getter : <Self where Self : P> (Self) -> () -> Self.A.Type
// CHECK: [[META:%[0-9]+]] = apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[OPENED_COPY]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @thick τ_0_0.A.Type
// CHECK: [[EXIST_META:%[0-9]+]] = init_existential_metatype [[META]] : $@thick (@opened([[OPENED_ID]], P) Self.A).Type, $@thick Any.Type
// CHECK: debug_value [[EXIST_META]] : $@thick Any.Type, let, name "x"
...
// CHECK: [[OPENED_COPY:%[0-9]+]] = alloc_stack $@opened([[OPENED_ID]], P) Self
// CHECK: copy_addr [[OPENED]] to [initialization] [[OPENED_COPY]] : $*@opened([[OPENED_ID]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.covariantAssocProperty4!getter : <Self where Self : P> (Self) -> () -> (Self.A, Self.A)
// CHECK: apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>(%{{[0-9]+}}, %{{[0-9]+}}, [[OPENED_COPY]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> (@out τ_0_0.A, @out τ_0_0.A)
// CHECK: init_existential_addr %{{[0-9]+}} : $*Any, $@opened([[OPENED_ID]], P) Self.A
// CHECK: init_existential_addr %{{[0-9]+}} : $*Any, $@opened([[OPENED_ID]], P) Self.A
...
// CHECK: [[OPENED_COPY:%[0-9]+]] = alloc_stack $@opened([[OPENED_ID]], P) Self
// CHECK: copy_addr [[OPENED]] to [initialization] [[OPENED_COPY]] : $*@opened([[OPENED_ID]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.covariantAssocProperty5!getter : <Self where Self : P> (Self) -> () -> Array<Self.A>
// CHECK: [[ARRAY:%[0-9]+]] = apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[OPENED_COPY]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @owned Array<τ_0_0.A>
// CHECK: [[ARRAY_UPCAST_FN:%[0-9]+]] = function_ref @$ss15_arrayForceCastySayq_GSayxGr0_lF : $@convention(thin) <τ_0_0, τ_0_1> (@guaranteed Array<τ_0_0>) -> @owned Array<τ_0_1>
// CHECK: [[RESULT:%[0-9]+]] = apply [[ARRAY_UPCAST_FN]]<@opened([[OPENED_ID]], P) Self.A, Any>([[ARRAY]]) : $@convention(thin) <τ_0_0, τ_0_1> (@guaranteed Array<τ_0_0>) -> @owned Array<τ_0_1>
// CHECK: debug_value %{{[0-9]+}} : $Array<Any>, let, name "x"
...
// CHECK: [[OPENED_COPY:%[0-9]+]] = alloc_stack $@opened([[OPENED_ID]], P) Self
// CHECK: copy_addr [[OPENED]] to [initialization] [[OPENED_COPY]] : $*@opened([[OPENED_ID]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.covariantAssocProperty6!getter : <Self where Self : P> (Self) -> () -> [String : Self.A]
// CHECK: [[DICT:%[0-9]+]] = apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[OPENED_COPY]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @owned Dictionary<String, τ_0_0.A>
// CHECK: [[DICT_UPCAST_FN:%[0-9]+]] = function_ref @$ss17_dictionaryUpCastySDyq0_q1_GSDyxq_GSHRzSHR0_r2_lF : $@convention(thin) <τ_0_0, τ_0_1, τ_0_2, τ_0_3 where τ_0_0 : Hashable, τ_0_2 : Hashable> (@guaranteed Dictionary<τ_0_0, τ_0_1>) -> @owned Dictionary<τ_0_2, τ_0_3>
// CHECK: [[RESULT:%[0-9]+]] = apply [[DICT_UPCAST_FN]]<String, @opened([[OPENED_ID]], P) Self.A, String, Any>([[DICT]]) : $@convention(thin) <τ_0_0, τ_0_1, τ_0_2, τ_0_3 where τ_0_0 : Hashable, τ_0_2 : Hashable> (@guaranteed Dictionary<τ_0_0, τ_0_1>) -> @owned Dictionary<τ_0_2, τ_0_3>
// CHECK: debug_value %{{[0-9]+}} : $Dictionary<String, Any>, let, name "x"
...
// CHECK: [[OPENED_COPY:%[0-9]+]] = alloc_stack $@opened([[OPENED_ID]], P) Self
// CHECK: copy_addr [[OPENED]] to [initialization] [[OPENED_COPY]] : $*@opened([[OPENED_ID]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self,  #P.covariantAssocProperty7!getter : <Self where Self : P> (Self) -> () -> ((Self.A) -> ()) -> ()
// CHECK: [[RESULT_FN:%[0-9]+]] = apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[OPENED_COPY]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @owned @callee_guaranteed @substituted <τ_0_0> (@noescape @callee_guaranteed @substituted <τ_0_0> (@in_guaranteed τ_0_0) -> () for <τ_0_0>) -> () for <τ_0_0.A>
// CHECK: [[STEP1:%[0-9]+]] = convert_function [[RESULT_FN]] : $@callee_guaranteed @substituted <τ_0_0> (@noescape @callee_guaranteed @substituted <τ_0_0> (@in_guaranteed τ_0_0) -> () for <τ_0_0>) -> () for <@opened([[OPENED_ID]], P) Self.A> to $@callee_guaranteed (@noescape @callee_guaranteed @substituted <τ_0_0> (@in_guaranteed τ_0_0) -> () for <@opened([[OPENED_ID]], P) Self.A>) -> ()
...
// CHECK: partial_apply [callee_guaranteed] [[THUNK]]<@opened([[OPENED_ID]], P) Self>([[STEP1]]) : $@convention(thin) <τ_0_0 where τ_0_0 : P> (@noescape @callee_guaranteed (@in_guaranteed Any) -> (), @guaranteed @callee_guaranteed (@noescape @callee_guaranteed @substituted <τ_0_0> (@in_guaranteed τ_0_0) -> () for <τ_0_0.A>) -> ()) -> ()
...
// CHECK: [[OPENED_COPY:%[0-9]+]] = alloc_stack $@opened([[OPENED_ID]], P) Self
// CHECK: copy_addr [[OPENED]] to [initialization] [[OPENED_COPY]] : $*@opened([[OPENED_ID]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.subscript!getter : <Self where Self : P> (Self) -> (()) -> Self.A
// CHECK: [[DEST:%[0-9]+]] = init_existential_addr [[LET]] : $*Any, $@opened([[OPENED_ID]], P) Self.A
// CHECK: apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[DEST]], [[OPENED_COPY]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @out τ_0_0.A
...
// CHECK: [[OPENED_COPY:%[0-9]+]] = alloc_stack $@opened([[OPENED_ID]], P) Self
// CHECK: copy_addr [[OPENED]] to [initialization] [[OPENED_COPY]] : $*@opened([[OPENED_ID]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.subscript!getter : <Self where Self : P> (Self) -> (()) -> Self.A.Type
// CHECK: [[META:%[0-9]+]] = apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[OPENED_COPY]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @thick τ_0_0.A.Type
// CHECK: [[EXIST_META:%[0-9]+]] = init_existential_metatype [[META]] : $@thick (@opened([[OPENED_ID]], P) Self.A).Type, $@thick Any.Type
// CHECK: debug_value [[EXIST_META]] : $@thick Any.Type, let, name "x"
...
// CHECK: [[OPENED_COPY:%[0-9]+]] = alloc_stack $@opened([[OPENED_ID]], P) Self
// CHECK: copy_addr [[OPENED]] to [initialization] [[OPENED_COPY]] : $*@opened([[OPENED_ID]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.subscript!getter : <Self where Self : P> (Self) -> (()) -> (Self.A, Self.A)
// CHECK: apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>(%{{[0-9]+}}, %{{[0-9]+}}, [[OPENED_COPY]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> (@out τ_0_0.A, @out τ_0_0.A)
// CHECK: init_existential_addr %{{[0-9]+}} : $*Any, $@opened([[OPENED_ID]], P) Self.A
// CHECK: init_existential_addr %{{[0-9]+}} : $*Any, $@opened([[OPENED_ID]], P) Self.A
...
// CHECK: [[OPENED_COPY:%[0-9]+]] = alloc_stack $@opened([[OPENED_ID]], P) Self
// CHECK: copy_addr [[OPENED]] to [initialization] [[OPENED_COPY]] : $*@opened([[OPENED_ID]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.subscript!getter : <Self where Self : P> (Self) -> (()) -> Array<Self.A>
// CHECK: [[ARRAY:%[0-9]+]] = apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[OPENED_COPY]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @owned Array<τ_0_0.A>
// CHECK: [[ARRAY_UPCAST_FN:%[0-9]+]] = function_ref @$ss15_arrayForceCastySayq_GSayxGr0_lF : $@convention(thin) <τ_0_0, τ_0_1> (@guaranteed Array<τ_0_0>) -> @owned Array<τ_0_1>
// CHECK: [[RESULT:%[0-9]+]] = apply [[ARRAY_UPCAST_FN]]<@opened([[OPENED_ID]], P) Self.A, Any>([[ARRAY]]) : $@convention(thin) <τ_0_0, τ_0_1> (@guaranteed Array<τ_0_0>) -> @owned Array<τ_0_1>
// CHECK: debug_value %{{[0-9]+}} : $Array<Any>, let, name "x"
...
// CHECK: [[OPENED_COPY:%[0-9]+]] = alloc_stack $@opened([[OPENED_ID]], P) Self
// CHECK: copy_addr [[OPENED]] to [initialization] [[OPENED_COPY]] : $*@opened([[OPENED_ID]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.subscript!getter : <Self where Self : P> (Self) -> (()) -> [String : Self.A]
// CHECK: [[DICT:%[0-9]+]] = apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[OPENED_COPY]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @owned Dictionary<String, τ_0_0.A>
// CHECK: [[DICT_UPCAST_FN:%[0-9]+]] = function_ref @$ss17_dictionaryUpCastySDyq0_q1_GSDyxq_GSHRzSHR0_r2_lF : $@convention(thin) <τ_0_0, τ_0_1, τ_0_2, τ_0_3 where τ_0_0 : Hashable, τ_0_2 : Hashable> (@guaranteed Dictionary<τ_0_0, τ_0_1>) -> @owned Dictionary<τ_0_2, τ_0_3>
// CHECK: [[RESULT:%[0-9]+]] = apply [[DICT_UPCAST_FN]]<String, @opened([[OPENED_ID]], P) Self.A, String, Any>([[DICT]]) : $@convention(thin) <τ_0_0, τ_0_1, τ_0_2, τ_0_3 where τ_0_0 : Hashable, τ_0_2 : Hashable> (@guaranteed Dictionary<τ_0_0, τ_0_1>) -> @owned Dictionary<τ_0_2, τ_0_3>
// CHECK: debug_value %{{[0-9]+}} : $Dictionary<String, Any>, let, name "x"
...
// CHECK: copy_addr [[OPENED]] to [initialization] [[OPENED_COPY]] : $*@opened([[OPENED_ID]], P) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P) Self, #P.subscript!getter : <Self where Self : P> (Self) -> ((Self.A) -> ()) -> ()
// CHECK: apply [[WITNESS]]<@opened([[OPENED_ID]], P) Self>([[STEP3]], [[OPENED_COPY]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@noescape @callee_guaranteed @substituted <τ_0_0> (@in_guaranteed τ_0_0) -> () for <τ_0_0.A>, @in_guaranteed τ_0_0) -> ()
...
// CHECK: [[OPENED:%[0-9]+]] = open_existential_addr immutable_access %0 : $*P2 to $*@opened([[OPENED_ID:"[0-9A-F-]+"]], P2) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P2) Self, #P.covariantAssocMethod1 : <Self where Self : P> (Self) -> () -> Self.A
// CHECK: apply [[WITNESS]]<@opened([[OPENED_ID]], P2) Self>(%{{[0-9]+}}, [[OPENED]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @out τ_0_0.A
// CHECK: init_existential_ref %{{[0-9]+}} : $@opened([[OPENED_ID]], P2) Self.A : $@opened([[OPENED_ID]], P2) Self.A, $Class & P
...
// CHECK: [[OPENED:%[0-9]+]] = open_existential_addr immutable_access %0 : $*P2 to $*@opened([[OPENED_ID:"[0-9A-F-]+"]], P2) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P2) Self, #P.covariantAssocMethod2 : <Self where Self : P> (Self) -> () -> Self.A?
// CHECK: apply [[WITNESS]]<@opened([[OPENED_ID]], P2) Self>(%{{[0-9]+}}, [[OPENED]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @out Optional<τ_0_0.A>
// CHECK: init_existential_ref %{{[0-9]+}} : $@opened([[OPENED_ID]], P2) Self.A : $@opened([[OPENED_ID]], P2) Self.A, $Class & P
...
// CHECK: [[OPENED:%[0-9]+]] = open_existential_addr immutable_access %0 : $*P2 to $*@opened([[OPENED_ID:"[0-9A-F-]+"]], P2) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P2) Self, #P.covariantAssocMethod3 : <Self where Self : P> (Self) -> () -> Self.A.Type
// CHECK: [[META:%[0-9]+]] = apply [[WITNESS]]<@opened([[OPENED_ID]], P2) Self>([[OPENED]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @thick τ_0_0.A.Type
// CHECK: [[EXIST_META:%[0-9]+]] = init_existential_metatype [[META]] : $@thick (@opened([[OPENED_ID]], P2) Self.A).Type, $@thick (Class & P).Type
...
// CHECK: [[OPENED:%[0-9]+]] = open_existential_addr immutable_access %0 : $*P2 to $*@opened([[OPENED_ID:"[0-9A-F-]+"]], P2) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P2) Self, #P.covariantAssocMethod4 : <Self where Self : P> (Self) -> () -> (Self.A, Self.A)
// CHECK: apply [[WITNESS]]<@opened([[OPENED_ID]], P2) Self>(%{{[0-9]+}}, %{{[0-9]+}}, [[OPENED]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> (@out τ_0_0.A, @out τ_0_0.A)
// CHECK: init_existential_ref %{{[0-9]+}} : $@opened([[OPENED_ID]], P2) Self.A : $@opened([[OPENED_ID]], P2) Self.A, $Class & P
// CHECK: init_existential_ref %{{[0-9]+}} : $@opened([[OPENED_ID]], P2) Self.A : $@opened([[OPENED_ID]], P2) Self.A, $Class & P
...
// CHECK: [[OPENED:%[0-9]+]] = open_existential_addr immutable_access %0 : $*P2 to $*@opened([[OPENED_ID:"[0-9A-F-]+"]], P2) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P2) Self, #P.covariantAssocMethod5 : <Self where Self : P> (Self) -> () -> Array<Self.A>
// CHECK: [[ARRAY:%[0-9]+]] = apply [[WITNESS]]<@opened([[OPENED_ID]], P2) Self>([[OPENED]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @owned Array<τ_0_0.A>
// CHECK: [[ARRAY_UPCAST_FN:%[0-9]+]] = function_ref @$ss15_arrayForceCastySayq_GSayxGr0_lF : $@convention(thin) <τ_0_0, τ_0_1> (@guaranteed Array<τ_0_0>) -> @owned Array<τ_0_1>
// CHECK: [[RESULT:%[0-9]+]] = apply [[ARRAY_UPCAST_FN]]<@opened([[OPENED_ID]], P2) Self.A, Class & P>([[ARRAY]]) : $@convention(thin) <τ_0_0, τ_0_1> (@guaranteed Array<τ_0_0>) -> @owned Array<τ_0_1>
...
// CHECK: [[OPENED:%[0-9]+]] = open_existential_addr immutable_access %0 : $*P2 to $*@opened([[OPENED_ID:"[0-9A-F-]+"]], P2) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P2) Self, #P.covariantAssocMethod6 : <Self where Self : P> (Self) -> () -> [String : Self.A]
// CHECK: [[DICT:%[0-9]+]] = apply [[WITNESS]]<@opened([[OPENED_ID]], P2) Self>([[OPENED]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @owned Dictionary<String, τ_0_0.A>
// CHECK: [[DICT_UPCAST_FN:%[0-9]+]] = function_ref @$ss17_dictionaryUpCastySDyq0_q1_GSDyxq_GSHRzSHR0_r2_lF : $@convention(thin) <τ_0_0, τ_0_1, τ_0_2, τ_0_3 where τ_0_0 : Hashable, τ_0_2 : Hashable> (@guaranteed Dictionary<τ_0_0, τ_0_1>) -> @owned Dictionary<τ_0_2, τ_0_3>
// CHECK: [[RESULT:%[0-9]+]] = apply [[DICT_UPCAST_FN]]<String, @opened([[OPENED_ID]], P2) Self.A, String, Class & P>([[DICT]]) : $@convention(thin) <τ_0_0, τ_0_1, τ_0_2, τ_0_3 where τ_0_0 : Hashable, τ_0_2 : Hashable> (@guaranteed Dictionary<τ_0_0, τ_0_1>) -> @owned Dictionary<τ_0_2, τ_0_3>
...
// CHECK: [[STEP1:%[0-9]+]] = partial_apply [callee_guaranteed] [[THUNK1]]<@opened([[OPENED_ID]], P2) Self>
// CHECK: [[STEP2:%[0-9]+]] = convert_function [[STEP1]] : $@callee_guaranteed (@guaranteed @opened([[OPENED_ID]], P2) Self.A) -> () to $@callee_guaranteed @substituted <τ_0_0 where τ_0_0 : _NativeClass> (@guaranteed τ_0_0) -> () for <@opened([[OPENED_ID]], P2) Self.A>
// CHECK: [[STEP3:%[0-9]+]] = convert_escape_to_noescape [not_guaranteed] [[STEP2]]
// CHECK: [[STEP4:%[0-9]+]] = convert_function [[STEP3]] : $@noescape @callee_guaranteed @substituted <τ_0_0 where τ_0_0 : _NativeClass> (@guaranteed τ_0_0) -> () for <@opened([[OPENED_ID]], P2) Self.A> to $@noescape @callee_guaranteed (@guaranteed @opened([[OPENED_ID]], P2) Self.A) -> ()
...
// CHECK: [[STEP5:%[0-9]+]] = partial_apply [callee_guaranteed] [[THUNK2]]<@opened([[OPENED_ID]], P2) Self>([[STEP4]])
// CHECK: [[STEP6:%[0-9]+]] = convert_function [[STEP5]] : $@callee_guaranteed (@in_guaranteed @opened([[OPENED_ID]], P2) Self.A) -> () to $@callee_guaranteed @substituted <τ_0_0> (@in_guaranteed τ_0_0) -> () for <@opened([[OPENED_ID]], P2) Self.A>
// CHECK: [[STEP7:%[0-9]+]] = convert_escape_to_noescape [not_guaranteed] [[STEP6]]
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P2) Self, #P.covariantAssocMethod7 : <Self where Self : P> (Self) -> ((Self.A) -> ()) -> ()
// CHECK: apply [[WITNESS]]<@opened([[OPENED_ID]], P2) Self>([[STEP7]], [[OPENED]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@noescape @callee_guaranteed @substituted <τ_0_0> (@in_guaranteed τ_0_0) -> () for <τ_0_0.A>, @in_guaranteed τ_0_0) -> ()
...
// CHECK: [[OPENED:%[0-9]+]] = open_existential_addr immutable_access %0 : $*P3 to $*@opened([[OPENED_ID:"[0-9A-F-]+"]], P3) Self
// CHECK: [[BOOL_ADDR:%[0-9]+]] = alloc_stack $Bool
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P3) Self, #P.covariantAssocMethod1 : <Self where Self : P> (Self) -> () -> Self.A
// CHECK: apply [[WITNESS]]<@opened([[OPENED_ID]], P3) Self>([[BOOL_ADDR]], [[OPENED]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @out τ_0_0.A
...
// CHECK: [[OPENED:%[0-9]+]] = open_existential_addr immutable_access %0 : $*P3 to $*@opened([[OPENED_ID:"[0-9A-F-]+"]], P3) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P3) Self, #P3.contravariantAssocMethod1 : <Self where Self : P3> (Self) -> (Self.A) -> ()
// CHECK: apply [[WITNESS]]<@opened([[OPENED_ID]], P3) Self>(%{{[0-9]+}}, [[OPENED]]) : $@convention(witness_method: P3) <τ_0_0 where τ_0_0 : P3> (Bool, @in_guaranteed τ_0_0) -> ()
...
// CHECK: [[OPENED:%[0-9]+]] = open_existential_addr immutable_access %0 : $*P3 to $*@opened([[OPENED_ID:"[0-9A-F-]+"]], P3) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P3) Self, #P3.invariantAssocMethod1 : <Self where Self : P3> (Self) -> () -> GenericStruct<Self.A>
// CHECK: [[RESULT:%[0-9]+]] = apply [[WITNESS]]<@opened([[OPENED_ID]], P3) Self>([[OPENED]]) : $@convention(witness_method: P3) <τ_0_0 where τ_0_0 : P3> (@in_guaranteed τ_0_0) -> GenericStruct<Bool>
...
// CHECK: [[OPENED:%[0-9]+]] = open_existential_addr immutable_access %0 : $*P4 to $*@opened([[OPENED_ID:"[0-9A-F-]+"]], P4) Self
// CHECK: [[WITNESS:%[0-9]+]] = witness_method $@opened([[OPENED_ID]], P4) Self, #P.covariantAssocMethod1 : <Self where Self : P> (Self) -> () -> Self.A
// CHECK: apply %4<@opened([[OPENED_ID]], P4) Self>(%{{[0-9]+}}, [[OPENED]]) : $@convention(witness_method: P) <τ_0_0 where τ_0_0 : P> (@in_guaranteed τ_0_0) -> @out τ_0_0.A
// CHECK: init_existential_addr %{{[0-9]+}} : $*P4, $@opened([[OPENED_ID]], P4) Self.B
// CHECK: init_existential_addr %{{[0-9]+}} : $*P4, $@opened([[OPENED_ID]], P4) Self.B
