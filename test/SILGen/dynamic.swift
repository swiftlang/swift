...
// CHECK-LABEL: sil hidden @_TTWC7dynamic3FooS_5ProtoFS1_12nativeMethodUS1___fRQPS1_FT_T_
// CHECK:         class_method {{%.*}} : $Foo, #Foo.nativeMethod!1 :
// CHECK-LABEL: sil hidden @_TTWC7dynamic3FooS_5ProtoFS1_g10nativePropSi
// CHECK:         class_method {{%.*}} : $Foo, #Foo.nativeProp!getter.1 :
// CHECK-LABEL: sil hidden @_TTWC7dynamic3FooS_5ProtoFS1_s10nativePropSi
// CHECK:         class_method {{%.*}} : $Foo, #Foo.nativeProp!setter.1 :
// CHECK-LABEL: sil hidden @_TTWC7dynamic3FooS_5ProtoFS1_g9subscriptFT6nativeSi_Si
// CHECK:         class_method {{%.*}} : $Foo, #Foo.subscript!getter.1 :
// CHECK-LABEL: sil hidden @_TTWC7dynamic3FooS_5ProtoFS1_s9subscriptFT6nativeSi_Si
// CHECK:         class_method {{%.*}} : $Foo, #Foo.subscript!setter.1 :

// @objc witnesses use vtable dispatch:
// CHECK-LABEL: sil hidden @_TTWC7dynamic3FooS_5ProtoFS1_10objcMethodUS1___fRQPS1_FT_T_
// CHECK:         class_method {{%.*}} : $Foo, #Foo.objcMethod!1 :
// CHECK-LABEL: sil hidden @_TTWC7dynamic3FooS_5ProtoFS1_g8objcPropSi
// CHECK:         class_method {{%.*}} : $Foo, #Foo.objcProp!getter.1 :
// CHECK-LABEL: sil hidden @_TTWC7dynamic3FooS_5ProtoFS1_s8objcPropSi
// CHECK:         class_method {{%.*}} : $Foo, #Foo.objcProp!setter.1 :
// CHECK-LABEL: sil hidden @_TTWC7dynamic3FooS_5ProtoFS1_g9subscriptFT4objcSi_Si
// CHECK:         class_method {{%.*}} : $Foo, #Foo.subscript!getter.1 :
// CHECK-LABEL: sil hidden @_TTWC7dynamic3FooS_5ProtoFS1_s9subscriptFT4objcSi_Si
// CHECK:         class_method {{%.*}} : $Foo, #Foo.subscript!setter.1 :

// Dynamic witnesses use objc dispatch:
// CHECK-LABEL: sil hidden @_TTWC7dynamic3FooS_5ProtoFS1_13dynamicMethodUS1___fRQPS1_FT_T_
...
// CHECK-LABEL: sil hidden @_TTWC7dynamic3FooS_5ProtoFS1_g11dynamicPropSi
...
// CHECK-LABEL: sil hidden @_TTWC7dynamic3FooS_5ProtoFS1_s11dynamicPropSi
...
// CHECK-LABEL: sil hidden @_TTWC7dynamic3FooS_5ProtoFS1_g9subscriptFT7dynamicSi_Si
...
// CHECK-LABEL: sil hidden @_TTWC7dynamic3FooS_5ProtoFS1_s9subscriptFT7dynamicSi_Si
