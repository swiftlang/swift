...
// CHECK-NEXT:    #MyClass.$instanceProperty!modify: (MyClass) -> @yield_once () yields (inout PropertyWrapper) -> () : @$s27property_wrappers_multifile7MyClassC17$instancePropertyAA0G7WrapperVvM [inherited]
