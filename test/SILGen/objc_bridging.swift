...
func castToCFunction(ptr: UnsafeRawPointer) {
  ...
  // CHECK: apply [[CASTFN]]<UnsafeRawPointer, @convention(c) (AnyObject?) -> ()>([[OUT]], [[IN]], [[META]]) : $@convention(thin) <τ_0_0, τ_0_1 where τ_0_0 : ~Escapable> (@in_guaranteed τ_0_0, @thick τ_0_1.Type) -> @out τ_0_1
