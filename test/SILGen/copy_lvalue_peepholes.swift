...
// CHECK-LABEL: sil @_TF21copy_lvalue_peepholes20init_var_from_lvalue
...
// CHECK-LABEL: sil @_TF21copy_lvalue_peepholes22assign_var_from_lvalue
// CHECK:   [[Y:%.*]] = alloc_box $Builtin.Int64
// CHECK:   [[X:%.*]] = alloc_box $Builtin.Int64
...
// CHECK-LABEL: sil @_TF21copy_lvalue_peepholes29init_var_from_computed_lvalue
...
// CHECK-LABEL: sil @_TF21copy_lvalue_peepholes27assign_computed_from_lvalue
// CHECK:   [[Y:%.*]] = alloc_box
...
// CHECK-LABEL: sil @_TF21copy_lvalue_peepholes24assign_var_from_computed
// CHECK:   [[X:%.*]] = alloc_box
// CHECK:   assign {{%.*}} to [[X]]#1
