// RUN: %target-swift-frontend(mock-sdk: %clang-importer-sdk) -emit-silgen %s -import-objc-header %S/Inputs/BoolBridgingTests.h | FileCheck %s --check-prefix=CHECK --check-prefix=CHECK-%target-cpu --check-prefix=CHECK-%target-os-%target-cpu
...
public func testFunctions() {
  ...
  // CHECK: [[FUNC_2:%.+]] = function_ref @testObjCBool
  // CHECK: [[BOOL_TO_OBJCBOOL:%.+]] = function_ref @_TF10ObjectiveC22_convertBoolToObjCBoolFSbVS_8ObjCBool
  // CHECK: [[INPUT_2:%.+]] = apply [[BOOL_TO_OBJCBOOL]]({{%.+}})
  // CHECK: [[RESULT_2:%.+]] = apply [[FUNC_2]]({{%.+}}) : $@convention(c) (ObjCBool) -> ObjCBool
  // CHECK: [[OBJCBOOL_TO_BOOL:%.+]] = function_ref @_TF10ObjectiveC22_convertObjCBoolToBoolFVS_8ObjCBoolSb
  // CHECK: = apply [[OBJCBOOL_TO_BOOL]]([[RESULT_2]])
  _ = testObjCBool(true)
...
public func testMethods(x: Test) {
  ...
  // CHECK: [[METHOD_2:%.+]] = class_method [volatile] %0 : $Test, #Test.testObjCBool!1.foreign
  // CHECK: [[BOOL_TO_OBJCBOOL:%.+]] = function_ref @_TF10ObjectiveC22_convertBoolToObjCBoolFSbVS_8ObjCBool
  // CHECK: [[INPUT_2:%.+]] = apply [[BOOL_TO_OBJCBOOL]]({{%.+}})
  // CHECK: [[RESULT_2:%.+]] = apply [[METHOD_2]]([[INPUT_2]], %0) : $@convention(objc_method) (ObjCBool, Test) -> ObjCBool
  // CHECK: [[OBJCBOOL_TO_BOOL:%.+]] = function_ref @_TF10ObjectiveC22_convertObjCBoolToBoolFVS_8ObjCBoolSb
  // CHECK: = apply [[OBJCBOOL_TO_BOOL]]([[RESULT_2]])
...
public func testProperties(x: Test) {
  ...
  // CHECK: [[SETTER_2:%.+]] = class_method [volatile] %0 : $Test, #Test.propObjCBool!setter.1.foreign
  // CHECK: [[BOOL_TO_OBJCBOOL:%.+]] = function_ref @_TF10ObjectiveC22_convertBoolToObjCBoolFSbVS_8ObjCBool
  // CHECK: [[INPUT_2:%.+]] = apply [[BOOL_TO_OBJCBOOL]]({{%.+}})
  // CHECK: apply [[SETTER_2]]([[INPUT_2]], %0) : $@convention(objc_method) (ObjCBool, Test) -> ()
  x.propObjCBool = true
...
public func testFunctionPointers() {
  ...
  // CHECK: = function_ref @_TToFF18objc_bool_bridging20testFunctionPointersFT_T_U0_FV10ObjectiveC8ObjCBoolS1_ : $@convention(c) (ObjCBool) -> ObjCBool
  let y: ObjCBoolFn = { $0 }
  _ = y(true)
...
// CHECK-LABEL: sil shared @_TFF18objc_bool_bridging20testFunctionPointersFT_T_U0_FV10ObjectiveC8ObjCBoolS1_
// CHECK: return %0 : $ObjCBool

// CHECK-LABEL: sil shared @_TToFF18objc_bool_bridging20testFunctionPointersFT_T_U0_FV10ObjectiveC8ObjCBoolS1_
// CHECK: [[NATIVE:%.+]] = function_ref @_TFF18objc_bool_bridging20testFunctionPointersFT_T_U0_FV10ObjectiveC8ObjCBoolS1_
// CHECK: [[RESULT:%.+]] = apply [[NATIVE]](%0) : $@convention(thin) (ObjCBool) -> ObjCBool
// CHECK: return [[RESULT]] : $ObjCBool
...
public func testBlocks() {
  ...
  // CHECK: = function_ref @_TFF18objc_bool_bridging10testBlocksFT_T_U0_FV10ObjectiveC8ObjCBoolS1_ : $@convention(thin) (ObjCBool) -> ObjCBool
...
public func testBlockProps(x: Test) {
  ...
  // CHECK: = function_ref @_TFF18objc_bool_bridging14testBlockPropsFCSo4TestT_U0_FSbSb : $@convention(thin) (Bool) -> Bool
  // CHECK: [[SETTER_2:%.+]] = class_method [volatile] %0 : $Test, #Test.propObjCBoolBlock!setter.1.foreign
  // CHECK: = apply [[SETTER_2]]({{%.+}}, %0) : $@convention(objc_method) (@convention(block) (ObjCBool) -> ObjCBool, Test) -> ()
...
public func testFunctionPointerMethods(x: Test) {
  ...
  // CHECK: [[METHOD_2:%.+]] = class_method [volatile] %0 : $Test, #Test.testObjCBoolFnToBlock!1.foreign
  // CHECK: [[CLOSURE_2:%.+]] = function_ref @_TToFF18objc_bool_bridging26testFunctionPointerMethodsFCSo4TestT_U0_FV10ObjectiveC8ObjCBoolS2_ : $@convention(c) (ObjCBool) -> ObjCBool
  // CHECK: [[RESULT_2:%.+]] = apply [[METHOD_2]]([[CLOSURE_2]], %0)
  // CHECK: function_ref @_TTRXFdCb_dV10ObjectiveC8ObjCBool_dS0__XFo_dSb_dSb_
...
class NewClass : NSObject {
  ...
  // CHECK-LABEL: sil hidden @_TToFC18objc_bool_bridging8NewClass12takesClosurefS0_FFSbSbT_ : $@convention(objc_method) (@convention(block) (ObjCBool) -> ObjCBool, NewClass) -> () {
  ...
  // CHECK-LABEL: sil hidden @_TFC18objc_bool_bridging8NewClass18takesObjCBoolBlockfS0_FbV10ObjectiveC8ObjCBoolS2_T_ : $@convention(method) (@owned @convention(block) (ObjCBool) -> ObjCBool, @guaranteed NewClass) -> () {
  // CHECK-LABEL: sil hidden @_TToFC18objc_bool_bridging8NewClass18takesObjCBoolBlockfS0_FbV10ObjectiveC8ObjCBoolS2_T_ : $@convention(objc_method) (@convention(block) (ObjCBool) -> ObjCBool, NewClass) -> () {
