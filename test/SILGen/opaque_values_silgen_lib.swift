...
// RUN: %target-swift-emit-silgen -enable-sil-ownership-verifier -enable-sil-opaque-values -emit-sorted-sil -Xllvm -sil-full-demangle -parse-stdlib -parse-as-library -module-name Swift %s | %FileCheck %s
