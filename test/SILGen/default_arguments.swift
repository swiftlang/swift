...
func testDefaultArg1() {
  ...
  // CHECK: [[LITFN:%[0-9]+]] = function_ref @_TFSdCfMSdFT20_builtinFloatLiteralBf80__Sd
...
func testAutocloseFile() {
  // CHECK-LABEL: sil shared @_TFF17default_arguments17testAutocloseFileFT_T_u_KT_SS : $@__noescape @thin () -> @owned String
  // CHECK: string_literal utf16{{.*}}default_arguments.swift

  // CHECK-LABEL: sil shared @_TFF17default_arguments17testAutocloseFileFT_T_u0_KT_Si : $@__noescape @thin () -> Int
