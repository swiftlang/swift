...
func testDictionaryUpcast(dict: Dictionary<BridgedObjC, BridgedObjC>) {
  // CHECK: [[UPCAST_FN:%[0-9]+]] = function_ref @_TFs17_dictionaryUpCastu2_R_s8Hashable1_S_rFGVs10Dictionaryq_q0__GS0_q1_q2__ : $@convention(thin) <τ_0_0, τ_0_1, τ_0_2, τ_0_3 where τ_0_0 : Hashable, τ_0_2 : Hashable> (@owned Dictionary<τ_0_0, τ_0_1>) -> @owned Dictionary<τ_0_2, τ_0_3>
...
func testDictionaryUpcastBridged(dict: Dictionary<BridgedSwift, BridgedSwift>) {
  // CHECK: [[BRIDGE_FN:%[0-9]+]] = function_ref @_TFs29_dictionaryBridgeToObjectiveCu2_R_s8Hashable1_S_rFGVs10Dictionaryq_q0__GS0_q1_q2__ : $@convention(thin) <τ_0_0, τ_0_1, τ_0_2, τ_0_3 where τ_0_0 : Hashable, τ_0_2 : Hashable> (@owned Dictionary<τ_0_0, τ_0_1>) -> @owned Dictionary<τ_0_2, τ_0_3>
...
func testSetUpcast(dict: Set<BridgedObjC>) {
  // CHECK: [[BRIDGE_FN:%[0-9]+]] = function_ref @_TFs10_setUpCastu0_R_s8Hashable0_S_rFGVs3Setq__GS0_q0__ : $@convention(thin) <τ_0_0, τ_0_1 where τ_0_0 : Hashable, τ_0_1 : Hashable> (@owned Set<τ_0_0>) -> @owned Set<τ_0_1>
...
func testSetUpcastBridged(dict: Set<BridgedSwift>) {
  // CHECK: [[BRIDGE_FN:%[0-9]+]] = function_ref @_TFs22_setBridgeToObjectiveCu0_R_s8Hashable0_S_rFGVs3Setq__GS0_q0__ : $@convention(thin) <τ_0_0, τ_0_1 where τ_0_0 : Hashable, τ_0_1 : Hashable> (@owned Set<τ_0_0>) -> @owned Set<τ_0_1>
