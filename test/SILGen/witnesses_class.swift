...
class Foo: Fooable {
  ...
  func foo() { }
  // CHECK-LABEL: sil hidden [transparent] [thunk] @_TTWC15witnesses_class3FooS_7FooableS_FS1_3foouRq_S1__fq_FT_T_
  // CHECK-NOT:     function_ref
  // CHECK:         class_method

  class func bar() {}
  // CHECK-LABEL: sil hidden [transparent] [thunk] @_TTWC15witnesses_class3FooS_7FooableS_ZFS1_3baruRq_S1__fMq_FT_T_
  // CHECK-NOT:     function_ref
  // CHECK:         class_method

  required init() {}
  // CHECK-LABEL: sil hidden [transparent] [thunk] @_TTWC15witnesses_class3FooS_7FooableS_FS1_CuRq_S1__fMq_FT_q_
  // CHECK-NOT:     function_ref
  // CHECK:         class_method
}

// CHECK-LABEL: sil hidden @_TF15witnesses_class3genuRq_S_7Fooable_Fq_T_
// CHECK:         bb0([[SELF:%.*]] : $T)
