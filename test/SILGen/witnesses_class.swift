...
class Foo: Fooable {
  ...
  func foo() { }
  // CHECK-LABEL: sil hidden @_TTWC15witnesses_class3FooS_7FooableS_FS1_3fooUS1___fQPS1_FT_T_
  // CHECK-NOT:     function_ref
  // CHECK:         class_method

  class func bar() {}
  // CHECK-LABEL: sil hidden @_TTWC15witnesses_class3FooS_7FooableS_FS1_3barUS1___fMQPS1_FT_T_
  // CHECK-NOT:     function_ref
  // CHECK:         class_method

  required init() {}
  // CHECK-LABEL: sil hidden @_TTWC15witnesses_class3FooS_7FooableS_FS1_CUS1___fMQPS1_FT_S2_
  // CHECK-NOT:     function_ref
  // CHECK:         class_method
}
