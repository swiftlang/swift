...
// RUN: %target-swift-emit-silgen-ossa -o /dev/null -enable-sil-opaque-values %s -target %target-cpu-apple-macosx11 -target-variant %target-cpu-apple-ios14-macabi -min-swift-runtime-version 5.0 -enable-experimental-feature StandaloneSwiftAvailability
