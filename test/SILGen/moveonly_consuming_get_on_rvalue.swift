// RUN: %target-swift-emit-silgen-ossa -enable-sil-opaque-values -module-name test -enable-experimental-feature UnderscoreOwned -enable-experimental-feature Lifetimes %s
