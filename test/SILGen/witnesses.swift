...
struct ConformingStruct : X {
  ...
  // CHECK-LABEL: sil hidden @_TTWV9witnesses16ConformingStructS_1XS_FS1_9selfTypesUS1___fRQPS1_FT1xS2__S2_ : $@cc(witness_method) @thin (@out ConformingStruct, @in ConformingStruct, @inout ConformingStruct) -> () {
  ...
  // CHECK-LABEL: sil hidden @_TTWV9witnesses16ConformingStructS_1XS_FS1_8loadableUS1___fRQPS1_FT1xVS_8Loadable_S3_ : $@cc(witness_method) @thin (Loadable, @inout ConformingStruct) -> Loadable {
  ...
  // CHECK-LABEL: sil hidden @_TTWV9witnesses16ConformingStructS_1XS_FS1_8addrOnlyUS1___fRQPS1_FT1xPS_8AddrOnly__PS3__ : $@cc(witness_method) @thin (@out AddrOnly, @in AddrOnly, @inout ConformingStruct) -> () {
  ...
  // CHECK-LABEL: sil hidden @_TTWV9witnesses16ConformingStructS_1XS_FS1_7genericUS1___fRQPS1_U__FT1xQ__Q_ : $@cc(witness_method) @thin <A> (@out A, @in A, @inout ConformingStruct) -> () {
  ...
  // CHECK-LABEL: sil hidden @_TTWV9witnesses16ConformingStructS_1XS_FS1_7classesUS1___fRQPS1_US_7Classes__FT1xQ__Q_ : $@cc(witness_method) @thin <A2 where A2 : Classes> (@owned A2, @inout ConformingStruct) -> @owned A2 {
...
// CHECK-LABEL: sil hidden @_TTWV9witnesses16ConformingStructS_1XS_FS1_oi3ltgUS1___fMQPS1_FTS2_S2__S2_ : $@cc(witness_method) @thin (@out ConformingStruct, @in ConformingStruct, @in ConformingStruct, @thick ConformingStruct.Type) -> () {
...
final class ConformingClass : X {
  ...
  // CHECK-LABEL: sil hidden @_TTWC9witnesses15ConformingClassS_1XS_FS1_9selfTypesUS1___fRQPS1_FT1xS2__S2_ : $@cc(witness_method) @thin (@out ConformingClass, @in ConformingClass, @inout ConformingClass) -> () {
...
// CHECK-LABEL: sil hidden @_TTWC9witnesses15ConformingClassS_12ClassBoundedS_FS1_9selfTypesUS1___fQPS1_FT1xS2__S2_ : $@cc(witness_method) @thin (@owned ConformingClass, @owned ConformingClass) -> @owned ConformingClass {
...
struct ConformingAOStruct : X {
  ...
  // CHECK-LABEL: sil hidden @_TTWV9witnesses18ConformingAOStructS_1XS_FS1_9selfTypesUS1___fRQPS1_FT1xS2__S2_ : $@cc(witness_method) @thin (@out ConformingAOStruct, @in ConformingAOStruct, @inout ConformingAOStruct) -> () {
...
struct ConformsWithMoreGeneric : X, Y {
  ...
  // CHECK-LABEL: sil hidden @_TTWV9witnesses23ConformsWithMoreGenericS_1XS_FS1_9selfTypesUS1___fRQPS1_FT1xS2__S2_ : $@cc(witness_method) @thin (@out ConformsWithMoreGeneric, @in ConformsWithMoreGeneric, @inout ConformsWithMoreGeneric) -> () {
  ...
  // CHECK-LABEL: sil hidden @_TTWV9witnesses23ConformsWithMoreGenericS_1XS_FS1_8addrOnlyUS1___fRQPS1_FT1xPS_8AddrOnly__PS3__ : $@cc(witness_method) @thin (@out AddrOnly, @in AddrOnly, @inout ConformsWithMoreGeneric) -> () {
  ...
  // CHECK-LABEL: sil hidden @_TTWV9witnesses23ConformsWithMoreGenericS_1XS_FS1_7genericUS1___fRQPS1_U__FT1xQ__Q_ : $@cc(witness_method) @thin <A> (@out A, @in A, @inout ConformsWithMoreGeneric) -> () {
  ...
  // CHECK-LABEL: sil hidden @_TTWV9witnesses23ConformsWithMoreGenericS_1XS_FS1_7classesUS1___fRQPS1_US_7Classes__FT1xQ__Q_ : $@cc(witness_method) @thin <A2 where A2 : Classes> (@owned A2, @inout ConformsWithMoreGeneric) -> @owned A2 {
...
// CHECK-LABEL: sil hidden @_TTWV9witnesses23ConformsWithMoreGenericS_1XS_FS1_oi3ltgUS1___fMQPS1_FTS2_S2__S2_ : $@cc(witness_method) @thin (@out ConformsWithMoreGeneric, @in ConformsWithMoreGeneric, @in ConformsWithMoreGeneric, @thick ConformsWithMoreGeneric.Type) -> () {
...
struct ImmutableModel: ReadOnlyRequirement {
  // CHECK-LABEL: sil hidden @_TTWV9witnesses14ImmutableModelS_19ReadOnlyRequirementS_FS1_g4propSS : $@cc(witness_method) @thin (@thick ImmutableModel.Type) -> @owned String
...
struct NonFailableModel: FailableRequirement, NonFailableRefinement, IUOFailableRequirement {
  // CHECK-LABEL: sil hidden @_TTWV9witnesses16NonFailableModelS_19FailableRequirementS_FS1_CUS1___fMQPS1_FT3fooSi_GSqS2__ : $@cc(witness_method) @thin (@out Optional<NonFailableModel>, Int, @thick NonFailableModel.Type) -> ()
  // CHECK-LABEL: sil hidden @_TTWV9witnesses16NonFailableModelS_21NonFailableRefinementS_FS1_CUS1___fMQPS1_FT3fooSi_S2_ : $@cc(witness_method) @thin (@out NonFailableModel, Int, @thick NonFailableModel.Type) -> ()
  // CHECK-LABEL: sil hidden @_TTWV9witnesses16NonFailableModelS_22IUOFailableRequirementS_FS1_CUS1___fMQPS1_FT3fooSi_GSQS2__ : $@cc(witness_method) @thin (@out ImplicitlyUnwrappedOptional<NonFailableModel>, Int, @thick NonFailableModel.Type) -> ()
  init(foo: Int) {}
}

struct FailableModel: FailableRequirement, IUOFailableRequirement {
  // CHECK-LABEL: sil hidden @_TTWV9witnesses13FailableModelS_19FailableRequirementS_FS1_CUS1___fMQPS1_FT3fooSi_GSqS2__

  // CHECK-LABEL: sil hidden @_TTWV9witnesses13FailableModelS_22IUOFailableRequirementS_FS1_CUS1___fMQPS1_FT3fooSi_GSQS2__
...
struct IUOFailableModel : NonFailableRefinement, IUOFailableRequirement {
  // CHECK-LABEL: sil hidden @_TTWV9witnesses16IUOFailableModelS_21NonFailableRefinementS_FS1_CUS1___fMQPS1_FT3fooSi_S2_
...
final class NonFailableClassModel: FailableClassRequirement, NonFailableClassRefinement, IUOFailableClassRequirement {
  // CHECK-LABEL: sil hidden @_TTWC9witnesses21NonFailableClassModelS_24FailableClassRequirementS_FS1_CUS1___fMQPS1_FT3fooSi_GSqS2__ : $@cc(witness_method) @thin (Int, @thick NonFailableClassModel.Type) -> @owned Optional<NonFailableClassModel>
  // CHECK-LABEL: sil hidden @_TTWC9witnesses21NonFailableClassModelS_26NonFailableClassRefinementS_FS1_CUS1___fMQPS1_FT3fooSi_S2_ : $@cc(witness_method) @thin (Int, @thick NonFailableClassModel.Type) -> @owned NonFailableClassModel
  // CHECK-LABEL: sil hidden @_TTWC9witnesses21NonFailableClassModelS_27IUOFailableClassRequirementS_FS1_CUS1___fMQPS1_FT3fooSi_GSQS2__ : $@cc(witness_method) @thin (Int, @thick NonFailableClassModel.Type) -> @owned ImplicitlyUnwrappedOptional<NonFailableClassModel>
  init(foo: Int) {}
}

final class FailableClassModel: FailableClassRequirement, IUOFailableClassRequirement {
  // CHECK-LABEL: sil hidden @_TTWC9witnesses18FailableClassModelS_24FailableClassRequirementS_FS1_CUS1___fMQPS1_FT3fooSi_GSqS2__

  // CHECK-LABEL: sil hidden @_TTWC9witnesses18FailableClassModelS_27IUOFailableClassRequirementS_FS1_CUS1___fMQPS1_FT3fooSi_GSQS2__
...
final class IUOFailableClassModel: NonFailableClassRefinement, IUOFailableClassRequirement {
  // CHECK-LABEL: sil hidden @_TTWC9witnesses21IUOFailableClassModelS_24FailableClassRequirementS_FS1_CUS1___fMQPS1_FT3fooSi_GSqS2__
  // CHECK: select_enum_addr
  // CHECK: unchecked_take_enum_data_addr
  // CHECK: inject_enum_addr {{.*}}Some
  // CHECK: inject_enum_addr {{.*}}None
  ...
  // CHECK-LABEL: sil hidden @_TTWC9witnesses21IUOFailableClassModelS_26NonFailableClassRefinementS_FS1_CUS1___fMQPS1_FT3fooSi_S2_
  // CHECK: function_ref @_TFSs36_getImplicitlyUnwrappedOptionalValueU__FGSQQ__Q_
  // CHECK: return [[RESULT:%[0-9]+]] : $IUOFailableClassModel

  // CHECK-LABEL: sil hidden @_TTWC9witnesses21IUOFailableClassModelS_27IUOFailableClassRequirementS_FS1_CUS1___fMQPS1_FT3fooSi_GSQS2__
  init!(foo: Int) {}
}
