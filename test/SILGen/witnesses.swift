...
struct ConformingStruct : X {
  ...
  // CHECK-LABEL: sil hidden @_TTWV9witnesses16ConformingStructS_1XFS1_9selfTypesUS1___fRQPS1_FT1xS2__S2_ : $@cc(witness_method) @thin (@out ConformingStruct, @in ConformingStruct, @inout ConformingStruct) -> () {
  ...
  // CHECK-LABEL: sil hidden @_TTWV9witnesses16ConformingStructS_1XFS1_8loadableUS1___fRQPS1_FT1xVS_8Loadable_S3_ : $@cc(witness_method) @thin (Loadable, @inout ConformingStruct) -> Loadable {
  ...
  // CHECK-LABEL: sil hidden @_TTWV9witnesses16ConformingStructS_1XFS1_8addrOnlyUS1___fRQPS1_FT1xPS_8AddrOnly__PS3__ : $@cc(witness_method) @thin (@out AddrOnly, @in AddrOnly, @inout ConformingStruct) -> () {
  ...
  // CHECK-LABEL: sil hidden @_TTWV9witnesses16ConformingStructS_1XFS1_7genericUS1___fRQPS1_U__FT1xQ__Q_ : $@cc(witness_method) @thin <A> (@out A, @in A, @inout ConformingStruct) -> () {
  ...
  // CHECK-LABEL: sil hidden @_TTWV9witnesses16ConformingStructS_1XFS1_7classesUS1___fRQPS1_US_7Classes__FT1xQ__Q_ : $@cc(witness_method) @thin <A2 where A2 : Classes> (@owned A2, @inout ConformingStruct) -> @owned A2 {
...
// CHECK-LABEL: sil hidden @_TTWV9witnesses16ConformingStructS_1XFS1_oi3ltgUS1___fMQPS1_FTS2_S2__S2_ : $@cc(witness_method) @thin (@out ConformingStruct, @in ConformingStruct, @in ConformingStruct, @thick ConformingStruct.Type) -> () {
...
final class ConformingClass : X {
  ...
  // CHECK-LABEL: sil hidden @_TTWC9witnesses15ConformingClassS_1XFS1_9selfTypesUS1___fRQPS1_FT1xS2__S2_ : $@cc(witness_method) @thin (@out ConformingClass, @in ConformingClass, @inout ConformingClass) -> () {
...
// CHECK-LABEL: sil hidden @_TTWC9witnesses15ConformingClassS_12ClassBoundedFS1_9selfTypesUS1___fQPS1_FT1xS2__S2_ : $@cc(witness_method) @thin (@owned ConformingClass, @owned ConformingClass) -> @owned ConformingClass {
...
struct ConformingAOStruct : X {
  ...
  // CHECK-LABEL: sil hidden @_TTWV9witnesses18ConformingAOStructS_1XFS1_9selfTypesUS1___fRQPS1_FT1xS2__S2_ : $@cc(witness_method) @thin (@out ConformingAOStruct, @in ConformingAOStruct, @inout ConformingAOStruct) -> () {
...
struct ConformsWithMoreGeneric : X, Y {
  ...
  // CHECK-LABEL: sil hidden @_TTWV9witnesses23ConformsWithMoreGenericS_1XFS1_9selfTypesUS1___fRQPS1_FT1xS2__S2_ : $@cc(witness_method) @thin (@out ConformsWithMoreGeneric, @in ConformsWithMoreGeneric, @inout ConformsWithMoreGeneric) -> () {
  ...
  // CHECK-LABEL: sil hidden @_TTWV9witnesses23ConformsWithMoreGenericS_1XFS1_8addrOnlyUS1___fRQPS1_FT1xPS_8AddrOnly__PS3__ : $@cc(witness_method) @thin (@out AddrOnly, @in AddrOnly, @inout ConformsWithMoreGeneric) -> () {
  ...
  // CHECK-LABEL: sil hidden @_TTWV9witnesses23ConformsWithMoreGenericS_1XFS1_7genericUS1___fRQPS1_U__FT1xQ__Q_ : $@cc(witness_method) @thin <A> (@out A, @in A, @inout ConformsWithMoreGeneric) -> () {
  ...
  // CHECK-LABEL: sil hidden @_TTWV9witnesses23ConformsWithMoreGenericS_1XFS1_7classesUS1___fRQPS1_US_7Classes__FT1xQ__Q_ : $@cc(witness_method) @thin <A2 where A2 : Classes> (@owned A2, @inout ConformsWithMoreGeneric) -> @owned A2 {
...
// CHECK-LABEL: sil hidden @_TTWV9witnesses23ConformsWithMoreGenericS_1XFS1_oi3ltgUS1___fMQPS1_FTS2_S2__S2_ : $@cc(witness_method) @thin (@out ConformsWithMoreGeneric, @in ConformsWithMoreGeneric, @in ConformsWithMoreGeneric, @thick ConformsWithMoreGeneric.Type) -> () {
...
struct UnlabeledWitness : LabeledRequirement {
  // CHECK-LABEL: sil hidden @_TTWV9witnesses16UnlabeledWitnessS_18LabeledRequirementFS1_6methodUS1___fRQPS1_FT1xVS_8Loadable_T_ : $@cc(witness_method) @thin (Loadable, @inout UnlabeledWitness) -> ()
...
struct UnlabeledSelfWitness : LabeledSelfRequirement {
  // CHECK-LABEL: sil hidden @_TTWV9witnesses20UnlabeledSelfWitnessS_22LabeledSelfRequirementFS1_6methodUS1___fRQPS1_FT1xS2__T_ : $@cc(witness_method) @thin (@in UnlabeledSelfWitness, @inout UnlabeledSelfWitness) -> ()
...
struct LabeledWitness : UnlabeledRequirement {
  // CHECK-LABEL: sil hidden @_TTWV9witnesses14LabeledWitnessS_20UnlabeledRequirementFS1_6methodUS1___fRQPS1_FT1xVS_8Loadable_T_ : $@cc(witness_method) @thin (Loadable, @inout LabeledWitness) -> ()
  func method(#x: Loadable) {}
}
...
struct LabeledSelfWitness : UnlabeledSelfRequirement {
  // CHECK-LABEL: sil hidden @_TTWV9witnesses18LabeledSelfWitnessS_24UnlabeledSelfRequirementFS1_6methodUS1___fRQPS1_FS2_T_ : $@cc(witness_method) @thin (@in LabeledSelfWitness, @inout LabeledSelfWitness) -> ()
...
struct ImmutableModel: ReadOnlyRequirement {
  // CHECK-LABEL: sil hidden @_TTWV9witnesses14ImmutableModelS_19ReadOnlyRequirementFS1_g4propSS : $@cc(witness_method) @thin (@thick ImmutableModel.Type) -> @owned String
...
struct NonFailableModel: FailableRequirement, NonFailableRefinement, IUOFailableRequirement {
  // CHECK-LABEL: sil hidden @_TTWV9witnesses16NonFailableModelS_19FailableRequirementFS1_CUS1___fMQPS1_FT3fooSi_GSqS2__ : $@cc(witness_method) @thin (@out Optional<NonFailableModel>, Int, @thick NonFailableModel.Type) -> ()
  // CHECK-LABEL: sil hidden @_TTWV9witnesses16NonFailableModelS_21NonFailableRefinementFS1_CUS1___fMQPS1_FT3fooSi_S2_ : $@cc(witness_method) @thin (@out NonFailableModel, Int, @thick NonFailableModel.Type) -> ()
  // CHECK-LABEL: sil hidden @_TTWV9witnesses16NonFailableModelS_22IUOFailableRequirementFS1_CUS1___fMQPS1_FT3fooSi_GSQS2__ : $@cc(witness_method) @thin (@out ImplicitlyUnwrappedOptional<NonFailableModel>, Int, @thick NonFailableModel.Type) -> ()
  init(foo: Int) {}
}

struct FailableModel: FailableRequirement, IUOFailableRequirement {
  // CHECK-LABEL: sil hidden @_TTWV9witnesses13FailableModelS_19FailableRequirementFS1_CUS1___fMQPS1_FT3fooSi_GSqS2__
...
struct IUOFailableModel : NonFailableRefinement, IUOFailableRequirement {
  // CHECK-LABEL: sil hidden @_TTWV9witnesses16IUOFailableModelS_21NonFailableRefinementFS1_CUS1___fMQPS1_FT3fooSi_S2_
...
final class NonFailableClassModel: FailableClassRequirement, NonFailableClassRefinement, IUOFailableClassRequirement {
  // CHECK-LABEL: sil hidden @_TTWC9witnesses21NonFailableClassModelS_24FailableClassRequirementFS1_CUS1___fMQPS1_FT3fooSi_GSqS2__ : $@cc(witness_method) @thin (Int, @thick NonFailableClassModel.Type) -> @owned Optional<NonFailableClassModel>
  // CHECK-LABEL: sil hidden @_TTWC9witnesses21NonFailableClassModelS_26NonFailableClassRefinementFS1_CUS1___fMQPS1_FT3fooSi_S2_ : $@cc(witness_method) @thin (Int, @thick NonFailableClassModel.Type) -> @owned NonFailableClassModel
  // CHECK-LABEL: sil hidden @_TTWC9witnesses21NonFailableClassModelS_27IUOFailableClassRequirementFS1_CUS1___fMQPS1_FT3fooSi_GSQS2__ : $@cc(witness_method) @thin (Int, @thick NonFailableClassModel.Type) -> @owned ImplicitlyUnwrappedOptional<NonFailableClassModel>
  init(foo: Int) {}
}
...
final class IUOFailableClassModel: NonFailableClassRefinement, IUOFailableClassRequirement {
  ...
  // CHECK-LABEL: sil hidden @_TTWC9witnesses21IUOFailableClassModelS_26NonFailableClassRefinementFS1_CUS1___fMQPS1_FT3fooSi_S2_
  // CHECK: function_ref @_TFSs36_getImplicitlyUnwrappedOptionalValueU__FGSQQ__Q_
  // CHECK: return [[RESULT:%[0-9]+]] : $IUOFailableClassModel

  // CHECK-LABEL: sil hidden @_TTWC9witnesses21IUOFailableClassModelS_27IUOFailableClassRequirementFS1_CUS1___fMQPS1_FT3fooSi_GSQS2__
  init!(foo: Int) {}
}
