...
// RUN: %target-swift-emit-silgen-ossa -enable-sil-opaque-values -Xllvm -sil-print-types -module-name protocol_extensions -disable-objc-attr-requires-foundation-module -enable-objc-interop %s
...
func testLogicalExistentialSetters(_ hasAP1: HasAP1, _ b: Bool) {
  ...
  // CHECK: apply [[SOMEP1_SETTER]]([[P1_COPY]], [[WRITE]]) : $@convention(method) (@in any P1, @inout HasAP1) -> ()
  // CHECK-NOT: deinit_existential_addr
