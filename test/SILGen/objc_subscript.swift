...
// RUN: %target-swift-emit-silgen(mock-sdk: -sdk %S/Inputs -I %t) -enable-sil-ownership-verifier %s -emit-verbose-sil -disable-objc-attr-requires-foundation-module | %FileCheck %s
