...
func concurrentWithCaptures(i: Int) -> Int {
  ...
  // CHECK: sil private [ossa] @$s4test22concurrentWithCaptures1iS2i_tFSiyJcfU_ : $@convention(thin) @Sendable (@guaranteed { var Int }) -> Int
  acceptsConcurrent {
    i + 1
  }
  i = i + 1

  // CHECK: sil private [ossa] @$s4test22concurrentWithCaptures1iS2i_tF13localFunctionL_SiyJF : $@convention(thin) @Sendable (@guaranteed { var Int }) -> Int
