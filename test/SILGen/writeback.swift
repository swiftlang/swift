...
// CHECK: apply [[FOO]]([[X_TEMP]]#1) : $[cc(method), thin] ((), [byref] Foo) -> ()
...
// CHECK: apply [[BAR]]([[X_TEMP]]#1) : $[thin] (x : [byref] Foo) -> ()
// CHECK: [[X1:%.*]] = load [[X_TEMP]]#1 : $*Foo
// CHECK: [[SET_X:%.*]] = function_ref @_T9writeback1xVS_3Foos : $[thin] (value : Foo) -> ()
// CHECK: apply [[SET_X]]([[X1]]) : $[thin] (value : Foo) -> ()
// CHECK: dealloc_stack [[X_TEMP]]#0 : $*[local_storage] Foo
...
// CHECK: apply [[GET]]([[TEMP]]#1) : $[thin] () -> Fungible
// CHECK: apply [[FUNGE]]([[TEMP]]#1) : $[thin] (x : [byref] Fungible) -> ()
// CHECK: [[SET:%.*]] = function_ref @_T9writeback11addressOnlyPS_8Fungible_s : $[thin] (value : Fungible) -> ()
// CHECK: apply [[SET]]([[TEMP]]#1) : $[thin] (value : Fungible) -> ()
