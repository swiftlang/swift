// RUN: %target-swift-frontend -emit-silgen-ossa -sil-verify-all -enable-sil-opaque-values %s -module-name test -swift-version 6 -target %target-swift-5.1-abi-triple -verify
