// RUN: %target-swift-emit-silgen -enable-sil-ownership-verifier -primary-file %s %S/Inputs/witness_tables_multifile_2.swift | %FileCheck %s -check-prefix=CHECK-FIRST-FILE
// RUN: %target-swift-emit-silgen -enable-sil-ownership-verifier %s -primary-file %S/Inputs/witness_tables_multifile_2.swift | %FileCheck %S/Inputs/witness_tables_multifile_2.swift -check-prefix=CHECK-SECOND-FILE
