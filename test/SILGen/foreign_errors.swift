...
// RUN: %target-swift-emit-silgen-ossa(mock-sdk: %clang-importer-sdk-nosource -I %t) -enable-sil-opaque-values -Xllvm -sil-print-types -module-name foreign_errors -parse-as-library %s
