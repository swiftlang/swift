// RUN: %target-swift-emit-silgen -sdk %S/Inputs %s -I %S/Inputs -enable-source-import -enable-swift3-objc-inference -swift-version 4 -enable-sil-ownership-verifier -enable-objc-interop | %FileCheck -check-prefix CHECK-SWIFT4 %s
