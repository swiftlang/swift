...
// CHECK: sil @_T21class_bound_protocols41class_bound_to_unbound_existential_upcastFT1xPS_10ClassBoundS_13NotClassBound__PS1__
...
// CHECK: sil @_T21class_bound_protocols18class_bound_methodFT1xPS_10ClassBound__T_
func class_bound_method(x:ClassBound) {
  ...
  // CHECK: apply [[METHOD]]([[PROJ]]) : $[cc(method), thin] ((), Builtin.ObjCPointer) -> ()
}
