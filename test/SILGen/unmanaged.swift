...
// CHECK-LABEL:sil @_TFV9unmanaged6HolderCfMS0_FT5valueCS_1C_S0_ : $@thin (@owned C, @thin Holder.Type) -> Holder
// CHECK-NEXT: bb0([[T0:%.*]] : $C,
...
// CHECK-LABEL:sil @_TF9unmanaged3setFT6holderRVS_6Holder_T_ : $@thin (@inout Holder) -> ()
...
// CHECK-LABEL:sil @_TF9unmanaged3getFT6holderRVS_6Holder_CS_1C : $@thin (@inout Holder) -> @owned C
// CHECK-NEXT: bb0([[ADDR:%.*]] : $*Holder):
// CHECK-NEXT:   [[T0:%.*]] = struct_element_addr [[ADDR]] : $*Holder, #Holder.value
...
// CHECK-LABEL:sil @_TF9unmanaged7projectFT2fnFT_VS_6Holder_CS_1C : $@thin (@owned @callee_owned () -> Holder) -> @owned C
