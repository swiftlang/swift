...
// RUN: %target-swift-emit-silgen-ossa(mock-sdk: %clang-importer-sdk-nosource -I %t) -o /dev/null -enable-sil-opaque-values -Xllvm -sil-print-types -module-name objc_error %s
