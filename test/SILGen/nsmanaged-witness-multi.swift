...
// RUN: %target-swift-frontend -module-name main -Xllvm -sil-print-types -emit-silgen-ossa -sil-verify-all -enable-sil-opaque-values -sdk %S/Inputs -primary-file %s %S/Inputs/nsmanaged-witness-multi-other.swift -I %S/Inputs -I %t -enable-source-import
