...
// CHECK-LABEL: sil @_TF22downcast_reabstraction19condFunctionFromAnyFP_T_ 
...
// CHECK-LABEL: sil @_TF22downcast_reabstraction21uncondFunctionFromAnyFP_T_ : $@thin (@in protocol<>) -> () {
