...
// CHECK-NEXT:   method #Protocol.property!modify: <Self where Self : Protocol> (inout Self) -> @yield_once () yields (inout Float) -> () : @$s13witness_table6StructVAA8ProtocolA2aDP8propertySfvMTW
...
// CHECK-NEXT:   method #Protocol.subscript!modify: <Self where Self : Protocol> (inout Self) -> @yield_once (Float, Float) yields (inout Float) -> () : @$s13witness_table6StructVAA8ProtocolA2aDPyS2f_SftciMTW
// CHECK: }
