...
// CHECK-NEXT:   method #Protocol.property!yielding_mutate: <Self where Self : Protocol> (inout Self) -> () -> () : @$s13witness_table6StructVAA8ProtocolA2aDP8propertySfvxTW
...
// CHECK-NEXT:   method #Protocol.subscript!yielding_mutate: <Self where Self : Protocol> (inout Self) -> (Float, Float) -> () : @$s13witness_table6StructVAA8ProtocolA2aDPyS2f_SftcixTW
// CHECK: }
