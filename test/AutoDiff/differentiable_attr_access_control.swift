...
@differentiable(primal: pfoo2(_:), adjoint: dfoo2)
...
@differentiable(adjoint: dbar1) // expected-error {{associated differentiation function 'dbar1' is required to either be public or @usableFromInline because the original function 'bar1' is public or @usableFromInline}}
...
@differentiable(primal: pbar2(_:), adjoint: dbar2) // expected-error {{associated differentiation function 'pbar2' is required to either be public or @usableFromInline because the original function 'bar2' is public or @usableFromInline}}
