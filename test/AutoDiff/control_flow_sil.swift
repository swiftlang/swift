...
// CHECK-SIL-LABEL: sil hidden @$s4condTZp0r0 : $@convention(thin) (Float) -> (Float, @owned @callee_guaranteed (Float) -> Float) {
...
// CHECK-SIL-LABEL: sil hidden @$s4condTUp0r0 : $@convention(thin) (Float, @guaranteed _AD__cond_bb3__PB__src_0_wrt_0) -> Float {
...
// CHECK-SIL-LABEL: sil hidden @$s14cond_tuple_varTUp0r0 : $@convention(thin) (Float, @guaranteed _AD__cond_tuple_var_bb3__PB__src_0_wrt_0) -> Float {
