...
// CHECK-SILGEN-LABEL: // static Wrapper.+ infix(_:_:)
// CHECK-SILGEN-NEXT: sil [differentiable source 0 wrt 0, 1 vjp @$s39differentiable_attr_silgen_other_module7WrapperV1poiyA2C_ACtFZTZp0_1r0] @$s39differentiable_attr_silgen_other_module7WrapperV1poiyA2C_ACtFZ : $@convention(method) (Wrapper, Wrapper, @thin Wrapper.Type) -> Wrapper
// CHECK-SIL-LABEL: // static Wrapper.+ infix(_:_:)
// CHECK-SIL-NEXT: sil [differentiable source 0 wrt 0, 1 jvp @$s39differentiable_attr_silgen_other_module7WrapperV1poiyA2C_ACtFZTzp0_1r0 vjp @$s39differentiable_attr_silgen_other_module7WrapperV1poiyA2C_ACtFZTZp0_1r0] @$s39differentiable_attr_silgen_other_module7WrapperV1poiyA2C_ACtFZ : $@convention(method) (Wrapper, Wrapper, @thin Wrapper.Type) -> Wrapper
