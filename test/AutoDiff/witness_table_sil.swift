...
struct S : Proto, VectorProtocol {
  ...
  // CHECK: [[JVP1_VJP_FNREF:%.*]] = function_ref @$s17witness_table_sil1SV9function1yS2f_SdtFTZp0_1r0
  // CHECK: [[JVP1_ADFUNC:%.*]] = autodiff_function [wrt 0 1] [order 1] [[JVP1_ORIG_FNREF]] : {{.*}} with {[[JVP1_JVP_FNREF]] : {{.*}}, [[JVP1_VJP_FNREF]] : {{.*}}}
  ...
  // CHECK: [[VJP1_VJP_FNREF:%.*]] = function_ref @$s17witness_table_sil1SV9function1yS2f_SdtFTZp0_1r0
  // CHECK: [[VJP1_ADFUNC:%.*]] = autodiff_function [wrt 0 1] [order 1] [[VJP1_ORIG_FNREF]] : {{.*}} with {[[VJP1_JVP_FNREF]] : {{.*}}, [[VJP1_VJP_FNREF]] : {{.*}}}
  ...
  // CHECK: [[JVP2_VJP_FNREF:%.*]] = function_ref @$s17witness_table_sil1SV9function2yS2f_SdtFTZp0_1_2r0
  // CHECK: [[JVP2_ADFUNC:%.*]] = autodiff_function [wrt 0 1 2] [order 1] [[JVP2_ORIG_FNREF]] : {{.*}} with {[[JVP2_JVP_FNREF]] : {{.*}}, [[JVP2_VJP_FNREF]] : {{.*}}}
  ...
  // CHECK: [[VJP2_VJP_FNREF:%.*]] = function_ref @$s17witness_table_sil1SV9function2yS2f_SdtFTZp0_1_2r0
  // CHECK: [[VJP2_ADFUNC:%.*]] = autodiff_function [wrt 0 1 2] [order 1] [[VJP2_ORIG_FNREF]] : {{.*}} with {[[VJP2_JVP_FNREF]] : {{.*}}, [[VJP2_VJP_FNREF]] : {{.*}}}
  ...
  // CHECK: [[JVP3_VJP_FNREF:%.*]] = function_ref @$s17witness_table_sil1SV9function3ySdSf_SdtFTZp1r0
  // CHECK: [[JVP3_ADFUNC:%.*]] = autodiff_function [wrt 1] [order 1] [[JVP3_ORIG_FNREF]] : {{.*}} with {[[JVP3_JVP_FNREF]] : {{.*}}, [[JVP3_VJP_FNREF]] : {{.*}}}
  ...
  // CHECK: [[VJP3_VJP_FNREF:%.*]] = function_ref @$s17witness_table_sil1SV9function3ySdSf_SdtFTZp1r0
  // CHECK: [[VJP3_ADFUNC:%.*]] = autodiff_function [wrt 1] [order 1] [[VJP3_ORIG_FNREF]] : {{.*}} with {[[VJP3_JVP_FNREF]] : {{.*}}, [[VJP3_VJP_FNREF]] : {{.*}}}
