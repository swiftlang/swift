// RUN: not %target-swift-emit-ir -primary-file %s
// REQUIRES: asserts

// TF-756: IRGen crash for `witness_method` instruction generated by the
// differentiation transform.

// TODO(TF-1059): Currently, this test is fails during the differentiation
// transform (SILOptimizer) and doesn't reach IRGen. When TF-1059 is fixed,
// the IRGen crash should be reproducible again; change the `RUN` line back to
// `not --crash`.
