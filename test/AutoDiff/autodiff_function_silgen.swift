...
// CHECK-SILGEN:   [[JVP_COPY:%.*]] = copy_value [[JVP]] : $@callee_guaranteed (Float) -> (@out Float, @owned @callee_guaranteed (@in_guaranteed Float) -> @out Float)
// CHECK-SILGEN:   [[JVP_THUNK:%.*]] = function_ref @${{.*}} : $@convention(thin) (@in_guaranteed Float, @guaranteed @callee_guaranteed (Float) -> (@out Float, @owned @callee_guaranteed (@in_guaranteed Float) -> @out Float)) -> (@out Float, @owned @callee_guaranteed (@in_guaranteed Float) -> @out Float)
...
// CHECK-SILGEN:   [[VJP_COPY:%.*]] = copy_value [[VJP]] : $@callee_guaranteed (Float) -> (@out Float, @owned @callee_guaranteed (@in_guaranteed Float) -> @out Float)
// CHECK-SILGEN:   [[VJP_THUNK:%.*]] = function_ref @${{.*}} : $@convention(thin) (@in_guaranteed Float, @guaranteed @callee_guaranteed (Float) -> (@out Float, @owned @callee_guaranteed (@in_guaranteed Float) -> @out Float)) -> (@out Float, @owned @callee_guaranteed (@in_guaranteed Float) -> @out Float)
