...
var closure5 : (Double) -> Int =
   { // expected-error {{cannot convert initializer of type '(Double) -> Double' to specified type '(Double) -> Int'}}
       $0 + 1.0 }
...
func funcdecl5(a: Int, _ y: Int) {
  ...
  var c : Int = { a,b-> Int in a+b} // expected-error{{cannot convert initializer of type '(Int, Int) -> Int' to specified type 'Int'}}
