...
var x1: X1 = .AnX1
x1 = .AnX1
x1 = .NotAnX1 // expected-error{{'Int' is not convertible to 'X1'}}
...
struct X2<T> {
  static var AnX2 = X2() // expected-error{{cannot convert the expression's type 'X2<T>' to type 'X2<T>'}}
...
x2 = .NotAnX2 // expected-error{{'Int' is not convertible to 'X2<Int>'}}
