...
class C1 {
  ...
  func processWithString(_ string: String, toInt: Int) { } // expected-warning{{'processWithString(_:toInt:)' could be named 'process(with:to:)'}}{{8-25=process}}{{42-42=to }}
...
func emptyFirstParamName(_ _: Int) { }
