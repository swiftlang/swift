...
func using(_ obj: PrivateMembers) {
  ...
  _ = PrivateMembers.PrivateInner.Invisible()
...
extension Outer.Middle.Inner {
  func useParentExtensionPrivate() {
    ...
    Outer.MiddleExtension.privateDeclaration()
    // expected-error@-1 {{'privateDeclaration' is inaccessible due to 'private' protection level}}
  }
}
