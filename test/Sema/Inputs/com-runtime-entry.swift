...
#if INVALID_RUNTIME_ENTRY_TYPES
@c
public func QueryInterface(_ pUnk: UnsafeMutableRawPointer) -> Int32 {
  0
}
#elseif INVALID_QUERY_INTERFACE
...
#if INVALID_RUNTIME_ENTRY_TYPES
@c
public func AddRef(_ pUnk: UnsafeRawPointer) -> UInt32 {
  0
}
#else
@c
...
#if INVALID_RUNTIME_ENTRY_TYPES
@c
public func Release(_ pUnk: UnsafeMutableRawPointer) -> Int32 {
  0
}
#elseif !MISSING_RELEASE
@c
