// RUN: %target-swift-frontend -disable-experimental-parser-round-trip -target %target-swift-6.2-abi-triple -enable-experimental-feature BuiltinModule -typecheck -verify %s
