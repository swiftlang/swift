...
class C {
  ...
  subscript(i: Int) -> Int! { return 0 } // expected-note {{implicitly unwrapped subscript 'subscript' declared here}}
  subscript(i: Float) -> Any! { return 0 } // expected-note {{implicitly unwrapped subscript 'subscript' declared here}}
}
