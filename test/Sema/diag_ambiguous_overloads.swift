...
do {
  ...
  // expected-note@-3 {{cannot convert result type 'String' to expected argument type 'Int'}}
  // expected-note@-4 {{cannot convert result type 'Double' to expected argument type 'Int'}}
