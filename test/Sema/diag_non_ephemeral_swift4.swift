...
takesMutableRaw(&globalResilient, 5) // expected-warning {{passing temporary pointer argument of type 'UnsafeMutableRawPointer' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
// expected-note@-1 {{implicit argument conversion from 'Int8' to 'UnsafeMutableRawPointer' produces a pointer valid only for the duration of the call}}

takesMutableRaw(&ResilientStruct.staticStoredProperty, 5) // expected-warning {{passing temporary pointer argument of type 'UnsafeMutableRawPointer' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
// expected-note@-1 {{implicit argument conversion from 'Int8' to 'UnsafeMutableRawPointer' produces a pointer valid only for the duration of the call}}

takesMutableRaw(&type(of: topLevelResilientS).staticStoredProperty, 5) // expected-warning {{passing temporary pointer argument of type 'UnsafeMutableRawPointer' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
// expected-note@-1 {{implicit argument conversion from 'Int8' to 'UnsafeMutableRawPointer' produces a pointer valid only for the duration of the call}}

//   - Resilient struct or class bases

takesMutableRaw(&topLevelResilientS.storedProperty, 5) // expected-warning {{passing temporary pointer argument of type 'UnsafeMutableRawPointer' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
// expected-note@-1 {{implicit argument conversion from 'Int8' to 'UnsafeMutableRawPointer' produces a pointer valid only for the duration of the call}}

takesMutableRaw(&topLevelResilientFinalC.storedProperty, 5) // expected-warning {{passing temporary pointer argument of type 'UnsafeMutableRawPointer' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
// expected-note@-1 {{implicit argument conversion from 'Int8' to 'UnsafeMutableRawPointer' produces a pointer valid only for the duration of the call}}

takesMutableRaw(&topLevelOptOfResilientS!.storedProperty, 5) // expected-warning {{passing temporary pointer argument of type 'UnsafeMutableRawPointer' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
// expected-note@-1 {{implicit argument conversion from 'Int8' to 'UnsafeMutableRawPointer' produces a pointer valid only for the duration of the call}}

//   - Protocol bases

takesRaw(&topLevelP.property) // expected-warning {{passing temporary pointer argument of type 'UnsafeRawPointer' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
// expected-note@-1 {{implicit argument conversion from 'Int8' to 'UnsafeRawPointer' produces a pointer valid only for the duration of the call}}

takesRaw(&type(of: topLevelP).staticProperty) // expected-warning {{passing temporary pointer argument of type 'UnsafeRawPointer' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
// expected-note@-1 {{implicit argument conversion from 'Int8' to 'UnsafeRawPointer' produces a pointer valid only for the duration of the call}}

takesRaw(&topLevelP[]) // expected-warning {{passing temporary pointer argument of type 'UnsafeRawPointer' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
// expected-note@-1 {{implicit argument conversion from 'Int8' to 'UnsafeRawPointer' produces a pointer valid only for the duration of the call}}

//   - Properties with observers

takesRaw(&topLevelWithObservers) // expected-warning {{passing temporary pointer argument of type 'UnsafeRawPointer' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
// expected-note@-1 {{implicit argument conversion from 'Int8' to 'UnsafeRawPointer' produces a pointer valid only for the duration of the call}}

takesRaw(&topLevelS.storedPropertyWithObservers) // expected-warning {{passing temporary pointer argument of type 'UnsafeRawPointer' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
// expected-note@-1 {{implicit argument conversion from 'Int8' to 'UnsafeRawPointer' produces a pointer valid only for the duration of the call}}

takesRaw(&topLevelOptOfS!.storedPropertyWithObservers) // expected-warning {{passing temporary pointer argument of type 'UnsafeRawPointer' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
// expected-note@-1 {{implicit argument conversion from 'Int8' to 'UnsafeRawPointer' produces a pointer valid only for the duration of the call}}

takesRaw(&topLevelC.storedPropertyWithObservers) // expected-warning {{passing temporary pointer argument of type 'UnsafeRawPointer' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
// expected-note@-1 {{implicit argument conversion from 'Int8' to 'UnsafeRawPointer' produces a pointer valid only for the duration of the call}}

takesRaw(&topLevelFinalC.storedPropertyWithObservers) // expected-warning {{passing temporary pointer argument of type 'UnsafeRawPointer' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
// expected-note@-1 {{implicit argument conversion from 'Int8' to 'UnsafeRawPointer' produces a pointer valid only for the duration of the call}}

takesRaw(&topLevelTupleOfS.0.storedPropertyWithObservers) // expected-warning {{passing temporary pointer argument of type 'UnsafeRawPointer' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
// expected-note@-1 {{implicit argument conversion from 'Int8' to 'UnsafeRawPointer' produces a pointer valid only for the duration of the call}}

//   - Computed properties

takesRaw(&topLevelOptOfS!.computedProperty) // expected-warning {{passing temporary pointer argument of type 'UnsafeRawPointer' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
// expected-note@-1 {{implicit argument conversion from 'Int8' to 'UnsafeRawPointer' produces a pointer valid only for the duration of the call}}

takesRaw(&topLevelC.computedProperty) // expected-warning {{passing temporary pointer argument of type 'UnsafeRawPointer' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
// expected-note@-1 {{implicit argument conversion from 'Int8' to 'UnsafeRawPointer' produces a pointer valid only for the duration of the call}}

takesRaw(&topLevelFinalC.computedProperty) // expected-warning {{passing temporary pointer argument of type 'UnsafeRawPointer' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
// expected-note@-1 {{implicit argument conversion from 'Int8' to 'UnsafeRawPointer' produces a pointer valid only for the duration of the call}}

takesRaw(&topLevelTupleOfS.0.computedProperty) // expected-warning {{passing temporary pointer argument of type 'UnsafeRawPointer' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
// expected-note@-1 {{implicit argument conversion from 'Int8' to 'UnsafeRawPointer' produces a pointer valid only for the duration of the call}}

//   - Subscripts

takesRaw(&topLevelS[]) // expected-warning {{passing temporary pointer argument of type 'UnsafeRawPointer' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
// expected-note@-1 {{implicit argument conversion from 'Int8' to 'UnsafeRawPointer' produces a pointer valid only for the duration of the call}}

takesRaw(&topLevelC[]) // expected-warning {{passing temporary pointer argument of type 'UnsafeRawPointer' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
// expected-note@-1 {{implicit argument conversion from 'Int8' to 'UnsafeRawPointer' produces a pointer valid only for the duration of the call}}

takesRaw(&topLevelFinalC[]) // expected-warning {{passing temporary pointer argument of type 'UnsafeRawPointer' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
// expected-note@-1 {{implicit argument conversion from 'Int8' to 'UnsafeRawPointer' produces a pointer valid only for the duration of the call}}
...
struct S1 {
  var property: Int8 = 0
  mutating func foo() {
    takesRaw(&property) // expected-warning {{passing temporary pointer argument of type 'UnsafeRawPointer' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
    // expected-note@-1 {{implicit argument conversion from 'Int8' to 'UnsafeRawPointer' produces a pointer valid only for the duration of the call}}

    takesRaw(&self.property) // expected-warning {{passing temporary pointer argument of type 'UnsafeRawPointer' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
    // expected-note@-1 {{implicit argument conversion from 'Int8' to 'UnsafeRawPointer' produces a pointer valid only for the duration of the call}}
  }
}
...
func testNonEphemeralInMembers() {
  ...
  let _: S2 = .takesConstStaticAndReturns([1, 2, 3]) // expected-warning {{passing temporary pointer argument of type 'UnsafePointer<Int>' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
  ...
  S2.takesMutableRawStatic(ptr: &local) // expected-warning {{passing temporary pointer argument of type 'UnsafeMutableRawPointer' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
  ...
  s2.takesMutableRaw(ptr: &local) // expected-warning {{passing temporary pointer argument of type 'UnsafeMutableRawPointer' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
  // expected-note@-1 {{implicit argument conversion from 'Int' to 'UnsafeMutableRawPointer' produces a pointer valid only for the duration of the call}}

  _ = s2[takesConstInt8: ""] // expected-warning {{passing temporary pointer argument of type 'UnsafePointer<Int8>' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
  // expected-note@-1 {{implicit argument conversion from 'String' to 'UnsafePointer<Int8>' produces a pointer valid only for the duration of the call}}

  s2[takesConstInt8: ""] += 1 // expected-warning {{passing temporary pointer argument of type 'UnsafePointer<Int8>' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
  // expected-note@-1 {{implicit argument conversion from 'String' to 'UnsafePointer<Int8>' produces a pointer valid only for the duration of the call}}
}
...
func testNonEphemeralInMemberwiseInits() {
  ...
  _ = S3(ptr1: &topLevelS, ptr2: &local) // expected-warning {{passing temporary pointer argument of type 'UnsafeMutableRawPointer?' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
  // expected-note@-1 {{implicit argument conversion from 'Int' to 'UnsafeMutableRawPointer?' produces a pointer valid only for the duration of the call}}

  _ = S3(ptr1: &local, ptr2: &topLevelS) // expected-warning {{passing temporary pointer argument of type 'UnsafeMutableRawPointer' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
  // expected-note@-1 {{implicit argument conversion from 'Int' to 'UnsafeMutableRawPointer' produces a pointer valid only for the duration of the call}}

  _ = E.mutableRaw(&local) // expected-warning {{passing temporary pointer argument of type 'UnsafeMutableRawPointer' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
  // expected-note@-1 {{implicit argument conversion from 'Int' to 'UnsafeMutableRawPointer' produces a pointer valid only for the duration of the call}}

  _ = E.const([1, 2, 3]) // expected-warning {{passing temporary pointer argument of type 'UnsafePointer<Int8>' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
  // expected-note@-1 {{implicit argument conversion from '[Int8]' to 'UnsafePointer<Int8>' produces a pointer valid only for the duration of the call}}

  _ = E.const("hello") // expected-warning {{passing temporary pointer argument of type 'UnsafePointer<Int8>' to parameter expecting a pointer that outlives the duration of the call leads to undefined behaviour; this will be an error in a future release}}
  // expected-note@-1 {{implicit argument conversion from 'String' to 'UnsafePointer<Int8>' produces a pointer valid only for the duration of the call}}
}
