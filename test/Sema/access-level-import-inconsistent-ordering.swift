...
/// Test main cases.
// RUN: %target-swift-frontend -typecheck -verify %t/Client.swift -I %t -package-name pkg
// RUN: %target-swift-frontend -typecheck -verify %t/Client_Clang.swift -I %t
// RUN: %target-swift-frontend -typecheck -verify %t/Client_Clang.swift -I %t -DINVERT
// RUN: %target-swift-frontend -typecheck -verify %t/Client_Clang_Submodules.swift -I %t
// RUN: %target-swift-frontend -typecheck -verify %t/Client_Clang_Submodules.swift -I %t -DINVERT
