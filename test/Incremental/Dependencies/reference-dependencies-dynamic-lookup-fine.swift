...
// RUN: %target-swift-frontend(mock-sdk: %clang-importer-sdk) -typecheck -disable-experimental-private-intransitive-dependencies -primary-file %t/main.swift -emit-reference-dependencies-path - > %t.swiftdeps

// Check that the output is deterministic.
// RUN: %target-swift-frontend(mock-sdk: %clang-importer-sdk) -typecheck -disable-experimental-private-intransitive-dependencies -primary-file %t/main.swift -emit-reference-dependencies-path - > %t-2.swiftdeps
