...
// RUN: %target-swift-frontend -fine-grained-dependency-include-intrafile -typecheck -disable-experimental-private-intransitive-dependencies -primary-file %t/main.swift %S/../Inputs/reference-dependencies-members-helper.swift -emit-reference-dependencies-path - > %t.swiftdeps

// RUN: %target-swift-frontend -fine-grained-dependency-include-intrafile -typecheck -disable-experimental-private-intransitive-dependencies -primary-file %t/main.swift %S/../Inputs/reference-dependencies-members-helper.swift -emit-reference-dependencies-path - > %t-2.swiftdeps
