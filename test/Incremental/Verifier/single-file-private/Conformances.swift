...
// RUN: cd %t && %target-swiftc_driver -typecheck -output-file-map %t/output.json -incremental -module-name main -enable-experimental-private-intransitive-dependencies -verify-incremental-dependencies %s
