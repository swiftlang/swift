...
func test() async throws {
  ...
  // CHECK: on:main.Greeter, target:RemoteCallTarget(mangledName: "$s4main7GreeterC5helloSSyFTE"), invocation:FakeInvocation(arguments: [], returnType: Optional(Swift.String), errorType: nil, argumentIndex: 0), throwing:Never, returning:String
