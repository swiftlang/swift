...
func compositionType() {
  ...
  _ = P1 & P2.self // expected-error {{binary operator '&' cannot be applied to operands of type 'P1.Protocol' and 'P2.Protocol'}} expected-note {{expected an argument list of type '(Self, Self)'}}
  _ = (P1 & P2).self // Ok.
