...
// expected-legacy-error@-1 {{module selector cannot specify a submodule}} expected-new-error@-1 {{unexpected code 'Submodule::' in import}}
// expected-legacy-note@-2 {{replace '::' with '.'}} {{50-52=.}}
...
// expected-legacy-error@-3 {{consecutive statements on a line must be separated by ';'}} expected-new-error@-3 {{unexpected code '*::Int' before variable}}
...
// expected-new-error@-9 {{unexpected code ']' before variable}}
...
// expected-legacy-error@-1 {{consecutive statements on a line must be separated by ';'}} {{19-19=;}} expected-new-error@-1 {{consecutive statements on a line must be separated by newline or ';'}}
// expected-new-note@-2 {{insert newline}} {{19-19=\n}}
// expected-new-note@-3 {{insert ';'}} {{19-19=;}}
// expected-legacy-error@-4 {{expected expression after unary operator}} expected-new-error@-4 {{unexpected code '.*::Index' before variable}}
// expected-legacy-error@-5 {{expected module name in module selector}}
...
// expected-legacy-error@-4 {{consecutive statements on a line must be separated by ';'}} {{26-26=;}} expected-new-error@-4 {{consecutive statements on a line must be separated by newline or ';'}}
// expected-new-note@-5 {{insert newline}} {{26-27= \n}}
// expected-new-note@-6 {{insert ';'}} {{26-27=}} {{27-27=;}}
// expected-legacy-error@-7 {{expected expression}} expected-new-error@-7 {{unexpected code 'else { 0 }' before variable}}
