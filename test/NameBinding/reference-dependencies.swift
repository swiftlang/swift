...
func overloadedOnProto<T>(_ _: T) {}
func overloadedOnProto<T: ThreeTilde>(_ _: T) {}
...
func genericTest<T: ProtoReferencedOnlyInGeneric>(_ _: T) {}
// CHECK-DAG: !private "ProtoReferencedOnlyInPrivateGeneric"
private func privateGenericTest<T: ProtoReferencedOnlyInPrivateGeneric>(_ _: T) {}
