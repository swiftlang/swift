...
class ThisBase1 {
  ...
  class var baseStaticVar: Int = 42 // expected-error {{class variables not yet supported}}
...
class ThisDerived1 : ThisBase1 {
  ...
  class var derivedStaticVar: Int = 42// expected-error {{class variables not yet supported}}
  ...
  class func staticTestSelf1() {
    ...
    self.baseFunc1(42) // expected-error {{cannot convert the expression's type '(Int) -> ()' to type 'ThisBase1'}}
  ...
  class func staticTestSuper1() {
    ...
    super.baseFunc1(42) // expected-error {{cannot convert the expression's type '(Int) -> ()' to type 'ThisBase1'}}
