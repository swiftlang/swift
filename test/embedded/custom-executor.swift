...
// RUN: %target-clang %target-clang-resource-dir-opt %t/a.o %t/executor.o -o %t/a.out %swift_obj_root/lib/swift/embedded/%module-target-triple/libswift_Concurrency.a -dead_strip
