...
// RUN: %target-embedded-link %t/a.o %t/executor.o -o %t/a.out %swift_obj_root/lib/swift/embedded/%target-cpu-apple-macos/libswift_Concurrency.a %target-embedded-concurrency-threading-shim -dead_strip
