...
// RUN: not %target-clang %target-clang-resource-dir-opt %t/Root.o %t/ClientA.o %t/ClientB.o %t/Application.o -o %t/Application
// RUNTODO: n%target-run %t/Application | %FileCheck %s
