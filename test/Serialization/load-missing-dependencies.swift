// RUN: rm -rf %t
// RUN: mkdir %t
// RUN: %swift -emit-module -o %t %S/../Inputs/empty.swift -module-name new_module
// RUN: %swift -emit-module -o %t %S/../Inputs/empty.swift -module-name another_new_module
// RUN: %swift -emit-module -o %t %S/Inputs/depends_on_new_module.swift -I=%t
// RUN: %swift %s -parse -I=%t
// RUN: rm %t/new_module.swiftmodule
// RUN: rm %t/another_new_module.swiftmodule
// RUN: %swift %s -parse -I=%t -verify -show-diagnostics-after-fatal
