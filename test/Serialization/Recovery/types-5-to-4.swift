...
class Sub: Base {} // expected-error {{cannot inherit from class 'Base' (compiled with Swift 5.3.3) because it has overridable members that could not be loaded in Swift 4.1.50}}
class Impl: Proto {} // expected-error {{type 'Impl' cannot conform to protocol 'Proto' (compiled with Swift 5.3.3) because it has requirements that could not be loaded in Swift 4.1.50}}
