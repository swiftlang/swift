...
// SIL: [[TMP:%.+]] = sil_global_addr @_Tv11transparent3tmpSi : $*Int
...
// SIL-LABEL: sil public_external [transparent] @_TF15def_transparent15testTransparentFT1xSb_Sb : $@thin (Bool) -> Bool {
// SIL: bb0(%0 : $Bool):
// SIL: return %0 : $Bool
...
// SIL-LABEL: sil public_external @_TF15def_transparent9do_switchFT1uOS_9MaybePair_T_ : $@thin (@owned MaybePair) -> () {
// SIL: bb0(%0 : $MaybePair):
...
// SIL-LABEL: sil public_external [transparent] @_TFV15def_transparent7WrapperCfMS0_FT3ValSi_S0_ : $@thin (Int, @thin Wrapper.Type) -> Wrapper {
// SIL-LABEL: sil public_external [transparent] @_TFV15def_transparent7Wrapper8getValuefS0_FT_Si : $@cc(method) @thin (Wrapper) -> Int {
// SIL-LABEL: sil public_external [transparent] @_TFV15def_transparent7Wrapperg10valueAgainSi : $@cc(method) @thin (Wrapper) -> Int {
// SIL-LABEL: sil public_external [transparent] @_TFV15def_transparent7Wrapper13getValueAgainfS0_FT_Si : $@cc(method) @thin (Wrapper) -> Int {
func test_wrapper() {
...
// SIL-LABEL: sil public_external [transparent] @_TF15def_transparent17open_existentialsFT1pPS_1P_2cpPS_2CP__T_
func test_open_existentials(p: P, cp: CP) {
  // SIL: open_existential [[EXIST:%[0-9]+]]#1 : $*P to $*@opened([[N:[0-9]+]]) P
  // SIL: open_existential_ref [[EXIST:%[0-9]+]] : $CP to $@opened([[M:[0-9]+]]) CP
  open_existentials(p: p, cp: cp)
}

// SIL-LABEL: sil shared_external [transparent] @_TF15def_transparent16curried_functionFT1xSi_FT1ySi_Si : $@thin (Int) -> @owned @callee_owned (Int) -> Int {
