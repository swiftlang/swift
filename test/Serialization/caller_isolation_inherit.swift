...
actor A {
  ...
  // CHECK-NEXT: sil @$s11WithFeature16unspecifiedAsyncyyxYalF : $@convention(thin) @async <τ_0_0> (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @in_guaranteed τ_0_0) -> ()
  func test1() async {
  ...
  // CHECK: sil @$s11WithFeature22unspecifiedAsyncCalleryyxYalF : $@convention(thin) @async <τ_0_0> (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @in_guaranteed τ_0_0) -> ()
  func test1b() async {
  ...
  // CHECK-LABEL: // unspecifiedAsyncCaller<A>(_:)
  // CHECK: // Isolation: caller_isolation_inheriting
  // CHECK: sil @$s14WithoutFeature22unspecifiedAsyncCalleryyxYalF : $@convention(thin) @async <τ_0_0> (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @in_guaranteed τ_0_0) -> ()
  func test2b() async {
  ...
  // CHECK: // Isolation: caller_isolation_inheriting
  // CHECK: sil @$s11WithFeature16nonisolatedAsyncyyxYalF : $@convention(thin) @async <τ_0_0> (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @in_guaranteed τ_0_0) -> ()
  func test3() async {
  ...
  // CHECK: // Isolation: caller_isolation_inheriting
  // CHECK: sil @$s11WithFeature22nonisolatedAsyncCalleryyxYalF : $@convention(thin) @async <τ_0_0> (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @in_guaranteed τ_0_0) -> ()
  func test3b() async {
  ...
  // CHECK-LABEL: // nonisolatedAsyncCaller<A>(_:)
  // CHECK: // Isolation: caller_isolation_inheriting
  // CHECK: sil @$s14WithoutFeature22nonisolatedAsyncCalleryyxYalF : $@convention(thin) @async <τ_0_0> (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @in_guaranteed τ_0_0) -> ()
  func test4b() async {
  ...
  // CHECK: // Isolation: caller_isolation_inheriting
  // CHECK: sil @$s11WithFeature1SV16unspecifiedAsyncyyxYalF : $@convention(method) @async <τ_0_0> (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @in_guaranteed τ_0_0, S) -> ()
  func test5() async {
    let s = WithFeature.S()
  ...
  // CHECK: // Isolation: caller_isolation_inheriting
  // CHECK: sil @$s11WithFeature1SV22unspecifiedAsyncCalleryyxYalF : $@convention(method) @async <τ_0_0> (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @in_guaranteed τ_0_0, S) -> ()
  func test5b() async {
    let s = WithFeature.S()
  ...
  // CHECK: // Isolation: caller_isolation_inheriting
  // CHECK: sil @$s11WithFeature1SV16nonisolatedAsyncyyxYalF : $@convention(method) @async <τ_0_0> (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @in_guaranteed τ_0_0, S) -> ()
  func test6() async {
    let s = WithFeature.S()
  ...
  // CHECK: // Isolation: caller_isolation_inheriting
  // CHECK: sil @$s11WithFeature1SV22nonisolatedAsyncCalleryyxYalF : $@convention(method) @async <τ_0_0> (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @in_guaranteed τ_0_0, S) -> ()
  func test6b() async {
    let s = WithFeature.S()
  ...
  // CHECK-LABEL: // S.unspecifiedAsyncCaller<A>(_:)
  // CHECK: // Isolation: caller_isolation_inheriting
  // CHECK: sil @$s14WithoutFeature1SV22unspecifiedAsyncCalleryyxYalF : $@convention(method) @async <τ_0_0> (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @in_guaranteed τ_0_0, S) -> ()
  func test7b() async {
    let s = WithoutFeature.S()
    await s.unspecifiedAsyncCaller(ns)
  }
  ...
  // CHECK-LABEL: // S.nonisolatedAsyncCaller<A>(_:)
  // CHECK: // Isolation: caller_isolation_inheriting
  // CHECK: sil @$s14WithoutFeature1SV22nonisolatedAsyncCalleryyxYalF : $@convention(method) @async <τ_0_0> (@sil_isolated @sil_implicit_leading_param @guaranteed Builtin.ImplicitIsolationActor, @in_guaranteed τ_0_0, S) -> ()
  func test8b() async {
    let s = WithoutFeature.S()
    await s.nonisolatedAsyncCaller(ns)
  }
