...
// CHECK-DAG: sil [global_init] @_TF11global_inita7MyConstSi : $@thin () -> Builtin.RawPointer
// CHECK-DAG: sil [global_init] @_TF11global_inita5MyVarSi : $@thin () -> Builtin.RawPointer
