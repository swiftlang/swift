...
// CHECK-DAG: sil [global_init] @_TF11global_initau7MyConstSi : $@convention(thin) () -> Builtin.RawPointer {
// CHECK-DAG: sil [global_init] @_TF11global_initau5MyVarSi : $@convention(thin) () -> Builtin.RawPointer {
