...
// SIL-LABEL: sil public_external [noinline] @_TFV12def_noinline18NoInlineInitStructCfT1xSb_S0_ : $@convention(thin) (Bool, @thin NoInlineInitStruct.Type) -> NoInlineInitStruct {
