...
// expected-note @-1 {{overloads for 'Int32' exist with these partially matching parameter lists: (), (Int32), (_bits: Int32), (bigEndian: Int32), (littleEndian: Int32), (_builtinIntegerLiteral: Int2048), (integerLiteral: Int32), (UInt8), (Int8), (UInt16), (Int16), (UInt32), (UInt64), (truncatingBitPattern: UInt64), (Int64), (truncatingBitPattern: Int64), (UInt), (truncatingBitPattern: UInt), (Int), (truncatingBitPattern: Int), (bitPattern: UInt32), (Float), (Double), (Float80), (String, radix: Int)}}