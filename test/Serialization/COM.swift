...
// CHECK-DAG: <COM_DECL_ATTR abbrevid=293 op0=0 op1=1 op2=0/> blob data = '00000000-0000-0000-C000-000000000046'

@com(implementation: "00000000-0000-0000-0000-000000000001")
public class CClass1 { }
// CHECK-DAG: <COM_DECL_ATTR abbrevid=293 op0=0 op1=0 op2=2/> blob data = '00000000-0000-0000-0000-000000000001'

@com(implementation: "00000000-0000-0000-0000-000000000002", threading: .free)
public class CClass2 { }
// CHECK-DAG: <COM_DECL_ATTR abbrevid=293 op0=0 op1=0 op2=3/> blob data = '00000000-0000-0000-0000-000000000002'

@com
public class CClass3 { }
// CHECK-DAG: <COM_DECL_ATTR abbrevid=293 op0=0 op1=0 op2=2/> blob data = ''
