...
// SIL:   [[MAKE_PAIR:%.+]] = function_ref @_TF8def_func8makePairU___FT1aQ_1bQ0__TQ_Q0__ : $@convention(thin) <τ_0_0, τ_0_1> (@out (τ_0_0, τ_0_1), @in τ_0_0, @in τ_0_1) -> ()
// SIL:   {{%.+}} = apply [[MAKE_PAIR]]<Int, Double>({{%.+}}, {{%.+}})

var pair : (Int, Double) = makePair(a: 1, b: 2.5)

// SIL:   [[DIFFERENT_A:%.+]] = function_ref @_TF8def_func9differentUSs9Equatable__FT1aQ_1bQ__Sb : $@convention(thin) <τ_0_0 where τ_0_0 : Equatable> (@in τ_0_0, @in τ_0_0) -> Bool
// SIL:   [[DIFFERENT_B:%.+]] = function_ref @_TF8def_func9differentUSs9Equatable__FT1aQ_1bQ__Sb : $@convention(thin) <τ_0_0 where τ_0_0 : Equatable> (@in τ_0_0, @in τ_0_0) -> Bool

different(a: 1, b: 2)
different(a: false, b: false)

// SIL:   [[DIFFERENT2_A:%.+]] = function_ref @_TF8def_func10different2USs9Equatable__FT1aQ_1bQ__Sb : $@convention(thin) <τ_0_0 where τ_0_0 : Equatable> (@in τ_0_0, @in τ_0_0) -> Bool
// SIL:   [[DIFFERENT2_B:%.+]] = function_ref @_TF8def_func10different2USs9Equatable__FT1aQ_1bQ__Sb : $@convention(thin) <τ_0_0 where τ_0_0 : Equatable> (@in τ_0_0, @in τ_0_0) -> Bool
different2(a: 1, b: 2)
...
// SIL:   [[DIFFERENT_WRAPPED:%.+]] = function_ref @_TF8def_func16differentWrappedUS_7Wrapped_S0__USs9Equatable__FT1aQ_1bQ0__Sb : $@convention(thin) <τ_0_0, τ_0_1 where τ_0_0 : Wrapped, τ_0_1 : Wrapped, τ_0_0.Value : Equatable, τ_0_0.Value == τ_0_1.Value> (@in τ_0_0, @in τ_0_1) -> Bool
...
// SIL: {{%.+}} = function_ref @_TF8def_func20testNoReturnAttrPolyU__FT1xQ__T_ : $@convention(thin) @noreturn <τ_0_0> (@in τ_0_0) -> ()


// SIL: sil @_TF8def_func16testNoReturnAttrFT_T_ : $@convention(thin) @noreturn () -> ()
// SIL: sil @_TF8def_func20testNoReturnAttrPolyU__FT1xQ__T_ : $@convention(thin) @noreturn <τ_0_0> (@in τ_0_0) -> ()
