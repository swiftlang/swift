...
// RUN: %target-swift-frontend -emit-module -O -module-name Swift -module-link-name swiftCore -parse-as-library -parse-stdlib -emit-module -sil-serialize-early -sil-serialize-witness-tables -sil-serialize-vtables %s -o %t/Swift.swiftmodule
