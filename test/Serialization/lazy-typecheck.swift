...
// RUN: %target-swift-frontend -package-name Package -typecheck -verify -verify-ignore-unrelated %S/../Inputs/lazy_typecheck_client.swift -DFLAG -I %t/baseline
...
// RUN: %target-swift-frontend -package-name Package -typecheck -verify -verify-ignore-unrelated %S/../Inputs/lazy_typecheck_client.swift -DFLAG -I %t/lazy-skip-all
...
// RUN: %target-swift-frontend -package-name Package -typecheck -verify -verify-ignore-unrelated %S/../Inputs/lazy_typecheck_client.swift -DFLAG -I %t/lazy-skip-all-non-resilient
...
// RUN: %target-swift-frontend -package-name Package -typecheck -verify -verify-ignore-unrelated %S/../Inputs/lazy_typecheck_client.swift -DFLAG -I %t/lazy-skip-non-inlinable
