...
// FORCE-LOAD: define{{( dllexport| linkonce_odr)?}} void @"_swift_FORCE_LOAD_$_module"() {{(comdat )?}}{
// FORCE-LOAD:   ret void
// FORCE-LOAD: }
// FORCE-LOAD-HEX: define{{( dllexport| linkonce_odr)?}} void @"_swift_FORCE_LOAD_$306d6f64756c65"() {{(comdat )?}}{
