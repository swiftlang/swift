...
// --- Public struct with private stored property of internal bridging header type -- should emit a record
...
// PUBLIC-STRUCT-INTERNAL-BRIDGING-HEADER-FIELD: HIDDEN_TRIVIAL_CLANG_RECORD_TYPE

// --- Public struct with private stored property of regular bridging header type -- should not emit a record
...
// PUBLIC-STRUCT-REGULAR-BRIDGING-HEADER-FIELD-NOT: HIDDEN_TRIVIAL_CLANG_RECORD_TYPE

// --- Transitive leak through a same-module struct with internal bridging header storage -- should emit
...
// TRANSITIVE-INTERNAL-BRIDGING-HEADER-FIELD: HIDDEN_TRIVIAL_CLANG_RECORD_TYPE
