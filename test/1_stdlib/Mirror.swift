...
func find(substring: String, within domain: String) -> String.Index? {
  let domainCount = domain.characters.length
  let substringCount = substring.characters.length
...
mirrors.test("Legacy") {
  ...
  do {
    ...
    expectEqual(1, md.children.length)
...
mirrors.test("Class/Root/Uncustomized") {
  ...
  expectEqual(1, a.children.length)
...
mirrors.test("Class/Root/superclass:.Generated") {
  ...
  expectEqual(1, b.children.length)
...
mirrors.test("class/Root/superclass:<default>") {
  ...
  expectEqual(1, c.children.length)
...
mirrors.test("class/CustomizedSuper/SuperclassCustomMirror/Indirect") {
  ...
  if let y = expectNotEmpty(b.superclassMirror()) {
    ...
    if let x = expectNotEmpty(y.superclassMirror()) {
      ...
      expectEqual(0, x.children.length)
...
mirrors.test("ObjC") {
  ...
  expectEqual(0, Mirror(reflecting: HasIVars()).children.length)
}
