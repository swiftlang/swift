...
func debugPrintedIs<T>(
  ...
  var actual = ""
  _prext_debugPrint(object, terminator: "", toStream: &actual)
...
func test_StdlibTypesPrinted() {
  ...
  _prext_print("test_StdlibTypesPrinted done")
}
...
func test_IntegerPrinting() {
  ...
  _prext_print("test_IntegerPrinting done")
}
...
func test_FloatingPointPrinting() {
  ...
  _prext_print("test_FloatingPointPrinting done")
}
...
func test_BoolPrinting() {
  ...
  _prext_print("test_BoolPrinting done")
}
test_BoolPrinting()
...
func test_CTypesPrinting() {
  ...
  _prext_print("test_CTypesPrinting done")
}
test_CTypesPrinting()
...
func test_PointerPrinting() {
  ...
  _prext_print("test_PointerPrinting done")
}
...
func test_ObjectPrinting() {
  ...
  _prext_print("test_ObjectPrinting done")
}
test_ObjectPrinting()
...
func test_gcMetatypePrinting() {
  ...
  _prext_print("test_gcMetatypePrinting done")
}
...
func test_ArrayPrinting() {
  ...
  _prext_print("test_ArrayPrinting done")
}
test_ArrayPrinting()
...
func test_DictionaryPrinting() {
  ...
  _prext_print("test_DictionaryPrinting done")
}
...
func test_SetPrinting() {
  ...
  _prext_print("test_SetPrinting done")
}
test_SetPrinting()
...
func test_TuplePrinting() {
  ...
  _prext_print("test_TuplePrinting done")
}
test_TuplePrinting()
...
func test_ArbitraryStructPrinting() {
  ...
  _prext_print("test_ArbitraryStructPrinting done")
}
...
func test_MetatypePrinting() {
  ...
  _prext_print("test_MetatypePrinting done")
}
...
func test_StringInterpolation() {
  ...
  _prext_print("test_StringInterpolation done")
}
...
func test_CustomStringInterpolation() {
  ...
  _prext_print("test_CustomStringInterpolation done")
}
...
// CHECK: {{^}}µ{{$}}
  ...
  _prext_print("test_StdoutUTF8Printing done")
}
...
func test_varargs() {
  ...
  _prext_print((output == "|1|2|3|4|\n") as Bool) // CHECK-NEXT: true
  output = ""
  _prext_debugPrint(
...
func test_playgroundPrintHook() {
  ...
  var explicitStream = ""
  printed = nil
  _prext_print("", 1, 2, 3, 4, "", separator: "!", toStream: &explicitStream)
