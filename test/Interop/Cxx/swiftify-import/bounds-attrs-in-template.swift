...
template <class T>
inline const T* __counted_by(size) cb_template(const T* __counted_by(size) p __noescape, long size) { return p; }
...
func testOriginalCB(p: UnsafePointer<CInt>, len: Int) {
