...
// CHECK: call swiftcc void @"$s4main11modifyInoutyys5Int32VzF"(ptr noalias align 4 captures(none) dereferenceable(4) @{{_ZN22WithInlineStaticMember12staticMemberE|"\?staticMember@WithInlineStaticMember@@2HA"}})
