// RUN: %target-run-simple-swift(-I %S/Inputs/ -Xfrontend -enable-experimental-cxx-interop -Onone) | %FileCheck %s
// RUN: %target-run-simple-swift(-I %S/Inputs/ -Xfrontend -enable-experimental-cxx-interop -O) | %FileCheck -check-prefix=CHECK-OPT %s
//
...
// CHECK-OPT-NEXT: MoveOnly 1 move-created
// CHECK-NEXT: MoveOnly 0 destroyed
// CHECK-OPT-NEXT: MoveOnly 0 destroyed
// CHECK-NEXT: MoveOnly 1 destroyed
// CHECK-OPT-NEXT: MoveOnly 1 destroyed
    let x2 = MoveOnly()
// CHECK-NEXT: MoveOnly 0 created
// CHECK-OPT-NEXT: MoveOnly 0 created
    consume(x2)
// CHECK-NEXT: MoveOnly 1 move-created
// CHECK-NEXT: MoveOnly 0 destroyed
// CHECK-OPT-NEXT: MoveOnly 0 destroyed
...
// CHECK-OPT-NEXT: Copyable 0 created
    byRValueRef(consuming: x3)
// CHECK-NEXT: Copyable 1 copy-created
// CHECK-OPT-NEXT: Copyable 1 copy-created
// CHECK-NEXT: Copyable 1 destroyed
// CHECK-OPT-NEXT: Copyable 1 destroyed
    let x4 = Copyable()
// CHECK-NEXT: Copyable 0 created
// CHECK-OPT-NEXT: Copyable 0 created
    consume(x4)
...
// CHECK-OPT-NEXT: Copyable 0 destroyed
// CHECK-NEXT: Copyable 0 destroyed
// CHECK-OPT-NEXT: Copyable 0 destroyed
}
