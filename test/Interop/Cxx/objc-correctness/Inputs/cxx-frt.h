...
+ (struct CxxRefType *)objCMethodReturningFRTUnannotated; // expected-warning {{ 'objCMethodReturningFRTUnannotated()' should be annotated with either SWIFT_RETURNS_RETAINED or SWIFT_RETURNS_UNRETAINED as it returns a SWIFT_SHARED_REFERENCE}}
