...
int Outer::voidNoArgsFlag = 0;

int main() {
  printf("add=%d\n", Outer::add(20, 22));
  // CHECK: add=42

  printf("voidNoArgsFlag=%d\n", Outer::voidNoArgsFlag);
  // CHECK: voidNoArgsFlag=0

  Outer::voidNoArgs();

  printf("voidNoArgsFlag=%d\n", Outer::voidNoArgsFlag);
  // CHECK: voidNoArgsFlag=42
  ...
  printf("callsSwiftHelper=%d\n", Outer::callsSwiftHelper(4));
  // CHECK: callsSwiftHelper=47

  printf("nestedCallsSwiftHelper=%d\n", Outer::Inner::nestedCallsSwiftHelper(-42));
  // CHECK: nestedCallsSwiftHelper=42
