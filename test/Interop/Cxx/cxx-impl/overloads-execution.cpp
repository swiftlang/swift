...
int main() {
  ...
  printf("overloadedByType(Point)=%d\n", overloadedByType(Point{100, 42}));
  // CHECK: overloadedByType(Point)=142
  ...
  printf("overloadedByArityAndType(Point,int)=%d\n",
         overloadedByArityAndType(Point{2, 40}, 67));
  // CHECK: overloadedByArityAndType(Point,int)=2814

  printf("overloadedByEnumType(int)=%d\n", overloadedByEnumType(1));
  // CHECK: overloadedByEnumType(int)=1
  printf("overloadedByEnumType(unsigned)=%d\n", overloadedByEnumType(2u));
  // CHECK: overloadedByEnumType(unsigned)=12
  printf("overloadedByEnumType(EnumFoo)=%d\n", overloadedByEnumType(FooA));
  // CHECK: overloadedByEnumType(EnumFoo)=20
  printf("overloadedByEnumType(EnumBar)=%d\n", overloadedByEnumType(EnumBar::BarB));
  // CHECK: overloadedByEnumType(EnumBar)=31
