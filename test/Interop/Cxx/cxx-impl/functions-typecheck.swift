...
// expected-error@+2{{global function 'refParam' cannot implement C++ function 'refParam' because reference parameters and return types are not yet supported}}
@cxx @implementation
func refParam(_: inout Int32) -> Int32 {
  return 0
}

// expected-error@+2{{global function 'constRefParam' cannot implement C++ function 'constRefParam' because reference parameters and return types are not yet supported}}
@cxx @implementation
func constRefParam(_: Int32) -> Int32 {
  return 0
}

// expected-error@+2{{global function 'refReturn()' cannot implement C++ function 'refReturn' because reference parameters and return types are not yet supported}}
@cxx @implementation
func refReturn() -> UnsafeMutablePointer<Int32> {
  fatalError()
}
