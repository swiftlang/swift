...
extension Shape {
  ...
  // expected-error@+2{{instance method 'keyFunction()' cannot implement C++ method 'keyFunction' because it is the first non-inline virtual method of C++ class 'Shape'}}
  @cxx @implementation
...
extension CloneDerived {
  // expected-error@+2{{instance method 'clone()' cannot implement C++ method 'clone' because it overrides a virtual method and changes its return type}}
  @cxx @implementation
...
extension MIDerived {
  // expected-error@+2{{instance method 'firstA()' cannot implement C++ method 'firstA' because it overrides a virtual method in a class hierarchy that uses multiple inheritance}}
  @cxx @implementation
  public func firstA() {}

  // expected-error@+2{{instance method 'fromB()' cannot implement C++ method 'fromB' because it overrides a virtual method in a class hierarchy that uses multiple inheritance}}
  @cxx @implementation
...
extension VDerived {
  // expected-error@+2{{instance method 'vbMethod()' cannot implement C++ method 'vbMethod' because it overrides a virtual method in a class hierarchy that has a virtual base}}
  @cxx @implementation
...
extension Engine {
  ...
  // expected-error@+2{{instance method 'keyAnchor()' cannot implement C++ method 'keyAnchor' because it is the first non-inline virtual method of C++ class 'Engine'}}
  @cxx @implementation
