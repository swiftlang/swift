...
struct Shape {
  ...
  // expected-note@+1{{declare a non-inline virtual method before 'keyFunction' to make that method the key function instead}}
...
__attribute__((swift_attr("release:releaseEngine"))) Engine {
  ...
  // The key function; its body stays in C++ (the execution test's main file).
  // expected-note@+1{{declare a non-inline virtual method before 'keyAnchor' to make that method the key function instead}}
