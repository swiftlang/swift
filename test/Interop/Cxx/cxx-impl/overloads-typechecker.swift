...
@cxx @implementation
func overloadedByType(_ p: Point) -> Int32 { return p.x + p.y }
...
@cxx @implementation
func overloadedByArityAndType(_ p: Point, _ z: Int32) -> Int32 { return (p.x + p.y) * z }

@cxx @implementation
func overloadedByEnumType(_ x: Int32) -> Int32 { return x }

@cxx @implementation
func overloadedByEnumType(_ x: UInt32) -> Int32 { return Int32(x) + 10 }

@cxx @implementation
func overloadedByEnumType(_ x: EnumFoo) -> Int32 { return Int32(x.rawValue) + 20 }

@cxx @implementation
func overloadedByEnumType(_ x: EnumBar) -> Int32 { return x.rawValue + 30 }
