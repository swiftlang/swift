// RUN: %target-swift-ide-test -print-module -module-to-print=CustomIterable -source-filename=x -I %S/Inputs -cxx-interoperability-mode=default -module-cache-path %t -I %swift_src_root/lib/ClangImporter/SwiftBridging -enable-experimental-feature BorrowingSequence | %FileCheck %s
