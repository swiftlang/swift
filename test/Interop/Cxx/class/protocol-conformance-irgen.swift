...
// CHECK: define {{.*}}i32 @"$sSo18ConformsToProtocolV4main11HasReturn42A2cDP8return42s5Int32VyFTW"(ptr noalias swiftself align 1 captures(none) dereferenceable(1) %{{.*}}, ptr %{{.*}}, ptr %{{.*}})
