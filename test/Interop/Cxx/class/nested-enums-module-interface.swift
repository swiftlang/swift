...
// CHECK:      struct Struct {
// CHECK-NEXT:   init()
// CHECK-NEXT:   enum Scoped : [[SCOPED_RAW_T:CInt|CUnsignedInt]] {
...
// CHECK-NEXT:     init(_ rawValue: [[UNSCOPED_RAW_T:CInt|CUnsignedInt]])
...
// CHECK-NEXT:   static var A1: [[ANON_RAW_T:Int|CInt|CUnsignedInt]] { get }
// CHECK-NEXT:   static var A2: [[ANON_RAW_T]] { get }
// CHECK-NEXT:   static var A3: [[ANON_RAW_T]] { get }
// CHECK-NEXT: }

// CHECK:      enum Namespace {
// CHECK-NEXT:   enum Scoped : [[NS_SCOPED_RAW_T:CInt|CUnsignedInt]] {
...
// CHECK-NEXT:   }
// CHECK-NEXT:   struct Unscoped : Hashable, Equatable, RawRepresentable {
// CHECK-NEXT:     init(_ rawValue: [[NS_UNSCOPED_RAW_T:CInt|CUnsignedInt]])
...
// CHECK-NEXT:   static var A1: [[NS_ANON_RAW_T:Int|CInt|CUnsignedInt]] { get }
