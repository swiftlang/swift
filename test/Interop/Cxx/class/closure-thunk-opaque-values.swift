...
// CHECK: sil shared [transparent] [serialized] [reabstraction_thunk] [ossa] [opaque] @$sSo7ARCWeakVIetCi_ABIegn_TR : $@convention(thin) (@in_guaranteed ARCWeak, @convention(c) (@in ARCWeak) -> ()) -> () {
