...
template<typename T>
struct HasNonEscapableAnonUnion {
    union SWIFT_NONESCAPABLE {
        int known;
        T unknown;
    };
};
...
using HasNonEscapableAnonUnionNonEscapable = HasNonEscapableAnonUnion<NonEscapable>;
...
public func anonymousUnions() {
    ...
    _ = HasNonEscapableAnonUnionNonEscapable()
    // CHECK: error: cannot find 'HasNonEscapableAnonUnionNonEscapable' in scope
    // CHECK-NO-LIFETIMES: error: cannot find 'HasNonEscapableAnonUnionNonEscapable' in scope
    _ = NonEscapableHasAnonUnionNonEscapable()
    // CHECK: error: cannot find 'NonEscapableHasAnonUnionNonEscapable' in scope
    // CHECK-NO-LIFETIMES: error: cannot find 'NonEscapableHasAnonUnionNonEscapable' in scope
    _ = NonEscapableOptional()
    #if os(macosx)
    // CHECK: error: cannot infer the lifetime dependence scope on an initializer with a ~Escapable parameter, specify '@_lifetime(borrow __v)' or '@_lifetime(copy __v)'
