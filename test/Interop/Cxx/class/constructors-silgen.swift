...
// CHECK: [[FUNC:%[0-9]+]] = function_ref @$sSo20ConstructorWithParamVyABs5Int32VcfCTo : $@convention(c) (Int32) -> @out ConstructorWithParam
...
// CHECK: [[FN:%.*]] = function_ref @$sSo11EmptyStructVABycfCTo : $@convention(c) () -> @out EmptyStruct
...
// CHECK: [[FN:%.*]] = function_ref @$sSo10IntWrapperVABycfCTo : $@convention(c) () -> @out IntWrapper
...
// CHECK: [[FN:%.*]] = function_ref @$sSo20TemplatedConstructorVyABSo7ArgTypeVcfCTo : $@convention(c) (ArgType) -> @out TemplatedConstructor
