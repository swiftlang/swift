// RUN: %target-run-simple-swift(-I %S/Inputs/ -Xfrontend -cxx-interoperability-mode=default -enable-experimental-feature SuppressCXXForeignReferenceTypeInitializers -Xfrontend -disable-availability-checking)
//
