...
// CHECK: [[CREATE_FN:%.*]] = function_ref @_ZN8MoveOnly6createEv : $@convention(c) () -> MoveOnly
...
// CHECK: [[TEST_FN:%.*]] = function_ref @_ZNK8MoveOnly4testEv : $@convention(c) (@in_guaranteed MoveOnly) -> Int32
...
// CHECK-LABEL: sil [clang MoveOnly.create] @_ZN8MoveOnly6createEv : $@convention(c) () -> MoveOnly

// CHECK-LABEL: sil [clang MoveOnly.test] @_ZNK8MoveOnly4testEv : $@convention(c) (@in_guaranteed MoveOnly) -> Int32
