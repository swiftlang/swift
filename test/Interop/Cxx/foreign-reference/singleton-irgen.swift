...
// CHECK: [[CREATED:%.*]] = call %struct.DeletedSpecialMembers* @_ZN21DeletedSpecialMembers6createEv()
...
// CHECK: call i32 @_ZNK21DeletedSpecialMembers4testEv(%struct.DeletedSpecialMembers* [[CLANG_CREATED]])

// CHECK: [[FROM:%.*]] = bitcast %TSo21DeletedSpecialMembersV* [[SWIFT_CREATED]] to %struct.DeletedSpecialMembers*
// CHECK: call void @_Z8mutateItR21DeletedSpecialMembers(%struct.DeletedSpecialMembers* [[FROM]])
