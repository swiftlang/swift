// RUN: %target-typecheck-verify-swift -cxx-interoperability-mode=default -I %S%{fs-sep}Inputs -verify-additional-file %S%{fs-sep}Inputs%{fs-sep}refcounted-smartptrs.h
