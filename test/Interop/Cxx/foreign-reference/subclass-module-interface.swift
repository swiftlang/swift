...
// CHECK: public class PrivateDtorShared {

// CHECK: open class ProtectedDtorShared {

// CHECK: public class DeletedDtorShared {
...
// CHECK-OFF: public class PrivateDtorShared {
// CHECK-OFF: public class ProtectedDtorShared {
// CHECK-OFF: public class DeletedDtorShared {
