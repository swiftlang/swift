...
// CHECK: warning: 'StaticMethodReturningCxxFrt' is not imported in a later version of Swift because it is returning a 'SWIFT_SHARED_REFERENCE' type but it is not annotated with either 'SWIFT_RETURNS_RETAINED' or 'SWIFT_RETURNS_UNRETAINED'
...
// CHECK: warning: 'global_function_returning_cxx_frt' is not imported in a later version of Swift because it is returning a 'SWIFT_SHARED_REFERENCE' type but it is not annotated with either 'SWIFT_RETURNS_RETAINED' or 'SWIFT_RETURNS_UNRETAINED'
