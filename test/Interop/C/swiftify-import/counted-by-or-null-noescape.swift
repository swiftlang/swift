...
// Check that ClangImporter correctly infers and expands @_SwiftifyImport macros for functions with __counted_by_or_null __noescape parameters.
...
//   expected-remark@11{{macro content: |}|}}
// }}
void nonnull(int len, int * __counted_by_or_null(len) _Nonnull __noescape p);
...
//   expected-remark@11{{macro content: |}|}}
// }}
void nullable(int len, int * __counted_by_or_null(len) _Nullable p __noescape);
...
// }}
int * __counted_by_or_null(len) __noescape returnPointer(int len);
...
//   expected-remark@11{{macro content: |}|}}
// }}
void anonymous(int len, int * __counted_by_or_null(len) _Nullable __noescape);

void keyword(int len, int * __counted_by_or_null(len) _Nullable func __noescape,
    int extension,
    int init,
    int open,
    int var,
...
//   expected-remark@11{{macro content: |}|}}
// }}
void func(int len, int * __counted_by_or_null(len) _Nullable func __noescape);

void *funcRenameKeyword(int len, int * __counted_by_or_null(len) _Nullable func __noescape,
    int extension,
    int init,
    int open,
    int var,
...
void *funcRenameKeywordAnonymous(int len, int * __counted_by_or_null(len) _Nullable __noescape,
    int,
    int,
    int,
    int,
...
//   expected-remark@11{{macro content: |}|}}
// }}
void funcRenameClash(int len, int * __counted_by_or_null(len) _Nullable func __noescape, int where)
...
//   expected-remark@11{{macro content: |}|}}
// }}
void funcRenameClashKeyword(int len, int * __counted_by_or_null(len) _Nullable func __noescape, int where)
...
//   expected-remark@11{{macro content: |}|}}
// }}
void funcRenameClashAnonymous(int len, int * __counted_by_or_null(len) _Nullable func __noescape, int)
...
//   expected-remark@11{{macro content: |}|}}
// }}
void funcRenameClashKeywordAnonymous(int len, int * __counted_by_or_null(len) _Nullable func __noescape, int)
