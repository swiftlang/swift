...
// Check that ClangImporter correctly infers and expands @_SwiftifyImport macros for functions with __sized_by_or_null __noescape parameters.
...
// expected-warning@+14{{combining '__sized_by_or_null' and '_Nonnull'; did you mean '__sized_by' instead?}}
...
//   expected-remark@11{{macro content: |}|}}
// }}
void nonnull(int len, const void * __sized_by_or_null(len) __noescape _Nonnull p);

// expected-expansion@+13:83{{
//   expected-remark@1{{macro content: |/// This is an auto-generated wrapper for safer interop|}}
...
// }}
const void * __sized_by_or_null(len) __noescape _Nonnull returnPointer(int len);
...
void doublebytesized(uint16_t *__sized_by_or_null(size) __noescape, int size);
