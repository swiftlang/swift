...
// RUN: %target-swift-frontend -emit-module -plugin-path %swift-plugin-dir -I %t -enable-experimental-feature SafeInteropWrappersNullAsEmptySpan -strict-memory-safety -Xcc -Wno-nullability-completeness \
...
//   expected-remark@1{{macro content: |/// This is an auto-generated wrapper for safer interop|}}
//   expected-remark@2{{macro content: |@_alwaysEmitIntoClient @inline(always) @_disfavoredOverload public func nonnullTyped(_ p: UnsafeMutableRawBufferPointer) {|}}
//   expected-remark@3{{macro content: |    let len = CInt(exactly: p.count)!|}}
...
//   expected-remark@1{{macro content: |/// This is an auto-generated wrapper for safer interop|}}
//   expected-remark@2{{macro content: |@_alwaysEmitIntoClient @inline(always) @_disfavoredOverload public func nullableTyped(_ p: UnsafeMutableRawBufferPointer) {|}}
//   expected-remark@3{{macro content: |    let len = CInt(exactly: p.count)!|}}
...
// GENERATED-HASH: c564dc1732b23f3bb73bd71881f83cae2ee9ef054178ffb4e04c4964e5f2bbc1
import Test
...
@_alwaysEmitIntoClient @inline(always) @_disfavoredOverload public func call_nonnullTyped(_ p: UnsafeMutableRawBufferPointer) {
...
@_alwaysEmitIntoClient @inline(always) @_disfavoredOverload public func call_nullableTyped(_ p: UnsafeMutableRawBufferPointer) {
