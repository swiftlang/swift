...
// Check that ClangImporter correctly infers and expands @_SwiftifyImport macros for functions with __sized_by_or_null __lifetimebound parameters and return values.
...
const uint16_t *__sized_by_or_null(size)  doublebytesized(uint16_t * p __sized_by_or_null(size) __lifetimebound, int size);
...
// GENERATED-HASH: 015177a8db1e9d0046e3da97e04643ff8e435f4f7101cbfcf48006ca167fafa9
import Test
