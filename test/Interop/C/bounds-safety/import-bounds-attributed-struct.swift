...
// RUN: %target-swift-frontend -Xcc -fexperimental-bounds-safety-attributes -emit-module -plugin-path %swift-plugin-dir -I %S/Inputs %s -cxx-interoperability-mode=default -verify -verify-additional-file %S/Inputs/bounds-attributed-struct.h -D VERIFY
