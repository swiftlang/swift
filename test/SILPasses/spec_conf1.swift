...
//CHECK: sil shared @_TTSgC10spec_conf13FooS0_S_1PS____TF10spec_conf114outer_functionUS_1P__FT2InQ__T_
//CHECK: function_ref @_TTSgC10spec_conf13FooS0_S_1PS____TF10spec_conf114inner_functionUS_1P__FT2InQ__T_
//CHECK-NEXT: retain
//CHECK-NEXT: apply
//CHECK: return
