...
sil @_TFC4main3Food : $@cc(method) @thin (@owned Foo) -> @owned Builtin.NativeObject {
bb0(%0 : $Foo):
...
sil @_TFC4main3FooD : $@cc(method) @thin (@owned Foo) -> () {
bb0(%0 : $Foo):
  debug_value %0 : $Foo  // let self              // id: %1
  // function_ref main.Foo.deinit
  %2 = function_ref @_TFC4main3Food : $@cc(method) @thin (@owned Foo) -> @owned Builtin.NativeObject // user: %3
  %3 = apply %2(%0) : $@cc(method) @thin (@owned Foo) -> @owned Builtin.NativeObject // user: %4
...
bb0(%0 : $@thick Foo.Type):
  ...
  %2 = function_ref @_TFC4main3FoocfMS0_FT_S0_ : $@cc(method) @thin (@owned Foo) -> @owned Foo // user: %3
  %3 = apply %2(%1) : $@cc(method) @thin (@owned Foo) -> @owned Foo // user: %4
  return %3 : $Foo                                // id: %4
}
...
bb0:
  ...
  %2 = apply %0(%1) : $@thin (@thick Foo.Type) -> @owned Foo // user: %3
  return %2 : $Foo                                // id: %3
}
