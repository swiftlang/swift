// RUN: %swift -disable-func-sig-opts -O -sil-inline-threshold 1 -emit-sil -primary-file %s | FileCheck %s
...
//CHECK: function_ref @_TTSg5Si___TF21specialize_apply_conf9main_funcU__FT2InQ__T_
//CHECK-NEXT: apply
//CHECK: return
func interesting() {
  main_func(In: 3)
