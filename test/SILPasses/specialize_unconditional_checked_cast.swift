...
// CHECK-LABEL: sil shared @_TTSg5C37specialize_unconditional_checked_cast1C_S0____TF37specialize_unconditional_checked_cast20ArchetypeToArchetypeU___FT1tQ_2t2Q0__Q0_ : $@thin (@out C, @in C, @in C) -> () {
// CHECK-NOT: unconditional_checked_cast archetype_to_archetype
ArchetypeToArchetype(t: c, t2: c)

// x -> x where x is not a class.
// CHECK-LABEL: sil shared @_TTSg5VSs5UInt8_S____TF37specialize_unconditional_checked_cast20ArchetypeToArchetypeU___FT1tQ_2t2Q0__Q0_ : $@thin (@out UInt8, @in UInt8, @in UInt8) -> () {
// CHECK-NOT: unconditional_checked_cast archetype_to_archetype
ArchetypeToArchetype(t: b, t2: b)

// x -> y where x is not a class but y is.
// CHECK-LABEL: sil shared @_TTSg5VSs5UInt8_C37specialize_unconditional_checked_cast1C___TF37specialize_unconditional_checked_cast20ArchetypeToArchetypeU___FT1tQ_2t2Q0__Q0_ : $@thin (@out C, @in UInt8, @in C) -> () {
...
// CHECK-LABEL: sil shared @_TTSg5C37specialize_unconditional_checked_cast1C_VSs5UInt8___TF37specialize_unconditional_checked_cast20ArchetypeToArchetypeU___FT1tQ_2t2Q0__Q0_ : $@thin (@out UInt8, @in C, @in UInt8) -> () {
// CHECK-NOT: unconditional_checked_cast archetype_to_archetype
// CHECK: builtin "int_trap"
// CHECK-NOT: unconditional_checked_cast archetype_to_archetype
...
// CHECK-LABEL: sil shared @_TTSg5C37specialize_unconditional_checked_cast1C_CS_1D___TF37specialize_unconditional_checked_cast20ArchetypeToArchetypeU___FT1tQ_2t2Q0__Q0_ : $@thin (@out D, @in C, @in D) -> () {
...
// CHECK-LABEL: sil shared @_TTSg5C37specialize_unconditional_checked_cast1D_CS_1C___TF37specialize_unconditional_checked_cast20ArchetypeToArchetypeU___FT1tQ_2t2Q0__Q0_ : $@thin (@out C, @in D, @in C) -> () {
// CHECK-NOT: unconditional_checked_cast archetype_to_archetype
...
// CHECK-LABEL: sil shared @_TTSg5C37specialize_unconditional_checked_cast1C_CS_1E___TF37specialize_unconditional_checked_cast20ArchetypeToArchetypeU___FT1tQ_2t2Q0__Q0_ : $@thin (@out E, @in C, @in E) -> () {
// CHECK-NOT: unconditional_checked_cast archetype_to_archetype
// CHECK: builtin "int_trap"
// CHECK-NOT: unconditional_checked_cast archetype_to_archetype
...
// CHECK-LABEL: sil shared @_TTSg5VSs5UInt8_VSs6UInt64___TF37specialize_unconditional_checked_cast20ArchetypeToArchetypeU___FT1tQ_2t2Q0__Q0_ : $@thin (@out UInt64, @in UInt8, @in UInt64) -> () {
// CHECK-NOT: unconditional_checked_cast archetype_to_archetype
// CHECK-NOT: unconditional_checked_cast archetype_to_archetype
// CHECK:      builtin "int_trap"
// CHECK-NOT: unconditional_checked_cast archetype_to_archetype
...
// x -> x where x is not a class.
// CHECK-LABEL: sil shared @_TTSg5VSs5UInt8___TF37specialize_unconditional_checked_cast31ArchetypeToConcreteConvertUInt8U__FT1tQ__VSs5UInt8 : $@thin (@in UInt8) -> UInt8 {
// CHECK: bb0
// CHECK-NEXT: load
// CHECK-NEXT: return
...
// x -> x where x is a class.
// CHECK-LABEL: sil shared @_TTSg5C37specialize_unconditional_checked_cast1C___TF37specialize_unconditional_checked_cast27ArchetypeToConcreteConvertCU__FT1tQ__CS_1C : $@thin (@in C) -> @owned C {
// CHECK: bb0
// CHECK-NEXT: load
// CHECK-NEXT: return
...
// CHECK-LABEL: sil shared @_TTSg5C37specialize_unconditional_checked_cast1D___TF37specialize_unconditional_checked_cast27ArchetypeToConcreteConvertCU__FT1tQ__CS_1C : $@thin (@in D) -> @owned C {
// CHECK: bb0
// CHECK-NEXT: load
// CHECK-NEXT: upcast
// CHECK-NEXT: return
...
// CHECK-LABEL: sil shared @_TTSg5C37specialize_unconditional_checked_cast1C___TF37specialize_unconditional_checked_cast27ArchetypeToConcreteConvertDU__FT1tQ__CS_1D : $@thin (@in C) -> @owned D {
// CHECK: bb0
...
// x -> x where x is not a class.
// CHECK-LABEL: sil shared @_TTSg5VSs5UInt8___TF37specialize_unconditional_checked_cast31ConcreteToArchetypeConvertUInt8U__FT1tVSs5UInt82t2Q__Q_ : $@thin (@out UInt8, UInt8, @in UInt8) -> () {
// CHECK: bb0
// CHECK-NEXT: store
// CHECK-NEXT: tuple
// CHECK-NEXT: return
...
// x -> x where x is a class.
// CHECK-LABEL: sil shared @_TTSg5C37specialize_unconditional_checked_cast1C___TF37specialize_unconditional_checked_cast27ConcreteToArchetypeConvertCU__FT1tCS_1C2t2Q__Q_ : $@thin (@out C, @owned C, @in C) -> () {
// CHECK: bb0
// CHECK-NEXT: store
// CHECK-NEXT: load
...
// x -> y where x is a super class of y.
// CHECK-LABEL: sil shared @_TTSg5C37specialize_unconditional_checked_cast1D___TF37specialize_unconditional_checked_cast27ConcreteToArchetypeConvertCU__FT1tCS_1C2t2Q__Q_ : $@thin (@out D, @owned C, @in D) -> () {
// CHECK: bb0
// CHECK-NEXT: alloc_stack
// CHECK-NEXT: store
...
// x -> y where x and y are unrelated classes.
// CHECK-LABEL: sil shared @_TTSg5C37specialize_unconditional_checked_cast1E___TF37specialize_unconditional_checked_cast27ConcreteToArchetypeConvertCU__FT1tCS_1C2t2Q__Q_ : $@thin (@out E, @owned C, @in E) -> () {
// CHECK: bb0
// CHECK-NEXT: strong_retain
// CHECK-NEXT: builtin "int_trap"
...
// CHECK-LABEL: sil shared @_TTSg5C37specialize_unconditional_checked_cast1C___TF37specialize_unconditional_checked_cast27ConcreteToArchetypeConvertDU__FT1tCS_1D2t2Q__Q_ : $@thin (@out C, @owned D, @in C) -> () {
// CHECK: bb0
// CHECK-NEXT: upcast
// CHECK-NEXT: store
// CHECK-NEXT: load
...
// x -> x where x is a class.
// CHECK-LABEL: sil shared @_TTSg5C37specialize_unconditional_checked_cast1C___TF37specialize_unconditional_checked_cast17SuperToArchetypeCU__FT1cCS_1C1tQ__Q_ : $@thin (@out C, @owned C, @in C) -> () {
// CHECK: bb0
// CHECK-NEXT: store
// CHECK-NEXT: load
// CHECK-NEXT: strong_release
...
// x -> y where x is a super class of y.
// CHECK-LABEL: sil shared @_TTSg5C37specialize_unconditional_checked_cast1D___TF37specialize_unconditional_checked_cast17SuperToArchetypeCU__FT1cCS_1C1tQ__Q_ : $@thin (@out D, @owned C, @in D) -> () {
// CHECK: bb0
...
// CHECK-LABEL: sil shared @_TTSg5C37specialize_unconditional_checked_cast1C___TF37specialize_unconditional_checked_cast17SuperToArchetypeDU__FT1dCS_1D1tQ__Q_ : $@thin (@out C, @owned D, @in C) -> () {
// CHECK-NOT: unconditional_checked_cast super_to_archetype
// CHECK: upcast
// CHECK-NOT: unconditional_checked_cast super_to_archetype
SuperToArchetypeD(d: d, t: c)

// CHECK-LABEL: sil shared @_TTSg5C37specialize_unconditional_checked_cast1D___TF37specialize_unconditional_checked_cast17SuperToArchetypeDU__FT1dCS_1D1tQ__Q_ : $@thin (@out D, @owned D, @in D) -> () {
// CHECK: bb0
// CHECK-NEXT: store
// CHECK-NEXT: load
// CHECK-NEXT: strong_release
...
// AnyObject -> Class.
// CHECK-LABEL: sil shared @_TTSg5C37specialize_unconditional_checked_cast1C___TF37specialize_unconditional_checked_cast22ExistentialToArchetypeU__FT1oPSs9AnyObject_1tQ__Q_ : $@thin (@out C, @owned AnyObject, @in C) -> () {
...
// AnyObject -> AnyObject
// CHECK-LABEL: sil shared @_TTSg5PSs9AnyObject____TF37specialize_unconditional_checked_cast22ExistentialToArchetypeU__FT1oPSs9AnyObject_1tQ__Q_ : $@thin (@out AnyObject, @owned AnyObject, @in AnyObject) -> () {
// CHECK: bb0
// CHECK-NEXT: store
// CHECK-NEXT: load
// CHECK-NEXT: strong_release
