...
// CHECK-LABEL: sil shared @_TTSC37specialize_unconditional_checked_cast1C_S0____TF37specialize_unconditional_checked_cast20ArchetypeToArchetypeU___FT1tQ_2t2Q0__Q0_ : $@thin (@out C, @in C, @in C) -> () {
// CHECK-NOT: unconditional_checked_cast archetype_to_archetype
ArchetypeToArchetype(t: c, t2: c)

// x -> x where x is not a class.
// CHECK-LABEL: sil shared @_TTSVSs5UInt8_S____TF37specialize_unconditional_checked_cast20ArchetypeToArchetypeU___FT1tQ_2t2Q0__Q0_ : $@thin (@out UInt8, @in UInt8, @in UInt8) -> () {
// CHECK-NOT: unconditional_checked_cast archetype_to_archetype
...
// CHECK-LABEL: sil shared @_TTSC37specialize_unconditional_checked_cast1C_VSs5UInt8___TF37specialize_unconditional_checked_cast20ArchetypeToArchetypeU___FT1tQ_2t2Q0__Q0_ : $@thin (@out UInt8, @in C, @in UInt8) -> () {
// CHECK-NOT: unconditional_checked_cast archetype_to_archetype
// CHECK: [[TRAP:%[0-9]+]] = builtin_function_ref "int_trap" : $@thin @noreturn @callee_owned () -> ()
// CHECK-NOT: unconditional_checked_cast archetype_to_archetype
// CHECK-NEXT: apply [[TRAP]]() : $@thin @noreturn @callee_owned () -> ()
...
// CHECK-LABEL: sil shared @_TTSC37specialize_unconditional_checked_cast1D_CS_1C___TF37specialize_unconditional_checked_cast20ArchetypeToArchetypeU___FT1tQ_2t2Q0__Q0_ : $@thin (@out C, @in D, @in C) -> () {
// CHECK-NOT: unconditional_checked_cast archetype_to_archetype
...
// CHECK-LABEL: sil shared @_TTSC37specialize_unconditional_checked_cast1C_CS_1E___TF37specialize_unconditional_checked_cast20ArchetypeToArchetypeU___FT1tQ_2t2Q0__Q0_ : $@thin (@out E, @in C, @in E) -> () {
// CHECK-NOT: unconditional_checked_cast archetype_to_archetype
// CHECK: [[TRAP:%[0-9]+]] = builtin_function_ref "int_trap" : $@thin @noreturn @callee_owned () -> ()
// CHECK-NOT: unconditional_checked_cast archetype_to_archetype
// CHECK-NEXT: apply [[TRAP]]() : $@thin @noreturn @callee_owned () -> ()
...
// CHECK-LABEL: sil shared @_TTSVSs5UInt8_VSs6UInt64___TF37specialize_unconditional_checked_cast20ArchetypeToArchetypeU___FT1tQ_2t2Q0__Q0_ : $@thin (@out UInt64, @in UInt8, @in UInt64) -> () {
// CHECK-NOT: unconditional_checked_cast archetype_to_archetype
// CHECK: [[TRAP:%[0-9]+]] = builtin_function_ref "int_trap" : $@thin @noreturn @callee_owned () -> ()
// CHECK-NOT: unconditional_checked_cast archetype_to_archetype
// CHECK-NEXT: apply [[TRAP]]() : $@thin @noreturn @callee_owned () -> ()
...
// x -> x where x is not a class.
// CHECK-LABEL: sil shared @_TTSVSs5UInt8___TF37specialize_unconditional_checked_cast31ArchetypeToConcreteConvertUInt8U__FT1tQ__VSs5UInt8 : $@thin (@in UInt8) -> UInt8 {
// CHECK: bb0
// CHECK-NEXT: load
// CHECK-NEXT: return
...
// CHECK-LABEL: sil shared @_TTSVSs6UInt64___TF37specialize_unconditional_checked_cast31ArchetypeToConcreteConvertUInt8U__FT1tQ__VSs5UInt8 : $@thin (@in UInt64) -> UInt8 {
// CHECK: bb0
// CHECK-NEXT: [[TRAP:%[0-9]+]] = builtin_function_ref "int_trap" : $@thin @noreturn @callee_owned () -> ()
// CHECK-NEXT: apply [[TRAP]]() : $@thin @noreturn @callee_owned () -> ()
...
// x -> x where x is a class.
// CHECK-LABEL: sil shared @_TTSC37specialize_unconditional_checked_cast1C___TF37specialize_unconditional_checked_cast27ArchetypeToConcreteConvertCU__FT1tQ__CS_1C : $@thin (@in C) -> @owned C {
// CHECK: bb0
// CHECK-NEXT: load
// CHECK-NEXT: return
...
// CHECK-LABEL: sil shared @_TTSVSs5UInt8___TF37specialize_unconditional_checked_cast27ArchetypeToConcreteConvertCU__FT1tQ__CS_1C : $@thin (@in UInt8) -> @owned C {
// CHECK: bb0
// CHECK-NEXT: [[TRAP:%[0-9]+]] = builtin_function_ref "int_trap" : $@thin @noreturn @callee_owned () -> ()
// CHECK-NEXT: apply [[TRAP]]() : $@thin @noreturn @callee_owned () -> ()
...
// CHECK-LABEL: sil shared @_TTSC37specialize_unconditional_checked_cast1D___TF37specialize_unconditional_checked_cast27ArchetypeToConcreteConvertCU__FT1tQ__CS_1C : $@thin (@in D) -> @owned C {
// CHECK: bb0
// CHECK-NEXT: load
// CHECK-NEXT: upcast
// CHECK-NEXT: return
...
// x -> x where x is not a class.
// CHECK-LABEL: sil shared @_TTSVSs5UInt8___TF37specialize_unconditional_checked_cast31ConcreteToArchetypeConvertUInt8U__FT1tVSs5UInt82t2Q__Q_ : $@thin (@out UInt8, UInt8, @in UInt8) -> () {
// CHECK: bb0
// CHECK-NEXT: store
// CHECK-NEXT: tuple
// CHECK-NEXT: return
...
// CHECK-LABEL: sil shared @_TTSC37specialize_unconditional_checked_cast1C___TF37specialize_unconditional_checked_cast31ConcreteToArchetypeConvertUInt8U__FT1tVSs5UInt82t2Q__Q_ : $@thin (@out C, UInt8, @in C) -> () {
// CHECK: bb0
// CHECK-NEXT: [[TRAP:%[0-9]+]] = builtin_function_ref "int_trap" : $@thin @noreturn @callee_owned () -> ()
// CHECK-NEXT: apply [[TRAP]]() : $@thin @noreturn @callee_owned () -> ()
...
// CHECK-LABEL: sil shared @_TTSVSs6UInt64___TF37specialize_unconditional_checked_cast31ConcreteToArchetypeConvertUInt8U__FT1tVSs5UInt82t2Q__Q_ : $@thin (@out UInt64, UInt8, @in UInt64) -> () {
// CHECK: bb0
// CHECK-NEXT: [[TRAP:%[0-9]+]] = builtin_function_ref "int_trap" : $@thin @noreturn @callee_owned () -> ()
// CHECK-NEXT: apply [[TRAP]]() : $@thin @noreturn @callee_owned () -> ()
...
// x -> x where x is a class.
// CHECK-LABEL: sil shared @_TTSC37specialize_unconditional_checked_cast1C___TF37specialize_unconditional_checked_cast27ConcreteToArchetypeConvertCU__FT1tCS_1C2t2Q__Q_ : $@thin (@out C, @owned C, @in C) -> () {
// CHECK: bb0
// CHECK-NEXT: store
// CHECK-NEXT: load
...
// x -> y where x is a class but y is not.
// CHECK-LABEL: sil shared @_TTSVSs5UInt8___TF37specialize_unconditional_checked_cast27ConcreteToArchetypeConvertCU__FT1tCS_1C2t2Q__Q_ : $@thin (@out UInt8, @owned C, @in UInt8) -> () {
// CHECK: bb0
// CHECK-NEXT: [[TRAP:%[0-9]+]] = builtin_function_ref "int_trap" : $@thin @noreturn @callee_owned () -> ()
// CHECK-NEXT: apply [[TRAP]]() : $@thin @noreturn @callee_owned () -> ()
...
// x -> y where x is a super class of y.
// CHECK-LABEL: sil shared @_TTSC37specialize_unconditional_checked_cast1D___TF37specialize_unconditional_checked_cast27ConcreteToArchetypeConvertCU__FT1tCS_1C2t2Q__Q_ : $@thin (@out D, @owned C, @in D) -> () {
// CHECK: bb0
// CHECK-NEXT: alloc_stack
// CHECK-NEXT: store
// CHECK-NEXT: unconditional_checked_cast downcast
...
// CHECK-LABEL: sil shared @_TTSC37specialize_unconditional_checked_cast1C___TF37specialize_unconditional_checked_cast27ConcreteToArchetypeConvertDU__FT1tCS_1D2t2Q__Q_ : $@thin (@out C, @owned D, @in C) -> () {
// CHECK: bb0
// CHECK-NEXT: upcast
// CHECK-NEXT: store
// CHECK-NEXT: load
...
// x -> x where x is a class.
// CHECK-LABEL: sil shared @_TTSC37specialize_unconditional_checked_cast1C___TF37specialize_unconditional_checked_cast17SuperToArchetypeCU__FT1cCS_1C1tQ__Q_ : $@thin (@out C, @owned C, @in C) -> () {
// CHECK: bb0
// CHECK-NEXT: store
// CHECK-NEXT: load
// CHECK-NEXT: strong_release
...
// CHECK-LABEL: sil shared @_TTSVSs5UInt8___TF37specialize_unconditional_checked_cast17SuperToArchetypeCU__FT1cCS_1C1tQ__Q_ : $@thin (@out UInt8, @owned C, @in UInt8) -> () {
// CHECK: bb0
// CHECK-NEXT: [[TRAP:%[0-9]+]] = builtin_function_ref "int_trap" : $@thin @noreturn @callee_owned () -> ()
// CHECK-NEXT: apply [[TRAP]]() : $@thin @noreturn @callee_owned () -> ()
...
// CHECK-LABEL: sil shared @_TTSC37specialize_unconditional_checked_cast1C___TF37specialize_unconditional_checked_cast17SuperToArchetypeDU__FT1dCS_1D1tQ__Q_ : $@thin (@out C, @owned D, @in C) -> () {
