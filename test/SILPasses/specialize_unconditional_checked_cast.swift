...
// CHECK-LABEL: sil shared @_TTSg5C37specialize_unconditional_checked_cast1C_S0____TF37specialize_unconditional_checked_cast20ArchetypeToArchetypeu0_rFT1tq_2t2q0__q0_ : $@convention(thin) (@out C, @in C, @in C) -> () {
// CHECK-NOT: unconditional_checked_cast archetype_to_archetype
ArchetypeToArchetype(t: c, t2: c)

// x -> x where x is not a class.
// CHECK-LABEL: sil shared @_TTSg5VSs5UInt8_S____TF37specialize_unconditional_checked_cast20ArchetypeToArchetypeu0_rFT1tq_2t2q0__q0_ : $@convention(thin) (@out UInt8, @in UInt8, @in UInt8) -> () {
// CHECK-NOT: unconditional_checked_cast archetype_to_archetype
ArchetypeToArchetype(t: b, t2: b)

// x -> y where x is not a class but y is.
// CHECK-LABEL: sil shared @_TTSg5VSs5UInt8_C37specialize_unconditional_checked_cast1C___TF37specialize_unconditional_checked_cast20ArchetypeToArchetypeu0_rFT1tq_2t2q0__q0_ : $@convention(thin) (@out C, @in UInt8, @in C) -> () {
...
// CHECK-LABEL: sil shared @_TTSg5C37specialize_unconditional_checked_cast1C_VSs5UInt8___TF37specialize_unconditional_checked_cast20ArchetypeToArchetypeu0_rFT1tq_2t2q0__q0_ : $@convention(thin) (@out UInt8, @in C, @in UInt8) -> () {
// CHECK-NOT: unconditional_checked_cast archetype_to_archetype
// CHECK: builtin "int_trap"
// CHECK-NOT: unconditional_checked_cast archetype_to_archetype
...
// CHECK-LABEL: sil shared @_TTSg5C37specialize_unconditional_checked_cast1C_CS_1D___TF37specialize_unconditional_checked_cast20ArchetypeToArchetypeu0_rFT1tq_2t2q0__q0_ : $@convention(thin) (@out D, @in C, @in D) -> () {
...
// CHECK-LABEL: sil shared @_TTSg5C37specialize_unconditional_checked_cast1D_CS_1C___TF37specialize_unconditional_checked_cast20ArchetypeToArchetypeu0_rFT1tq_2t2q0__q0_ : $@convention(thin) (@out C, @in D, @in C) -> () {
// CHECK-NOT: unconditional_checked_cast archetype_to_archetype
...
// CHECK-LABEL: sil shared @_TTSg5C37specialize_unconditional_checked_cast1C_CS_1E___TF37specialize_unconditional_checked_cast20ArchetypeToArchetypeu0_rFT1tq_2t2q0__q0_ : $@convention(thin) (@out E, @in C, @in E) -> () {
// CHECK-NOT: unconditional_checked_cast archetype_to_archetype
// CHECK: builtin "int_trap"
// CHECK-NOT: unconditional_checked_cast archetype_to_archetype
...
// CHECK-LABEL: sil shared @_TTSg5VSs5UInt8_VSs6UInt64___TF37specialize_unconditional_checked_cast20ArchetypeToArchetypeu0_rFT1tq_2t2q0__q0_ : $@convention(thin) (@out UInt64, @in UInt8, @in UInt64) -> () {
// CHECK-NOT: unconditional_checked_cast archetype_to_archetype
// CHECK-NOT: unconditional_checked_cast archetype_to_archetype
// CHECK:      builtin "int_trap"
// CHECK-NOT: unconditional_checked_cast archetype_to_archetype
...
// CHECK-LABEL: sil shared @_TTSg5C37specialize_unconditional_checked_cast1C___TF37specialize_unconditional_checked_cast31ArchetypeToConcreteConvertUInt8urFT1tq__VSs5UInt8 : $@convention(thin) (@in C) -> UInt8 {
// CHECK: bb0
// CHECK: builtin "int_trap"
// CHECK: unreachable
// CHECK-NEXT: }
...
// CHECK-LABEL: sil shared @_TTSg5VSs6UInt64___TF37specialize_unconditional_checked_cast31ArchetypeToConcreteConvertUInt8urFT1tq__VSs5UInt8 : $@convention(thin) (@in UInt64) -> UInt8 {
// CHECK: bb0
// CHECK: builtin "int_trap"
// CHECK: unreachable
// CHECK-NEXT: }
...
// CHECK-LABEL: sil shared @_TTSg5VSs5UInt8___TF37specialize_unconditional_checked_cast27ArchetypeToConcreteConvertCurFT1tq__CS_1C : $@convention(thin) (@in UInt8) -> @owned C {
// CHECK: bb0
// CHECK: builtin "int_trap"
// CHECK: unreachable
// CHECK-NEXT: }
...
// CHECK-LABEL: sil shared @_TTSg5C37specialize_unconditional_checked_cast1E___TF37specialize_unconditional_checked_cast27ArchetypeToConcreteConvertCurFT1tq__CS_1C : $@convention(thin) (@in E) -> @owned C {
// CHECK: bb0
// CHECK: builtin "int_trap"
// CHECK: unreachable
// CHECK-NEXT: }
...
// result.
// CHECK-LABEL: sil shared @_TTSg5C37specialize_unconditional_checked_cast1C___TF37specialize_unconditional_checked_cast27ArchetypeToConcreteConvertEurFT1tq__CS_1E : $@convention(thin) (@in C) -> @owned E {
// CHECK: bb0
// CHECK: builtin "int_trap"
// CHECK: unreachable
// CHECK-NEXT: }
...
// CHECK-LABEL: sil shared @_TTSg5C37specialize_unconditional_checked_cast1C___TF37specialize_unconditional_checked_cast31ConcreteToArchetypeConvertUInt8urFT1tVSs5UInt82t2q__q_ : $@convention(thin) (@out C, UInt8, @in C) -> () {
// CHECK: bb0
// CHECK: builtin "int_trap"
// CHECK: unreachable
// CHECK-NEXT: }
...
// CHECK-LABEL: sil shared @_TTSg5VSs6UInt64___TF37specialize_unconditional_checked_cast31ConcreteToArchetypeConvertUInt8urFT1tVSs5UInt82t2q__q_ : $@convention(thin) (@out UInt64, UInt8, @in UInt64) -> () {
// CHECK: bb0
// CHECK: builtin "int_trap"
// CHECK: unreachable
// CHECK-NEXT: }
...
// x -> y where x is a class but y is not.
// CHECK-LABEL: sil shared @_TTSg5VSs5UInt8___TF37specialize_unconditional_checked_cast27ConcreteToArchetypeConvertCurFT1tCS_1C2t2q__q_ : $@convention(thin) (@out UInt8, @owned C, @in UInt8) -> () {
// CHECK: bb0
// CHECK: builtin "int_trap"
// CHECK: unreachable
// CHECK-NEXT: }
...
// x -> y where x is a super class of y.
// CHECK-LABEL: sil shared @_TTSg5C37specialize_unconditional_checked_cast1D___TF37specialize_unconditional_checked_cast17SuperToArchetypeCurFT1cCS_1C1tq__q_ : $@convention(thin) (@out D, @owned C, @in D) -> () {
// CHECK: bb0
// CHECK: unconditional_checked_cast_addr take_always C in 
SuperToArchetypeC(c: c, t: d)

// x -> y where x is a class and y is not.
// CHECK-LABEL: sil shared @_TTSg5VSs5UInt8___TF37specialize_unconditional_checked_cast17SuperToArchetypeCurFT1cCS_1C1tq__q_ : $@convention(thin) (@out UInt8, @owned C, @in UInt8) -> () {
// CHECK: bb0
// CHECK: builtin "int_trap"
// CHECK: unreachable
// CHECK-NEXT: }
...
// CHECK-LABEL: sil shared @_TTSg5C37specialize_unconditional_checked_cast1C___TF37specialize_unconditional_checked_cast17SuperToArchetypeDurFT1dCS_1D1tq__q_ : $@convention(thin) (@out C, @owned D, @in C) -> () {
...
// AnyObject -> Class.
// CHECK-LABEL: sil shared @_TTSg5C37specialize_unconditional_checked_cast1C___TF37specialize_unconditional_checked_cast22ExistentialToArchetypeurFT1oPSs9AnyObject_1tq__q_ : $@convention(thin) (@out C, @owned AnyObject, @in C) -> () {
...
// CHECK-LABEL: sil shared @_TTSg5VSs5UInt8___TF37specialize_unconditional_checked_cast22ExistentialToArchetypeurFT1oPSs9AnyObject_1tq__q_ : $@convention(thin) (@out UInt8, @owned AnyObject, @in UInt8) -> () {
// CHECK: builtin "int_trap"()
// CHECK: unreachable
// CHECK-NEXT: }
