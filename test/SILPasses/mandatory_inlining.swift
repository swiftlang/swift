...
// CHECK-LABEL: sil hidden [transparent] @_TF18mandatory_inlining25class_constrained_genericuRdq_CS_1C_Fq_GSqPMPs9AnyObject__ : $@convention(thin) <T where T : C> (@owned T) -> Optional<AnyObject.Type>
@transparent
...
func invoke(c: C) {
  // CHECK-NOT: function_ref @_TF18mandatory_inlining25class_constrained_genericuRdq_CS_1C_Fq_GSqPMPs9AnyObject__
  // CHECK-NOT: apply
