...
// RUN: %swift %s -triple x86_64-apple-darwin13 -sdk=%S/Inputs -I=%S/Inputs/custom-modules -I %t -module-cache-path=%t/clang-module-cache -parse
// RUN: %swift %s -triple x86_64-apple-darwin13 -I %t -module-cache-path=%t/clang-module-cache -parse -verify
