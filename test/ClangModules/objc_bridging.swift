...
// RUN: %swift %clang-importer-sdk -parse -parse-as-library -enable-objc-failable-initializers -verify -module-cache-path %t/clang-module-cache -target x86_64-apple-macosx10.9 %s
