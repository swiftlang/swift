...
// RUN: %swift %clang-importer-sdk -emit-sil -module-cache-path %t/clang-module-cache -I %S/Inputs/custom-modules -target x86_64-apple-darwin13 %s -strict-keyword-arguments -verify
...
func testDynamicSelf(queen: B, wobbler: NSWobbling) {
  ...
  var hive1 = Hive.hiveWithQueen(queen)
  hive1 = hive
  hive = hive1
