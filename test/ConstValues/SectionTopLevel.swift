...
// CHECK: @"$s15SectionTopLevel13floatLiteral1Sfvp" = {{.*}}constant %TSf <{ float {{0x40091EB860000000|3\.140000e\+00}} }>, section "mysection"
...
// CHECK: @"$s15SectionTopLevel6tuple2Si_SfSbtvp" = {{.*}}constant <{ %TSi, %TSf, %TSb }> <{ %TSi <{ {{i64|i32}} 42 }>, %TSf <{ float {{0x40091EB860000000|3\.140000e\+00}} }>, %TSb zeroinitializer }>, section "mysection"
