...
// T1-DAG: Decl[FreeFunction]/OtherModule: CFArrayCreate({#(allocator): CFAllocator!#}, {#(values): UnsafeMutablePointer<ConstUnsafePointer<()>>#}, {#(numValues): CFIndex#}, {#(callBacks): ConstUnsafePointer<CFArrayCallBacks>#})[#CFArray!#]{{$}}
...
// T2-DAG: Decl[FreeFunction]/OtherModule: .CFArrayCreate({#(allocator): CFAllocator!#}, {#(values): UnsafeMutablePointer<ConstUnsafePointer<()>>#}, {#(numValues): CFIndex#}, {#(callBacks): ConstUnsafePointer<CFArrayCallBacks>#})[#CFArray!#]{{$}}
