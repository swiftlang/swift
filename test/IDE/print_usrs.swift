// RUN: %target-swift-frontend(mock-sdk: %clang-importer-sdk) -swift-version 3  -typecheck -verify -disable-objc-attr-requires-foundation-module %s
// RUN: %target-swift-ide-test(mock-sdk: %clang-importer-sdk) -swift-version 3 -print-usrs -source-filename %s | %FileCheck %s -strict-whitespace
