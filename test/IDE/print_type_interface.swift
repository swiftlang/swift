...
// TYPE4: public mutating func removeFirst(_ n: Int)
...
// TYPE5: public func formIndex(_ i: inout Int, offsetBy n: Int)
// TYPE5: public func distance(from start: Int, to end: Int) -> Int
// TYPE5: public func joined(separator: String) -> String
