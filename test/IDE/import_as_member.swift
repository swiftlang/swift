...
// PRINT-NOT: static var static1: CDouble

// PRINT:      extension Struct1 {
// PRINT-NEXT:   static var globalVar: CDouble
// PRINT-NEXT:   init(value value: CDouble)
// PRINT-NEXT:   init(specialLabel specialLabel: ())
// PRINT-NEXT:   func inverted() -> Struct1
// PRINT-NEXT:   mutating func invert()
// PRINT-NEXT:   func translate(radians radians: CDouble) -> Struct1
// PRINT-NEXT:   func scale(_ radians: CDouble) -> Struct1
// PRINT-NEXT:   var radius: CDouble { get nonmutating set }
// PRINT-NEXT:   var altitude: CDouble{{$}}
// PRINT-NEXT:   var magnitude: CDouble { get }
// PRINT-NEXT:   static func staticMethod() -> CInt
// PRINT-NEXT:   static var property: CInt
// PRINT-NEXT:   static var getOnlyProperty: CInt { get }
// PRINT-NEXT:   func selfComesLast(x x: CDouble)
// PRINT-NEXT:   func selfComesThird(a a: CInt, b b: CFloat, x x: CDouble)
// PRINT-NEXT: }
// PRINT-NOT: static var static1: CDouble


// Make sure the other extension isn't here.
// PRINTB-NOT: static var globalVar: CDouble

// PRINTB:      extension Struct1 {
// PRINTB:        static var static1: CDouble
// PRINTB-NEXT:   static var static2: CFloat
// PRINTB-NEXT:   init(float value: CFloat)
...
// PRINT-APINOTES-3-NEXT: func IAMStruct1APINoteCreateFunction(_ _: CInt) -> Struct1
...
// PRINT-APINOTES-4-NEXT: var IAMStruct1APINoteVar: CDouble
// PRINT-APINOTES-4:      extension Struct1 {
// PRINT-APINOTES-4-NEXT:   var newApiNoteVar: CDouble
// PRINT-APINOTES-4-NEXT:   @available(swift, obsoleted: 4.2, renamed: "Struct1.newApiNoteVar")
// PRINT-APINOTES-4-NEXT:   var oldApiNoteVar: CDouble
// PRINT-APINOTES-4-NEXT:   var apiNoteVarInSwift4: CDouble
...
// PRINT-APINOTES-4-NEXT:   init(newLabel _: CInt)
// PRINT-APINOTES-4-NEXT:   @available(swift, obsoleted: 4.2, renamed: "Struct1.init(newLabel:)")
// PRINT-APINOTES-4-NEXT:   init(oldLabel _: CInt)
// PRINT-APINOTES-4-NEXT:   typealias NewApiNoteType = CDouble
...
// PRINT-APINOTES-4-NEXT: var IAMStruct1APINoteVarInSwift4: CDouble
...
// PRINT-APINOTES-4-NEXT: func IAMStruct1APINoteCreateFunction(_ _: CInt) -> Struct1
