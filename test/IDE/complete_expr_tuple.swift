...
// TUPLE_NO_DOT_2-DAG: Decl[InfixOperatorFunction]/OtherModule[Swift]: == {#(foo: Int, bar: Double)#}[#Bool#]{{; name=.+$}}
...
// TUPLE_NO_DOT_3-DAG: Decl[InfixOperatorFunction]/OtherModule[Swift]: == {#(foo: Int, Double)#}[#Bool#]{{; name=.+$}}
