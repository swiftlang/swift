...
// MODULE_QUALIFIED_3: Decl[InfixOperatorFunction]/OtherModule[Swift]: != {#protocol<>.Type?#}[#Bool#];
...
// MODULE_QUALIFIED_4: Decl[InfixOperatorFunction]/OtherModule[Swift]: != {#protocol<>.Type?#}[#Bool#];
