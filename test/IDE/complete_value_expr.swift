...
func testGenericConforming1<T: P1>(_ x: T) {
...
func testGenericConforming2<T: P2>(_ x: T) {
...
func testGenericConforming3<T: P3>(_ x: T) {
...
func testConstrainedGeneric1<S: P1>(_ x: Generic1<S>) {
  x.#^PROTOCOL_EXT_CONSTRAINED_GENERIC_1^#
}
func testConstrainedGeneric2<S: P4 where S.T : P1>(_ x: S) {
...
func testConstrainedGeneric1<S: P4 where S.T == OnlyMe>(_ x: S) {
  x.#^PROTOCOL_EXT_CONSTRAINED_GENERIC_3^#
}
func testConstrainedGeneric1_sub<S: P4 where S.T == OnlyMe>(_ x: S) {
