...
// RUN: %swift-ide-test -print-module -source-filename %s -sdk %sdk -target %target-triple -module-to-print=ObjectiveC.NSObject -function-definitions=false -module-cache-path=%t/mcp -enable-objc-forward-declarations > %t/ObjectiveC.NSObject.forward-decls.txt
