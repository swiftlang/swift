...
// PRIVATE_NOMINAL_MEMBERS_6-DAG: Decl[InstanceMethod]/Super/IsSystem:         reduce({#(initialResult): ~Copyable#}, {#(nextPartialResult): (consuming ~Copyable, Equatable) throws -> ~Copyable##(_ partialResult: consuming ~Copyable, Equatable) throws -> ~Copyable#})[' rethrows'][#~Copyable#]{{; name=.+}}
