...
extern const _Null_unspecified CFNewType MyCFNewTypeValue;
extern _Null_unspecified CFNewType FooAudited(void);
_Pragma("clang arc_cf_code_audited end")
extern const _Null_unspecified CFNewType MyCFNewTypeValueUnauditedButConst;
...
_Pragma("clang arc_cf_code_audited begin")
extern const _Null_unspecified MyABINewType kMyABINewTypeGlobal;
extern const _Null_unspecified MyABIOldType kMyABIOldTypeGlobal;
...
extern const _Null_unspecified NSSomeContextName NSMyContextName;
