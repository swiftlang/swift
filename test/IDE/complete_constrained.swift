...
// MYSTRUCT_INT_DOT-DAG: Decl[InstanceMethod]/CurrNominal:   methodWithConstrainedGenericParam({#x: U#})[#Int#][# where U : SomeProto#]; name=methodWithConstrainedGenericParam(x: U)
...
// META_MYSTRUCT_INT_DOT-DAG: Decl[Constructor]/CurrNominal:      init({#withConstrainedGenericParam: U#})[#MyStruct<Int>#][# where U : SomeProto#]; name=init(withConstrainedGenericParam: U)
// META_MYSTRUCT_INT_DOT-DAG: Decl[InstanceMethod]/CurrNominal:   methodWithConstrainedGenericParam({#(self): MyStruct<Int>#})[#(x: U) -> Int#][# where U : SomeProto#]; name=methodWithConstrainedGenericParam(self: MyStruct<Int>)
