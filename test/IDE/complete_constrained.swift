...
// MYSTRUCT_INT_DOT-DAG: Decl[InstanceMethod]/CurrNominal:   methodWithConstrainedGenericParam{#<U>#}({#x: U#})[#Int#][# where U : SomeProto#]; name=methodWithConstrainedGenericParam<U>(x: U)
// MYSTRUCT_INT_DOT-DAG: Decl[InstanceMethod]/CurrNominal:   concreteExt_TEqInt_None()[#Int#]; name=concreteExt_TEqInt_None()
// MYSTRUCT_INT_DOT-DAG: Decl[InstanceMethod]/CurrNominal:   concreteExt_None_TEqInt{#<U>#}({#(x): U#})[#Int#]; name=concreteExt_None_TEqInt<U>(x: U)
// MYSTRUCT_INT_DOT-DAG: Decl[InstanceMethod]/Super:         protoExt_AssocEqInt_None()[#Int#]; name=protoExt_AssocEqInt_None()
// MYSTRUCT_INT_DOT-DAG: Decl[InstanceMethod]/Super:         protoExt_None_AssocEqInt{#<U>#}({#(x): U#})[#Int#]; name=protoExt_None_AssocEqInt<U>(x: U)
...
// META_MYSTRUCT_INT_DOT-DAG: Decl[Constructor]/CurrNominal:      init{#<U>#}({#int: U#})[#MyStruct<Int>#]; name=init<U>(int: U)
// META_MYSTRUCT_INT_DOT-DAG: Decl[Constructor]/CurrNominal:      init{#<U>#}({#withConstrainedGenericParam: U#})[#MyStruct<Int>#][# where U : SomeProto#]; name=init<U>(withConstrainedGenericParam: U)
// META_MYSTRUCT_INT_DOT-DAG: Decl[InstanceMethod]/CurrNominal:   methodWithConstrainedGenericParam{#<U>#}({#(self): MyStruct<Int>#})[#(x: U) -> Int#][# where U : SomeProto#]; name=methodWithConstrainedGenericParam<U>(self: MyStruct<Int>)
...
// META_MYSTRUCT_INT_DOT-DAG: Decl[InstanceMethod]/CurrNominal:   concreteExt_None_TEqInt{#<U>#}({#(self): MyStruct<Int>#})[#(U) -> Int#]; name=concreteExt_None_TEqInt<U>(self: MyStruct<Int>)
...
// META_MYSTRUCT_INT_DOT-DAG: Decl[InstanceMethod]/Super:         protoExt_None_AssocEqInt{#<U>#}({#(self): MyStruct<Int>#})[#(U) -> Int#]; name=protoExt_None_AssocEqInt<U>(self: MyStruct<Int>)
