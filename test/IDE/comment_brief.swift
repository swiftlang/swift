...
// CHECK-NEXT: Func/briefBlock7 {{.*}} BriefComment=[Aaa. * Bbb.]
// CHECK-NEXT: Func/briefBlock8 {{.*}} BriefComment=[Aaa. * Bbb. * Ccc.]
// CHECK-NEXT: Func/briefBlock9 {{.*}} BriefComment=[Aaa. * Bbb. Ccc.]
...
// CHECK-NEXT: Func/briefBlockWithASCIIArt5 {{.*}} BriefComment=[Aaa. Bbb.]
