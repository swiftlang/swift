...
// ARG_MyEnum_NOBINDING-DAG: Decl[EnumElement]/CurrNominal/TypeRelation[Identical]: east[#MyEnum#];
// ARG_MyEnum_NOBINDING-DAG: Decl[EnumElement]/CurrNominal/TypeRelation[Identical]: west[#MyEnum#];
...
// SECOND_ARG-DAG: Decl[GlobalVar]/CurrModule/TypeRelation[Identical]: globalInt[#Int#]; name=globalInt
