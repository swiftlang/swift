...
// PERSONTYPE-INFER-DOT-OPT-NEXT: Decl[InstanceVar]/CurrNominal/IsSystem:   span[#Span<Person>#]; name=span
// PERSONTYPE-INFER-DOT-OPT-NEXT: Decl[InstanceVar]/CurrNominal/IsSystem:   mutableSpan[#MutableSpan<Person>#]; name=mutableSpan
...
// PERSONTYPE-DOT-OPT-NEXT: Decl[InstanceVar]/CurrNominal/IsSystem:   span[#Span<Person>#]; name=span
// PERSONTYPE-DOT-OPT-NEXT: Decl[InstanceVar]/CurrNominal/IsSystem:   mutableSpan[#MutableSpan<Person>#]; name=mutableSpan
...
// PERSONTYPE-DOT-OPT-SPACE-NEXT: Decl[InstanceVar]/CurrNominal/IsSystem:   span[#Span<Person>#]; name=span
// PERSONTYPE-DOT-OPT-SPACE-NEXT: Decl[InstanceVar]/CurrNominal/IsSystem:   mutableSpan[#MutableSpan<Person>#]; name=mutableSpan
