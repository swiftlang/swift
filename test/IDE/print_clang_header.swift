...
// RUN: %target-swift-ide-test -source-filename %s -print-header -header-to-print %S/Inputs/header.h --cc-args -target %target-triple -fsyntax-only %t.m -I %S/Inputs > %t.txt
