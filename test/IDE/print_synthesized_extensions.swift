...
// CHECK5:  <synthesized>extension <ref:Struct>S10</ref> {
// CHECK5-NEXT:     <decl:Func>public func <loc>p3Func(<decl:Param>i: <ref:Struct>Int</ref></decl>)</loc> -> <ref:Struct>Int</ref></decl></synthesized>
...
// CHECK8:  <synthesized>extension <ref:Struct>S4</ref> {
...
// CHECK9: <synthesized>extension <ref:Struct>S6</ref> {
// CHECK9-NEXT: <decl:Func>public func <loc>p3Func(<decl:Param>i: <ref:Struct>Int</ref></decl>)</loc> -> <ref:Struct>Int</ref></decl></synthesized>
