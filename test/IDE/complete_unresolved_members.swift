...
// UNRESOLVED_3_OPT: Begin completions, 11 items
...
// UNRESOLVED_3_OPT-DAG: Decl[InstanceMethod]/CurrNominal/IsSystem: edit({#(self): &Optional<SomeEnum1>#})[#(@_lifetime(0: copy 0) (inout OutputSpan<SomeEnum1>) throws(Error) -> ~Copyable) -> ~Copyable#];
...
// Exhaustive to make sure we don't include `init({#(some):` or `init({#nilLiteral:` entries
// UNRESOLVED_3_OPTOPTOPT: Begin completions, 11 items
...
// UNRESOLVED_3_OPTOPTOPT-DAG: Decl[InstanceMethod]/CurrNominal/IsSystem: edit({#(self): &Optional<SomeEnum1??>#})[#(@_lifetime(0: copy 0) (inout OutputSpan<SomeEnum1??>) throws(Error) -> ~Copyable) -> ~Copyable#];
...
// UNRESOLVED_OPT_4: Begin completions, 13 items
...
// UNRESOLVED_OPT_4-DAG: Decl[InstanceMethod]/CurrNominal/IsSystem: edit({#(self): &Optional<Somewhere>#})[#(@_lifetime(0: copy 0) (inout OutputSpan<Somewhere>) throws(Error) -> ~Copyable) -> ~Copyable#];
...
// SUGAR_TYPE: Begin completions, 11 items
...
// SUGAR_TYPE-DAG: Decl[InstanceMethod]/CurrNominal/IsSystem: edit({#(self): &Optional<SomeEnum1>#})[#(@_lifetime(0: copy 0) (inout OutputSpan<SomeEnum1>) throws(Error) -> ~Copyable) -> ~Copyable#];
