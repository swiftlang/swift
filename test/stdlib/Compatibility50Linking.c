...
// RUN: %target-clang %s -all_load %test-resource-dir/%target-sdk-name/libswiftCompatibility50.a %test-resource-dir/%target-sdk-name/libswiftCompatibility51.a %test-resource-dir/%target-sdk-name/libswiftCompatibility53.a -lobjc -o %t/main
