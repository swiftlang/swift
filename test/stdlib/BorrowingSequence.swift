...
// MARK: - SpanIterator tests

suite.test("SpanIterator/basic")
.require(.stdlib_6_4).code {
  guard #available(SwiftStdlib 6.4, *) else {
    expectTrue(false)
    return
...
suite.test("SpanIterator/partial-reads")
.require(.stdlib_6_4).code {
  guard #available(SwiftStdlib 6.4, *) else {
    expectTrue(false)
    return
...
suite.test("SpanIterator/no-arg-convenience")
.require(.stdlib_6_4).code {
  guard #available(SwiftStdlib 6.4, *) else {
    expectTrue(false)
    return
...
suite.test("SpanIterator/empty-span")
.require(.stdlib_6_4).code {
  guard #available(SwiftStdlib 6.4, *) else {
    expectTrue(false)
    return
...
suite.test("SpanIterator/single-element")
.require(.stdlib_6_4).code {
  guard #available(SwiftStdlib 6.4, *) else {
    expectTrue(false)
    return
...
suite.test("SpanIterator/skip-basic")
.require(.stdlib_6_4).code {
  guard #available(SwiftStdlib 6.4, *) else {
    expectTrue(false)
    return
...
suite.test("SpanIterator/skip-past-end")
.require(.stdlib_6_4).code {
  guard #available(SwiftStdlib 6.4, *) else {
    expectTrue(false)
    return
...
suite.test("SpanIterator/skip-zero")
.require(.stdlib_6_4).code {
  guard #available(SwiftStdlib 6.4, *) else {
    expectTrue(false)
    return
...
suite.test("SpanIterator/skip-then-partial-read")
.require(.stdlib_6_4).code {
  guard #available(SwiftStdlib 6.4, *) else {
    expectTrue(false)
    return
...
suite.test("SpanIterator/noncopyable-elements")
.require(.stdlib_6_4).code {
  guard #available(SwiftStdlib 6.4, *) else {
    expectTrue(false)
    return
...
.require(.stdlib_6_4).code {
  ...
  // because the inner SpanIterator exhausts before the limit check fires
  let arr = [1, 2, 3]
  let span = arr.span
...
struct LimitedIterator: BorrowingIteratorProtocol, ~Copyable, ~Escapable {
  ...
  init(_ inner: consuming SpanIterator<Int>, limit: Int) {
    _inner = inner
    _remaining = limit
  }
...
struct LimitedSeq: Iterable, ~Copyable, ~Escapable {
  ...
  func makeBorrowingIterator() -> LimitedIterator {
    LimitedIterator(SpanIterator(_span), limit: _limit)
  }
}
