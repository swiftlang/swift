...
func test_UnicodeScalarDoesNotImplementArithmetic(_ us: UnicodeScalar, i: Int) {
  ...
  // SWIFT_ENABLE_TENSORFLOW: `AnyDerivative` is in core Swift module only on tensorflow branch.
  // expected-note@-2 {{overloads for '-' exist with these partially matching parameter lists: (AnyDerivative, AnyDerivative), (Double, Double), (Float, Float), (Float16, Float16), (Float80, Float80), (Int, Int), (Int16, Int16), (Int32, Int32), (Int64, Int64), (Int8, Int8), (UInt, UInt), (UInt16, UInt16), (UInt32, UInt32), (UInt64, UInt64), (UInt8, UInt8)}}
