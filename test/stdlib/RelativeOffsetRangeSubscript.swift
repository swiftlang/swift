//===--- RelativeOffsetRangeSubscript.swift ----------------------------------------===//
//
...
let RelativeOffsetRangeSubscript = TestSuite("RelativeOffsetRangeSubscript")

RelativeOffsetRangeSubscript.test("closed-range") {
...
RelativeOffsetRangeSubscript.test("half-open-range") {
  let x = [2, 3, 54, 1, 3, 4, 5, 6, 8]
...
RelativeOffsetRangeSubscript.test("partial-range-upto") {
  let x = [2, 3, 54, 1, 3, 4, 5, 6, 8]
...
RelativeOffsetRangeSubscript.test("partial-range-through") {
  let x = [2, 3, 54, 1, 3, 4, 5, 6, 8]
...
RelativeOffsetRangeSubscript.test("partial-range-from") {
  let x = [2, 3, 54, 1, 3, 4, 5, 6, 8]
...
RelativeOffsetRangeSubscript.test("offsetting-a-subsequence") {
  let x = [2, 3, 54, 1, 3, 4, 5, 6, 8]
...
RelativeOffsetRangeSubscript.test("replace-range") {
...
RelativeOffsetRangeSubscript.test("replace-string-range") {
  var x = "Hello, Swift!"
...
RelativeOffsetRangeSubscript.test("relativeAsOffset") {
  var x = [2, 3, 54, 1, 3, 4, 5, 6, 8]
