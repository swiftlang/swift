...
if #available(iOS 10.0, OSX 10.12, tvOS 10.0, watchOS 4.0, *) {
    ...
    AccelerateTests_vDSPConversion.test("BNNS/ImageStackDescriptor") {
    ...
    AccelerateTests_vDSPConversion.test("BNNS/VectorDescriptor") {
    ...
    AccelerateTests_vDSPConversion.test("BNNS/LayerData") {
    ...
    AccelerateTests_vDSPConversion.test("BNNS/Activation") {
