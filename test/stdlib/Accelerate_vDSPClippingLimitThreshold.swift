...
if #available(iOS 10.0, OSX 10.12, tvOS 10.0, watchOS 4.0, *) {
  ...
  Accelerate_vDSPClippingLimitThresholdTests.test("BNNS/ImageStackDescriptor") {
  ...
  Accelerate_vDSPClippingLimitThresholdTests.test("BNNS/VectorDescriptor") {
  ...
  Accelerate_vDSPClippingLimitThresholdTests.test("BNNS/LayerData") {
  ...
  Accelerate_vDSPClippingLimitThresholdTests.test("BNNS/Activation") {
