...
if #available(iOS 9999, OSX 9999, tvOS 9999, watchOS 9999, *) {
    ...
    AccelerateTests.test("vDSP/SinglePrecisionFill") {
    ...
    AccelerateTests.test("vDSP/SinglePrecisionClear") {
        var result = [Float](repeating: 1, count: count)
        var legacyResult = [Float](repeating: -1, count: count)
    ...
    AccelerateTests.test("vDSP/DoublePrecisionFill") {
    ...
    AccelerateTests.test("vDSP/DoublePrecisionClear") {
        var result = [Double](repeating: 1, count: count)
        var legacyResult = [Double](repeating: -1, count: count)
    ...
    AccelerateTests.test("vDSP/SinglePrecisionHanningNormalized") {
        var result = [Float](repeating: 1, count: count)
        var legacyResult = [Float](repeating: -1, count: count)
    ...
    AccelerateTests.test("vDSP/SinglePrecisionHanningNormalizedHalf") {
        var result = [Float](repeating: 1, count: count)
        var legacyResult = [Float](repeating: -1, count: count)
    ...
    AccelerateTests.test("vDSP/SinglePrecisionHanningDenormalized") {
        var result = [Float](repeating: 1, count: count)
        var legacyResult = [Float](repeating: -1, count: count)
    ...
    AccelerateTests.test("vDSP/SinglePrecisionHanningDenormalizedHalf") {
        var result = [Float](repeating: 1, count: count)
        var legacyResult = [Float](repeating: -1, count: count)
    ...
    AccelerateTests.test("vDSP/SinglePrecisionHamming") {
        var result = [Float](repeating: 1, count: count)
        var legacyResult = [Float](repeating: -1, count: count)
    ...
    AccelerateTests.test("vDSP/SinglePrecisionHammingHalf") {
        var result = [Float](repeating: 1, count: count)
        var legacyResult = [Float](repeating: -1, count: count)
    ...
    AccelerateTests.test("vDSP/SinglePrecisionBlackman") {
        var result = [Float](repeating: 1, count: count)
        var legacyResult = [Float](repeating: -1, count: count)
    ...
    AccelerateTests.test("vDSP/SinglePrecisionBlackmanHalf") {
        var result = [Float](repeating: 1, count: count)
        var legacyResult = [Float](repeating: -1, count: count)
    ...
    AccelerateTests.test("vDSP/DoublePrecisionHanningNormalized") {
        var result = [Double](repeating: 1, count: count)
        var legacyResult = [Double](repeating: -1, count: count)
    ...
    AccelerateTests.test("vDSP/DoublePrecisionHanningNormalizedHalf") {
        var result = [Double](repeating: 1, count: count)
        var legacyResult = [Double](repeating: -1, count: count)
    ...
    AccelerateTests.test("vDSP/DoublePrecisionHanningDenormalized") {
        var result = [Double](repeating: 1, count: count)
        var legacyResult = [Double](repeating: -1, count: count)
    ...
    AccelerateTests.test("vDSP/DoublePrecisionHanningDenormalizedHalf") {
        var result = [Double](repeating: 1, count: count)
        var legacyResult = [Double](repeating: -1, count: count)
    ...
    AccelerateTests.test("vDSP/DoublePrecisionHamming") {
        var result = [Double](repeating: 1, count: count)
        var legacyResult = [Double](repeating: -1, count: count)
    ...
    AccelerateTests.test("vDSP/DoublePrecisionHammingHalf") {
        var result = [Double](repeating: 1, count: count)
        var legacyResult = [Double](repeating: -1, count: count)
    ...
    AccelerateTests.test("vDSP/DoublePrecisionBlackman") {
        var result = [Double](repeating: 1, count: count)
        var legacyResult = [Double](repeating: -1, count: count)
    ...
    AccelerateTests.test("vDSP/DoublePrecisionBlackmanHalf") {
        var result = [Double](repeating: 1, count: count)
        var legacyResult = [Double](repeating: -1, count: count)
    ...
    AccelerateTests.test("vDSP/SinglePrecisionRampWithRange") {
        var result = [Float](repeating: 1, count: count)
        var legacyResult = [Float](repeating: -1, count: count)
    ...
    AccelerateTests.test("vDSP/SinglePrecisionRampWithIncrement") {
        var result = [Float](repeating: 1, count: count)
        var legacyResult = [Float](repeating: -1, count: count)
    ...
    AccelerateTests.test("vDSP/SinglePrecisionRampWithMultiplier") {
        var result = [Float](repeating: 1, count: count)
        var legacyResult = [Float](repeating: -1, count: count)
    ...
    AccelerateTests.test("vDSP/StereoSinglePrecisionRampWithMultiplier") {
        var result = [Float](repeating: 1, count: count)
        var legacyResult = [Float](repeating: -1, count: count)
    ...
    AccelerateTests.test("vDSP/DoublePrecisionRampWithRange") {
        var result = [Double](repeating: 1, count: count)
        var legacyResult = [Double](repeating: -1, count: count)
    ...
    AccelerateTests.test("vDSP/DoublePrecisionRampWithMultiplier") {
        var result = [Double](repeating: 1, count: count)
        var legacyResult = [Double](repeating: -1, count: count)
    ...
    AccelerateTests.test("vDSP/StereoDoublePrecisionRampWithMultiplier") {
        var result = [Double](repeating: 1, count: count)
        var legacyResult = [Double](repeating: -1, count: count)
