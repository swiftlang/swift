...
let ff: CGFloat = floorf(20.0) // expected-error{{cannot convert initial value of type 'Float' to specified type 'CGFloat'}}
...
var a: [String] = [1] // expected-error{{cannot convert initial value of type '[Int]' to specified type '[String]'}}
var b: Int = [1, 2, 3] // expected-error{{cannot convert initial value of type '[Int]' to specified type 'Int'}}

var f1: Float = 2.0
var f2: Float = 3.0

var dd: Double = f1 - f2 // expected-error{{cannot convert initial value of type 'Float' to specified type 'Double'}}
...
let _: String = testIS1() // expected-error {{cannot convert initial value of type 'Int' to specified type 'String'}}
