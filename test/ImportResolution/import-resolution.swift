...
// RUN: %target-swift-frontend -typecheck %s -enable-source-import -I %S/Inputs -sdk "" -verify -verify-ignore-unrelated -show-diagnostics-after-fatal
...
// RUN: %target-swift-frontend -typecheck %s -I %t -sdk "" -verify -verify-ignore-unrelated -show-diagnostics-after-fatal
