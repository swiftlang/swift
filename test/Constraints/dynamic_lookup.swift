...
obj.prop2 = "hello" // expected-error{{cannot assign to 'prop2' in 'obj'}}
...
var p: P = Y()
var obj3 : AnyObject = (p as AnyObject)! // expected-error{{operand of postfix '!' should have optional type; type is 'AnyObject'}}
