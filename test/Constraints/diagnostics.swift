...
// expected-note@-1 {{use 'as' to pass array elements as variadic arguments}} {{15-15= as Int...}}
variadic([1,2,3]) // expected-error {{cannot pass an array of type '[Int]' as variadic arguments of type 'Int'}}
// expected-note@-1 {{use 'as' to pass array elements as variadic arguments}} {{17-17= as Int...}}
// expected-note@-2 {{remove brackets to pass array elements directly}} {{10-11=}} {{16-17=}}
variadic([1,2,3,]) // expected-error {{cannot pass an array of type '[Int]' as variadic arguments of type 'Int'}}
// expected-note@-1 {{use 'as' to pass array elements as variadic arguments}} {{18-18= as Int...}}
...
// expected-note@-1 {{use 'as' to pass array elements as variadic arguments}}
...
// expected-note@-2 {{use 'as' to pass array elements as variadic arguments}}
// expected-note@-3 {{remove brackets to pass array elements directly}}
variadic([1] + [2] as [Int]) // expected-error {{cannot pass an array of type '[Int]' as variadic arguments of type 'Int'}}
// expected-note@-1 {{use 'as' to pass array elements as variadic arguments}} {{10-10=(}} {{28-28=) as Int...}}

foo[array] // expected-error {{cannot pass an array of type '[Int]' as variadic arguments of type 'Int'}}
// expected-note@-1 {{use 'as' to pass array elements as variadic arguments}}  {{10-10= as Int...}}
foo[[1,2,3]] // expected-error {{cannot pass an array of type '[Int]' as variadic arguments of type 'Int'}}
// expected-note@-1 {{use 'as' to pass array elements as variadic arguments}} {{12-12= as Int...}}
