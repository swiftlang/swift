...
func f1(_ _: (Int, Float) -> Int) { }

func f2(_ _: (_: (Int) -> Int)) -> Int {}

func f3(_ _: (_: (Int) -> Float) -> Int) {}
...
func expect<T, U>(_ _: T) -> (U.Type) -> Int { return { a in 0 } }
func expect<T, U>(_ _: T, _: Int = 1) -> (U.Type) -> String { return { a in "String" } }
