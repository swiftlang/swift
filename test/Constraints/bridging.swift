...
func rdar21244068(_ n: NSString!) -> String {
  return n  // expected-error {{cannot convert return expression of type 'NSString!' to return type 'String'}}
}

func forceBridgeDiag(_ obj: BridgedClass!) -> BridgedStruct {
  return obj // expected-error{{cannot convert return expression of type 'BridgedClass!' to return type 'BridgedStruct'}}
}
