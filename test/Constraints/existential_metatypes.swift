...
var qp: Q.Protocol
var pp: P.Protocol = qp // expected-error{{cannot convert initializer of type 'Q.Protocol' to specified type 'P.Protocol'}}
...
let c: Any.Type.Protocol = Toaster.Type.self // expected-error {{cannot convert initializer of type 'Toaster.Type.Protocol' to specified type 'Any.Type.Protocol' (aka 'protocol<>.Type.Protocol')}}
...
let h: WashingMachine.Type.Type = Dryer.Type.self // expected-error {{cannot convert initializer of type 'Dryer.Type.Type' to specified type 'WashingMachine.Type.Type'}}
