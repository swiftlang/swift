...
// RUN: diff -u %S/Outputs/dump-module/cake.json %t.dump.json
...
// RUN: diff -u %S/Outputs/dump-module/cake-abi.json %t.dump.json

// RUN: %api-digester -diagnose-sdk --input-paths %t.dump.json -input-paths %S/Outputs/dump-module/cake.json

// Round-trip testing:
// RUN: %api-digester -deserialize-sdk --input-paths %S/Outputs/dump-module/cake.json -o %t.dump.json
// RUN: diff -u %S/Outputs/dump-module/cake.json %t.dump.json
// RUN: %api-digester -deserialize-sdk --input-paths %S/Outputs/dump-module/cake-abi.json -o %t.dump.json
// RUN: diff -u %S/Outputs/dump-module/cake-abi.json %t.dump.json
