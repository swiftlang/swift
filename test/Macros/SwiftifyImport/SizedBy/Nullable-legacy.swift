...
// Mirrors Nullable.swift but exercises the legacy opt-in
// behavior: without `nullableAsEmptySpan: true`, every Optional
// pointer parameter / return value propagates as Optional in the wrapper.
// The invocations deliberately omit `nullableAsEmptySpan` so this also
// mirrors what a pre-`nullableAsEmptySpan` compiler would emit.
