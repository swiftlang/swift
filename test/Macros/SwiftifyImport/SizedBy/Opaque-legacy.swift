...
// Mirrors Opaque.swift but exercises the legacy opt-in behavior:
// without `nullableAsEmptySpan: true`, normal Optional pointer
// parameters propagate as Optional in the wrapper. IUO parameters are
// stripped, but the underlying pointer is NOT force-unwrapped at the call
// site (matching the modern wrapper convention — the flag only affects
// _Nullable normal-Optional pointers, not _Null_unspecified IUO pointers).
