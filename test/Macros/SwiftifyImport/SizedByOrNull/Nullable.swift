...
@_SwiftifyImport(.sizedByOrNull(pointer: .param(1), size: "len"), .sizedByOrNull(pointer: .return, size: "len"), .lifetimeDependence(dependsOn: .param(1), pointer: .return, type: .copy))
