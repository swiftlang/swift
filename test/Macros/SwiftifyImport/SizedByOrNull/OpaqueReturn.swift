...
//--- test.swift
@_SwiftifyImport(.sizedByOrNull(pointer: .return, size: "size"))
...
@_SwiftifyImport(.sizedByOrNull(pointer: .return, size: "size"), .sizedByOrNull(pointer: .param(1), size: "size"), .lifetimeDependence(dependsOn: .param(1), pointer: .return, type: .copy))
