...
@_SwiftifyImport(.sizedByOrNull(pointer: .return, size: "size * count"))
...
@_SwiftifyImport(.sizedByOrNull(pointer: .param(2), size: "size"),
                 .sizedByOrNull(pointer: .return, size: "size"),
