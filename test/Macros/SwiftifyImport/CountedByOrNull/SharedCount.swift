...
@_SwiftifyImport(.countedByOrNull(pointer: .param(1), count: "len"), .countedByOrNull(pointer: .param(2), count: "len * size"))
public func myFunc2(_ ptr: UnsafePointer<CInt>, _ ptr2: UnsafePointer<CInt>, _ len: CInt, _ size: CInt) {
}

@_SwiftifyImport(.countedByOrNull(pointer: .param(1), count: "len"), .countedByOrNull(pointer: .param(2), count: "size"), .countedByOrNull(pointer: .param(3), count: "len * size"))
public func myFunc3(_ ptr: UnsafePointer<CInt>, _ ptr2: UnsafePointer<CInt>, _ ptr3: UnsafePointer<CInt>, _ len: CInt, _ size: CInt) {
}

@_SwiftifyImport(.countedByOrNull(pointer: .param(3), count: "len"), .countedByOrNull(pointer: .param(2), count: "size"), .countedByOrNull(pointer: .param(1), count: "len * size"))
public func myFunc4(_ ptr: UnsafePointer<CInt>, _ ptr2: UnsafePointer<CInt>, _ ptr3: UnsafePointer<CInt>, _ len: CInt, _ size: CInt) {
}

@_SwiftifyImport(.countedByOrNull(pointer: .param(1), count: "len * size"), .countedByOrNull(pointer: .param(3), count: "len"), .countedByOrNull(pointer: .param(2), count: "size"))
