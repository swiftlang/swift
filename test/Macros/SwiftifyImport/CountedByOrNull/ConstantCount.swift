...
//--- test.swift
@_SwiftifyImport(.countedByOrNull(pointer: .param(1), count: "37"))
...
@_SwiftifyImport(.countedByOrNull(pointer: .param(1), count: "37"), .nonescaping(pointer: .param(1)))
...
@_SwiftifyImport(.countedByOrNull(pointer: .return, count: "37"))
