...
//--- test.swift
@_SwiftifyImportProtocol(.method(signature: "func myFunc(_ ptr: UnsafePointer<CInt>, _ len: CInt)", paramInfo: [.countedByOrNull(pointer: .param(1), count: "len")]))
protocol SimpleProtocol {
  func myFunc(_ ptr: UnsafePointer<CInt>, _ len: CInt)
}

@_SwiftifyImportProtocol(.method(signature: "func foo(_ ptr: UnsafePointer<CInt>, _ len: CInt)", paramInfo: [.countedByOrNull(pointer: .param(1), count: "len"), .nonescaping(pointer: .param(1))]),
                         .method(signature: "func bar(_ len: CInt) -> UnsafePointer<CInt>", paramInfo: [.countedByOrNull(pointer: .return, count: "len"), .nonescaping(pointer: .return), .lifetimeDependence(dependsOn: .self, pointer: .return, type: .borrow)]))
...
@_SwiftifyImportProtocol(.method(signature: "func foo(_ ptr: UnsafePointer<CInt>, _ len: CInt)", paramInfo: [.countedByOrNull(pointer: .param(1), count: "len"), .nonescaping(pointer: .param(1))]),
                         .method(signature: "func bar(_ ptr: UnsafePointer<CInt>, _ len: CInt)", paramInfo: [.countedByOrNull(pointer: .param(1), count: "len")]))
...
@_SwiftifyImportProtocol(.method(signature: "func foo(_ ptr: UnsafePointer<CInt>, _ len1: CInt)", paramInfo: [.countedByOrNull(pointer: .param(1), count: "len1")]),
                         .method(signature: "func foo(bar: UnsafePointer<CInt>, _ len2: CInt)", paramInfo: [.countedByOrNull(pointer: .param(1), count: "len2")]))
