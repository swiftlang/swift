...
// CHECK-NEXT: func ptrNamed(ptr _param0: UnsafeBufferPointer<CInt>) {
// CHECK-NEXT:     return unsafe ptrNamed(ptr: `_param0`.baseAddress!, CInt(exactly: `_param0`.count)!)
// CHECK-NEXT: }
...
// CHECK: @_alwaysEmitIntoClient
// CHECK-NEXT: func allNamed(ptr _param0: UnsafeBufferPointer<CInt>) {
// CHECK-NEXT:     return unsafe allNamed(ptr: `_param0`.baseAddress!, len: CInt(exactly: `_param0`.count)!)
// CHECK-NEXT: }
