...
; CHECK: _TTSfcl35_TFF7specgen6callerFSiT_U_FTSiSi_T_Si___TF7specgen12take_closureFFTSiSi_T_T_ ---> function signature specialization <Arg[0] = Closure Propagated> of specgen.take_closure ((Swift.Int, Swift.Int) -> ()) -> ()
; CHECK: _TTSfcl35_TFF7specgen6callerFSiT_U_FTSiSi_T_Si___TTSgSi___TF7specgen12take_closureFFTSiSi_T_T_ ---> function signature specialization <Arg[0] = Closure Propagated> of generic specialization <Swift.Int> of specgen.take_closure ((Swift.Int, Swift.Int) -> ()) -> ()
; CHECK: _TTSgSi___TTSfcl35_TFF7specgen6callerFSiT_U_FTSiSi_T_Si___TF7specgen12take_closureFFTSiSi_T_T_ ---> generic specialization <Swift.Int> of function signature specialization <Arg[0] = Closure Propagated> of specgen.take_closure ((Swift.Int, Swift.Int) -> ()) -> ()
; CHECK: _TTSfcpfr24_TF8capturep6helperFSiT__n___TTRXFo_dSi_dT__XFo_iSi_dT__ ---> function signature specialization <Arg[0] = Constant Propagated> of reabstraction thunk helper from @callee_owned (@unowned Swift.Int) -> (@unowned ()) to @callee_owned (@in Swift.Int) -> (@unowned ())
; CHECK: _TTSfcpi0_cpfl0_cpse0v4u123_cpg53globalinit_33_06E7F1D906492AE070936A9B58CBAE1C_token8_cpfr36_TFtest_capture_propagation2_closure___TF7specgen12take_closureFFTSiSi_T_T_ ---> function signature specialization <Arg[0] = Constant Propagated, Arg[1] = Constant Propagated, Arg[2] = Constant Propagated, Arg[3] = Constant Propagated, Arg[4] = Constant Propagated> of specgen.take_closure ((Swift.Int, Swift.Int) -> ()) -> ()
; CHECK: _TTSfs_s_d___TTSgVSs16_REPLExitHandler___TFVSs22_ContiguousArrayBufferCU__fMGS_Q__FT5countSi15minimumCapacitySi_GS_Q__ ---> function signature specialization <Arg[0] = Exploded, Arg[1] = Exploded, Arg[2] = Dead> of generic specialization <Swift._REPLExitHandler> of Swift._ContiguousArrayBuffer.init <A>(Swift._ContiguousArrayBuffer<A>.Type)(count : Swift.Int, minimumCapacity : Swift.Int) -> Swift._ContiguousArrayBuffer<A>
; CHECK: _TTSfgs___TFVSs11_StringCore15_invariantCheckfS_FT_T_ ---> function signature specialization <Arg[0] = Owned To Guaranteed and Exploded> of Swift._StringCore._invariantCheck (Swift._StringCore)() -> ()
; CHECK: _TTSfn_n_n_n___TTSfs_n_n___TTSgGVSs15EmptyCollectionVSs6UInt16_GS_S0__Ss14CollectionTypeSs_GVSs14EmptyGeneratorS0__GS2_S0__Ss13GeneratorTypeSs_SiSiSs16ForwardIndexTypeSs_SiSiSs18_SignedIntegerTypeSs_SiSiSs33_BuiltinIntegerLiteralConvertibleSs_Si_S0____TFVSs11_StringCore12replaceRangefRS_USs14CollectionType_USs13GeneratorType_Ss16ForwardIndexType_Ss18_SignedIntegerType_Ss33_BuiltinIntegerLiteralConvertible____FTGVSs5RangeSi_4withQ__T_ ---> function signature specialization <> of function signature specialization <Arg[0] = Exploded> of generic specialization <Swift.EmptyCollection<Swift.UInt16> with Swift.EmptyCollection<Swift.UInt16> : Swift.CollectionType in Swift, Swift.EmptyGenerator<Swift.UInt16> with Swift.EmptyGenerator<Swift.UInt16> : Swift.GeneratorType in Swift, Swift.Int with Swift.Int : Swift.ForwardIndexType in Swift, Swift.Int with Swift.Int : Swift._SignedIntegerType in Swift, Swift.Int with Swift.Int : Swift._BuiltinIntegerLiteralConvertible in Swift, Swift.Int, Swift.UInt16> of Swift._StringCore.replaceRange (inout Swift._StringCore)<A : Swift.CollectionType>(Swift.Range<Swift.Int>, with : A) -> ()
; CHECK: _TTSfg___TTSfs_d___TFVSs11_StringCoreCfMS_FVSs13_StringBufferS_ ---> function signature specialization <Arg[0] = Owned To Guaranteed> of function signature specialization <Arg[0] = Exploded, Arg[1] = Dead> of Swift._StringCore.init (Swift._StringCore.Type)(Swift._StringBuffer) -> Swift._StringCore
; CHECK: _TTSfd_i_d_i_d_i___TFVSs11_StringCoreCfMS_FVSs13_StringBufferS_ ---> function signature specialization <Arg[0] = Dead, Arg[1] = Value Promoted from InOut, Arg[2] = Dead, Arg[3] = Value Promoted from InOut, Arg[4] = Dead, Arg[5] = Value Promoted from InOut> of Swift._StringCore.init (Swift._StringCore.Type)(Swift._StringBuffer) -> Swift._StringCore
