...
// CHECK-NEXT:       {
// CHECK-NEXT:         "protocol": "testModB.testModBProtocol",
// CHECK-NEXT:         "definingModule": "testModB"
// CHECK-NEXT:       },
// CHECK-NEXT:       {
// CHECK-NEXT:         "protocol": "ExtractExternalConformances.MyProto",
// CHECK-NEXT:         "definingModule": "ExtractExternalConformances"
// CHECK-NEXT:       },
// CHECK-NEXT:       {
// CHECK-NEXT:         "protocol": "testModB.TestExternalConformanceProtocol",
// CHECK-NEXT:         "definingModule": "ExtractExternalConformances"
// CHECK-NEXT:       }
// CHECK-NEXT:     ],
