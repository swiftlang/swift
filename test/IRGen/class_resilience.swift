...
// CHECK-32-SAME: { [[INT]] [[#MDSIZE32]], i32 5, i32 [[#MDWORDS + 6 + 4]] }
// CHECK-64-SAME: { [[INT]] [[#MDSIZE64]], i32 5, i32 [[#MDWORDS + 3 + 4]] }
...
// CHECK-32-SAME: { [[INT]] [[#MDSIZE32]], i32 5, i32 [[#MDWORDS + 6 + 2]] }
// CHECK-64-SAME: { [[INT]] [[#MDSIZE64]], i32 5, i32 [[#MDWORDS + 3 + 2]] }

// CHECK: @"$s16class_resilience16MyResilientChildCMo" = {{(protected )?}}{{(dllexport )?}}constant [[BOUNDS]]
// CHECK-32-SAME: { [[INT]] [[#MDSIZE32 + WORDSIZE + WORDSIZE]], i32 5, i32 [[#MDWORDS + 6 + 3]] }
// CHECK-64-SAME: { [[INT]] [[#MDSIZE64 + WORDSIZE + WORDSIZE]], i32 5, i32 [[#MDWORDS + 3 + 3]] }

// CHECK: @"$s16class_resilience24MyResilientGenericParentCMo" = {{(protected )?}}{{(dllexport )?}}constant [[BOUNDS]]
// CHECK-32-SAME: { [[INT]] [[#MDSIZE32]], i32 5, i32 [[#MDWORDS + 6 + 3]] }
// CHECK-64-SAME: { [[INT]] [[#MDSIZE64]], i32 5, i32 [[#MDWORDS + 3 + 3]] }

// CHECK: @"$s16class_resilience24MyResilientConcreteChildCMo" = {{(protected )?}}{{(dllexport )?}}constant [[BOUNDS]]
// CHECK-32-SAME: { [[INT]] [[#MDSIZE32 + WORDSIZE + WORDSIZE + WORDSIZE]], i32 5, i32 [[#MDWORDS + 6 + 5]] }
// CHECK-64-SAME: { [[INT]] [[#MDSIZE64 + WORDSIZE + WORDSIZE + WORDSIZE]], i32 5, i32 [[#MDWORDS + 3 + 5]] }
