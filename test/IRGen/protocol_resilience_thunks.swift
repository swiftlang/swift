...
// CHECK-LABEL: define{{( dllexport)?}}{{( protected)?}} swiftcc void @"$S26protocol_resilience_thunks19MyResilientProtocolP12throwingFuncyyKFTj"(%swift.opaque* noalias nocapture swiftself, %swift.error**{{( noalias nocapture swifterror dereferenceable\(8\))?}}, %swift.type*, i8**)
...
// CHECK-NEXT: call swiftcc void [[FN]](%swift.opaque* noalias nocapture swiftself %0, %swift.error**{{( noalias nocapture swifterror dereferenceable\(8\))?}} %1, %swift.type* %2, i8** %3)
// CHECK-NEXT: ret void
