...
// RUN: %target-swift-frontend -sdk %S/Inputs -I %t -primary-file %s -emit-ir -disable-incremental-llvm-codegen -disable-objc-attr-requires-foundation-module | FileCheck %s
