...
struct Impl: P {
    ...
    // CHECK:   call swiftcc void @swift_willThrowTyped(ptr noalias undef, ptr getelementptr inbounds (<{ i64, i64, ptr, ptr, i64, ptr }>, ptr @"$s16typed_throws_abi5EmptyVMf", i32 0, i32 4), ptr [[ERROR_WITNESS]])
    ...
    // CHECK:   call swiftcc void @swift_willThrowTyped(ptr noalias [[ERROR]], ptr getelementptr inbounds (<{ i64, i64, ptr, ptr, i64, ptr, i32, [4 x i8] }>, ptr @"$s16typed_throws_abi7OneWordVMf", i32 0, i32 4), ptr [[ERROR_WITNESS]])
    // CHECK:   store ptr inttoptr (i64 1 to ptr), ptr %2, align 8
    // CHECK:   ret i64 {{%.*}}
    // CHECK: }
    ...
    // CHECK:   call swiftcc void @swift_willThrowTyped(ptr noalias [[ERROR]], ptr getelementptr inbounds (<{ i64, i64, ptr, ptr, i64, ptr, i32, i32 }>, ptr @"$s16typed_throws_abi8TwoWordsVMf", i32 0, i32 4), ptr [[ERROR_WITNESS]])
    // CHECK:   store ptr inttoptr (i64 1 to ptr), ptr %2, align 8
    // CHECK:   ret { i64, i64 } {{%.*}}
    // CHECK: }
    ...
    // CHECK:   call swiftcc void @swift_willThrowTyped(ptr noalias [[ERROR]], ptr getelementptr inbounds (<{ i64, i64, ptr, ptr, i64, ptr, i32, i32, i32, [4 x i8] }>, ptr @"$s16typed_throws_abi10ThreeWordsVMf", i32 0, i32 4), ptr [[ERROR_WITNESS]])
    // CHECK:   store ptr inttoptr (i64 1 to ptr), ptr %2, align 8
    // CHECK:   ret { i64, i64, i64 } {{%.*}}
    // CHECK: }
