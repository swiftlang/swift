...
// CHECK: [[RESULT:%.*]] = call swiftcc ptr @swift_task_addCancellationHandler(ptr @"$s8builtins30testTaskAddCancellationHandlerSV_SVtyYaFyycfU_", ptr null)
...
// CHECK: [[RESULT_2:%.*]] = call swiftcc ptr @swift_task_addCancellationHandler(ptr @"$s8builtins30testTaskAddCancellationHandlerSV_SVtyYaFyycfU0_TA", ptr [[CONTEXT]])
...
// CHECK: [[RESULT:%.*]] = call swiftcc ptr @swift_task_addPriorityEscalationHandler(ptr @"$s8builtins36testTaskAddPriorityEscalationHandlerSV_SVtyYaFys5UInt8V_ADtcfU_", ptr null)
// CHECK: [[STR:%.*]] = call {{.*}}@swift_allocObject(ptr getelementptr inbounds (%swift.full_boxmetadata, ptr @metadata.3, i32 0, i32 2), i64 32, i64 7)
// CHECK: [[RESULT_2:%.*]] = call swiftcc ptr @swift_task_addPriorityEscalationHandler(ptr @"$s8builtins36testTaskAddPriorityEscalationHandlerSV_SVtyYaFys5UInt8V_ADtcfU0_TA", ptr [[STR]])
// CHECK: musttail call swifttailcc void {{%.*}}(ptr swiftasync {{%.*}}, ptr [[RESULT]], ptr [[RESULT_2]])
