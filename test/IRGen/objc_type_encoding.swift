...
// RUN: %target-swift-frontend(mock-sdk: -sdk %S/Inputs -I %t) %s -emit-ir -disable-incremental-llvm-codegen -disable-objc-attr-requires-foundation-module | FileCheck %s -check-prefix=CHECK-%target-os
