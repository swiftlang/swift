...
// CHECK-macosx: [[ENC3:@.*]] = private unnamed_addr constant [27 x i8] c"v24@0:8@\22MyCustomObject\2216\00"
// CHECK-macosx: @_PROTOCOL_METHOD_TYPES__TtP18objc_type_encoding10MyProtocol_ = private constant { [3 x i8*] } { [3 x i8*] [i8* getelementptr inbounds ([35 x i8], [35 x i8]* [[ENC1]], i64 0, i64 0), i8* getelementptr inbounds ([46 x i8], [46 x i8]* [[ENC2]], i64 0, i64 0), i8* getelementptr inbounds ([27 x i8], [27 x i8]* [[ENC3]], i64 0, i64 0)] }
...
// CHECK-ios: [[ENC3:@.*]] = private unnamed_addr constant [27 x i8] c"v24@0:8@\22MyCustomObject\2216\00"
// CHECK-ios: @_PROTOCOL_METHOD_TYPES__TtP18objc_type_encoding10MyProtocol_ = private constant { [3 x i8*] } { [3 x i8*] [i8* getelementptr inbounds ([35 x i8], [35 x i8]* [[ENC1]], i64 0, i64 0), i8* getelementptr inbounds ([46 x i8], [46 x i8]* [[ENC2]], i64 0, i64 0), i8* getelementptr inbounds ([27 x i8], [27 x i8]* [[ENC3]], i64 0, i64 0)] }
