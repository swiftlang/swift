...
public struct G3<T: P6 & P4>: P3 where T.A4.A1: P1 {
  ...
  // CHECK-LABEL: define internal swiftcc i32 @"$s28fulfillment_map_key_equality2G3VyxGAA2P3A2aEP1xs5Int32VvgTW"(ptr noalias swiftself align 1 captures(none) %0, ptr %Self, ptr %SelfWitnessTable) {{.*}} {
