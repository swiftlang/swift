...
//    CHECK-SAME:   i8**, 
//    CHECK-SAME:   [[INT]], 
//   CHECK-apple:  %objc_class*
// CHECK-unknown: %swift.type*, 
...
//    CHECK-SAME:   [[INT]], 
//   CHECK-apple:   %T4main5Value[[UNIQUE_ID_1]]C* (%swift.opaque*, %swift.type*)* 
//    CHECK-SAME: }> <{ 
//    CHECK-SAME:   void (%T4main5Value[[UNIQUE_ID_1]]C*)* 
//    CHECK-SAME:   @"$s4main5Value[[UNIQUE_ID_1]]CfD", 
//    CHECK-SAME:   i8** @"$sBoWV", 
//   CHECK-apple:   [[INT]] ptrtoint (%objc_class* @"$s4main5Value[[UNIQUE_ID_1]]CySiGMM" to [[INT]]), 
//   CHECK-apple:   %objc_class* @"OBJC_CLASS_$__TtCs12_SwiftObject", 
//   CHECK-apple:   %swift.opaque* @_objc_empty_cache, 
//   CHECK-apple:   %swift.opaque* null, 
//   CHECK-apple:   [[INT]] add (
//   CHECK-apple:     [[INT]] ptrtoint (
//   CHECK-apple:       { 
//   CHECK-apple:         i32, 
//   CHECK-apple:         i32, 
//   CHECK-apple:         i32, 
...
//   CHECK-apple:         i8*, 
//   CHECK-apple:         i8*, 
//   CHECK-apple:         { i32, i32, [1 x { [[INT]]*, i8*, i8*, i32, i32 }] }*, 
//   CHECK-apple:         i8*, 
//   CHECK-apple:         i8* 
//   CHECK-apple:       }* @_DATA__TtC4mainP[[UNIQUE_ID_2:[0-9A-Z_]+]]5Value to [[INT]]
//   CHECK-apple:     ), 
//   CHECK-apple:     [[INT]] 2
//   CHECK-apple:   ), 
// CHECK-unknown:  i64 0, 
// CHECK-unknown:  %swift.type* null, 
// CHECK-unknown:  %swift.opaque* null, 
// CHECK-unknown:  %swift.opaque* null, 
// CHECK-unknown:  i64 1,
//    CHECK-SAME:   i32 26, 
//    CHECK-SAME:   i32 0, 
...
//    CHECK-SAME:   i32 {{(16|8)}}, 
//    CHECK-SAME:   %swift.type_descriptor* bitcast (<{ i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i16, i16, i16, i16, i8, i8, i8, i8, i32, i32, %swift.method_descriptor }>* @"$s4main5Value[[UNIQUE_ID_1]]CMn" to %swift.type_descriptor*), 
//    CHECK-SAME:   i8* null, 
