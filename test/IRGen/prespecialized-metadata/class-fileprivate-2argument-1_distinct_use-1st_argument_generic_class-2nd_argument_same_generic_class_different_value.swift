...
//         CHECK-SAME:   i8** @"$sBoWV", 
//   CHECK-apple-SAME:   [[INT]] ptrtoint (%objc_class* @"$s4main5Value[[UNIQUE_ID_1]]LLCyAA9Argument1ACLLCySiGAFySSGGMM" to [[INT]]), 
...
//         CHECK-SAME:     }>* @"$s4main5Value[[UNIQUE_ID_1]]LLCMn" to %swift.type_descriptor*
//         CHECK-SAME:   ),
//         CHECK-SAME:   i8* null,
