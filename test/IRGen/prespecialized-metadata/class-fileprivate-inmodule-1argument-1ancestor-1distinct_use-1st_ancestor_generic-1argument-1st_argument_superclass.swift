...
//   CHECK-apple-SAME:    %objc_class* @"$s4main5Value[[UNIQUE_ID_1]]LLCyAA9Ancestor1ACLLCySSGGMM" to [[INT]]
//   CHECK-apple-SAME:  ),
...
//         CHECK-SAME:          %swift.type*
//         CHECK-SAME:        )*
//         CHECK-SAME:      }>* @"$s4main9Ancestor1[[UNIQUE_ID_1]]LLCyADySSGGMf" to %swift.full_heapmetadata*
//         CHECK-SAME:    ),
//         CHECK-SAME:    i32 0,
//         CHECK-SAME:    i32 2
//         CHECK-SAME:  ),
