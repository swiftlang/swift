...
// CHECK-WMO: define linkonce_odr void @"_swift_FORCE_LOAD_$_TEST"()
...
// CHECK-WMO-THREADED: define linkonce_odr void @"_swift_FORCE_LOAD_$_TEST"()
// CHECK-WMO-THREADED: source_filename = "-"
...
// CHECK-SINGLE-FILE-FIRST: define linkonce_odr void @"_swift_FORCE_LOAD_$_TEST"()
// CHECK-SINGLE-FILE-FIRST-NOT: source_filename

// CHECK-SINGLE-FILE-SECOND: source_filename = "-"
// CHECK-SINGLE-FILE-SECOND: define linkonce_odr void @"_swift_FORCE_LOAD_$_TEST"()
