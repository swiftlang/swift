...
class Foo {
  // x86_64-macosx: define hidden swiftcc { i64, i64 } @_T08abitypes3FooC3bar{{[_0-9a-zA-Z]*}}F(%C8abitypes3Foo* swiftself) {{.*}} {
  // x86_64-macosx: define hidden { <2 x float>, <2 x float> } @_T08abitypes3FooC3bar{{[_0-9a-zA-Z]*}}FTo(i8*, i8*) unnamed_addr {{.*}} {
  // x86_64-ios: define hidden swiftcc { i64, i64 } @_T08abitypes3FooC3bar{{[_0-9a-zA-Z]*}}F(%C8abitypes3Foo* swiftself) {{.*}} {
  // x86_64-ios: define hidden { <2 x float>, <2 x float> } @_T08abitypes3FooC3bar{{[_0-9a-zA-Z]*}}FTo(i8*, i8*) unnamed_addr {{.*}} {
  // i386-ios: define hidden swiftcc void @_T08abitypes3FooC3bar{{[_0-9a-zA-Z]*}}F(%VSC6MyRect* noalias nocapture sret, %C8abitypes3Foo* swiftself) {{.*}} {
  // i386-ios: define hidden void @_T08abitypes3FooC3bar{{[_0-9a-zA-Z]*}}FTo(%VSC6MyRect* noalias nocapture sret, i8*, i8*) unnamed_addr {{.*}} {
  // armv7-ios: define hidden swiftcc { float, float, float, float } @_T08abitypes3FooC3bar{{[_0-9a-zA-Z]*}}F(%C8abitypes3Foo* swiftself) {{.*}} {
  // armv7-ios: define hidden void @_T08abitypes3FooC3bar{{[_0-9a-zA-Z]*}}FTo(%VSC6MyRect* noalias nocapture sret, i8*, i8*) unnamed_addr {{.*}} {
  // armv7s-ios: define hidden swiftcc { float, float, float, float } @_T08abitypes3FooC3bar{{[_0-9a-zA-Z]*}}F(%C8abitypes3Foo* swiftself) {{.*}} {
  // armv7s-ios: define hidden void @_T08abitypes3FooC3bar{{[_0-9a-zA-Z]*}}FTo(%VSC6MyRect* noalias nocapture sret, i8*, i8*) unnamed_addr {{.*}} {
  // arm64-ios: define hidden swiftcc { i64, i64 } @_T08abitypes3FooC3bar{{[_0-9a-zA-Z]*}}F(%C8abitypes3Foo* swiftself) {{.*}} {
  // arm64-ios: define hidden [[ARM64_MYRECT]] @_T08abitypes3FooC3bar{{[_0-9a-zA-Z]*}}FTo(i8*, i8*) unnamed_addr {{.*}} {
  // x86_64-tvos: define hidden swiftcc { i64, i64 } @_T08abitypes3FooC3bar{{[_0-9a-zA-Z]*}}F(%C8abitypes3Foo* swiftself) {{.*}} {
  // x86_64-tvos: define hidden { <2 x float>, <2 x float> } @_T08abitypes3FooC3bar{{[_0-9a-zA-Z]*}}FTo(i8*, i8*) unnamed_addr {{.*}} {
  // arm64-tvos: define hidden swiftcc { i64, i64 }  @_T08abitypes3FooC3bar{{[_0-9a-zA-Z]*}}F(%C8abitypes3Foo* swiftself) {{.*}} {
  // arm64-tvos: define hidden [[ARM64_MYRECT]] @_T08abitypes3FooC3bar{{[_0-9a-zA-Z]*}}FTo(i8*, i8*) unnamed_addr {{.*}} {
  // i386-watchos: define hidden swiftcc void @_T08abitypes3FooC3bar{{[_0-9a-zA-Z]*}}F(%VSC6MyRect* noalias nocapture sret, %C8abitypes3Foo* swiftself) {{.*}} {
  ...
  // armv7k-watchos: define hidden swiftcc { float, float, float, float } @_T08abitypes3FooC3bar{{[_0-9a-zA-Z]*}}F(%C8abitypes3Foo* swiftself) {{.*}} {
  ...
  // x86_64-macosx: define hidden swiftcc double @_T08abitypes3FooC14getXFromNSRect{{[_0-9a-zA-Z]*}}F(double, double, double, double, %C8abitypes3Foo* swiftself) {{.*}} {
  ...
  // armv7-ios: define hidden swiftcc double @_T08abitypes3FooC14getXFromNSRect{{[_0-9a-zA-Z]*}}F(float, float, float, float, %C8abitypes3Foo* swiftself) {{.*}} {
  // armv7-ios: define hidden double @_T08abitypes3FooC14getXFromNSRect{{[_0-9a-zA-Z]*}}FTo(i8*, i8*, [4 x i32]) unnamed_addr {{.*}} {
  // armv7s-ios: define hidden swiftcc double @_T08abitypes3FooC14getXFromNSRect{{[_0-9a-zA-Z]*}}F(float, float, float, float, %C8abitypes3Foo* swiftself) {{.*}} {
  // armv7s-ios: define hidden double @_T08abitypes3FooC14getXFromNSRect{{[_0-9a-zA-Z]*}}FTo(i8*, i8*, [4 x i32]) unnamed_addr {{.*}} {
  // armv7k-watchos: define hidden swiftcc double @_T08abitypes3FooC14getXFromNSRect{{[_0-9a-zA-Z]*}}F(float, float, float, float, %C8abitypes3Foo* swiftself) {{.*}} {
  ...
  // x86_64-macosx: define hidden swiftcc float @_T08abitypes3FooC12getXFromRect{{[_0-9a-zA-Z]*}}F(i64, i64, %C8abitypes3Foo* swiftself) {{.*}} {
  // x86_64-macosx: define hidden float @_T08abitypes3FooC12getXFromRect{{[_0-9a-zA-Z]*}}FTo(i8*, i8*, <2 x float>, <2 x float>) unnamed_addr {{.*}} {
  // armv7-ios: define hidden swiftcc float @_T08abitypes3FooC12getXFromRect{{[_0-9a-zA-Z]*}}F(float, float, float, float, %C8abitypes3Foo* swiftself) {{.*}} {
  // armv7-ios: define hidden float @_T08abitypes3FooC12getXFromRect{{[_0-9a-zA-Z]*}}FTo(i8*, i8*, [4 x i32]) unnamed_addr {{.*}} {
  // armv7s-ios: define hidden swiftcc float @_T08abitypes3FooC12getXFromRect{{[_0-9a-zA-Z]*}}F(float, float, float, float, %C8abitypes3Foo* swiftself) {{.*}} {
  // armv7s-ios: define hidden float @_T08abitypes3FooC12getXFromRect{{[_0-9a-zA-Z]*}}FTo(i8*, i8*, [4 x i32]) unnamed_addr {{.*}} {
  // armv7k-watchos: define hidden swiftcc float @_T08abitypes3FooC12getXFromRect{{[_0-9a-zA-Z]*}}F(float, float, float, float, %C8abitypes3Foo* swiftself) {{.*}} {
  ...
  // x86_64-macosx: define hidden swiftcc float @_T08abitypes3FooC25getXFromRectIndirectSwift{{[_0-9a-zA-Z]*}}F(i64, i64, %C8abitypes3Foo* swiftself) {{.*}} {
  ...
  // x86_64-macosx:      define hidden swiftcc float @_T08abitypes3FooC4barc{{[_0-9a-zA-Z]*}}F(%CSo13StructReturns*, %C8abitypes3Foo* swiftself) {{.*}} {
  ...
  // armv7-ios: define hidden swiftcc float @_T08abitypes3FooC4barc{{[_0-9a-zA-Z]*}}F(%CSo13StructReturns*, %C8abitypes3Foo* swiftself) {{.*}} {
  ...
  // armv7s-ios: define hidden swiftcc float @_T08abitypes3FooC4barc{{[_0-9a-zA-Z]*}}F(%CSo13StructReturns*, %C8abitypes3Foo* swiftself) {{.*}} {
  ...
  // armv7k-watchos:      define hidden swiftcc float @_T08abitypes3FooC4barc{{[_0-9a-zA-Z]*}}F(%CSo13StructReturns*, %C8abitypes3Foo* swiftself) {{.*}} {
  ...
  // x86_64-macosx: define hidden swiftcc { double, double, double } @_T08abitypes3FooC3baz{{[_0-9a-zA-Z]*}}F(%C8abitypes3Foo* swiftself) {{.*}} {
  ...
  // x86_64-macosx:      define hidden swiftcc double @_T08abitypes3FooC4bazc{{[_0-9a-zA-Z]*}}F(%CSo13StructReturns*, %C8abitypes3Foo* swiftself) {{.*}} {
  ...
  // x86_64-macosx:      define hidden swiftcc i64 @_T08abitypes3FooC7getpair{{[_0-9a-zA-Z]*}}F(%CSo13StructReturns*, %C8abitypes3Foo* swiftself) {{.*}} {
  ...
  // x86_64-macosx:      define hidden swiftcc i64 @_T08abitypes3FooC9getnested{{[_0-9a-zA-Z]*}}F(%CSo13StructReturns*, %C8abitypes3Foo* swiftself) {{.*}} {
  ...
  // x86_64-macosx:       define hidden swiftcc i1 @_T08abitypes3FooC6negate{{[_0-9a-zA-Z]*}}F(i1, %C8abitypes3Foo* swiftself) {{.*}} {
  ...
  // i386-watchos:  define hidden swiftcc i1 @_T08abitypes3FooC6negate{{[_0-9a-zA-Z]*}}F(i1, %C8abitypes3Foo* swiftself)
  ...
  // x86_64-macosx: define hidden swiftcc i1 @_T08abitypes3FooC7negate2{{[_0-9a-zA-Z]*}}F(i1, %C8abitypes3Foo* swiftself) {{.*}} {
  ...
  //
  // x86_64-ios: define hidden swiftcc i1 @_T08abitypes3FooC7negate2{{[_0-9a-zA-Z]*}}F(i1, %C8abitypes3Foo* swiftself) {{.*}} {
  ...
  //
  // armv7-ios: define hidden swiftcc i1 @_T08abitypes3FooC7negate2{{[_0-9a-zA-Z]*}}F(i1, %C8abitypes3Foo* swiftself) {{.*}} {
  ...
  //
  // armv7s-ios: define hidden swiftcc i1 @_T08abitypes3FooC7negate2{{[_0-9a-zA-Z]*}}F(i1, %C8abitypes3Foo* swiftself) {{.*}} {
  ...
  //
  // arm64-ios: define hidden swiftcc i1 @_T08abitypes3FooC7negate2{{[_0-9a-zA-Z]*}}F(i1, %C8abitypes3Foo* swiftself) {{.*}} {
  ...
  //
  // i386-ios: define hidden swiftcc i1 @_T08abitypes3FooC7negate2{{[_0-9a-zA-Z]*}}F(i1, %C8abitypes3Foo* swiftself) {{.*}} {
  ...
  //
  // x86_64-tvos: define hidden swiftcc i1 @_T08abitypes3FooC7negate2{{[_0-9a-zA-Z]*}}F(i1, %C8abitypes3Foo* swiftself) {{.*}} {
  ...
  //
  // arm64-tvos: define hidden swiftcc i1 @_T08abitypes3FooC7negate2{{[_0-9a-zA-Z]*}}F(i1, %C8abitypes3Foo* swiftself) {{.*}} {
  ...
  // i386-watchos: define hidden swiftcc i1 @_T08abitypes3FooC7negate2{{[_0-9a-zA-Z]*}}F(i1, %C8abitypes3Foo* swiftself) {{.*}} {
  ...
  //
  // armv7k-watchos: define hidden swiftcc i1 @_T08abitypes3FooC7negate2{{[_0-9a-zA-Z]*}}F(i1, %C8abitypes3Foo* swiftself) {{.*}} {
  ...
  // x86_64-macosx: define hidden swiftcc i1 @_T08abitypes3FooC7negate3SbSbF(i1, %C8abitypes3Foo* swiftself) {{.*}} {
  ...
  // x86_64-ios: define hidden swiftcc i1 @_T08abitypes3FooC7negate3SbSbF(i1, %C8abitypes3Foo* swiftself) {{.*}} {
  ...
  // i386-ios: define hidden swiftcc i1 @_T08abitypes3FooC7negate3SbSbF(i1, %C8abitypes3Foo* swiftself) {{.*}} {
  ...
  // x86_64-macosx: define hidden swiftcc void @_T08abitypes3FooC10throwsTestySbKF(i1, %C8abitypes3Foo* swiftself, %swift.error** swifterror) {{.*}} {
  ...
  // x86_64-ios: define hidden swiftcc void @_T08abitypes3FooC10throwsTestySbKF(i1, %C8abitypes3Foo* swiftself, %swift.error** swifterror) {{.*}} {
  ...
  // i386-ios: define hidden swiftcc void @_T08abitypes3FooC10throwsTestySbKF(i1, %C8abitypes3Foo* swiftself, %swift.error**) {{.*}} {
  ...
  // x86_64-macosx: define hidden swiftcc i32 @_T08abitypes3FooC10getRawEnum{{[_0-9a-zA-Z]*}}F(%C8abitypes3Foo* swiftself) {{.*}} {
  ...
  dynamic func testArchetype(_ work: Work) {
    ...
    // x86_64-macosx: call swiftcc void @_T08abitypes3FooC13testArchetype{{[_0-9a-zA-Z]*}}F(%objc_object* [[OBJCPTR]], %C8abitypes3Foo* swiftself %{{.*}})
  }
  ...
  // x86_64-macosx: define hidden swiftcc void @_T08abitypes3FooC20testGenericTypeParam{{[_0-9a-zA-Z]*}}F(%objc_object*, %swift.type* %T, %C8abitypes3Foo* swiftself) {{.*}} {
  ...
  // arm64-ios: define hidden swiftcc { i64, i64, i64, i64 } @_T08abitypes3FooC14callJustReturn{{[_0-9a-zA-Z]*}}F(%CSo13StructReturns*, i64, i64, i64, i64, %C8abitypes3Foo* swiftself) {{.*}} {
  ...
  //
  // arm64-tvos: define hidden swiftcc { i64, i64, i64, i64 } @_T08abitypes3FooC14callJustReturn{{[_0-9a-zA-Z]*}}F(%CSo13StructReturns*, i64, i64, i64, i64, %C8abitypes3Foo* swiftself) {{.*}} {
