// RUN: %target-swift-frontend(mock-sdk: %clang-importer-sdk) -I %S/Inputs/abi %s -emit-ir -disable-incremental-llvm-codegen | FileCheck -check-prefix=%target-cpu-%target-os %s
