...
// CHECK-LABEL: define hidden void @_TF17generic_same_type13intCollection{{.*}}(%swift.opaque* noalias, %swift.type* %C, i8** %C.CollectionType, %swift.type* %C.Generator, i8** %C.Generator.GeneratorType, %swift.type* %C.Generator.Element, %swift.type* %C._Element)
