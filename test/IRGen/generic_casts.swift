...
func allToInt<T>(x: T) -> Int {
  ...
  // CHECK: call i1 @swift_dynamicCast(%swift.opaque* [[T0]], %swift.opaque* [[TEMP]], %swift.type* %T, %swift.type* @_TMdSi, i64 7)
...
func intToAll<T>(x: Int) -> T {
  ...
  // CHECK: [[T0:%.*]] = bitcast %Si* [[INT_TEMP]] to %swift.opaque*
  // CHECK: call i1 @swift_dynamicCast(%swift.opaque* %0, %swift.opaque* [[T0]], %swift.type* @_TMdSi, %swift.type* %T, i64 7)
  return x as! T
}
