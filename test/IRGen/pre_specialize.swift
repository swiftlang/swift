...
// CHECK-A-DAG: define{{( dllexport)?}}{{( protected)?}} swiftcc void @"$s1A13InternalThingV9computedXxvsSi_Ts5"([[INT]] %0, ptr noalias {{(nofree )?}}swiftself {{(writeonly )?}}align {{(4|8)}} captures(none) dereferenceable({{(4|8)}}){{.*}} %1)
...
// CHECK-A-DAG: define{{( dllexport)?}}{{( protected)?}} swiftcc void @"$s1A13InternalThingVyxSicisSi_Ts5"([[INT]] %0, [[INT]] %1, ptr noalias {{(nofree )?}}swiftself {{(writeonly )?}}align {{(4|8)}} captures(none) dereferenceable({{(4|8)}}){{.*}} %2)
...
// specialized InternalThing.computedX.setter
// CHECK-B-DAG: define{{( dllexport)?}}{{( protected)?}} swiftcc void @"$s1A13InternalThingV9computedXxvs1B07AnotherB0C_Ts5"(ptr %0, ptr noalias {{(nofree )?}}swiftself align {{(4|8)}} captures(none) dereferenceable({{(4|8)}}) %1)
...
// specialized InternalThing.subscript.setter
// CHECK-B-DAG: define{{( dllexport)?}}{{( protected)?}} swiftcc void @"$s1A13InternalThingVyxSicis1B07AnotherB0C_Ts5"(ptr %0, [[INT]] %1, ptr noalias {{(nofree )?}}swiftself align {{(4|8)}} captures(none) dereferenceable({{(4|8)}}) %2)
