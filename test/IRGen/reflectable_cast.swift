...
// RUN: %target-swift-frontend -DFULL -enable-full-reflection-metadata -target %target-cpu-apple-macosx99.99 -emit-ir %s | %FileCheck %s --check-prefix=CHECK-FULL
...
public class ReflectableCasts {
	...
	// CHECK-OPT-IN-LABEL: define swiftcc void @"$s16reflectable_cast16ReflectableCastsC26conditionalCastCompositionys0C0_pSgAA1ROFZ"({{.*}})
	// CHECK-OPT-IN-DAG: call zeroext i1 @swift_reflectableCast(%swift.opaque* {{%.*}}, %swift.opaque* {{.*}}{{%.*}}, %swift.type* {{.*}}, %swift.type* {{.*}}, {{.*}})
	// CHECK-OPT-IN-DAG: ret void

	// CHECK-FULL-LABEL: define swiftcc void @"$s16reflectable_cast16ReflectableCastsC26conditionalCastCompositionys0C0_pSgAA1ROFZ"({{.*}})
	// CHECK-FULL-DAG: call zeroext i1 @swift_reflectableCast(%swift.opaque* {{%.*}}, %swift.opaque* {{.*}}{{%.*}}, %swift.type* {{.*}}, %swift.type* {{.*}}, {{.*}})
	// CHECK-FULL-DAG: ret void
	public static func conditionalCastComposition(_ s: R) -> Reflectable? {
		return s as? Reflectable & P
	}
	...
	// CHECK-OPT-IN-LABEL: define swiftcc void @"$s16reflectable_cast16ReflectableCastsC20forceCastCompositionys0C0_pAA1ROFZ"({{.*}})
	// CHECK-OPT-IN-DAG: call zeroext i1 @swift_reflectableCast(%swift.opaque* {{%.*}}, %swift.opaque* {{.*}}{{%.*}}, %swift.type* {{.*}}, %swift.type* {{.*}}, {{.*}})
	// CHECK-OPT-IN-DAG: ret void

	// CHECK-FULL-LABEL: define swiftcc void @"$s16reflectable_cast16ReflectableCastsC20forceCastCompositionys0C0_pAA1ROFZ"({{.*}})
	// CHECK-FULL-DAG: call zeroext i1 @swift_reflectableCast(%swift.opaque* {{%.*}}, %swift.opaque* {{.*}}{{%.*}}, %swift.type* {{.*}}, %swift.type* {{.*}}, {{.*}})
	// CHECK-FULL-DAG: ret void
	public static func forceCastComposition(_ s: R) -> Reflectable {
		return s as! Reflectable & P
	}
	...
	// CHECK-OPT-IN-LABEL: define swiftcc i1 @"$s16reflectable_cast16ReflectableCastsC17isTestCompositionySbAA1ROFZ"({{.*}})
	// CHECK-OPT-IN-DAG: call zeroext i1 @swift_reflectableCast(%swift.opaque* {{.*}}{{%.*}}, %swift.opaque* {{.*}}{{%.*}}, %swift.type* {{.*}}, %swift.type* {{.*}}, {{.*}})
	// CHECK-OPT-IN-DAG: ret i1 {{%[0-9]+}}

	// CHECK-FULL-LABEL: define swiftcc i1 @"$s16reflectable_cast16ReflectableCastsC17isTestCompositionySbAA1ROFZ"({{.*}})
	// CHECK-FULL-DAG: call zeroext i1 @swift_reflectableCast(%swift.opaque* {{.*}}{{%.*}}, %swift.opaque* {{.*}}{{%.*}}, %swift.type* {{.*}}, %swift.type* {{.*}}, {{.*}})
	// CHECK-FULL-DAG: ret i1 {{%[0-9]+}}
	public static func isTestComposition(_ s: R) -> Bool {
		return s is Reflectable & P
	}
}
