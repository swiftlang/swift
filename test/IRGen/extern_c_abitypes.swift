...
func test() {
  ...
  //
  // CHECK-x86_64: call void     @c_roundtrip_c_struct(ptr noalias sret(%TSo8c_structV) captures(none) {{.*}}, ptr{{( byval\(%struct.c_struct\))?}}[[ALIGN:(align [0-9]+)?]] {{.*}})
  // CHECK-x86_64: call void @swift_roundtrip_c_struct(ptr noalias sret(%TSo8c_structV) captures(none)   {{.*}}, ptr{{( byval\(%TSo8c_structV\))?}}[[ALIGN]] {{.*}})
  // CHECK-arm64:  call void     @c_roundtrip_c_struct(ptr noalias sret(%TSo8c_structV) captures(none) {{.*}}, ptr{{( byval\(%struct.c_struct\))?}}[[ALIGN:(align [0-9]+)?]] {{.*}})
  // CHECK-arm64:  call void @swift_roundtrip_c_struct(ptr noalias sret(%TSo8c_structV) captures(none)   {{.*}}, ptr{{( byval\(%TSo8c_structV\))?}}[[ALIGN]] {{.*}})
  // CHECK-wasm32: call void     @c_roundtrip_c_struct(ptr noalias sret(%TSo8c_structV) captures(none) {{.*}}, ptr{{( byval\(%struct.c_struct\))?}}[[ALIGN:(align [0-9]+)?]] {{.*}})
  // CHECK-wasm32: call void @swift_roundtrip_c_struct(ptr noalias sret(%TSo8c_structV) captures(none)   {{.*}}, ptr{{( byval\(%TSo8c_structV\))?}}[[ALIGN]] {{.*}})
