...
// CHECK-OPT-LABEL: define{{.*}}swiftcc void @"$s13inout_noalias6rotateyys11InlineArrayVy$63_SdGz_AEzS2dtF"(ptr noalias {{(nofree )?}}align 8 captures(none) dereferenceable(512) %0, ptr noalias {{(nofree )?}}align 8 captures(none) dereferenceable(512) %1, double %2, double %3) {{.*}} {
