...
// CHECK-OPT-LABEL: define{{.*}}swiftcc void @"$s13inout_noalias6rotateyys11InlineArrayVy$63_SdGz_AEzS2dtF"(ptr noalias align 8 {{(nofree )?}}captures(none) dereferenceable(512) %0, ptr noalias align 8 {{(nofree )?}}captures(none) dereferenceable(512) %1, double %2, double %3) {{.*}} {
