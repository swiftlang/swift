...
// Setter definition
// CHECK: define{{.*}} swiftcc void @"$s24coroutine_accessors_past02OhD0V1gSivs"(i64 %0, ptr noalias swiftself align 8 captures(none) dereferenceable(8) %1) #0

// yielding mutate definition
// CHECK: define{{.*}} {{(swiftcc|swiftcorocc)}} { ptr, ptr } @"$s24coroutine_accessors_past02OhD0V1gSivx"(ptr noalias %0, ptr{{( swiftcoro)?}} %1, ptr noalias swiftself align 8 captures(none) dereferenceable(8) %2)
