...
// OSIZE: define internal i8** @"$S21same_type_constraints12GenericKlazzCyxq_GAA1EAAH4Data_AA0F4TypePWT"(%swift.type* %"GenericKlazz<T, R>.Data", %swift.type* nocapture readonly %"GenericKlazz<T, R>", i8** nocapture readnone %"GenericKlazz<T, R>.E") [[ATTRS:#[0-9]+]] {
