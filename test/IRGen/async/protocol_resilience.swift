...
// CHECK-INDIRECT: [[TMP4:%.*]] = and i64 ptrtoint (ptr inttoptr (i64 add (i64 ptrtoint (ptr @"\01__imp_$s18resilient_protocol9AwaitableP4wait6ResultQzyYaFTjTu" to i64), i64 1) to ptr) to i64), 1
// CHECK-INDIRECT: [[TMP5:%.*]] = icmp eq i64 [[TMP4]], 0
// CHECK-INDIRECT: [[TMP6:%.*]] = and i64 ptrtoint (ptr inttoptr (i64 add (i64 ptrtoint (ptr @"\01__imp_$s18resilient_protocol9AwaitableP4wait6ResultQzyYaFTjTu" to i64), i64 1) to ptr) to i64), -2
