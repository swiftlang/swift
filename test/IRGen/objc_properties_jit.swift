// RUN: %target-swift-frontend(mock-sdk: %clang-importer-sdk) %s -emit-ir -disable-incremental-llvm-codegen -disable-objc-attr-requires-foundation-module -use-jit | FileCheck %s
