...
// RUN: %target-swift-frontend %S/Inputs/multithread_module/main.swift -emit-ir -disable-incremental-llvm-codegen -o %t/main.ll %s -o %t/mt_module.ll -num-threads 2 -O -g -module-name test
