...
// CHECK-LABEL: define hidden void @_TF34witness_table_objc_associated_type32witnessOffsetAfterAssociatedTypeuRq_S_1B_Fq_T_(%swift.opaque*, %swift.type* %T, i8** %T.B, %swift.type* %T.AA, i8** %T.AA.A)
...
// CHECK-LABEL: define hidden void @_TF34witness_table_objc_associated_type36witnessOffsetAfterAssociatedTypeObjCuRq_S_1C_Fq_T_(%swift.opaque*, %swift.type* %T, i8** %T.C, %swift.type* %T.OO) {{.*}} {
