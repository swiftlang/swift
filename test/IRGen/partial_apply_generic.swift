...
// CHECK-LABEL: define internal void @_TPA__TF21partial_apply_generic16hugeStructReturn{{.*}}(%V21partial_apply_generic10HugeStruct* noalias sret, %V21partial_apply_generic10HugeStruct* byval align {{4|8}}, %swift.refcounted*) {{.*}} {
// CHECK:   tail call void @_TF21partial_apply_generic16hugeStructReturn{{.*}}(%V21partial_apply_generic10HugeStruct* noalias sret %0, %V21partial_apply_generic10HugeStruct* byval align {{4|8}} %1)
// CHECK:   ret void
// CHECK: }
