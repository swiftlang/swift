...
// RUN: %target-swift-frontend -sdk %S/Inputs -primary-file %s -emit-ir -disable-incremental-llvm-codegen | FileCheck %s
...
// RUN: %target-swift-frontend -sdk %S/Inputs -primary-file %s -F %t -DIMPORT_EMPTY -emit-ir -disable-incremental-llvm-codegen > %t.ll
