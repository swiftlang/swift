...
// CHECK: define hidden void @_T012objc_structs8getFrame{{[_0-9a-zA-Z]*}}F([[NSRECT]]* noalias nocapture sret, [[GIZMO]]*) {{.*}} {
...
// CHECK: define hidden void @_T012objc_structs8setFrame{{[_0-9a-zA-Z]*}}F(%CSo5Gizmo*, %VSC6NSRect* noalias nocapture dereferenceable({{.*}})) {{.*}} {
...
// CHECK: define hidden void @_T012objc_structs8makeRect{{[_0-9a-zA-Z]*}}F([[NSRECT]]* noalias nocapture sret, double, double, double, double)
...
// CHECK: define hidden [[stringLayout:[^@]*]] @_T012objc_structs14stringFromRect{{[_0-9a-zA-Z]*}}F(%VSC6NSRect* noalias nocapture dereferenceable({{.*}})) {{.*}} {
...
// CHECK: define hidden void @_T012objc_structs9insetRect{{[_0-9a-zA-Z]*}}F([[NSRECT]]* noalias nocapture sret, %VSC6NSRect* noalias nocapture dereferenceable({{.*}}), double, double)
...
// CHECK: define hidden void @_T012objc_structs19convertRectFromBase{{[_0-9a-zA-Z]*}}F([[NSRECT]]* noalias nocapture sret, [[NSVIEW]]*, [[NSRECT]]* noalias nocapture dereferenceable({{.*}}))
...
// CHECK: define hidden void @_T012objc_structs20useStructOfNSStringsSC0deF0VADF(%VSC17StructOfNSStrings* noalias nocapture sret, %VSC17StructOfNSStrings* noalias nocapture dereferenceable({{.*}}))
