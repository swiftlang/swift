...
// CHECK-DAG: @"$s{{.*}}10CCOMObjectCMn.com.vtable.$s3COM12ISwiftObjectMp" = private constant { ptr, i64, ptr, ptr, ptr, ptr, ptr } { ptr @"$s{{.*}}10CCOMObjectCMn.com.interface_map", i64  8, ptr @QueryInterface, ptr @AddRef, ptr @Release, ptr @"$s{{.*}}10CCOMObjectC{{.*}}ISwiftObject{{.*}}6object{{.*}}TWV", ptr @"$s{{.*}}10CCOMObjectC{{.*}}ISwiftObject{{.*}}8metadata{{.*}}TWV"
// CHECK-DAG: @"$s{{.*}}10CCOMObjectCMn.com.vtable.$s{{.*}}8IDerivedMp"    = private constant { ptr, i64, ptr, ptr, ptr, ptr, ptr } { ptr @"$s{{.*}}10CCOMObjectCMn.com.interface_map", i64 16, ptr @QueryInterface, ptr @AddRef, ptr @Release, ptr @"$s{{.*}}10CCOMObjectCAA5IBaseA2aDP6methodys6UInt32VSpys5Int32VGSgFTWV", ptr @"$s{{.*}}10CCOMObjectCAA8IDerivedA2aDP7refinedys6UInt32VSpys5Int32VGSgFTWV"
// CHECK-DAG: @"$s{{.*}}10CCOMObjectCMn.com.vtable.$s{{.*}}10IUnrelatedMp" = private constant { ptr, i64, ptr, ptr, ptr, ptr }      { ptr @"$s{{.*}}10CCOMObjectCMn.com.interface_map", i64 24, ptr @QueryInterface, ptr @AddRef, ptr @Release, ptr @"$s{{.*}}10CCOMObjectCAA10IUnrelatedA2aDP8functionys6UInt32VSpys5Int32VGSgFTWV"
