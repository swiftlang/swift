...
// CHECK-DAG-OPT: @_T09dllexport1cCACycfC = dllexport alias void (), void ()* @_swift_dead_method_stub
// CHECK-DAG: define dllexport swiftcc %swift.refcounted* @_T09dllexport1cCfd(%C9dllexport1c*{{.*}})
// CHECK-DAG-NO-OPT: define dllexport swiftcc %C9dllexport1c* @_T09dllexport1cCACycfc(%C9dllexport1c*)
// CHECK-DAG-NO-OPT: define dllexport swiftcc %C9dllexport1c* @_T09dllexport1cCACycfC(%swift.type*)
// CHECK-DAG: define dllexport swiftcc i8* @_T09dllexport2ciAA1cCfau()
// CHECK-DAG-NO-OPT: define dllexport swiftcc void @_T09dllexport1dC1m33_C57BA610BA35E21738CC992438E660E9LLyyF(%C9dllexport1d*)
// CHECK-DAG-NO-OPT: define dllexport swiftcc void @_T09dllexport1dCfD(%C9dllexport1d*)
// CHECK-DAG: define dllexport swiftcc %swift.refcounted* @_T09dllexport1dCfd(%C9dllexport1d*{{.*}})
// CHECK-DAG: define dllexport %swift.type* @_T09dllexport1cCMa()
// CHECK-DAG: define dllexport %swift.type* @_T09dllexport1dCMa()
// CHECK-DAG-NO-OPT: define dllexport swiftcc %C9dllexport1d* @_T09dllexport1dCACycfc(%C9dllexport1d*)
// CHECK-DAG-OPT: define dllexport swiftcc void @_T09dllexport1dCfD(%C9dllexport1d*)
