...
public distributed actor class MyClass {
  public var x: Int
  public init(transport: ActorTransport) {
...
public distributed actor class Exchanger<T> {
  public var value: T

  public convenience init(transport: ActorTransport, value: T) {
