...
// CHECK-LABEL: declare extern_weak swiftcc %swift.metadata_response @"$s31weak_import_availability_helper16UnavailableStructVMa"(i64)
...
// CHECK-LABEL: declare extern_weak swiftcc void @"$s31weak_import_availability_helper16UnavailableStructV17unavailableMethodyyF"(ptr noalias swiftself)
