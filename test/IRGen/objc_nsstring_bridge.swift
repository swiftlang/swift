...
// RUN: %swift -emit-ir -module-cache-path %t/clang-module-cache -target x86_64-apple-macosx10.9 -sdk %S/Inputs -I=%S/Inputs -enable-source-import -primary-file %s | FileCheck %s
