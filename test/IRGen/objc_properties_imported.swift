...
// RUN: %swift %clang-importer-sdk -enable-source-import -module-cache-path %t/clang-module-cache -target x86_64-apple-macosx10.9 -emit-ir -o - -primary-file %s | FileCheck %s
