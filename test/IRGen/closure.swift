...
// CHECK-DAG: [[METADATA:@.*]] = private constant %swift.full_boxmetadata { i64 1, i64 {{.*}}, ptr {{.*}}@__swift_closure_destructor{{(\.ptrauth.*)?}}, ptr null, %swift.type { i64 1024 }, i32 16, ptr @"\01l__swift5_reflection_descriptor" }
