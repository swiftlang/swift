...
// RUN: %target-swift-frontend(mock-sdk: -sdk %S/Inputs -I %t) -primary-file %s -emit-ir -disable-incremental-llvm-codegen | FileCheck --check-prefix=CHECK --check-prefix=CHECK-%target-ptrsize %s
