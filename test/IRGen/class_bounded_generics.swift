...
func class_bounded_archetype_method<T : ClassBoundBinary>(x: T, y: T) {
  ...
  // CHECK: call %objc_object* @objc_retain(%objc_object* [[Y:%.*]])
...
func class_bounded_erasure(x: ConcreteClass) -> ClassBound {
  ...
  // CHECK: [[T1:%.*]] = insertvalue { %objc_object*, i8** } [[T0]], i8** getelementptr inbounds ([1 x i8*]* @_TWPC22class_bounded_generics13ConcreteClassS_10ClassBound, i32 0, i32 0), 1
