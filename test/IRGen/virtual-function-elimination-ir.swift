...
// Has vfunc slots at offsets 88, 96, 104 (on 64-bit) / 60, 64, 68 (on 32-bit).
...
// CHECK-64: !4 = !{}
// CHECK-64: !5 = !{i64 96, !"$s4main7MyClassC3fooyyFTq"}
// CHECK-64: !6 = !{i64 104, !"$s4main7MyClassC3baryyFTq"}
// CHECK-64: !7 = !{i64 112, !"$s4main7MyClassCACycfCTq"}
// CHECK-64: !8 = !{i64 1, i64 96, i64 116}
...
// CHECK-32: !4 = !{}
// CHECK-32: !5 = !{i64 60, !"$s4main7MyClassC3fooyyFTq"}
// CHECK-32: !6 = !{i64 64, !"$s4main7MyClassC3baryyFTq"}
// CHECK-32: !7 = !{i64 68, !"$s4main7MyClassCACycfCTq"}
// CHECK-32: !8 = !{i64 1, i64 60, i64 72}
