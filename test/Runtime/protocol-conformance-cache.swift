...
// CHECK: Check confomance Swift.Dictionary<Swift.String, Swift.Int> to Proto: not found, source: section scan
...
// CHECK: Check confomance a.GenericClassConditional<Swift.String> to Proto: not found, source: section scan
...
// CHECK: Check confomance Swift.Optional<Swift.String> to Proto: not found, source: section scan
assert(doesNotConformToProto(String?.self))
