...
// CHECK-DAG: #SR8083_Base.init!allocator: (SR8083_Base.Type) -> (any Decoder) throws -> SR8083_Base : @$s23class_codable_inherited10SR8083_SubC4fromACs7Decoder_p_tKcfC [override]	// SR8083_Sub.__allocating_init(from:)
// CHECK: {{^}$}}
