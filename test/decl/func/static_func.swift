...
struct DuplicateStatic {
  static static func f1() {} // expected-error{{'static' cannot appear after another 'static' or 'class' pattern}}{{10-17=}}
  static class func f2() {} // expected-error{{'class' cannot appear after another 'static' or 'class' pattern}}{{10-16=}}
  class static func f3() {} // expected-error{{'static' cannot appear after another 'static' or 'class' pattern}}{{9-16=}} expected-error{{class methods are only allowed within classes; use 'static' to declare a static method}}{{3-8=static}}
  class class func f4() {} // expected-error{{'class' cannot appear after another 'static' or 'class' pattern}}{{9-15=}} expected-error{{class methods are only allowed within classes; use 'static' to declare a static method}}{{3-8=static}}
  override static static func f5() {} // expected-error{{'static' cannot appear after another 'static' or 'class' pattern}}{{19-26=}} expected-error{{'override' can only be specified on class members}} {{3-12=}}
  static override static func f6() {} // expected-error{{'static' cannot appear after another 'static' or 'class' pattern}}{{19-26=}} expected-error{{'override' can only be specified on class members}} {{10-19=}}
  static static override func f7() {} // expected-error{{'static' cannot appear after another 'static' or 'class' pattern}}{{10-17=}} expected-error{{'override' can only be specified on class members}} {{17-26=}}
