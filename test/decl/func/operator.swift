...
_ = 3...-5  // expected-error {{ambiguous missing whitespace between unary and binary operators}} expected-note {{could be binary '...' and prefix '-'}} expected-note {{could be postfix '...' and binary '-'}}
