...
class IUOTestSubclass : IUOTestBaseClass {
  ...
  override func manyA(_: AnyObject!, _: AnyObject!) {}
  override func manyB(_ a: AnyObject!, b: AnyObject!) {}

  override func result() -> AnyObject! { return nil }
  override func both(_ x: AnyObject!) -> AnyObject! { return x }

  override init(_: AnyObject!) {}
  override init(one: AnyObject!) {}
  override init(a: AnyObject!, b: AnyObject!) {}
}

class IUOTestSubclass2 : IUOTestBaseClass {
  override func oneA(_ x: AnyObject!) {}

  override func oneB(x: AnyObject!) {}

  override func oneC(_: AnyObject!) {}
