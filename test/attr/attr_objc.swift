...
// RUN: %swift-ide-test -print-ast-typechecked -source-filename %s -target x86_64-apple-darwin13 -function-definitions=true -prefer-type-repr=false -print-implicit-attrs=true -explode-pattern-binding-decls=true | FileCheck %s
