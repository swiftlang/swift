...
// Type check and verify the test itself which applies @warn to a macro expansion expression
...
// This test verifies that @warn effect applies to everything within a macro expansion, and that @warn attributes within the expanded
