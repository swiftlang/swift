...
func testInvalidKeywordCall(x: NoKeyword, y: NoKeywordProtocol & AnyObject) {
  x(a: 1, b: 2) // expected-error {{'@dynamicCallable' type 'NoKeyword' cannot be applied with keyword arguments; missing 'dynamicallyCall(withKeywordArguments:)' method}} {{documentation-file=dynamic-callable-requirements}}
  y(a: 1, b: 2) // expected-error {{'@dynamicCallable' type 'any NoKeywordProtocol & AnyObject' cannot be applied with keyword arguments; missing 'dynamicallyCall(withKeywordArguments:)' method}} {{documentation-file=dynamic-callable-requirements}}
}
