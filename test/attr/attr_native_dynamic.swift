...
struct Strukt {
  ...
  // CHECK: (accessor_decl {{.*}} access=internal @yield_once _modify for="dynamicStorageOnlyVar"
  ...
  // CHECK: (accessor_decl {{.*}} access=internal @yield_once _modify for="computedVarGetterSetter"
  ...
  // CHECK: (accessor_decl {{.*}} access=internal dynamic @yield_once _modify for="computedVarGetterModify"
  ...
  // CHECK: (accessor_decl {{.*}} access=internal dynamic @yield_once _read for="computedVarReadSet"
  ...
  // CHECK: (accessor_decl {{.*}} access=internal @yield_once _modify for="computedVarReadSet"
  ...
  // CHECK: (accessor_decl {{.*}} access=internal dynamic @yield_once _read for="computedVarReadModify"
  // CHECK: (accessor_decl {{.*}} access=internal dynamic @yield_once _modify for="computedVarReadModify"
  ...
  // CHECK: (accessor_decl {{.*}}access=internal @yield_once _modify for="storedWithObserver"
  ...
  // CHECK: (accessor_decl {{.*}} access=internal @yield_once _modify for="subscript(_:)"
  ...
  // CHECK: (accessor_decl {{.*}} access=internal dynamic get for="subscript(_:)"
  // CHECK: (accessor_decl {{.*}} access=internal dynamic @yield_once _modify for="subscript(_:)"
  ...
  // CHECK: (accessor_decl {{.*}} access=internal dynamic @yield_once _read for="subscript(_:)"
  // CHECK: (accessor_decl {{.*}} access=internal dynamic @yield_once _modify for="subscript(_:)"
