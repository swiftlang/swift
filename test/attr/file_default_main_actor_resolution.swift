...
default @NotAnActor
// expected-error@-1:9 {{'@NotAnActor' is not a valid file-level default}}
// expected-note@-2:9 {{a file-level default must be '@MainActor', 'nonisolated', '@available', or '@diagnose'}}
...
default @MainActor
// expected-error@-1:9 {{'@MainActor' is not a valid file-level default}}
// expected-note@-2:9 {{a file-level default must be '@MainActor', 'nonisolated', '@available', or '@diagnose'}}
...
default @MainActor
// expected-error@-1:9 {{global actor 'MainActor' is not a valid file-level default}}
