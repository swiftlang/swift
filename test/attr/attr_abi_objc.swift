...
@abi(func available5(_: FutureType)) // expected-error {{'FutureType' is only available in macOS 99 or newer}}
func available5(_: FutureType) {} // expected-error {{'FutureType' is only available in macOS 99 or newer}} expected-note 2 {{add @available attribute to enclosing global function}} {{22:1-1=@available(macOS 99, *)\n}}
