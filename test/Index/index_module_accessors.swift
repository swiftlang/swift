...
// data for the module.
public struct S {
  // CHECK-DAG: instance-property(public)/Swift | x | s:3Mod1SV1xSivp | Def,RelChild
  // CHECK-DAG: instance-method/acc-get/Swift | getter:x | s:3Mod1SV1xSivg | Def,Impl,RelChild,RelAcc
  public let x = 0

  // CHECK-DAG: instance-property(public)/Swift | y | s:3Mod1SV1ySivp | Def,RelChild
  // CHECK-DAG: instance-method/acc-get/Swift | getter:y | s:3Mod1SV1ySivg | Def,Impl,RelChild,RelAcc
  public var y: Int {
    0
  }

  // CHECK-DAG: instance-property(public)/Swift | z | s:3Mod1SV1zSivp | Def,RelChild
  ...
  // CHECK-DAG: instance-property(public)/Swift | a | s:3Mod1SV1aSivp | Def,RelChild
