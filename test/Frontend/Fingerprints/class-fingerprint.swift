...
// RUN: cd %t && %swiftc_driver  -disable-type-fingerprints -enable-batch-mode -j2 -incremental -disable-experimental-private-intransitive-dependencies -driver-show-incremental main.swift definesAB.swift usesA.swift usesB.swift -module-name main -output-file-map ofm.json >&output1
...
// RUN: cd %t && %swiftc_driver  -disable-type-fingerprints -enable-batch-mode -j2 -incremental -disable-experimental-private-intransitive-dependencies -driver-show-incremental main.swift definesAB.swift usesA.swift usesB.swift  -module-name main -output-file-map ofm.json >&output2
...
// RUN: cd %t && %swiftc_driver  -enable-batch-mode -j2 -incremental -disable-experimental-private-intransitive-dependencies -driver-show-incremental main.swift definesAB.swift usesA.swift usesB.swift -module-name main -output-file-map ofm.json >&output3
...
// RUN: cd %t && %swiftc_driver  -enable-batch-mode -j2 -incremental -disable-experimental-private-intransitive-dependencies -driver-show-incremental main.swift definesAB.swift usesA.swift usesB.swift -module-name main -output-file-map ofm.json >&output4
