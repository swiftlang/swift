...
func test_precondition_check(x: Int, y: Int) -> Int {
  _precondition_safety_check(x > y, "test precondition check")
  return x + y
}

func test_partial_safety_check(x: Int, y: Int) -> Int {
  _partial_safety_check(x > y, "test partial safety check")
  return x + y
}
...
// RELEASE-NOT:  "precondition failed"
...
// RELEASE-NOT:  "safety check failed"
