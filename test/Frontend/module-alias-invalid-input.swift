...
// INVALID_MODULE_ALIAS2: error: duplicate module alias; the name "bar" is already used for a module alias
...
// INVALID_MODULE_ALIAS3: error: duplicate module alias; the name "baz" is already used for a module alias
...
// INVALID_MODULE_ALIAS4: error: invalid module alias format "bar"; make sure to use the format '-module-alias name=new_name'
