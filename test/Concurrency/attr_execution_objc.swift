...
func test(t: Test, i: TestIsolated) async throws {
  let fn = t.load // @execution(caller) () async -> Void

  let _: @isolated(any) () async -> Void = fn
  // expected-error@-1 {{cannot convert value of type '@execution(caller) () async -> Void' to specified type '@isolated(any) () async -> Void'}}
