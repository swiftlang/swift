...
///////////////////////////////////////
//
// DISCUSSION: For tests that involve closure captures with
// nonisolated(nonsending) and suppressing errors in the closure itself. Tests
// where the suppressed error is outside the closure itself are in other places
// in the file.
