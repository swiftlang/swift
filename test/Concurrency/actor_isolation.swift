...
actor LazyActor {
    ...
    // expected-warning@-1 {{'nonisolated' can not be applied to a lazy property that is a member of a 'Sendable' type 'LazyActor'; this is an error in the Swift 6 language mode}}
