...
struct ImplicitlySendable {
  ...
  // never okay
  nonisolated lazy var e = 0  // expected-error {{'nonisolated' can not be applied to a lazy property that is a member of a 'Sendable' type 'ImplicitlySendable'}}
  @P nonisolated var f = 0  // expected-error {{'nonisolated' can not be applied to a property with property wrapper that is a member of a 'Sendable' type 'ImplicitlySendable'}}
}
...
public struct PublicSendable: Sendable {
  ...
  // never okay
  nonisolated lazy var e = 0  // expected-error {{'nonisolated' can not be applied to a lazy property that is a member of a 'Sendable' type 'PublicSendable'}}
  @P nonisolated var f = 0  // expected-error {{'nonisolated' can not be applied to a property with property wrapper that is a member of a 'Sendable' type 'PublicSendable'}}
}
...
@MainActor struct S {
  ...
  @P nonisolated var x = 0 // expected-error {{'nonisolated' can not be applied to a property with property wrapper that is a member of a 'Sendable' type 'S'}}
  nonisolated lazy var y = 1 // expected-error {{'nonisolated' can not be applied to a lazy property that is a member of a 'Sendable' type 'S'}}
