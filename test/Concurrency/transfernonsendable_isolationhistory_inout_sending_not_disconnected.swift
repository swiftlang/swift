// RUN: %target-swift-frontend -emit-sil -strict-concurrency=complete -target %target-swift-5.1-abi-triple -parse-as-library -sil-region-isolation-emit-isolation-history -verify %s -o /dev/null
