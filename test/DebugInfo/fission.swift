// Verify basic support for DWARF Fission aka Split-DWARF (1-to-1 in/out)
//
// RUN: %target-swift-frontend -c %/s -o %t_single.o -g -debug-info-format=dwarf -dwarf-fission-path %t_single.dwo
...
//
// RUN: %target-swift-frontend -c %/s %/S/Inputs/secondary.swift -o /dev/null -g -debug-info-format=dwarf -dwarf-fission-path %t_multi.dwo
