...
//
// RUN: %target-swift-frontend -c %/s -o %t_single.o -g -debug-info-format=dwarf -split-dwarf-output %t_single.dwo
...
//
// RUN: %target-swift-frontend -c %/s %/S/Inputs/secondary.swift -o /dev/null -g -debug-info-format=dwarf -split-dwarf-output %t_multi.dwo
