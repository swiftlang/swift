...
public func date() {
  // LOC-CHECK: call {{.*}} @_TFSSCfT21_builtinStringLiteralBp13lengthInBytesBw7isASCIIBi1__SS{{.*}}, !dbg ![[L1:.*]]
  let d1 = NSDateFormatter()
  // LOC-CHECK: br{{.*}}, !dbg ![[L2:.*]]
  d1.dateFormat = "dd. mm. yyyy" // LOC-CHECK: call{{.*}}objc_msgSend{{.*}}, !dbg ![[L2]]
  // LOC-CHECK: call {{.*}} @_TFSSCfT21_builtinStringLiteralBp13lengthInBytesBw7isASCIIBi1__SS{{.*}}, !dbg ![[L3:.*]]
