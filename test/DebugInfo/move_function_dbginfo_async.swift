...
// SIL: bb0([[ARG:%[0-9]+]] : $*T):
// SIL:   debug_value [uses_moveable_value_debuginfo] [[ARG]]
...
// SIL-NEXT: debug_value [uses_moveable_value_debuginfo] [[ARG]]
// SIL:   hop_to_executor
// SIL-NEXT: debug_value [uses_moveable_value_debuginfo] [[ARG]]
// SIL:   cond_br {{%[0-9]+}}, bb1, bb2
//
// SIL: bb1:
// SIL:   debug_value [uses_moveable_value_debuginfo] undef
...
// SIL-NEXT:  debug_value [uses_moveable_value_debuginfo] undef
// SIL:   hop_to_executor
// SIL-NEXT: debug_value [uses_moveable_value_debuginfo] undef
// SIL:   br bb3
//
...
// SIL-NEXT: debug_value [uses_moveable_value_debuginfo] %0
