...
// RUN: %FileCheck --input-file %t/none/module_interface_qualification.swiftinterface %s --check-prefixes FLAGS-NON-REQUIRED,FLAGS-NON-IGNORABLE,UNALIASED,UNQUALIFIED
...
// RUN: %FileCheck --input-file %t/alias/module_interface_qualification.swiftinterface %s --check-prefixes FLAGS-NON-REQUIRED,FLAGS-NON-IGNORABLE,ALIASED
...
// RUN: %FileCheck --input-file %t/selector/module_interface_qualification.swiftinterface %s --check-prefixes FLAGS-REQUIRED,FLAGS-NON-IGNORABLE,UNALIASED,QUALIFIED
...
// RUN: %FileCheck --input-file %t/conditional/module_interface_qualification.swiftinterface %s --check-prefixes FLAGS-NON-REQUIRED,FLAGS-IGNORABLE,UNALIASED,QUALIFIED,UNQUALIFIED,CONDITIONS
...
// Check whether the module interface enables $ModuleSelector or not

// FLAGS-REQUIRED: swift-module-flags:{{.*}} -enable-experimental-feature ModuleSelector
// FLAGS-NON-REQUIRED-NOT: swift-module-flags:{{.*}} -enable-experimental-feature ModuleSelector

// FLAGS-IGNORABLE: swift-module-flags-ignorable:{{.*}} -enable-experimental-feature ModuleSelector
// FLAGS-NON-IGNORABLE-NOT: swift-module-flags-ignorable:{{.*}} -enable-experimental-feature ModuleSelector
