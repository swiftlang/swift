...
// RUN: %target-swift-emit-module-interface(%t/LayoutPrespec.swiftinterface) %s -module-name LayoutPrespec
// RUN: %target-swift-typecheck-module-from-interface(%t/LayoutPrespec.swiftinterface) -module-name LayoutPrespec
// RUN: %target-swift-typecheck-module-from-interface(%t/LayoutPrespec.swiftinterface) -module-name LayoutPrespec
