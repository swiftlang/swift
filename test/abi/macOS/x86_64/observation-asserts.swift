...
// RUN: %abi-symbol-checker %s %t/symbols --base %S/observation.swift
// RUN: diff -u %S/../../DO-NOT-EDIT-THIS/macOS/x86_64/observation/baseline-asserts %t/symbols
...
// *** NOTE: ***
// You will normally add new entries in 'abi/macOS/x86_64/observation.swift' instead
