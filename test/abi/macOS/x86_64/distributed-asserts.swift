...
// RUN: %abi-symbol-checker %s %t/symbols --base %S/distributed.swift
// RUN: diff -u %S/../../DO-NOT-EDIT-THIS/macOS/x86_64/distributed/baseline-asserts %t/symbols
...
// *** NOTE: ***
// You will normally add new entries in 'abi/macOS/x86_64/distributed.swift' instead
