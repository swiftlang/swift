...
// RUN: diff -u %S/../../DO-NOT-EDIT-THIS/macOS/x86_64/regex-builder/baseline-asserts %t/symbols
...
// *** NOTE: ***
// You will normally add new entries in 'abi/macOS/x86_64/regex-builder.swift' instead
