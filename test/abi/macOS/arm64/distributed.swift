...
// RUN: %llvm-nm -g --defined-only -f just-symbols %stdlib_dir/arm64/libswiftDistributed.dylib > %t/symbols
// RUN: %abi-symbol-checker %s %t/symbols
// RUN: diff -u %S/../../Inputs/macOS/arm64/distributed/baseline %t/symbols
...
Added: _$s11Distributed0A5ActorPAAE9whenLocalyqd__Sgqd__xYiYaYbqd_0_YKXEYaqd_0_YKs8SendableRd__s5ErrorRd_0_r0_lFTu// UNSUPPORTED: OS=windows-msvc
