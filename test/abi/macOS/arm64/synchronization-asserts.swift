...
// RUN: diff -u %S/../../DO-NOT-EDIT-THIS/macOS/arm64/synchronization/baseline-asserts %t/symbols
...
// *** NOTE: ***
// You will normally add new entries in 'abi/macOS/arm64/synchronization.swift'
// instead of this file. This file is dedicated for assert only symbols.
