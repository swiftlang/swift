...
e0[] // expected-error {{cannot subscript a value of type '[Int]' with an argument of type '()'}}
  // expected-note @-1 {{overloads for 'subscript' exist with these partially matching parameter lists: ((UnboundedRange_) -> ()), (Int), (ORE), (OffsetBound), (R), (Range<Int>), (Range<Self.Index>)}}
