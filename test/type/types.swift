...
func foo1(a : UnsafePointer<Void>) {} // expected-warning {{UnsafePointer<Void> is deprecated; use UnsafeRawPointer instead}}{{15-34=UnsafeRawPointer}}
func foo2(a : UnsafeMutablePointer<()>) {} // expected-warning {{UnsafeMutablePointer<Void> is deprecated; use UnsafeMutableRawPointer instead}}{{15-39=UnsafeMutableRawPointer}}
class C {
  func foo1(a : UnsafePointer<Void>) {} // expected-warning {{UnsafePointer<Void> is deprecated; use UnsafeRawPointer instead}}{{17-36=UnsafeRawPointer}}
  func foo2(a : UnsafeMutablePointer<()>) {} // expected-warning {{UnsafeMutablePointer<Void> is deprecated; use UnsafeMutableRawPointer instead}}{{17-41=UnsafeMutableRawPointer}}
  func foo3() {
    let _ : UnsafePointer<Void> // expected-warning {{UnsafePointer<Void> is deprecated; use UnsafeRawPointer instead}}{{13-32=UnsafeRawPointer}}
    let _ : UnsafeMutablePointer<Void> // expected-warning {{UnsafeMutablePointer<Void> is deprecated; use UnsafeMutableRawPointer instead}}{{13-39=UnsafeMutableRawPointer}}
  }
}
