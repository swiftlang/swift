...
// expected-warning@-1 {{use of protocol 'Sequence' as a type must be written 'any Sequence' or 'some Sequence'}}
// expected-note@-2 {{use 'any Sequence' to create an existential type}}
// expected-note@-3 {{use 'some Sequence' to create an opaque type}}
