...
typealias T04 = P1 & P2! // expected-warning {{implicitly unwrapped optionals are only allowed at top level and as function results; treating '!' as if it were '?' for Swift 3 and Swift 4}}
// expected-error@-1 {{non-protocol, non-class type 'P2?' cannot be used within a protocol-constrained type}}
