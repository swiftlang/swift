...
// expected-error@-1 {{implicitly unwrapped optionals are only allowed at top level and as function results}}
...
typealias T04 = P1 & P2! // expected-error {{implicitly unwrapped optionals are only allowed at top level and as function results}}
