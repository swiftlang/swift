...
// CHECK-LABEL: sil [serialized] [canonical] [stage=canonical] [ossa] @$ss1XVABycfC : $@convention(method) (@thin X.Type) -> X
// CHECK: bb0
// CHECK-NEXT: struct $X ()
// CHECK-NEXT: return
...
// SIB-CHECK-LABEL: sil [serialized] [canonical] [stage=canonical] [ossa] @$ss1XVABycfC : $@convention(method) (@thin X.Type) -> X
// SIB-CHECK: bb0
// SIB-CHECK-NEXT: struct $X ()
// SIB-CHECK-NEXT: return

// SIB-CHECK-LABEL: sil [canonical] [stage=canonical] @unknown : $@convention(thin) () -> ()
