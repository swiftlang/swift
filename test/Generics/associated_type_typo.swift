...
func typoAssoc2<T : P1, U : P1 where T.assoc == U.assoc>() { } // expected-error {{There is no way to infer the generic parameter 'U' if it is not used in function signature}} 
