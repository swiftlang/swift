...
// CHECK-NEXT:   U[.P4].P4Assoc == T[.P3].P3Assoc [inferred @ {{.*}}:[[@LINE+4]]:26]
...
// CHECK-NEXT:   U[.P4].P4Assoc == T[.P3].P3Assoc [explicit @ {{.*}}requirement_inference.swift:[[@LINE+4]]:68]
// CHECK-NEXT:   T : P3 [explicit @ {{.*}}requirement_inference.swift:[[@LINE+3]]:21]
// CHECK-NEXT:   T[.P3].P3Assoc : P2 [redundant @ {{.*}}requirement_inference.swift:[[@LINE+2]]:54]
...
// CHECK-NEXT: Requirements:
// CHECK-NEXT:   T : PCommonAssoc1 [explicit @ {{.*}}requirement_inference.swift:[[@LINE+5]]:21]
// CHECK-NEXT:   T : PCommonAssoc2 [explicit @ {{.*}}requirement_inference.swift:[[@LINE+4]]:69]
// CHECK-NEXT:   T[.PCommonAssoc2].CommonAssoc == T[.PCommonAssoc1].CommonAssoc [inferred @ {{.*}}requirement_inference.swift:[[@LINE+3]]:69]
