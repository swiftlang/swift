...
func f13<T : P>(x: T) -> T.B<Int> {} // expected-error {{cannot specialize non-generic type 'B' (aka 'Int')}}{{29-34=}}

func f14<T : P>(x: T) -> T.C<Int> {}

func f15<T : P>(x: T) -> T.D<Int> {}

func f16<T : P>(x: T) -> T.D {} // expected-error {{reference to generic type 'D' (aka 'G') requires arguments in <...>}}
