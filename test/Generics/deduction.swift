...
func takeTuples<T, U>(_ _: (T, U), _: (U, T)) {
}
...
func returnTuple<T, U>(_ _: T) -> (T, U) { } // expected-note {{in call to function 'returnTuple'}}
...
func unaryFnIntInt(_ _: Int) -> Int {}

func unaryFnOvl(_ _: Int) -> Int {} // expected-note{{found this candidate}}
func unaryFnOvl(_ _: Float) -> Int {} // expected-note{{found this candidate}}
...
postfix func <*> <B:Bool_>(_ _: Test<B>) -> Int? { return .none }
