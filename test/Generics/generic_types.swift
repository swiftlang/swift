...
func useNested(ii: Int, hni: HasNested<Int>,
  ...
  var innerF : InnerF = innerI // expected-error{{cannot convert initializer of type 'InnerI' (aka 'HasNested<Int>.Inner') to specified type 'InnerF' (aka 'HasNested<Float>.Inner')}}
