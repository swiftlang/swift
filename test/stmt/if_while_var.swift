...
if let x = opt, let y = opt, x != y,
   let a = opt, var b = opt { // expected-warning {{value 'a' was defined but never used; consider replacing with boolean test}} {{4-12=}} {{15-15= != nil}} expected-warning {{value 'b' was defined but never used; consider replacing with boolean test}} {{17-25=}} {{28-28= != nil}}
}
...
if 1 != 2, 4 == 57 {}
if 1 != 2, 4 == 57, let x = opt {} // expected-warning {{value 'x' was defined but never used; consider replacing with boolean test}} {{21-29=}} {{32-32= != nil}}
