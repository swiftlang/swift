...
// RUN: not --crash env %env-SWIFT_IS_CURRENT_EXECUTOR_LEGACY_MODE_OVERRIDE=legacy %env-SWIFT_UNEXPECTED_EXECUTOR_LOG_LEVEL=2 %env-SWIFT_BACKTRACE=enable=no %target-run %t/crash4.out 2>&1 | %FileCheck %t/src/Crash4.swift --check-prefix=LEGACY_CHECK
// RUN: not --crash env %env-SWIFT_IS_CURRENT_EXECUTOR_LEGACY_MODE_OVERRIDE=swift6 %env-SWIFT_UNEXPECTED_EXECUTOR_LOG_LEVEL=2 %env-SWIFT_BACKTRACE=enable=no %target-run %t/crash4.out 2>&1 | %FileCheck %t/src/Crash4.swift --check-prefix=SWIFT6_CHECK --dump-input=always
...
// RUN: not --crash env %env-SWIFT_IS_CURRENT_EXECUTOR_LEGACY_MODE_OVERRIDE=legacy %env-SWIFT_UNEXPECTED_EXECUTOR_LOG_LEVEL=2 %env-SWIFT_BACKTRACE=enable=no %target-run %t/crash5.out 2>&1 | %FileCheck %t/src/Crash5.swift --check-prefix=LEGACY_CHECK
// RUN: not --crash env %env-SWIFT_IS_CURRENT_EXECUTOR_LEGACY_MODE_OVERRIDE=swift6 %env-SWIFT_UNEXPECTED_EXECUTOR_LOG_LEVEL=2 %env-SWIFT_BACKTRACE=enable=no %target-run %t/crash5.out 2>&1 | %FileCheck %t/src/Crash5.swift --check-prefix=SWIFT6_CHECK --dump-input=always
...
// RUN: not --crash env %env-SWIFT_IS_CURRENT_EXECUTOR_LEGACY_MODE_OVERRIDE=legacy %env-SWIFT_UNEXPECTED_EXECUTOR_LOG_LEVEL=2 %env-SWIFT_BACKTRACE=enable=no %target-run %t/crash6.out 2>&1 | %FileCheck %t/src/Crash6.swift --check-prefix=LEGACY_CHECK
// RUN: not --crash env %env-SWIFT_IS_CURRENT_EXECUTOR_LEGACY_MODE_OVERRIDE=swift6 %env-SWIFT_UNEXPECTED_EXECUTOR_LOG_LEVEL=2 %env-SWIFT_BACKTRACE=enable=no %target-run %t/crash6.out 2>&1 | %FileCheck %t/src/Crash6.swift --check-prefix=SWIFT6_CHECK --dump-input=always
