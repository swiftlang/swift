...
func testFSEventStreamRef(stream: FSEventStreamRef) {
  ...
  _ = ConstFSEventStreamRef(stream) // expected-error {{ambiguous use of initializer; cannot convert value of type 'FSEventStreamRef' (aka 'OpaquePointer') to any of potential types UnsafeMutableRawPointer, UnsafeRawPointer}}
