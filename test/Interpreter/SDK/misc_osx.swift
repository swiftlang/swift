...
func testFSEventStreamRef(stream: FSEventStreamRef) {
  ...
  // expected-note @-1 {{overloads for 'ConstFSEventStreamRef' exist with these partially matching parameter lists: (bitPattern: Int), (bitPattern: UInt), (UnsafePointer<T>), (UnsafeMutablePointer<T>), (nilLiteral: ())}}
