...
func checkClassName(cls: AnyClass, name: String, mangled: String)
{
...
func checkProtocolName(proto: Protocol, name: String, mangled: String)
{
...
func checkIvarName(cls: AnyClass, name: String)
{
