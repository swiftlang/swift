// RUN: %target-swift-frontend %s -emit-silgen | %target-sil-opt -enable-sil-verify-all | FileCheck %s
...
// CHECK-LABEL:  @_TF28generic_signature_with_depth4testu0_Rq_S_5mmExtq0_S0_zqqq_S_14mmSequenceType9GeneratorS_15mmGeneratorType7Elementqqq0_S1_9GeneratorS2_7Element_FTq_q0__q_ : $@convention(thin) <EC1, EC2 where EC1 : mmExt, EC2 : mmExt, EC1.Generator : mmGeneratorType, EC2.Generator : mmGeneratorType, EC1.Generator.Element == EC2.Generator.Element> (@out EC1, @in EC1, @in EC2) -> () {
