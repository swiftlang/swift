...
// CHECK-LABEL:  @_TF28generic_signature_with_depth4testu0_R_S_5mmExt0_S0_W_9Generator7Element_zW0_S1_S2__rFTq_q0__q_ : $@convention(thin) <EC1, EC2 where EC1 : mmExt, EC2 : mmExt, EC1.Generator : mmGeneratorType, EC2.Generator : mmGeneratorType, EC1.Generator.Element == EC2.Generator.Element> (@out EC1, @in EC1, @in EC2) -> () {
