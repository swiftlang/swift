...
// CHECK: // SimpleEmptyDistributedActor.init(kappa:other:)
...
// CHECK: [[SELF:%[0-9]+]] "self"
// CHECK: bb0([[TRANSPORT]] : $*ActorTransport, [[OTHER]] : Int, [[SELF]] : $SimpleEmptyDistributedActor):
...
// CHECK: [[ASSIGN_WITNESS_METHOD:%[0-9]+]] = witness_method $@opened<@opened({{.*}})
