...
// CHECK-LABEL: sil shared [noinline] @_TTSf4d___TTSg5Bi32____TFVs9ContainerCfT_GS_x_ : $@convention(thin) () -> Container<Builtin.Int32> {
// CHECK: }

// CHECK-LABEL: sil shared [noinline] @_TTSf4d___TTSg5Bi32____TFVs9Container11doSomethingfT_T_ : $@convention(thin) () -> () {
// CHECK: }
