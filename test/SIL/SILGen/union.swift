...
// CHECK: sil @_T5union6truthyOS_7Boolishg
var truthy : Boolish {
  // CHECK: [[TRUTHY:%[0-9]+]] = function_ref @_TO5union7Boolish6truthyFMS0_S0_
...
// CHECK: sil @_T5union5falsyOS_7Boolishg
var falsy : Boolish {
  // CHECK: [[FALSY:%[0-9]+]] = function_ref @_TO5union7Boolish5falsyFMS0_S0_
  // CHECK: [[BOOLISH:%[0-9]+]] = metatype $Boolish.metatype
