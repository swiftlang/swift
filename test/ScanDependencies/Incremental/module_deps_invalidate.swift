...
// CLEAN-INCREMENTAL-SCAN-CHECK: remark: Re-using serialized module scanning dependency cache from: {{.*}}cache.moddepcache
// CLEAN-INCREMENTAL-SCAN-CHECK: remark: Serializing module scanning dependency cache to: {{.*}}cache.moddepcache
// CLEAN-INCREMENTAL-SCAN-CHECK-NOT: remark: Dependency info for module '{{.*}}' invalidated due to

// STALE-C-INCREMENTAL-SCAN-CHECK: remark: Re-using serialized module scanning dependency cache from: {{.*}}cache.moddepcache
// STALE-C-INCREMENTAL-SCAN-CHECK: remark: Dependency info for module 'C' invalidated due to a modified input since last scan: {{.*}}C.swiftmodule{{.*}}swiftinterface
// STALE-C-INCREMENTAL-SCAN-CHECK: remark: Dependency info for module 'B' invalidated due to an out-of-date dependency.
// STALE-C-INCREMENTAL-SCAN-CHECK: remark: Dependency info for module 'A' invalidated due to an out-of-date dependency.
// STALE-C-INCREMENTAL-SCAN-CHECK: remark: Serializing module scanning dependency cache to: {{.*}}cache.moddepcache
// STALE-C-INCREMENTAL-SCAN-CHECK-NOT: remark: Dependency info for module 'D' invalidated

// NEW-A-INCREMENTAL-SCAN-CHECK: remark: Re-using serialized module scanning dependency cache from: {{.*}}cache.moddepcache
// NEW-A-INCREMENTAL-SCAN-CHECK: remark: Dependency info for module 'A' invalidated due to a modified input since last scan: {{.*}}A.swiftmodule{{.*}}swiftinterface
// NEW-A-DEPS-CHECK: "clang": "X"

// STALE-X-INCREMENTAL-SCAN-CHECK: remark: Re-using serialized module scanning dependency cache from: {{.*}}cache.moddepcache
// STALE-X-INCREMENTAL-SCAN-CHECK: remark: Dependency info for module 'X' invalidated due to a modified input since last scan: {{.*}}X.h
// STALE-X-INCREMENTAL-SCAN-CHECK: remark: Dependency info for module 'A' invalidated due to an out-of-date dependency.
// STALE-X-INCREMENTAL-SCAN-CHECK: remark: Serializing module scanning dependency cache to: {{.*}}cache.moddepcache
