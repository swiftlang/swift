...
// RUN:   %t/test.swift -o %t/deps.json -experimental-bridging-header-chaining -scanner-output-dir %t \
...
// RUN:   -disable-implicit-string-processing-module-import -disable-implicit-concurrency-module-import \
// RUN:   %t/user.swift -o %t/deps2.json -experimental-bridging-header-chaining -scanner-output-dir %t \
...
// RUN:   -disable-implicit-string-processing-module-import -disable-implicit-concurrency-module-import \
// RUN:   %t/user.swift -experimental-bridging-header-chaining -o %t/User.swiftmodule \
...
// RUN:   -disable-implicit-string-processing-module-import -disable-implicit-concurrency-module-import \
// RUN:   -Xcc -fmodule-map-file=%t/a.modulemap -Xcc -fmodule-map-file=%t/b.modulemap \
// RUN:   -I %t %t/user2.swift -import-objc-header %t/Bridging2.h -experimental-bridging-header-chaining -scanner-output-dir %t \
// RUN:   -o %t/deps3.json

// RUN: %swift-scan-test -action get_chained_bridging_header -- %target-swift-frontend -emit-module \
// RUN:   -module-name User -module-cache-path %t/clang-module-cache -O \
// RUN:   -disable-implicit-string-processing-module-import -disable-implicit-concurrency-module-import \
// RUN:   %t/user.swift -experimental-bridging-header-chaining -o %t/User.swiftmodule -import-objc-header %t/Bridging2.h \
...
// RUN:   -disable-implicit-string-processing-module-import -disable-implicit-concurrency-module-import \
// RUN:   -Xcc -fmodule-map-file=%t/a.modulemap -Xcc -fmodule-map-file=%t/b.modulemap \
// RUN:   -I %t %t/user2.swift -import-objc-header %t/Bridging3.h -experimental-bridging-header-chaining -scanner-output-dir %t \
...
// CACHE-LOAD: remark: Re-using serialized module scanning dependency cache from:
