// RUN: %target-swift-frontend -disable-objc-attr-requires-foundation-module -disable-redundant-coercion-warning -typecheck -verify -import-cf-types -I %S/Inputs/custom-modules %s
