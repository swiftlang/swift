...
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: method 'methodReturningCompleteInterface' not imported
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: return type not imported
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: interface 'CompleteInterface' is incomplete
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: interface 'CompleteInterface' forward declared here
...
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: method 'methodTakingACompleteInterfaceAsAParameter:andAnother:' not imported
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: parameter 'param1' not imported
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: interface 'CompleteInterface' is incomplete
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: interface 'CompleteInterface' forward declared here
...
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: function 'CFunctionReturningACompleteInterface' not imported
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: return type not imported
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: interface 'CompleteInterface' is incomplete
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: interface 'CompleteInterface' forward declared here
...
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: function 'CFunctionTakingACompleteInterfaceAsAParameter' not imported
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: parameter 'param1' not imported
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: interface 'CompleteInterface' is incomplete
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: interface 'CompleteInterface' forward declared here
...
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: method 'methodReturningCompleteProtocol' not imported
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: return type not imported
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: protocol 'CompleteProtocol' is incomplete
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: protocol 'CompleteProtocol' forward declared here
...
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: method 'methodTakingACompleteProtocolAsAParameter:' not imported
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: parameter 'param1' not imported
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: protocol 'CompleteProtocol' is incomplete
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: protocol 'CompleteProtocol' forward declared here
...
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: function 'CFunctionReturningACompleteProtocol' not imported
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: return type not imported
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: protocol 'CompleteProtocol' is incomplete
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: protocol 'CompleteProtocol' forward declared here
...
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: function 'CFunctionTakingACompleteProtocolAsAParameter' not imported
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: parameter 'param1' not imported
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: protocol 'CompleteProtocol' is incomplete
// CHECK-NOT: IncompleteTypes.h:{{[0-9]+}}:{{[0-9]+}}: error: protocol 'CompleteProtocol' forward declared here
