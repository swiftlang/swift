...
// CHECK-NEXT:   ^
// CHECK-NEXT: ctypes.h:{{[0-9]+}}:3: error: built-in type 'Complex' not supported
// CHECK-NEXT:   int _Complex c;
// CHECK-NEXT:   ^
...
// CHECK: IncompleteTypes.h:{{[0-9]+}}:1: error: property 'propertyUsingAForwardDeclaredProtocol' not imported
...
// CHECK: IncompleteTypes.h:{{[0-9]+}}:1: error: property 'propertyUsingAForwardDeclaredInterface' not imported
...
// CHECK: IncompleteTypes.h:{{[0-9]+}}:1: error: method 'methodReturningForwardDeclaredProtocol' not imported
...
// CHECK: IncompleteTypes.h:{{[0-9]+}}:1: error: method 'methodReturningForwardDeclaredInterface' not imported
...
// CHECK:     IncompleteTypes.h:{{[0-9]+}}:1: error: method 'methodTakingAForwardDeclaredProtocolAsAParameter:' not imported
...
// CHECK:     IncompleteTypes.h:{{[0-9]+}}:1: error: method 'methodTakingAForwardDeclaredInterfaceAsAParameter:andAnother:' not imported
...
// CHECK: IncompleteTypes.h:{{[0-9]+}}:1: error: function 'CFunctionReturningAForwardDeclaredInterface' not imported
...
// CHECK: IncompleteTypes.h:{{[0-9]+}}:1: error: function 'CFunctionReturningAForwardDeclaredProtocol' not imported
...
// CHECK: IncompleteTypes.h:{{[0-9]+}}:1: error: function 'CFunctionTakingAForwardDeclaredInterfaceAsAParameter' not imported
...
// CHECK: IncompleteTypes.h:{{[0-9]+}}:1: error: function 'CFunctionTakingAForwardDeclaredProtocolAsAParameter' not imported
...
// CHECK-NEXT: {{^}}        ^
// CHECK-NEXT: macros.h:{{[0-9]+}}:22: error: only numeric and string macro literals supported
// CHECK-NEXT:      #define CHAR_LITERAL 'a'
// CHECK-NEXT: {{^}}                     ^
...
// CHECK-NEXT: {{^}}        ^
// CHECK-NEXT: macros.h:{{[0-9]+}}:32: error: operator '%' not supported in macro arithmetic
// CHECK-NEXT:      #define INVALID_ARITHMETIC_7 3 % 2
// CHECK-NEXT: {{^}}                               ^

// CHECK:      macros.h:{{[0-9]+}}:9: error: macro 'INVALID_INTEGER_LITERAL_2' not imported
// CHECK-NEXT:      #define INVALID_INTEGER_LITERAL_2 10abc
// CHECK-NEXT: {{^}}        ^
// CHECK-NEXT: macros.h:{{[0-9]+}}:35: error: invalid numeric literal
// CHECK-NEXT:      #define INVALID_INTEGER_LITERAL_2 10abc
// CHECK-NEXT: {{^}}                                  ^
