...
// CHECK-NEXT:     ^~~~~~~~~~~~~~~
// CHECK-NEXT: macros.h:{{[0-9]+}}:9: error: macro 'FUNC_LIKE_MACRO' not imported: function like macros not supported
...
// CHECK-NEXT:     ^~~~~~~~~~~~~~~~~~~~
// CHECK-NEXT:      macros.h:{{[0-9]+}}:9: error: macro 'INVALID_ARITHMETIC_1' not imported: structure not supported
...
// CHECK-NEXT:     ^~~~~~~~~~~~~~~~~~~~
// CHECK-NEXT: macros.h:{{[0-9]+}}:9: error: macro 'INVALID_ARITHMETIC_2' not imported: structure not supported
...
// CHECK-NEXT:     ^~~~~~~~~~~~~~~~~~~~
// CHECK-NEXT: macros.h:{{[0-9]+}}:9: error: macro 'INVALID_ARITHMETIC_3' not imported: structure not supported
...
// CHECK-NEXT:     ^~~~~~~~~~~~~~~~~~~~
// CHECK-NEXT: macros.h:{{[0-9]+}}:9: error: macro 'INVALID_ARITHMETIC_4' not imported: structure not supported
...
// CHECK-NEXT:     ^~~~~~~~~~~~~~~~~~~~
// CHECK-NEXT: macros.h:{{[0-9]+}}:9: error: macro 'INVALID_ARITHMETIC_5' not imported: structure not supported
...
// CHECK-NEXT:     ^~~~~~~~~~~~~~~~~~~~
// CHECK-NEXT: macros.h:{{[0-9]+}}:9: error: macro 'INVALID_ARITHMETIC_6' not imported: structure not supported
...
// CHECK-NEXT:     ^~~~~~~~~~~~~~~~~~~~
// CHECK-NEXT: macros.h:{{[0-9]+}}:9: error: macro 'INVALID_ARITHMETIC_7' not imported
...
// CHECK-NEXT:     ^~~~~~~~~~~~
// CHECK-NEXT: macros.h:{{[0-9]+}}:9: error: macro 'CHAR_LITERAL' not imported
...
// CHECK-NEXT: ^~~~~~~~~~~~~
// CHECK-NEXT: macros.h:{{[0-9]+}}:9: error: macro 'UNSUPPORTED_1' not imported: structure not supported
...
// CHECK-NEXT: ^~~~~~~~~~~~~
// CHECK-NEXT: macros.h:{{[0-9]+}}:9: error: macro 'UNSUPPORTED_2' not imported: structure not supported
...
// CHECK-NEXT: ^~~~~~~~~~~~~
// CHECK-NEXT: macros.h:{{[0-9]+}}:9: error: macro 'UNSUPPORTED_3' not imported: structure not supported
...
// CHECK-NEXT: ^~~~~~~~~~~~~
// CHECK-NEXT: macros.h:{{[0-9]+}}:9: error: macro 'UNSUPPORTED_4' not imported: structure not supported
...
// CHECK-NEXT: ^~~~~~~~~~~~~
// CHECK-NEXT: macros.h:{{[0-9]+}}:9: error: macro 'UNSUPPORTED_5' not imported: structure not supported
