...
// CHECK-NEXT:   var readonlyPropFromInterface: CInt { get }
// CHECK-NEXT:   var readwritePropFromInterface: CInt { get set }
// CHECK-NEXT:   var methodAsPropertyWitnessFromInterface: CInt { get }
// CHECK-NEXT:   func methodFromInterfaceCategory()
// CHECK-NEXT:   var propFromInterfaceCategory: CInt { get }
// CHECK-NEXT:   func methodFromVisibleCategory()
// CHECK-NEXT:   var readonlyPropFromVisibleCategory: CInt { get }
// CHECK-NEXT:   func propAsMethodWitnessFromVisibleCategory() -> CInt
// CHECK-NEXT:   func methodFromOtherCategory()
// CHECK-NEXT:   var propFromOtherCategory: CInt { get }
// CHECK-NEXT: }
