// RUN: %target-swift-frontend(mock-sdk: %clang-importer-sdk) -disable-redundant-coercion-warning -typecheck -parse-as-library -verify -swift-version 4 -I %S/Inputs/custom-modules %s
