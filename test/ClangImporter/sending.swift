// RUN: %target-swift-frontend -swift-version 6 -target %target-swift-5.1-abi-triple -emit-sil -o /dev/null %s -parse-as-library -enable-experimental-feature SendingArgsAndResults -verify -import-objc-header %S/Inputs/sending.h
