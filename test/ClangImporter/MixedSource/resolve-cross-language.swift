...
// RUN: %target-swift-frontend(mock-sdk: %clang-importer-sdk) -emit-module -enable-objc-interop -emit-objc-header -o %t %S/Inputs/resolve-cross-language/Base.swift -disable-objc-attr-requires-foundation-module
