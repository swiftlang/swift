...
// DWARF_FISSION: -split-dwarf-output {{.*}}options{{.*}}.dwo
...
// DWARF_FISSION_MULTI: -primary-file {{.*}}main.swift {{.*}} -split-dwarf-output {{.*}}main{{.*}}.dwo {{.*}}
// DWARF_FISSION_MULTI: -primary-file {{.*}}lib.swift {{.*}} -split-dwarf-output {{.*}}lib{{.*}}.dwo {{.*}}
