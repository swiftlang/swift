...
// RUN: cd %t && %swiftc_driver -driver-print-bindings ./main.swift ./other.swift ./yet-another.swift -incremental -enable-experimental-private-intransitive-dependencies -driver-show-incremental -output-file-map %t/output.json 2>&1 |%FileCheck %s -check-prefix=MUST-EXEC
...
// RUN: cd %t && %swiftc_driver -driver-print-bindings ./main.swift ./other.swift ./yet-another.swift -incremental -enable-experimental-private-intransitive-dependencies -output-file-map %t/output.json 2>&1 | %FileCheck %s -check-prefix=NO-EXEC
...
// RUN: cd %t && %swiftc_driver -driver-print-bindings ./main.swift ./other.swift ./yet-another.swift -incremental -enable-experimental-private-intransitive-dependencies -output-file-map %t/output.json 2>&1 | %FileCheck %s -check-prefix=BUILD-RECORD
...
// RUN: cd %t && %swiftc_driver -driver-print-bindings ./main.swift ./other.swift ./yet-another.swift ./added.swift -incremental -enable-experimental-private-intransitive-dependencies -output-file-map %t/output.json 2>&1 > %t/added.txt
...
// RUN: cd %t && %swiftc_driver -driver-print-bindings ./main.swift ./other.swift ./yet-another.swift -incremental -enable-experimental-private-intransitive-dependencies -output-file-map %t/output.json 2>&1 | %FileCheck %s -check-prefix=BUILD-RECORD-PLUS-CHANGE
...
// RUN: %{python} %S/Inputs/touch.py 443865900 %t/*
// RUN: cd %t && %swiftc_driver -driver-print-bindings ./main.swift ./other.swift -incremental -enable-experimental-private-intransitive-dependencies -output-file-map %t/output.json 2>&1 | %FileCheck %s -check-prefix=FILE-REMOVED
...
// RUN: cd %t && %swiftc_driver -driver-print-bindings ./main.swift ./other.swift ./yet-another.swift -incremental -enable-experimental-private-intransitive-dependencies -output-file-map %t/output.json 2>&1 | %FileCheck %s -check-prefix=INVALID-RECORD
