...
// RUN: cp -r %S/Inputs/too-liberal-func-base-name/* %t
...
// RUN: cp %S/Inputs/too-liberal-func-base-name/fileB2.swift %t/fileB.swift
...
// RUN: cp %S/Inputs/too-liberal-func-base-name/{fileA.swiftdeps,fileB.swift,imported.swiftmodule} %t
