...
// RUN: cp -r %S/Inputs/too-conservative/* %t
...
// RUN: mkdir %t/stage1; cp %t/*.* stage1
...
// RUN: cp %S/Inputs/too-conservative/fileA.swiftdeps %t
// RUN: cp %S/Inputs/too-conservative/fileB2.swift %t/fileB.swift
...
// RUN: %t/main | tee run2 | grep Int > /dev/null && rm %t/main
...
// RUN: cp %S/Inputs/too-conservative/{fileA.swiftdeps,fileB.swift,imported.swiftmodule} %t
