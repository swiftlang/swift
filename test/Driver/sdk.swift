...
// RUN: env PATH=%t/usr/bin %swift_legacy_driver_plain -### -i %s | FileCheck -check-prefix=NOSDK %s
...
// RUN: env PATH=%t/usr/bin %swift_legacy_driver_plain -### -i %s | FileCheck -check-prefix=XCRUN-SDK %s
...
// RUN: env PATH=%t/usr/bin %swift_legacy_driver_plain -### -i %s | FileCheck -check-prefix=ROOT-SDK %s
