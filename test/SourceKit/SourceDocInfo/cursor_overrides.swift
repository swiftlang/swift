...
// RUN: %sourcekitd-test -req=cursor -pos=16:7 %s -- -embed-bitcode -triple x86_64-apple-macosx10.12 -I %S/Inputs/cursor-overrides %mcp_opt %s | FileCheck -check-prefix=CHECK1 %s
