...
// RUN: %sourcekitd-test -req=cursor -pos=117:6 %s -- -F %S/../Inputs/libIDE-mock-sdk -I %t.tmp %mcp_opt %s | tee /tmp/xxx | %FileCheck %s -check-prefix=CHECK52
...
// RUN: %sourcekitd-test -req=cursor -pos=157:6 %s -- -F %S/../Inputs/libIDE-mock-sdk -I %t.tmp %mcp_opt %s | tee /tmp/xxx | %FileCheck %s -check-prefix=CHECK72
