...
//
// INTERFACE:      @_alwaysEmitIntoClient @inline(always) @_disfavoredOverload public func hasBufferOverload(_ p: UnsafeMutableBufferPointer<CInt>)
// INTERFACE:      @{{_?}}lifetime(p: copy p)
// INTERFACE-NEXT: @_alwaysEmitIntoClient @inline(always) @_disfavoredOverload public func hasSpanOverload(_ p: inout MutableSpan<CInt>)
