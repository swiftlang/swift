...
// FIXME: rdar://152280207 (@_addressable annotations should support address projections into copyable types)
// Remove the FIXMEs in this file. Presumably they are all related to SILGen of address projections.
...
/* FIXME: Incorrect error: lifetime-dependent value escapes its scope
@lifetime(borrow holder)
...
/* TODO: Invalid SIL: rdar://152273896 (SILGen: @_addressableSelf support for class methods)
...
// FIXME: Unexpected copy: invalid when C is imported from C++.
//
...
// CHECK:   [[ACCESS:%[0-9]+]] = begin_access [read] [unsafe] [[MD]]
// FIXME-CHECK-NOT: load
// FIXME-CHECK-NOT: alloc_stack
// FIXME-CHECK-NOT: store
// FIXME-CHECK:   apply %{{.*}}([[ACCESS]]) : $@convention(method) (@in_guaranteed Object) -> ()
