...
// CHECK: }
func exploded_trivial_type_dead(_ a: inout Int) {
}
...
// CHECK-NOT: alloc_stack
// CHECK: }
func exploded_trivial_type_returned(_ a: inout Int) -> Int {
  return a
}
...
// CHECK-NOT: alloc_stack
// CHECK: }
func exploded_trivial_type_stored(_ a: inout Int) {
  a = 12
}
...
// CHECK-NOT: alloc_stack
// CHECK: }
func exploded_trivial_type_stored_returned(_ a: inout Int) -> Int {
  a = 12
  return a
}
...
// CHECK-NOT: alloc_stack
// CHECK: }
func exploded_nontrivial_type_dead(_ a: inout String) {
}
...
// CHECK-NOT: alloc_stack
// CHECK: }
func exploded_nontrivial_type_returned(_ a: inout String) -> String {
  return a
}
...
// CHECK-NOT: alloc_stack
// CHECK: }
func exploded_nontrivial_type_stored(_ a: inout String) {
  a = "x"
}
...
// CHECK-NOT: alloc_stack
// CHECK: }
func exploded_nontrivial_type_stored_returned(_ a: inout String) -> String {
  a = "x"
  return a
}
