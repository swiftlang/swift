...
// RUN: %target-swift-frontend -O -target %target-swift-5.1-abi-triple -primary-file %s %S/Inputs/specialize_opaque_type_archetypes_multifile_A.swift -emit-sil | %FileCheck %s
