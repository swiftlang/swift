...
// RESILIENT-LABEL: sil [serialized] [canonical] [stage=canonical] [ossa] @$s9External218ResilientContainerV33genericEagerMoveInlineableContextyyxlF : {{.*}} {
...
// RESILIENT-LABEL: sil [serialized] [canonical] [stage=canonical] [ossa] @$s9External218ResilientContainerV26eagerMoveInlineableContextyyF : $@convention(method) (@in_guaranteed ResilientContainer) -> () {
...
// RESILIENT-LABEL: sil [serialized] [canonical] [stage=canonical] [ossa] @$s9External218ResilientContainerV17inlineableContextyyF
