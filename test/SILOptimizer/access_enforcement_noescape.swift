// RUN: %target-swift-frontend -module-name access_enforcement_noescape -verify-sil-ownership -enforce-exclusivity=checked -Onone -emit-sil -swift-version 4 -parse-as-library %s | %FileCheck %s
