...
public func aggGenericStructUseMoveOnlyWithoutEscaping(_ x: AggGenericStruct<CopyableKlass>) {
}
public func aggGenericStructConsume(_ x: __owned AggGenericStruct<CopyableKlass>) {
}
