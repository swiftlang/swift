// RUN: %target-swift-frontend -emit-sil -enable-sil-ownership-verifier -sdk %S/../SILGen/Inputs %s -I %S/../SILGen/Inputs -enable-source-import -parse-stdlib -o /dev/null -verify
