...
// RUN: %target-swift-frontend -module-name access_marker_mandatory -enable-sil-ownership-verifier -parse-as-library -Xllvm -sil-full-demangle -emit-sil -Onone -enforce-exclusivity=checked %s | %FileCheck %s
