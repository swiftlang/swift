...
// RUN: %target-swift-frontend -profile-generate -enable-upcoming-feature InferSendableFromCaptures -Xllvm -sil-print-types -emit-silgen -primary-file %S/Inputs/constant_evaluable.swift -o %t/constant_evaluable_profiler_test_silgen.sil
//
