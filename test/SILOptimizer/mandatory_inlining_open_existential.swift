...
// CHECK-LABEL: sil hidden [heuristic_always_inline] @$s35mandatory_inlining_open_existential6callee1pAA1P_pAaD_p_tF
// CHECK: [[OPENED:%[0-9]+]] = open_existential_addr immutable_access {{%[0-9]+}} : $*any P to $*[[OPENED_TY:@opened\([0-9]+, any P\) Self]]
