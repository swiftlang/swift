...
// RUN: %target-build-swift -O -wmo -module-name=Main -package-name Pkg -I%t -I%S/Inputs/cross-module %s -Xfrontend -Rcross-module-optimization-serialization-failed -Xfrontend -verify
