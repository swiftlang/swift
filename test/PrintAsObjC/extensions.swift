...
// RUN: %target-swift-frontend %clang-importer-sdk -parse-as-library %t/extensions.swiftmodule -parse -emit-objc-header-path %t/extensions.h -import-objc-header %S/../Inputs/empty.h
