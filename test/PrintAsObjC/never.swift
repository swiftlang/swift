...
// RUN: %target-swift-frontend(mock-sdk: %clang-importer-sdk) -parse-as-library %t/never.swiftmodule -typecheck -verify -emit-objc-header-path %t/never.h -disable-objc-attr-requires-foundation-module
