...
class ClassWithCustomName {
  func forwardCustomName(_ _: ClassWithCustomName2) {}
}
...
@objc class Methods {
  ...
  func testIgnoredParam(_ _: Int) {}
  func testIgnoredParams(_ _: Int, again _: Int) {}
  ...
  @IBAction func actionMethod(_ _: AnyObject) {}

  func methodWithReservedParameterNames(_ long: AnyObject, protected: AnyObject) {}

  func honorRenames(_ _: ClassWithCustomName) {}

  func unmanaged(_ _: Unmanaged<AnyObject>) -> Unmanaged<Methods>? { return nil }
}
