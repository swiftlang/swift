// {"kind":"typecheck","signature":"swift::rewriting::RewriteSystem::verifyRewriteRules(swift::rewriting::RewriteSystem::ValidityPolicy) const","signatureNext":"RequirementMachine::computeCompletion"}
