...
public protocol Q_CollectionDefaultsType : Q_SequenceType, Q_IndexableType {
}
...
extension Q_CollectionDefaultsType {
  ...
  public final func generate() -> Q_IndexingGenerator<Boo> {
    return Q_IndexingGenerator(pos: self.startIndex, elements: self)
  }
}

public struct Q_IndexingGenerator<C: Q_IndexableType> : IteratorProtocol {
