...
struct BadIndexable2 : Indexable {
  ...
  // Since String is not Strideable, 'successor(of:)' will not be defaulted
}
...
struct GoodBidirectionalIndexable2 : BidirectionalIndexable {
  ...
  func successor(of i: String) -> String { return "" }
  func predecessor(of i: String) -> String { return "" }
}
...
struct BadBidirectionalIndexable : BidirectionalIndexable {
  ...
  // Since String is not Strideable, 'predecessor(of:)' will not be defaulted
}
