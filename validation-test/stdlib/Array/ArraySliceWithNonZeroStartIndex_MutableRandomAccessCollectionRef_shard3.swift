...
// Inputs/ArraySliceWithNonZeroStartIndex_MutableRandomAccessCollectionRef/main.swift,
// to limit each shard's running time to a reasonable amount.
// RUN: %empty-directory(%t)
// RUN: %target-build-swift %s %S/Inputs/ArraySliceWithNonZeroStartIndex_MutableRandomAccessCollectionRef/main.swift -o %t/a.out
