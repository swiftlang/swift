...
// Inputs/Slice_Of_MinimalMutableRangeReplaceableRandomAccessCollection_WithPrefix/main.swift,
// to limit each shard's running time to a reasonable amount.
// RUN: %empty-directory(%t)
// RUN: %target-build-swift %s %S/Inputs/Slice_Of_MinimalMutableRangeReplaceableRandomAccessCollection_WithPrefix/main.swift -o %t/a.out
