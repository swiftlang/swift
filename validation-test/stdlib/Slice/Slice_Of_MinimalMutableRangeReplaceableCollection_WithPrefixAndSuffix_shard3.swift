...
// Inputs/Slice_Of_MinimalMutableRangeReplaceableCollection_WithPrefixAndSuffix/main.swift,
// to limit each shard's running time to a reasonable amount.
// RUN: %empty-directory(%t)
// RUN: %target-build-swift %s %S/Inputs/Slice_Of_MinimalMutableRangeReplaceableCollection_WithPrefixAndSuffix/main.swift -o %t/a.out
