...
// Inputs/MinimalMutableRangeReplaceableBidirectionalCollection/main.swift,
// to limit each shard's running time to a reasonable amount.
// RUN: %empty-directory(%t)
// RUN: %target-build-swift %s %S/Inputs/MinimalMutableRangeReplaceableBidirectionalCollection/main.swift -o %t/a.out
