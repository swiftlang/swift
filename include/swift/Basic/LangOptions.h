...
namespace swift {
  ...
  public:
    ...
    /// Check whether the given platform condition matches the given string.
    bool checkPlatformConditionAndValue(PlatformConditionKind Kind, StringRef Value) const;
