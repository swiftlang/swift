...
/// Determine whether the concrete `remoteCall(Void)(...)` witness
/// on the given actor system is `nonisolated(nonsending)`.
///
...
bool distributedThunkShouldBeNonisolatedNonsending(FuncDecl *func);
