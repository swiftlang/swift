...
enum class MemberwiseInitKind {
  /// The default memberwise initalizer.
  Default,
  /// A compatibility memberwise initializer that includes private initialized
  /// variables. This only exists for migration purposes, and will be removed
  /// in a future language mode.
  Compatibility
};
...
public:
  ...
  bool isMemberwiseInitialized(MemberwiseInitKind initKind,
...
public:
  ...
  void setIsMemberwiseInitializer(MemberwiseInitKind initKind) {
    ...
    switch (initKind) {
    case MemberwiseInitKind::Default:
  ...
  std::optional<MemberwiseInitKind> isMemberwiseInitializer() const {
    ...
    case SILSynthesizeKind::MemberwiseInitializer:
      return MemberwiseInitKind::Default;
