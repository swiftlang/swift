...
public:
  ...
  static IndexSubset *get(const ASTContext &ctx, const SmallBitVector &indices);

  static IndexSubset *get(const ASTContext &ctx, unsigned capacity,
  ...
  static IndexSubset *getDefault(const ASTContext &ctx, unsigned capacity,
                                 bool includeAll = false) {
    return get(ctx, SmallBitVector(capacity, includeAll));
  }

  static IndexSubset *getFromRange(const ASTContext &ctx, unsigned capacity,
  ...
  static IndexSubset *getFromString(const ASTContext &ctx, StringRef string);
  ...
  IndexSubset *adding(unsigned index, const ASTContext &ctx) const;
  IndexSubset *extendingCapacity(const ASTContext &ctx,
