...
public:
  ...
  virtual void markConformanceUsed(ProtocolConformanceRef conformance) = 0;
};
...
public:
  ...
  void markConformanceUsed(ProtocolConformanceRef conformance) override {
    return Principal.markConformanceUsed(conformance);
  }
};
