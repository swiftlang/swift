...
/// An ASTContext-data structure to identify a subset of indices like
/// a bit vector. It is most notably used for for identifying a subset of
/// function parameters and results in automatic differentiation code paths.
