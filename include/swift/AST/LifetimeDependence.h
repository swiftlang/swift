...
public:
  ...
  /// Determine whether this LifetimeDependenceInfo can convert to other. This
  /// is determined according to the Lifetime Subtyping rules in
  /// docs/ReferenceGuides/LifetimeAnnotation.md.
  ///
  /// See canConvertLifetimeDependencies.
  bool canConvertTo(const LifetimeDependenceInfo &other) const;
...
/// Determine whether 'from's lifetime dependencies
/// are can convert to those specified by 'to'.
///
...
bool canConvertLifetimeDependencies(ArrayRef<LifetimeDependenceInfo> from, ArrayRef<LifetimeDependenceInfo> to);
