...
class HiddenLibSyntaxAction : public SyntaxParseActions {
  ...
  /// The explicit action. Will never be \c nullptr. If no explicit action was
...
public:
  ...
  /// null. If no \c ExplicitAction is given, the \c LibSyntaxAction will also
  /// be used as the \c LibSyntaxAction.
  ...
  OpaqueSyntaxNodeKind getOpaqueKind() override {
    return OpaqueSyntaxNodeKind::HiddenSyntax;
  }
