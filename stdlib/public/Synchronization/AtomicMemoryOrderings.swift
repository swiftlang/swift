...
public struct AtomicRelaxed {
  ...
  @_alwaysEmitIntoClient
  @_transparent
  public static var relaxed: AtomicRelaxed {
    AtomicRelaxed()
  }
}
...
public struct AtomicAcquiring {
  ...
  @_alwaysEmitIntoClient
  @_transparent
  public static var acquiring: AtomicAcquiring {
    AtomicAcquiring()
  }
}
...
public struct AtomicReleasing {
  ...
  @_alwaysEmitIntoClient
  @_transparent
  public static var releasing: AtomicReleasing {
    AtomicReleasing()
  }
}
...
@available(SwiftStdlib 5.10, *)
@frozen
public struct AtomicAcquiringAndReleasing {
  @available(SwiftStdlib 5.10, *)
  @_alwaysEmitIntoClient
  @_transparent
  init() {}
  ...
  @_alwaysEmitIntoClient
  @_transparent
  public static var acquiringAndReleasing: AtomicAcquiringAndReleasing {
    AtomicAcquiringAndReleasing()
  }
}

@available(SwiftStdlib 5.10, *)
@frozen
public struct AtomicSequentiallyConsistent {
  @available(SwiftStdlib 5.10, *)
  @_alwaysEmitIntoClient
  @_transparent
  init() {}
  ...
  @_alwaysEmitIntoClient
  @_transparent
  public static var sequentiallyConsistent: AtomicSequentiallyConsistent {
...
@_transparent
public func atomicMemoryFence(
  ordering: AtomicAcquiringAndReleasing
) {
...
@_transparent
public func atomicMemoryFence(
  ordering: AtomicSequentiallyConsistent
) {
