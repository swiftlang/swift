...
/// tasks do not outlive the scope in which they are created. The guarantee that within
/// a structured task hierarchy, which can span many levels of child tasks,
/// no child-task will remain running longer than its parent task, simplifies reasoning about resource usage,
