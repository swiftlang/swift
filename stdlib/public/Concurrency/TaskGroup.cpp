...
PollResult TaskGroupImpl::waitAll(AsyncTask *waitingTask) {
  SWIFT_TASK_DEBUG_LOG("group(%p) waitAll, status = %s", this, statusLoadRelaxed().to_string(this).c_str());
