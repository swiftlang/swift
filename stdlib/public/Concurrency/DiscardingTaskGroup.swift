...
public func withDiscardingTaskGroup<GroupResult>( // for source-compatibility
  returning returnType: GroupResult.Type = GroupResult.self,
...
@_disfavoredOverload
@available(*, deprecated, message: "Replaced by nonisolated(nonsending) overload")
public func withThrowingDiscardingTaskGroup<GroupResult>( // for source-compatibility
  returning returnType: GroupResult.Type = GroupResult.self,
  isolation: isolated (any Actor)? = #isolation,
