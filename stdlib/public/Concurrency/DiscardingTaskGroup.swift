...
nonisolated(nonsending) public func withDiscardingTaskGroup<GroupResult>(
...
public struct DiscardingTaskGroup {
  ...
  @usableFromInline
  nonisolated(nonsending) internal mutating func awaitAllRemainingTasksNonsending() async throws {
...
@available(SwiftStdlib 5.9, *)
@_alwaysEmitIntoClient
nonisolated(nonsending) public func withThrowingDiscardingTaskGroup<GroupResult>(
  returning returnType: GroupResult.Type = GroupResult.self,
...
public struct ThrowingDiscardingTaskGroup<Failure: Error> {
  ...
  /// Await all the remaining tasks on this group.
  @usableFromInline
  nonisolated(nonsending) internal mutating func awaitAllRemainingTasksNonisolated(bodyError: Error?) async throws {
