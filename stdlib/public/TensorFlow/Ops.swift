...
public extension Tensor where Scalar : Numeric & Comparable {
  ...
  @_inlineable @inline(__always)
  func argmax() -> Int32 {
    return _TFGetScalarOrDie(flattened().argmax(squeezingAxis: 0))
  }

  /// Returns the index of the minimum value of the flattened scalars.
  @_inlineable @inline(__always)
  func argmin() -> Int32 {
    return _TFGetScalarOrDie(flattened().argmin(squeezingAxis: 0))
  }
}
...
public extension Tensor where Scalar : Numeric {
  ...
  func mean() -> Scalar {
    let axes = Tensor<Int32>(rangeFrom: 0, to: rank, stride: 1)
    return _TFGetScalarOrDie(Raw.mean(self, reductionIndices: axes))
  }
  ...
  func sum() -> Scalar {
    let axes = Tensor<Int32>(rangeFrom: 0, to: rank, stride: 1)
    return _TFGetScalarOrDie(Raw.sum(self, reductionIndices: axes))
  }
