...
extension String {
  ...
  @swift3_migration(renamed="localizedName(of:)")
  @warn_unused_result
  ...
  /// information.
  @warn_unused_result
  @swift3_migration(renamed="canBeConverted(to:)")
  ...
  @warn_unused_result
  @swift3_migration(renamed="capitalized(with:)")
  ...
  @warn_unused_result
  @swift3_migration(renamed="completePath(into:caseSensitive:matchesInto:filterTypes:)")
  ...
  @warn_unused_result
  @swift3_migration(renamed="components(separatedBy:)")
  ...
  /// locale.
  @warn_unused_result
  @swift3_migration(renamed="lowercased(with:)")
  ...
  @warn_unused_result
  @swift3_migration(renamed="padding(toLength:withPad:startingAt:)")
  ...
  /// locale.
  @warn_unused_result
  @swift3_migration(renamed="uppercased(with:)")
