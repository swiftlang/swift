...
public struct URL : ReferenceConvertible, CustomStringConvertible, Equatable {
    ...
    /// - seealso: func bookmarkData(_ options: BookmarkCreationOptions = [], includingResourceValuesForKeys keys: Set<URLResourceKey>? = nil, relativeTo url: URL? = nil) throws -> Data
    ...
    public func bookmarkData(_ options: BookmarkCreationOptions = [], includingResourceValuesForKeys keys: Set<URLResourceKey>? = nil, relativeTo url: URL? = nil) throws -> Data {
        let result = try _url.bookmarkData(options, includingResourceValuesForKeys: keys.flatMap { Array($0) }, relativeTo: url)
