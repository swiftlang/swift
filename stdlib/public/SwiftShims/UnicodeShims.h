...
const __swift_uint8_t *swift_stdlib_GraphemeClusterBreakPropertyTrie;
...
swift_stdlib_GraphemeClusterBreakPropertyTrieMetadata;

SWIFT_RUNTIME_STDLIB_API
const __swift_uint16_t *
swift_stdlib_ExtendedGraphemeClusterNoBoundaryRulesMatrix;

SWIFT_RUNTIME_STDLIB_API
__swift_int32_t swift_stdlib_unicode_strToUpper(
...
SWIFT_RUNTIME_STDLIB_API
__swift_int32_t swift_stdlib_unicode_strToLower(
  __swift_uint16_t *Destination, __swift_int32_t DestinationCapacity,
  const __swift_uint16_t *Source, __swift_int32_t SourceLength);
...
SWIFT_RUNTIME_STDLIB_API
void swift_stdlib_ubrk_close(__swift_stdlib_UBreakIterator *bi);

SWIFT_RUNTIME_STDLIB_API
__swift_stdlib_UBreakIterator *
swift_stdlib_ubrk_open(__swift_stdlib_UBreakIteratorType type,
...
SWIFT_RUNTIME_STDLIB_API
void swift_stdlib_ubrk_setUText(__swift_stdlib_UBreakIterator *bi,
                                  __swift_stdlib_UText *text,
                                  __swift_stdlib_UErrorCode *status);

SWIFT_RUNTIME_STDLIB_API
void swift_stdlib_ubrk_setText(__swift_stdlib_UBreakIterator *bi,
...
swift_stdlib_utext_openUTF8(__swift_stdlib_UText *_Nullable, const char *,
                              __swift_int64_t, __swift_stdlib_UErrorCode *);

SWIFT_RUNTIME_STDLIB_API
__swift_stdlib_UText *
swift_stdlib_utext_openUChars(__swift_stdlib_UText *_Nullable,
                                const __swift_stdlib_UChar *, __swift_int64_t,
                                __swift_stdlib_UErrorCode *);

SWIFT_RUNTIME_STDLIB_API
__swift_int32_t swift_stdlib_ubrk_preceding(__swift_stdlib_UBreakIterator *bi,
                                              __swift_int32_t offset);

SWIFT_RUNTIME_STDLIB_API
__swift_int32_t swift_stdlib_ubrk_following(__swift_stdlib_UBreakIterator *bi,
                                              __swift_int32_t offset);

SWIFT_RUNTIME_STDLIB_API
__swift_stdlib_UBool
swift_stdlib_unorm2_hasBoundaryBefore(const __swift_stdlib_UNormalizer2 *,
                                        __swift_stdlib_UChar32);

SWIFT_RUNTIME_STDLIB_API
const __swift_stdlib_UNormalizer2 *
swift_stdlib_unorm2_getNFCInstance(__swift_stdlib_UErrorCode *);

SWIFT_RUNTIME_STDLIB_API
__swift_int32_t
swift_stdlib_unorm2_normalize(const __swift_stdlib_UNormalizer2 *,
                                const __swift_stdlib_UChar *, __swift_int32_t,
                                __swift_stdlib_UChar *, __swift_int32_t,
                                __swift_stdlib_UErrorCode *);

SWIFT_RUNTIME_STDLIB_API
__swift_int32_t swift_stdlib_unorm2_spanQuickCheckYes(
...
SWIFT_RUNTIME_STDLIB_API
void swift_stdlib_u_charAge(
    __swift_stdlib_UChar32, __swift_stdlib_UVersionInfo _Nonnull);

SWIFT_RUNTIME_STDLIB_API
__swift_int32_t
    swift_stdlib_u_getIntPropertyValue(__swift_stdlib_UChar32,
                                         __swift_stdlib_UProperty);

SWIFT_RUNTIME_STDLIB_API
__swift_int32_t swift_stdlib_u_charName(
...
SWIFT_RUNTIME_STDLIB_API
__swift_int32_t swift_stdlib_u_strToLower(
...
SWIFT_RUNTIME_STDLIB_API
__swift_int32_t swift_stdlib_u_strToTitle(
    __swift_stdlib_UChar *dest, __swift_int32_t destCapacity,
    const __swift_stdlib_UChar *src, __swift_int32_t srcLength,
...
SWIFT_RUNTIME_STDLIB_API
__swift_int32_t swift_stdlib_u_strToUpper(
    __swift_stdlib_UChar *dest, __swift_int32_t destCapacity,
    const __swift_stdlib_UChar *src, __swift_int32_t srcLength,
    const char *_Nullable locale, __swift_stdlib_UErrorCode *pErrorCode);

SWIFT_RUNTIME_STDLIB_API
double swift_stdlib_u_getNumericValue(__swift_stdlib_UChar32 c);
