...
// OutputRawSpan<Element> represents a span of memory which contains
...
@available(SwiftStdlib 6.2, *)
extension OutputRawSpan: Sendable {}

@available(SwiftStdlib 6.2, *)
extension OutputRawSpan where Element: ~Copyable  {
...
//    let os = OutputRawSpan(_initializing: buf, initialized: initialized)
...
@available(SwiftStdlib 6.2, *)
extension OutputRawSpan where Element: BitwiseCopyable {
...
//    let os = OutputRawSpan(_initializing: rebased, initialized: initialized)
//    self = unsafe _overrideLifetime(os, borrowing: buffer)
//  }
}
...
extension OutputRawSpan where Element: ~Copyable {
  ...
  public mutating func moveAppend(
    ...
    let source = unsafe OutputRawSpan(
