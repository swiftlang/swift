...
extension StorageView.Index: Equatable where Element: ~Copyable {
...
extension StorageView.Index: Hashable where Element: ~Copyable {}
...
extension StorageView.Index: Comparable where Element: ~Copyable {
  @inlinable @inline(__always)
  public static func <(lhs: Self, rhs: Self) -> Bool {
