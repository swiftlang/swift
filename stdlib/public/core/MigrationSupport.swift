...
extension LazySequenceProtocol {
  ...
  ///
  /// - Complexity: O(1)
  @available(swift, deprecated: 4.1, obsoleted: 5.1, renamed: "compactMap(_:)", message: "Please use compactMap(_:) for the case where closure returns an optional value")
