...
public protocol CodingKeyPath: CustomStringConvertible,
                               CustomDebugStringConvertible {
  /// The `CodingKey` components that comprise this Key Path.
...
/// Default implementation to `CodingKeyPath` for a
/// String-based `RawRepresentable` enum.
