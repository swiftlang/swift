...
///
/// With a `CodingKeyRepresentable` type, you can convert between a
...
/// container, rather than encoding the dictionary as an unkeyed container of alternating key-value pairs.
