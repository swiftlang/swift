...
extension String {
  ...
  @swift3_migration(message="Please use String.init?(validatingUTF8:). Note however that is does not accept nil as a valid pointer.")
  @warn_unused_result
  ...
  /// characters (U+FFFD).
  @swift3_migration(message="Please use String.init(cString:). Note however that is does not accept nil as a valid pointer. String.decodeCString might also be an option, should you need more control.")
  @warn_unused_result
