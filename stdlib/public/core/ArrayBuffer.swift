...
internal struct _ArrayBuffer<Element> : _ArrayBufferProtocol {
  ...
  internal init(nsArray: _NSArrayCore) {
    _correctnessCheck(_isClassOrObjCExistential(Element.self))
  ...
  internal func downcast<U>(
    ...
    // _correctnessCheck(U.self is Element.Type)
...
extension _ArrayBuffer {
  ...
  internal var firstElementAddress: UnsafeMutablePointer<Element> {
    _correctnessCheck(_isNative, "must be a native buffer")
  ...
  internal var count: Int {
    ...
    set {
      _correctnessCheck(_isNative, "attempting to update count of Cocoa array")
  ...
  internal var nativeOwner: AnyObject {
    _correctnessCheck(_isNative, "Expect a native array")
