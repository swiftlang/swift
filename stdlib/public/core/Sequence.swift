...
public protocol Sequence {
  ...
  /// Calls the given closure with a pointer to the sequence's
  /// contiguous storage.  If no such storage exists, it is
  /// first created.  If the sequence does not support an internal
  /// representation in a form of contiguous storage, the closure is not
