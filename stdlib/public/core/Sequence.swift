...
@swift3_migration(renamed="IteratorProtocol")
...
@swift3_migration(renamed="Sequence")
...
extension SequenceType where Generator.Element : Equatable {
  ...
  ///
  /// - Requires: `maxSplit >= 0`
  @swift3_migration(message="call 'split(by:maxSplits:omittingEmptySubsequences:)' and invert the 'allowEmptySlices' argument")
  @warn_unused_result
  public func split(
...
@swift3_migration(renamed="IteratorSequence")
