...
public struct ClassMetadata {
  @unsafe var superclassMetadata: UnsafeMutablePointer<ClassMetadata>?
...
public struct HeapObject {
  ...
  @unsafe var metadata: UnsafeRawPointer
...
@unsafe func alignedAlloc(size: Int, alignment: Int) -> UnsafeMutableRawPointer? {
...
@unsafe func swift_allocObject(metadata: UnsafeMutablePointer<ClassMetadata>, requiredSize: Int, requiredAlignmentMask: Int) -> UnsafeMutablePointer<HeapObject> {
...
@safe(unchecked) @_cdecl("swift_deallocObject")
...
@unsafe func swift_deallocObject(object: UnsafeMutablePointer<HeapObject>, allocatedSize: Int, allocatedAlignMask: Int) {
  free(UnsafeMutableRawPointer(object))
}

@safe(unchecked) @_cdecl("swift_deallocClassInstance")
...
@unsafe func swift_deallocClassInstance(object: UnsafeMutablePointer<HeapObject>, allocatedSize: Int, allocatedAlignMask: Int) {
...
@safe(unchecked) @_cdecl("swift_deallocPartialClassInstance")
...
@unsafe func swift_deallocPartialClassInstance(object: UnsafeMutablePointer<HeapObject>, metadata: UnsafeMutablePointer<ClassMetadata>, allocatedSize: Int, allocatedAlignMask: Int) {
...
@safe(unchecked) @_cdecl("swift_initStaticObject")
...
@unsafe func swift_initStaticObject(metadata: UnsafeMutablePointer<ClassMetadata>, object: UnsafeMutablePointer<HeapObject>) -> UnsafeMutablePointer<HeapObject> {
  _swift_embedded_set_heap_object_metadata_pointer(object, metadata)
  object.pointee.refcount = HeapObject.immortalRefCount | HeapObject.doNotFreeBit
  return object
}

@safe(unchecked) @_cdecl("swift_initStackObject")
...
@unsafe func swift_initStackObject(metadata: UnsafeMutablePointer<ClassMetadata>, object: UnsafeMutablePointer<HeapObject>) -> UnsafeMutablePointer<HeapObject> {
  _swift_embedded_set_heap_object_metadata_pointer(object, metadata)
...
@unsafe @_cdecl("swift_dynamicCastClass")
...
@unsafe @_cdecl("swift_dynamicCastClassUnconditional")
...
@safe(unchecked) @_cdecl("swift_isUniquelyReferenced_native")
...
@safe(unchecked) @_cdecl("swift_isUniquelyReferenced_nonNull_native")
public func swift_isUniquelyReferenced_nonNull_native(object: Builtin.RawPointer) -> Bool {
  return swift_isUniquelyReferenced_nonNull_native(object: UnsafeMutablePointer<HeapObject>(object))
}

@unsafe func swift_isUniquelyReferenced_nonNull_native(object: UnsafeMutablePointer<HeapObject>) -> Bool {
  let refcount = refcountPointer(for: object)
  return loadAcquire(refcount) == 1
}

@safe(unchecked) @_cdecl("swift_retain")
...
@safe(unchecked) @_cdecl("swift_retain_n")
...
@unsafe func swift_retain_n_(object: UnsafeMutablePointer<HeapObject>, n: UInt32) -> UnsafeMutablePointer<HeapObject> {
  let refcount = refcountPointer(for: object)
...
@safe(unchecked) @_cdecl("swift_release")
...
@safe(unchecked) @_cdecl("swift_release_n")
...
@unsafe func swift_release_n_(object: UnsafeMutablePointer<HeapObject>?, n: UInt32) {
...
@safe(unchecked) @_cdecl("swift_retainCount")
...
@unsafe fileprivate func refcountPointer(for object: UnsafeMutablePointer<HeapObject>) -> UnsafeMutablePointer<Int> {
...
@unsafe fileprivate func loadRelaxed(_ atomic: UnsafeMutablePointer<Int>) -> Int {
  Int(Builtin.atomicload_monotonic_Word(atomic._rawValue))
}

@unsafe fileprivate func loadAcquire(_ atomic: UnsafeMutablePointer<Int>) -> Int {
  Int(Builtin.atomicload_acquire_Word(atomic._rawValue))
}

@unsafe fileprivate func subFetchAcquireRelease(_ atomic: UnsafeMutablePointer<Int>, n: Int) -> Int {
  let oldValue = Int(Builtin.atomicrmw_sub_acqrel_Word(atomic._rawValue, n._builtinWordValue))
  return oldValue - n
}

@unsafe fileprivate func addRelaxed(_ atomic: UnsafeMutablePointer<Int>, n: Int) {
  _ = Builtin.atomicrmw_add_monotonic_Word(atomic._rawValue, n._builtinWordValue)
}

@unsafe fileprivate func compareExchangeRelaxed(_ atomic: UnsafeMutablePointer<Int>, expectedOldValue: Int, desiredNewValue: Int) -> Bool {
...
@unsafe fileprivate func storeRelease(_ atomic: UnsafeMutablePointer<Int>, newValue: Int) {
  Builtin.atomicstore_release_Word(atomic._rawValue, newValue._builtinWordValue)
}

@unsafe fileprivate func storeRelaxed(_ atomic: UnsafeMutablePointer<Int>, newValue: Int) {
  Builtin.atomicstore_monotonic_Word(atomic._rawValue, newValue._builtinWordValue)
}

/// Exclusivity checking

@unsafe @_cdecl("swift_beginAccess")
...
@unsafe @_extern(c, "arc4random_buf")
func arc4random_buf(buf: UnsafeMutableRawPointer, nbytes: Int)

@unsafe public func swift_stdlib_random(_ buf: UnsafeMutableRawPointer, _ nbytes: Int) {
  arc4random_buf(buf: buf, nbytes: nbytes)
}

@unsafe @_cdecl("swift_clearSensitive")
@inline(never)
