...
extension String {
  ...
  public struct UTF8View
    ...
    public var endIndex: Index {
      _invariant(_legacyOffsets.end >= -3 && _legacyOffsets.end <= 0,
    ...
    internal func _nonASCIIIndex(atEncodedOffset n: Int) -> Index {
      _invariant(!_guts._isASCIIOrSmallASCII)
...
extension String.UTF8View.Iterator : IteratorProtocol {
  ...
  internal mutating func _fillBuffer() -> Unicode.UTF8.CodeUnit {
    _invariant(!_guts.isASCII, "next() already checks for known ASCII")
