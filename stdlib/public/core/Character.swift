  ...
  internal init(_unverified guts: _StringGuts) {
    self = _visitGuts(guts,
      ascii: { ascii in
        ...
        _invariant(ascii.count == 2)
        _invariant(ascii.start[0] == _CR)
        _invariant(ascii.start[1] == _LF)
