  ...
  func toUpper() -> String {
    ...
    while i != len {
      ...
      if u8 < 0x80 {
        ...
        if u8 == 0xC3 && (0xA0 .. 0xBF).contains(u8_1) && u8_1 != 0xB7 {
  ...
  func toLower() -> String {
    ...
    while i != len {
      ...
      if u8 < 0x80 {
        ...
        resultArray[i] = u8
        var u8_1 = str_value[i + 1]
        if u8 == 0xC3 && (0x80 .. 0x9F).contains(u8_1) && u8_1 != 0x97 {
          resultArray[i+1] = u8_1 + 0x20
        } else {
          resultArray[i+1] = u8_1
        }
...
extension String {
  constructor(v : Int128, radix : Int = 10) {
    var Buffer = StringByteData.getNew(128)
    var i = c_print_int(Buffer.base.value, 128, v, radix)
    str_value = Buffer[0..Int(i)]
  }

  constructor(v : Int8, radix : Int = 10) {
    this = String(Int128(v), radix)
  }
  constructor(v : UInt8, radix : Int = 10) {
    this = String(Int128(v), radix)
  }
  constructor(v : Int16, radix : Int = 10) {
    this = String(Int128(v), radix)
  }
  constructor(v : Int32, radix : Int = 10) {
    this = String(Int128(v), radix)
  }
  constructor(v : UInt32, radix : Int = 10) {
    this = String(Int128(v), radix)
  }
  constructor(v : Int64, radix : Int = 10) {
    this = String(Int128(v), radix)
  }
  constructor(v : UInt64, radix : Int = 10) {
    this = String(Int128(v), radix)
  }
...
struct StringByteData : Enumerable {
   ...
   typealias Elements = StringByteData
   func getElements() -> StringByteData { return this }
  ...
  subscript (rng : IntRange) -> StringByteData {
    get {
      var len = getLength()
...
extension StringByteData : Range {
