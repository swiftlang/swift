...
extension UInt8 {
  ...
  init(v: UInt) {
    var srcNotWord = Builtin.zextOrBitCast_Word_Int64(v.value)
    var tmp = Builtin.u_to_u_checked_trunc_Int64_Int8(srcNotWord)
    Builtin.condfail(tmp.1)
    var dstNotWord = tmp.0
    value = dstNotWord
...
extension UInt32 : Hashable {
  func hashValue() -> Int {
    return Int(Builtin.sextOrBitCast_Int32_Word(self.value))
  }
}
...
struct Int32 : BuiltinIntegerLiteralConvertible, IntegerLiteralConvertible,
  ...
  @transparent
  func _getBuiltinArrayBoundValue() -> Builtin.Word {
    return Builtin.sextOrBitCast_Int32_Word(self.value)
  }
...
extension UInt64 : Hashable {
  func hashValue() -> Int {
    return Int(Builtin.truncOrBitCast_Int64_Word(self.value))
  }
}
...
struct UInt : BuiltinIntegerLiteralConvertible, IntegerLiteralConvertible,
  ...
  @transparent
  type var max: UInt { return 0xFFFF_FFFF_FFFF_FFFF }
  @transparent
...
extension UInt {
  init(v: UInt8) {
    var srcNotWord = v.value
    var dstNotWord = Builtin.zext_Int8_Int64(srcNotWord)
    value = Builtin.truncOrBitCast_Int64_Word(dstNotWord)
  }
...
struct Int : BuiltinIntegerLiteralConvertible, IntegerLiteralConvertible,
  ...
  @transparent
  type var max: Int { return 0x7FFF_FFFF_FFFF_FFFF }
  @transparent
  type var min: Int { return -0x7FFF_FFFF_FFFF_FFFF-1 }
}
