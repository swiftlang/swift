...
2. Clone `swiftlang/swift-cmark`, `swiftlang/swift`, `swiftlang/swift-corelibs-libdispatch`, `swiftlang/swift-corelibs-foundation`, `swiftlang/swift-corelibs-xctest`, `swiftlang/swift-tools-support-core`, `swiftlang/swift-llbuild`, `swiftlang/swift-argument-parser`, `swiftlang/swift-driver`, `swiftlang/swift-package-manager`, `JPSim/Yams`, `swiftlang/indexstore-db` into the build workspace
...
git clone https://github.com/swiftlang/swift-argument-parser swift-argument-parser
