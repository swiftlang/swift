...
1. Clone `apple/swift-llbuild` into a folder named `swift-llbuild`
1. Clone `apple/swift-package-manager` into a folder named `swift-package-manager`
...
git clone https://github.com/apple/swift-llbuild
...
md S:\b\spm
cd S:\b\spm
C:\Python27\python.exe S:\swift-package-manager\Utilities\bootstrap --foundation S:\b\foundation --libdisptch-build-dir S:\b\libdispatch --libdispatch-source-dir S:\swift-corelibs-libdispatch
```
