...
**Declaration type validation**: Produces a type for each declaration.
...
Whenever the conformance lookup table encounters a problem, such as a
...
**Order-independence testing**: One of the intended improvements from
