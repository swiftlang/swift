...
The Swift programming language was designed to interoperate well with C and Objective-C. Existing Objective-C APIs were available to Swift programs since the initial release of Swift. This rich interoperability support allowed Swift to supplant Objective-C in a lot of codebases. On the other hand, Swift did not have a good C++ interoperability story, which hindered its ability to coexist with or supplant C++ in existing C++ codebases.
