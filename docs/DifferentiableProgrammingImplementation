...
> NOTE: The custom differentiation tutorial does not reflect the current state of differentiation in Swift. You can use it as a general guide to differentiaion, but its code samples will not compile.
