...
A type has a universally fragile representation if there is no
...
Most language structures in Swift have resilience implications. This
...
It is an error to place the \[unchanging\] annotation on any of these
types:
