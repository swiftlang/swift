...
\begin{gather*}
\ConfReq{\rT}{Sequence}\otimes\Sigma_a = \ConfReq{String}{Sequence}\\
\ConfReq{\rU}{Sequence}\otimes\Sigma_a = \ConfReq{Substring}{Sequence}\\
...
\begin{gather*}
\ConfReq{\rT}{Sequence}\otimes\Sigma = \ConfReq{$\archetype{C}$}{Sequence}\\
\ConfReq{\rU}{Sequence}\otimes\Sigma = \ConfReq{$\archetype{C.SubSequence}$}{Sequence}\\
...
\\
&\ConfReq{\rT}{Sequence} \mapsto \text{(invalid)},\\
&\SubstConf{\rU}{Set<Int>}{Sequence}
}
\end{align*}
We apply this substitution map to each requirement of our generic signature:
\begin{gather*}
\ConfReq{\rT}{Sequence}\otimes\Sigma = \ConfReq{Float}{Sequence}\\
\ConfReq{\rU}{Sequence}\otimes\Sigma = \ConfReq{Set<Int>}{Sequence}\\
