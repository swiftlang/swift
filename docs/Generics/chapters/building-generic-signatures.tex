...
\begin{enumerate}
\item For a \index{conformance requirement}\textbf{conformance requirement} $\TP$, perform the \index{global conformance lookup}global conformance lookup $\pP\otimes\tT$:
\begin{enumerate}
