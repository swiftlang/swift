...
% Workaround from https://github.com/muzimuzhi/thmtools/issues/72
...
\newcommand{\VerbInput}[1]{\VerbatimInput[frame=single]{\currfiledir #1}}
...
\newcommand{\Tprime}{\texttt{T}'}
\newcommand{\Xprime}{\texttt{X}'}
\newcommand{\Cprime}{\texttt{C}'}
...
\newcommand{\FwdMap}[1]{1_{\EquivClass{#1}}}

% Opaque archetypes for Chapter 12
\newcommand{\Opaque}[1]{\EquivClass{\circlearrowright \texttt{#1}}}
\newcommand{\Ot}{\Opaque{\tT}}
\newcommand{\Ox}{\Opaque{\rT}}
\newcommand{\Oy}{\Opaque{\ttgp{1}{0}}}

% Existential archetypes for Chapter 13
\newcommand{\Exist}[1]{\EquivClass{\Box\,\texttt{#1}}}
\newcommand{\Et}{\Exist{T}}
\newcommand{\ESelf}{\Exist{Self}}
\newcommand{\AnyP}{\texttt{any~P}}
\newcommand{\AnyQ}{\texttt{any~Q}}
\newcommand{\AnyX}{\texttt{any~X}}
\newcommand{\AnyY}{\texttt{any~Y}}
...
\newcommand{\ConfRule}[2]{#1 \cdot #2 \Eq #1}
\newcommand{\SameRule}[2]{#1 \Eq #2}
\newcommand{\AssocRule}[2]{\protosym{#1}\cdot\texttt{#2} \Eq \assocsym{#1}{#2}}

\newcommand{\CRule}[1]{$\diamond\, #1$}

%%%
% Proof at the end of completion chapter
%%%
...
% Tweak the spacing in the table of contents to get better page breaks.
\RedeclareSectionCommands[tocbeforeskip=1.5em]{part}
...
\newcommand{\IndexProto}[1]{\Index{#1 protocol@\texttt{#1} protocol}}
...
\part{Nuts and Bolts}\label{part:nuts and bolts}
...
\subfile{chapters/opaque-result-types}
