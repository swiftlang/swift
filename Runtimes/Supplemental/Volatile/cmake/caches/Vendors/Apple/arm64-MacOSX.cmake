...
if(NOT DEFINED SwiftVolatile_TARGET_VARIANT_DEPLOYMENT_TARGET)
  message(SEND_ERROR "SwiftVolatile_TARGET_VARIANT_DEPLOYMENT_TARGET not defined")
endif()
...
set(SwiftVolatile_PLATFORM_SUBDIR macosx CACHE STRING "")

set(SwiftVolatile_COMPILER_VARIANT_TARGET "arm64-apple-ios${SwiftVolatile_TARGET_VARIANT_DEPLOYMENT_TARGET}-macabi" CACHE STRING "")
